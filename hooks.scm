...
(define (snd-hooks)
  ...
  (list after-graph-hook lisp-graph-hook before-transform-hook mix-release-hook save-hook mus-error-hook
	...
	mark-hook view-files-select-hook dac-hook stop-dac-hook stop-playing-selection-hook after-apply-hook draw-mark-hook
	...
	start-playing-selection-hook recorder-file-hook selection-changed-hook after-save-as-hook before-save-as-hook
	before-exit-hook before-close-hook))
