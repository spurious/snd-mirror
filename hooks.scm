...
(define (snd-hooks)
  (list after-graph-hook lisp-graph-hook before-transform-hook mix-position-changed-hook stop-playing-channel-hook save-hook mus-error-hook
	...
	graph-hook key-press-hook mouse-drag-hook mouse-press-hook mouse-release-hook enved-hook read-hook mouse-click-hook 
	mark-hook previous-files-select-hook dac-hook stop-dac-hook stop-playing-selection-hook apply-hook))
