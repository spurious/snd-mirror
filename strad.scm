...
(define* (bow beg dur frq amplitude #:key
	      (bufsize 2205)
  ...
  (let* ((beg (inexact->exact (floor (* beg *srate*))))
    ...
    (run
	 ...
	 (set! vint (+ (/ (* (vct-ref vinut indexrt_2) (- alphart 1)(- alphart 2)) 2)
		       (* (vct-ref vinut indexrt_1) (* alphart -1) (- alphart 2))
		       (/ (* (vct-ref vinut indexrt) (- alphart 1) alphart) 2)))
	 (bowfilt inharm)
