...
static void define_procedures(void)
{
  ...
  XM_DEFINE_PROCEDURE("XtDisplayInitialize", gxm_XtDisplayInitialize_w, 8, 0, 0, H_XtDisplayInitialize);
  XM_DEFINE_PROCEDURE("XtOpenApplication", gxm_XtOpenApplication_w, 9, 0, 0, H_XtOpenApplication);
  XM_DEFINE_PROCEDURE("XtVaOpenApplication", gxm_XtVaOpenApplication_w, 8, 0, 0, H_XtVaOpenApplication);
  XM_DEFINE_PROCEDURE("XtAppInitialize", gxm_XtAppInitialize_w, 8, 0, 0, H_XtAppInitialize);
  XM_DEFINE_PROCEDURE("XtVaAppInitialize", gxm_XtVaAppInitialize_w, 7, 0, 0, H_XtVaAppInitialize);
  XM_DEFINE_PROCEDURE("XtOpenDisplay", gxm_XtOpenDisplay_w, 8, 0, 0, H_XtOpenDisplay);
  ...
  XM_DEFINE_PROCEDURE("XtInitialize", gxm_XtInitialize_w, 6, 0, 0, H_XtInitialize);
...
{
  #define XM_DEFINE_ACCESSOR(Name, Value, Help, SetName, SetValue, A1, A2, A3, A4) \
     XEN_DEFINE_PROCEDURE_WITH_SETTER(XM_FIELD_PREFIX #Name XM_POSTFIX, Value, Help, XM_FIELD_PREFIX #SetName XM_POSTFIX, SetValue, A1, A2, A3, A4)
  ...
  XM_DEFINE_READER("XColor", gxm_XColor_w, 0, 6, 0, NULL);
  ...
  XM_DEFINE_READER("XArc", gxm_XArc_w, 6, 0, 0, NULL);
  XM_DEFINE_READER("XWindowChanges", gxm_XWindowChanges_w, 7, 0, 0, NULL);
  XM_DEFINE_READER("XSetWindowAttributes", gxm_XSetWindowAttributes_w, 0, 0, 1, NULL);
  XM_DEFINE_READER("XPoint", gxm_XPoint_w, 2, 0, 0, NULL);
  ...
  XM_DEFINE_READER("XSegment", gxm_XSegment_w, 4, 0, 0, NULL);
  XM_DEFINE_READER("XRectangle", gxm_XRectangle_w, 4, 0, 0, NULL);
  ...
  XM_DEFINE_READER("XTextItem", gxm_XTextItem_w, 4, 0, 0, NULL);
  ...
  XM_DEFINE_READER("mwidth", gxm_mwidth_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("mheight", gxm_mheight_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("ndepths", gxm_ndepths_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("depths", gxm_depths_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("root_depth", gxm_root_depth_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("root_visual", gxm_root_visual_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("default_gc", gxm_default_gc_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("cmap", gxm_cmap_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("white_pixel", gxm_white_pixel_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("black_pixel", gxm_black_pixel_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("max_maps", gxm_max_maps_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("min_maps", gxm_min_maps_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("backing_store", gxm_backing_store_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("save_unders", gxm_save_unders_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("root_input_mask", gxm_root_input_mask_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("lbearing", gxm_lbearing_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("rbearing", gxm_rbearing_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("ascent", gxm_ascent_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("descent", gxm_descent_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("attributes", gxm_attributes_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("card32", gxm_card32_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("fid", gxm_fid_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("properties", gxm_properties_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("min_bounds", gxm_min_bounds_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("max_bounds", gxm_max_bounds_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("per_char", gxm_per_char_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("input", gxm_input_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("initial_state", gxm_initial_state_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("icon_pixmap", gxm_icon_pixmap_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("icon_window", gxm_icon_window_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("icon_x", gxm_icon_x_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("icon_y", gxm_icon_y_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("icon_mask", gxm_icon_mask_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("window_group", gxm_window_group_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("visualid", gxm_visualid_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("class", gxm_class_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("red_mask", gxm_red_mask_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("green_mask", gxm_green_mask_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("blue_mask", gxm_blue_mask_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("bits_per_rgb", gxm_bits_per_rgb_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("map_entries", gxm_map_entries_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("colormap_size", gxm_colormap_size_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("nvisuals", gxm_nvisuals_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("visuals", gxm_visuals_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("bits_per_pixel", gxm_bits_per_pixel_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("background_pixmap", gxm_background_pixmap_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("background_pixel", gxm_background_pixel_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("border_pixmap", gxm_border_pixmap_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("border_pixel", gxm_border_pixel_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("bit_gravity", gxm_bit_gravity_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("win_gravity", gxm_win_gravity_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("backing_planes", gxm_backing_planes_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("backing_pixel", gxm_backing_pixel_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("save_under", gxm_save_under_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("event_mask", gxm_event_mask_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("do_not_propagate_mask", gxm_do_not_propagate_mask_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("cursor", gxm_cursor_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("map_installed", gxm_map_installed_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("map_state", gxm_map_state_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("all_event_masks", gxm_all_event_masks_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("your_event_mask", gxm_your_event_mask_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("screen", gxm_screen_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("xoffset", gxm_xoffset_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("byte_order", gxm_byte_order_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("bitmap_unit", gxm_bitmap_unit_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("bitmap_bit_order", gxm_bitmap_bit_order_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("bitmap_pad", gxm_bitmap_pad_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("bytes_per_line", gxm_bytes_per_line_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("obdata", gxm_obdata_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("sibling", gxm_sibling_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("stack_mode", gxm_stack_mode_w, 1, 0, 0, NULL);
 
  XM_DEFINE_READER("red_max", gxm_red_max_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("red_mult", gxm_red_mult_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("green_max", gxm_green_max_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("green_mult", gxm_green_mult_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("blue_max", gxm_blue_max_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("blue_mult", gxm_blue_mult_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("base_pixel", gxm_base_pixel_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("killid", gxm_killid_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("data", gxm_data_w, 1, 0, 0, NULL);

  XM_DEFINE_READER("min_height", gxm_min_height_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("max_height", gxm_max_height_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("min_width", gxm_min_width_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("max_width", gxm_max_width_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("height_inc", gxm_height_inc_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("width_inc", gxm_width_inc_w, 1, 0, 0, NULL);

#if HAVE_MOTIF
#if MOTIF_2
  XM_DEFINE_READER("page_number", gxm_page_number_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("page_widget", gxm_page_widget_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("status_area_widget", gxm_status_area_widget_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("major_tab_widget", gxm_major_tab_widget_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("minor_tab_widget", gxm_minor_tab_widget_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("source_data", gxm_source_data_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("location_data", gxm_location_data_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("parm", gxm_parm_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("parm_format", gxm_parm_format_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("parm_length", gxm_parm_length_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("parm_type", gxm_parm_type_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("transfer_id", gxm_transfer_id_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("destination_data", gxm_destination_data_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("remaining", gxm_remaining_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("item_or_text", gxm_item_or_text_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("auto_selection_type", gxm_auto_selection_type_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("new_outline_state", gxm_new_outline_state_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("prev_page_number", gxm_prev_page_number_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("prev_page_widget", gxm_prev_page_widget_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("rendition", gxm_rendition_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("render_table", gxm_render_table_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("last_page", gxm_last_page_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("crossed_boundary", gxm_crossed_boundary_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("client_data", gxm_client_data_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("status", gxm_status_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("font_name", gxm_font_name_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("tag", gxm_tag_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("traversal_destination", gxm_traversal_destination_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("dragProtocolStyle", gxm_dragProtocolStyle_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("direction", gxm_direction_w, 1, 0, 0, NULL);
#endif
  XM_DEFINE_READER("reason", gxm_reason_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("timeStamp", gxm_timeStamp_w, 1, 0, 0, NULL);
  XM_DEFINE_ACCESSOR("operation", gxm_operation_w, "", "set_operation", gxm_set_operation_w, 1, 0, 2, 0);
  XM_DEFINE_READER("operations", gxm_operations_w, 1, 0, 0, NULL);
  XM_DEFINE_ACCESSOR("dropSiteStatus", gxm_dropSiteStatus_w, "", "set_dropSiteStatus", gxm_set_dropSiteStatus_w, 1, 0, 2, 0);
  XM_DEFINE_READER("dropAction", gxm_dropAction_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("iccHandle", gxm_iccHandle_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("completionStatus", gxm_completionStatus_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("dragContext", gxm_dragContext_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("animate", gxm_animate_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("length", gxm_length_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("click_count", gxm_click_count_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("widget", gxm_widget_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("item_position", gxm_item_position_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("callbackstruct", gxm_callbackstruct_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("set", gxm_set_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("item", gxm_item_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("item_length", gxm_item_length_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("selected_items", gxm_selected_items_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("selected_item_count", gxm_selected_item_count_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("selected_item_positions", gxm_selected_item_positions_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("selection_type", gxm_selection_type_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("mask", gxm_mask_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("mask_length", gxm_mask_length_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("dir", gxm_dir_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("dir_length", gxm_dir_length_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("pattern", gxm_pattern_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("pattern_length", gxm_pattern_length_w, 1, 0, 0, NULL);
#if MOTIF_2
  XM_DEFINE_READER("position", gxm_position_w, 1, 0, 0, NULL);
#endif
  XM_DEFINE_READER("currInsert", gxm_currInsert_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("newInsert", gxm_newInsert_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("startPos", gxm_startPos_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("endPos", gxm_endPos_w, 1, 0, 0, NULL);
  XM_DEFINE_READER("text", gxm_text_w, 1, 0, 0, NULL);
  ...
  XM_DEFINE_READER("XpmImage", gxm_XpmImage_w, 5, 0, 0, NULL);
  ...
  XM_DEFINE_READER("XpmColorSymbol", gxm_XpmColorSymbol_w, 3, 0, 0, NULL);
  XM_DEFINE_READER("XpmAttributes", gxm_XpmAttributes_w, 0, 0, 0, NULL);
#endif
