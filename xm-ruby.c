...
static void define_structs(void)
{
  ...
  XM_DEFINE_READER(XColor, gxm_XColor_w, 0, 6, 0);
  ...
  XM_DEFINE_READER(XArc, gxm_XArc_w, 6, 0, 0);
  XM_DEFINE_READER(XWindowChanges, gxm_XWindowChanges_w, 7, 0, 0);
  XM_DEFINE_READER(XSetWindowAttributes, gxm_XSetWindowAttributes_w, 0, 0, 1);
  XM_DEFINE_READER(XPoint, gxm_XPoint_w, 2, 0, 0);
  ...
  XM_DEFINE_READER(XSegment, gxm_XSegment_w, 4, 0, 0);
  XM_DEFINE_READER(XRectangle, gxm_XRectangle_w, 4, 0, 0);
  ...
  XM_DEFINE_READER(XTextItem, gxm_XTextItem_w, 4, 0, 0);
  ...
  XM_DEFINE_READER(XpmImage, gxm_XpmImage_w, 5, 0, 0);
  ...
  XM_DEFINE_READER(XpmColorSymbol, gxm_XpmColorSymbol_w, 3, 0, 0);
  XM_DEFINE_READER(XpmAttributes, gxm_XpmAttributes_w, 0, 0, 0);
#endif
