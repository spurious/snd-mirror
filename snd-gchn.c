...
static SCM sg_sample2x(SCM samp, SCM snd, SCM chn)
{
  ...
  SND_ASSERT_CHAN(Sg_sample2x, snd, chn, 2);
  cp = get_cp(snd, chn, Sg_sample2x);
  return(TO_SCM_INT(grf_x((double)(TO_C_INT(samp))/(double)SND_SRATE(cp->sound), cp->axis)));
}
...
static SCM sg_sample2y(SCM samp, SCM snd, SCM chn)
{
  ...
  SND_ASSERT_CHAN(Sg_sample2y, snd, chn, 2);
  cp = get_cp(snd, chn, Sg_sample2y);
  return(TO_SCM_INT(grf_y(sample(TO_C_INT(samp), cp), cp->axis)));
}

static SCM sg_channel_graph_widget(SCM snd, SCM chn)
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_channel_graph_widget, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_channel_sx, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_channel_sy, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_channel_zx, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_channel_zy, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_channel_gsy, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_channel_gzy, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_channel_w, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_channel_f, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_channel_main_pane, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_gsy_adj, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_gzy_adj, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_sy_adj, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_sx_adj, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_zy_adj, snd, chn, 1);
...
{
  chan_info *cp;
  SND_ASSERT_CHAN(Sg_zx_adj, snd, chn, 1);
