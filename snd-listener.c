...
#define GUI_SET_CURSOR(w, cursor) gdk_window_set_cursor(gtk_widget_get_window(w), cursor)
#define GUI_UNSET_CURSOR(w, cursor) gdk_window_set_cursor(gtk_widget_get_window(w), cursor)
#define GUI_UPDATE(w) 
