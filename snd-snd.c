...
for " S_vct2sound_file " and " S_close_sound_file "."
...
{
  #define H_vct2sound_file "(" S_vct2sound_file " fd vct-obj samps): write samps samples from vct-obj to the sound file fd"
  int fd, nums, i;
  off_t err;
  float *vals;
  vct *v = NULL;
