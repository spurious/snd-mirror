...
(CFNC-PA "GtkWidget* gtk_dialog_new_with_buttons gchar* title GtkWindow* @parent GtkDialogFlags flags etc buttons" 2 10 '("gchar*" "int"))
...
(CFNC-PA "void gtk_dialog_add_buttons GtkDialog* dialog etc buttons" 2 10 '("gchar*" "int"))
...
(CFNC-PA "GtkTextTag* gtk_text_buffer_create_tag GtkTextBuffer* buffer gchar* tag_name etc tags" 1 6 '("gchar*"))
...
;;; gtypes as list -- not sure how to handle that
...
(CFNC-23-PA "GtkWidget* gtk_file_chooser_dialog_new gchar* title GtkWindow* parent GtkFileChooserAction action etc buttons" 2 10 '("gchar*" "int"))
