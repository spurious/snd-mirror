...
(CFNC-23 "void gtk_entry_completion_set_match_func GtkEntryCompletion* completion GtkEntryCompletionMatchFunc func lambda_data func_data GDestroyNotify func_notify") 
...
(CFNC-23 "guint g_timeout_add_full gint priority guint interval GSourceFunc func lambda_data func_data GDestroyNotify notify") 
...
(CFNC-23 "guint g_idle_add_full gint priority GSourceFunc func lambda_data func_data GDestroyNotify notify") 
...
(CFNC-23 "void gtk_file_filter_add_custom GtkFileFilter* filter GtkFileFilterFlags needed GtkFileFilterFunc func lambda_data func_data GDestroyNotify notify") 
...
#!
;;; bizarre! I think this is needed for cell layout to make any sense, but the header file is not included in gtk.h
(CLNG-23 "GTK_TYPE_CELL_VIEW")
(CCAST-23 "GTK_CELL_VIEW(obj)" "GtkCellView*")
(CCHK-23 "GTK_IS_CELL_VIEW(obj)" "GtkCellView*")

(CFNC-23 "GType gtk_cell_view_get_type void")
(CFNC-23 "GtkWidget* gtk_cell_view_new void")
(CFNC-23 "GtkWidget* gtk_cell_view_new_with_text gchar* text")
(CFNC-23 "GtkWidget* gtk_cell_view_new_with_markup gchar* markup")
(CFNC-23 "GtkWidget* gtk_cell_view_new_with_pixbuf GdkPixbuf* pixbuf")
(CFNC-23 "void gtk_cell_view_set_value GtkCellView* cell_view GtkCellRenderer* renderer gchar* property GValue* value")
;;;(CFNC-23 "void gtk_cell_view_set_values GtkCellView* cell_view GtkCellRenderer* renderer ...")
(CFNC-23 "void gtk_cell_view_set_model GtkCellView* cell_view GtkTreeModel* model")
(CFNC-23 "void gtk_cell_view_set_displayed_row GtkCellView* cell_view GtkTreePath* path")
(CFNC-23 "GtkTreePath* gtk_cell_view_get_displayed_row GtkCellView* cell_view")
(CFNC-23 "gboolean gtk_cell_view_get_size_of_row GtkCellView* cell_view GtkTreePath* path GtkRequisition* requisition")
(CFNC-23 "void gtk_cell_view_set_background_color GtkCellView* cell_view GdkColor* color")
!#
