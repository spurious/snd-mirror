...
;;; out 2.3 ;(cdef "GTK_COMBO_CLASS(klass)")
;;; out 2.3 (CCHK "GTK_IS_COMBO(obj)" "GtkCombo*")
;;; out 2.3 ;(cdef1 "GTK_IS_COMBO_CLASS(klass)")
;;; out 2.3 ;(cdef "GTK_COMBO_GET_CLASS(obj)")
...
;;; out 2.3 ;(cdef "GTK_ITEM_FACTORY_CLASS(klass)")
;;; out 2.3 (CCHK "GTK_IS_ITEM_FACTORY(object)" "GtkItemFactory*")
;;; out 2.3 ;(cdef1 "GTK_IS_ITEM_FACTORY_CLASS(klass)")
;;; out 2.3 ;(cdef "GTK_ITEM_FACTORY_GET_CLASS(obj)")
...
;;; out 2.3 (CFNC "void gtk_item_factory_popup_with_data GtkItemFactory* ifactory gpointer func_data GtkDestroyNotify destroy guint x guint y guint mouse_button guint32 time")
...
;;; out 2.3 (CFNC "GtkObject* gtk_object_new GtkType type gchar* first_property_name ...")
...
;;; out 2.3 ;(cdef "GTK_OPTION_MENU_CLASS(klass)")
;;; out 2.3 (CCHK "GTK_IS_OPTION_MENU(obj)" "GtkOptionMenu*")
;;; out 2.3 ;(cdef1 "GTK_IS_OPTION_MENU_CLASS(klass)")
;;; out 2.3 ;(cdef "GTK_OPTION_MENU_GET_CLASS(obj)")
...
;(CFNC-23 "void gtk_toolbar_set_orientation GtkToolbar* toolbar GtkOrientation orientation")
;(CFNC-23 "void gtk_toolbar_set_tooltips GtkToolbar* toolbar gboolean enable")
;(CFNC-23 "GtkOrientation gtk_toolbar_get_orientation GtkToolbar* toolbar")
;(CFNC-23 "GtkToolbarStyle gtk_toolbar_get_style GtkToolbar* toolbar")
;(CFNC-23 "GtkIconSize gtk_toolbar_get_icon_size GtkToolbar* toolbar")
;(CFNC-23 "gboolean gtk_toolbar_get_tooltips GtkToolbar* toolbar")
;(CFNC-23 "void gtk_toolbar_set_style GtkToolbar* toolbar GtkToolbarStyle style")
;(CFNC-23 "void gtk_toolbar_unset_style GtkToolbar* toolbar")
...
(CFNC-23 "GtkWidget* gtk_file_chooser_dialog_new gchar* title GtkWindow* parent GtkFileChooserAction action gchar* first_button_text ...")
...
;(CFNC-23 "void gtk_tree_model_filter_set_visible_func GtkTreeModelFilter* filter GtkTreeModelFilterVisibleFunc func gpointer data GtkDestroyNotify destroy") 
;(CFNC-23 "void gtk_tree_model_filter_set_modify_func GtkTreeModelFilter* filter gint n_columns GType* types GtkTreeModelFilterModifyFunc func gpointer data GtkDestroyNotify destroy") 
...
;(CFNC-23 "void gtk_action_group_add_actions_full GtkActionGroup* action_group GtkActionEntry* entries guint n_entries gpointer user_data GDestroyNotify destroy") 
(CFNC-23 "void gtk_action_group_add_toggle_actions_full GtkActionGroup* action_group GtkToggleActionEntry* entries guint n_entries gpointer user_data GDestroyNotify destroy") 
;(CFNC-23 "void gtk_action_group_add_radio_actions_full GtkActionGroup* action_group GtkRadioActionEntry* entries guint n_entries gint value GCallback on_change gpointer user_data GDestroyNotify destroy") 
;(CFNC-23 "void gtk_action_group_set_translate_func GtkActionGroup* action_group GtkTranslateFunc func gpointer data GtkDestroyNotify notify") 
...
(CFNC-23 "void gtk_entry_completion_set_match_func GtkEntryCompletion* completion GtkEntryCompletionMatchFunc func gpointer func_data GDestroyNotify func_notify") 
...
(CFNC-23 "GtkToolItem* gtk_radio_tool_button_new_with_stock_from_widget GtkWidget* group gchar* stock_id") 
...
(CFNC-23 "guint g_timeout_add_full gint priority guint interval GSourceFunc function gpointer data GDestroyNotify notify") 
(CFNC-23 "guint g_timeout_add guint interval GSourceFunc function gpointer data") 
(CFNC-23 "guint g_idle_add GSourceFunc function gpointer data") 
(CFNC-23 "guint g_idle_add_full gint priority GSourceFunc function gpointer data GDestroyNotify notify") 
...
(CFNC-23 "void gtk_file_filter_add_custom GtkFileFilter* filter GtkFileFilterFlags needed GtkFileFilterFunc func gpointer data GDestroyNotify notify") 
...
(CFNC-23 "void gtk_cell_layout_set_attributes GtkCellLayout* cell_layout GtkCellRenderer* cell ...") 
(CFNC-23 "void gtk_cell_layout_add_attribute GtkCellLayout* cell_layout GtkCellRenderer* cell gchar* attribute gint column") 
(CFNC-23 "void gtk_cell_layout_set_cell_data_func GtkCellLayout* cell_layout GtkCellRenderer* cell GtkCellLayoutDataFunc func gpointer func_data GDestroyNotify destroy") 
...
(CFNC-23 "void gtk_file_chooser_set_filename GtkFileChooser* chooser char* filename") 
(CFNC-23 "void gtk_file_chooser_select_filename GtkFileChooser* chooser char* filename") 
...
(CFNC-23 "void gtk_file_chooser_set_current_folder GtkFileChooser* chooser gchar* filename") 
...
(CFNC-23 "void gtk_file_chooser_set_uri GtkFileChooser* chooser char* uri") 
(CFNC-23 "void gtk_file_chooser_select_uri GtkFileChooser* chooser char* uri") 
...
(CFNC-23 "void gtk_file_chooser_set_current_folder_uri GtkFileChooser* chooser gchar* uri") 
