...
;; int*		    (void gsl_ran_poisson_array (gsl_rng* size_t int* double))   ; unsigned int*
		    ...
		    (reader-cond ((>= gsl-version 1.16) (double gsl_bspline_greville_abscissa (size_t gsl_bspline_workspace*))))
		    (reader-cond ((>= gsl-version 1.16) (int gsl_bspline_knots_greville (gsl_vector* gsl_bspline_workspace* double*))))
		    ...
		    (reader-cond ((>= gsl-version 1.16) (void gsl_sort2 (double* size_t double* size_t size_t))))
		    (reader-cond ((>= gsl-version 1.16) (void gsl_sort_vector2 (gsl_vector* gsl_vector*))))
		    (reader-cond ((>= gsl-version 1.16) (int gsl_poly_dd_hermite_init (double* double* double* double* double* size_t))))
...
;; vf*		    (int gsl_blas_dsdot (gsl_vector_float* gsl_vector_float* double*))
;;		    (int gsl_blas_sdot (gsl_vector_float* gsl_vector_float* float*))
;; vf*		    (int gsl_blas_ddot (gsl_vector* gsl_vector* double*))
;; vf*		    (int gsl_blas_cdotu (gsl_vector_complex_float* gsl_vector_complex_float* gsl_complex_float*))
;; vf*		    (int gsl_blas_cdotc (gsl_vector_complex_float* gsl_vector_complex_float* gsl_complex_float*))
...
;; vf*		    (float gsl_blas_snrm2 (gsl_vector_float*))
;; vf*		    (float gsl_blas_sasum (gsl_vector_float*))
		    (double gsl_blas_dnrm2 (gsl_vector*))
		    (double gsl_blas_dasum (gsl_vector*))
;; cf*		    (float gsl_blas_scnrm2 (gsl_vector_complex_float*))
;; cf*		    (float gsl_blas_scasum (gsl_vector_complex_float*))
		    (double gsl_blas_dznrm2 (gsl_vector_complex*))
		    (double gsl_blas_dzasum (gsl_vector_complex*))
;; vf*		    (size_t_t gsl_blas_isamax (gsl_vector_float*))
		    (size_t_t gsl_blas_idamax (gsl_vector*))
;; cf*		    (size_t_t gsl_blas_icamax (gsl_vector_complex_float*))
		    (size_t_t gsl_blas_izamax (gsl_vector_complex*))
;; vf*		    (int gsl_blas_sswap (gsl_vector_float* gsl_vector_float*))
;; vf*		    (int gsl_blas_scopy (gsl_vector_float* gsl_vector_float*))
;; vf*		    (int gsl_blas_saxpy (float gsl_vector_float* gsl_vector_float*))
...
;; cf*		    (int gsl_blas_cswap (gsl_vector_complex_float* gsl_vector_complex_float*))
;; cf*		    (int gsl_blas_ccopy (gsl_vector_complex_float* gsl_vector_complex_float*))
...
;;;; vf*		    (int gsl_blas_srot (gsl_vector_float* gsl_vector_float* float float))
;; vf*		    (int gsl_blas_srotm (gsl_vector_float* gsl_vector_float* float*))
...
;; vf*		    (void gsl_blas_sscal (float gsl_vector_float*))
		    (void gsl_blas_dscal (double gsl_vector*))
;; cf*		    (void gsl_blas_csscal (float gsl_vector_complex_float*))
		    (void gsl_blas_zdscal (double gsl_vector_complex*))
;;;; mf*;; vf*		    (int gsl_blas_sgemv (int float gsl_matrix_float* gsl_vector_float* float gsl_vector_float*))
;; mf*;; vf*		    (int gsl_blas_strmv (int int int gsl_matrix_float* gsl_vector_float*))
;; mf*;; vf*		    (int gsl_blas_strsv (int int int gsl_matrix_float* gsl_vector_float*))
...
;; cf*		    (int gsl_blas_ctrmv (int int int gsl_matrix_complex_float* gsl_vector_complex_float*))
;; cf*		    (int gsl_blas_ctrsv (int int int gsl_matrix_complex_float* gsl_vector_complex_float*))
...
;;;; mf*;; vf*		    (int gsl_blas_ssymv (int float gsl_matrix_float* gsl_vector_float* float gsl_vector_float*))
;; mf*;; vf*		    (int gsl_blas_sger (float gsl_vector_float* gsl_vector_float* gsl_matrix_float*))
;;;; mf*;; vf*		    (int gsl_blas_ssyr (int float gsl_vector_float* gsl_matrix_float*))
;;;; mf*;; vf*		    (int gsl_blas_ssyr2 (int float gsl_vector_float* gsl_vector_float* gsl_matrix_float*))
...
;;;; cf*		    (int gsl_blas_cher (int float gsl_vector_complex_float* gsl_matrix_complex_float*))
...
;;;; mf*		    (int gsl_blas_sgemm (int int float gsl_matrix_float* gsl_matrix_float* float gsl_matrix_float*))
;;;; mf*		    (int gsl_blas_ssymm (int int float gsl_matrix_float* gsl_matrix_float* float gsl_matrix_float*))
;;;; mf*		    (int gsl_blas_ssyrk (int int float gsl_matrix_float* float gsl_matrix_float*))
;;;; mf*		    (int gsl_blas_ssyr2k (int int float gsl_matrix_float* gsl_matrix_float* float gsl_matrix_float*))
;;;; mf*		    (int gsl_blas_strmm (int int int int float gsl_matrix_float* gsl_matrix_float*))
;;;; mf*		    (int gsl_blas_strsm (int int int int float gsl_matrix_float* gsl_matrix_float*))
...
;; cf*;; cfloat		    (int gsl_blas_caxpy (gsl_complex_float gsl_vector_complex_float* gsl_vector_complex_float*))
;; cf*;; cfloat		    (void gsl_blas_cscal (gsl_complex_float gsl_vector_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_cgemv (int gsl_complex_float gsl_matrix_complex_float* gsl_vector_complex_float* gsl_complex_float gsl_vector_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_chemv (int gsl_complex_float gsl_matrix_complex_float* gsl_vector_complex_float* gsl_complex_float gsl_vector_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_cgeru (gsl_complex_float gsl_vector_complex_float* gsl_vector_complex_float* gsl_matrix_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_cgerc (gsl_complex_float gsl_vector_complex_float* gsl_vector_complex_float* gsl_matrix_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_cher2 (int gsl_complex_float gsl_vector_complex_float* gsl_vector_complex_float* gsl_matrix_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_cgemm (int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float* gsl_complex_float gsl_matrix_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_csymm (int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float* gsl_complex_float gsl_matrix_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_csyrk (int int gsl_complex_float gsl_matrix_complex_float* gsl_complex_float gsl_matrix_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_csyr2k (int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float* gsl_complex_float gsl_matrix_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_ctrmm (int int int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_ctrsm (int int int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float*))
;; cf*;; cfloat		    (int gsl_blas_chemm (int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float* gsl_complex_float gsl_matrix_complex_float*))
;;;; cf*;; cfloat		    (int gsl_blas_cher2k (int int gsl_complex_float gsl_matrix_complex_float* gsl_matrix_complex_float* float gsl_matrix_complex_float*))
;;;; cf*		    (int gsl_blas_cherk (int int float gsl_matrix_complex_float* float gsl_matrix_complex_float*))
...
;; float*	    (void cblas_cdotu_sub (int void* int void* int void*))
;; float*	    (void cblas_cdotc_sub (int void* int void* int void*))
...
;; float*	    (void cblas_cswap (int void* int void* int))
;; float*	    (void cblas_ccopy (int void* int void* int))
;; float*	    (void cblas_caxpy (int void* void* int void* int))
...
;; float*	    (void cblas_cscal (int void* void* int))
...
;; float*	    (void cblas_cgemv (int int int int void* void* int void* int void* void* int))
;; float*	    (void cblas_cgbmv (int int int int int int void* void* int void* int void* void* int))
;; float*	    (void cblas_ctrmv (int int int int int void* int void* int))
;; float*	    (void cblas_ctbmv (int int int int int int void* int void* int))
;; float*	    (void cblas_ctpmv (int int int int int void* void* int))
;; float*	    (void cblas_ctrsv (int int int int int void* int void* int))
;; float*	    (void cblas_ctbsv (int int int int int int void* int void* int))
;; float*	    (void cblas_ctpsv (int int int int int void* void* int))
...
;; float*	    (void cblas_chemv (int int int void* void* int void* int void* void* int))
;; float*	    (void cblas_chbmv (int int int int void* void* int void* int void* void* int))
;; float*	    (void cblas_chpmv (int int int void* void* void* int void* void* int))
;; float*	    (void cblas_cgeru (int int int void* void* int void* int void* int))
;; float*	    (void cblas_cgerc (int int int void* void* int void* int void* int))
;; float*	    (void cblas_cher (int int int float void* int void* int))
;;		    (void cblas_chpr (int int int float void* int void*))
;; float*	    (void cblas_cher2 (int int int void* void* int void* int void* int))
;; float*	    (void cblas_chpr2 (int int int void* void* int void* int void*))
...
;; float*	    (void cblas_cgemm (int int int int int int void* void* int void* int void* void* int))
;; float*	    (void cblas_csymm (int int int int int void* void* int void* int void* void* int))
;; float*	    (void cblas_csyrk (int int int int int void* void* int void* void* int))
;; float*	    (void cblas_csyr2k (int int int int int void* void* int void* int void* void* int))
;; float*	    (void cblas_ctrmm (int int int int int int int void* void* int void* int))
;; float*	    (void cblas_ctrsm (int int int int int int int void* void* int void* int))
...
;; float*	    (void cblas_chemm (int int int int int void* void* int void* int void* void* int))
...
;; fn_t		    (int gsl_heapsort_index (size_t* void* size_t size_t int))
		    ...
		    (reader-cond ((>= gsl-version 1.16) (gsl_multifit_robust_workspace* gsl_multifit_robust_alloc (gsl_multifit_robust_type* size_t size_t))))
		    (reader-cond ((>= gsl-version 1.16) (void gsl_multifit_robust_free (gsl_multifit_robust_workspace*))))
		    (reader-cond ((>= gsl-version 1.16) (int gsl_multifit_robust_tune (double gsl_multifit_robust_workspace*))))
		    (reader-cond ((>= gsl-version 1.16) (char* gsl_multifit_robust_name (gsl_multifit_robust_workspace*))))
		    (reader-cond ((>= gsl-version 1.16) (gsl_multifit_robust_stats gsl_multifit_robust_statistics (gsl_multifit_robust_workspace*))))
