...
;; 1.16?		    (int gsl_poly_dd_hermite_init (double* double* double* double* double* size_t))
		    ...
		    ;; gsl_vector_float is float data, all the same stuff as gsl_vector_double
		    ;; it looks like bare _vector is double
		    ;; int* will have to translate to long long int* as (int* iv) to parallel (double* fv)
		    ;; some of the void* look like complex numbers
