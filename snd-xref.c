...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "clean-sound", "clear-listener", "clip-hook", "clipping", "clm-channel", "clm-expsrc",
 ...
 "comb-bank?", "comb?", "combined-data-color", "comment", "complexify", "concatenate-envelopes",
 ...
 "float-vector->channel", "float-vector->list", "float-vector->string", "float-vector-abs!", "float-vector-add!", "float-vector-equal?",
 ...
 "iir-filter?", "immutable!", "immutable?", "in", "in-any", "ina",
 ...
 "insert-selection", "insert-silence", "insert-sound", "int-vector", "int-vector-ref", "int-vector-set!",
 "int-vector?", "integer->colormap", "integer->mark", "integer->mix", "integer->region", "integer->sound",
 "integer->transform", "integrate-envelope", "invert-filter", "iterate", "iterator-at-end?", "iterator-sequence",
 "iterator?", "izcos", "izcos?", "j0evencos", "j0evencos?", "j0j1cos",
 ...
 "lbj-piano", "left-sample", "let->list", "let-ref", "let-set!", "let-temporarily",
 "let?", "linear->db", "linear-src-channel", "lint for scheme", "lisp-graph-hook", "lisp-graph-style",
 "lisp-graph?", "list->float-vector", "list-ladspa", "listener-click-hook", "listener-color", "listener-colorized",
 ...
 "make-variable-display", "make-variable-graph", "make-wave-train", "make-wave-train-with-env", "map-channel", "map-sound-files",
 ...
 "readin", "readin?", "rectangular->magnitudes", "rectangular->polar", "redo", "region->float-vector",
 "region->integer", "region-chans", "region-framples", "region-graph-style", "region-home", "region-maxamp",
 ...
 "*rootlet-redefinition-hook*", "round-interp", "round-interp?", "rssb", "rssb-interp", "rssb?",
 ...
 "times->samples", "tiny-font", "touch-tone", "trace", "tracking-cursor-style", "transform->float-vector",
 "transform->integer", "transform-dialog", "transform-framples", "transform-graph-style", "transform-graph-type", "transform-graph?",
 ...
 "two-tab", "two-zero", "two-zero?", "type-of", "unbind-key", "*unbound-variable-hook*",
 ...
 "user interface extensions", "variable-display", "variable-graph?", "varlet", "vibrating-uniform-circular-string", "view-files-amp",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "clean_sound", "clear_listener", "clip_hook", "clipping", "clm_channel", "clm_expsrc",
 ...
 "comb_bank?", "comb?", "combined_data_color", "comment", "complexify", "concatenate_envelopes",
 ...
 "float_vector2channel", "float_vector2list", "float_vector2string", "float_vector_abs!", "float_vector_add!", "float_vector_equal?",
 ...
 "iir_filter?", "immutable!", "immutable?", "call_in", "in_any", "ina",
 ...
 "insert_selection", "insert_silence", "insert_sound", "int_vector", "int_vector_ref", "int_vector_set!",
 "int_vector?", "integer2colormap", "integer2mark", "integer2mix", "integer2region", "integer2sound",
 "integer2transform", "integrate_envelope", "invert_filter", "iterate", "iterator_at_end?", "iterator_sequence",
 "iterator?", "izcos", "izcos?", "j0evencos", "j0evencos?", "j0j1cos",
 ...
 "lbj_piano", "left_sample", "let2list", "let_ref", "let_set!", "let_temporarily",
 "let?", "linear2db", "linear_src_channel", "lint_for_scheme", "lisp_graph_hook", "lisp_graph_style",
 "lisp_graph?", "list2float_vector", "list_ladspa", "listener_click_hook", "listener_color", "listener_colorized",
 ...
 "make_variable_display", "make_variable_graph", "make_wave_train", "make_wave_train_with_env", "map_channel", "map_sound_files",
 ...
 "readin", "readin?", "rectangular2magnitudes", "rectangular2polar", "redo_edit", "region2float_vector",
 "region2integer", "region_chans", "region_framples", "region_graph_style", "region_home", "region_maxamp",
 ...
 "_rootlet_redefinition_hook_", "round_interp", "round_interp?", "rssb", "rssb_interp", "rssb?",
 ...
 "times2samples", "tiny_font", "touch_tone", "trace", "tracking_cursor_style", "transform2float_vector",
 "transform2integer", "transform_dialog", "transform_framples", "transform_graph_style", "transform_graph_type", "transform_graph?",
 ...
 "two_tab", "two_zero", "two_zero?", "type_of", "unbind_key", "_unbound_variable_hook_",
 ...
 "user_interface_extensions", "variable_display", "variable_graph?", "varlet", "vibrating_uniform_circular_string", "view_files_amp",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "sndscm.html#analogfilterdoc", "s7.html#bytevector", "s7.html#bytevectorref", "s7.html#bytevectorset",
 ...
 "extsnd.html#combineddatacolor", "extsnd.html#comment", "sndscm.html#complexify", "sndscm.html#concatenateenvelopes",
 ...
 "extsnd.html#previoussample", "extsnd.html#printdialog", "extsnd.html#printlength", "s7.html#proceduredocumentation",
 "s7.html#proceduresetter", "s7.html#proceduresignature", "s7.html#proceduresource", "extsnd.html#progressreport",
 ...
 "extsnd.html#stdinprompt", "sndscm.html#stereotomono", "sndscm.html#stereoflute", "extsnd.html#stopplayer",
 "extsnd.html#stopplaying", "extsnd.html#stopplayinghook", "extsnd.html#stopplayingselectionhook", "sndscm.html#stretchenvelope",
 "sndscm.html#stretchsoundviadft", "s7.html#stringtobytevector", "s7.html#stringposition", "s7.html#sublet",
