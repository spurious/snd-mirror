...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "default-output-srate", "defgenerator", "define-envelope", "define-selection-via-marks", "definstrument", "defvar",
 ...
 "delete-selection", "delete-selection-and-smooth", "delete-transform", "delete-watcher", "describe-hook", "describe-mark",
 "dialog-widgets", "disable-control-panel", "display-bark-fft", "display-db", "display-edits", "display-scanned-synthesis",
 "dissolve-fade", "dither-channel", "dither-sound", "dlocsig", "do?", "dot-product",
 "dot-size", "draw-axes", "draw-dot", "draw-dots", "draw-line", "draw-lines",
 "draw-mark-hook", "draw-mix-hook", "draw-string", "drop sites", "drop-hook", "during-open-hook",
 "edit-fragment", "edit-header-dialog", "edit-hook", "edit-list->function", "edit-position", "edit-properties",
 "edit-property", "edit-tree", "edits", "edot-product", "elliptic filters", "emacs-style-save-as",
 "env", "env-any", "env-channel", "env-channel-with-base", "env-expt-channel", "env-interp",
 "env-mixes", "env-selection", "env-sound", "env-sound-interp", "env?", "enved-base",
 ...
 "envelope-interp", "enveloped-mix", "eps-bottom-margin", "eps-file", "eps-left-margin", "eps-size",
 "*error-hook*", "*error-info*", "eval-between-marks", "eval-over-selection", "every-sample?", "exit",
 "exit-hook", "expand-control", "expand-control-bounds", "expand-control-hop", "expand-control-jitter", "expand-control-length",
 "expand-control-ramp", "expand-control?", "explode-sf2", "exponentially-weighted-moving-average", "extract-channel", "extract-channels",
 "*features*", "feedback fm", "fft", "fft sizes", "fft-edit", "fft-log-frequency",
 "fft-log-magnitude", "fft-smoother", "fft-squelch", "fft-window", "fft-window-alpha", "fft-window-beta",
 "fft-with-phases", "file database", "file->array", "file->frame", "file->frame?", "file->sample",
 "file->sample?", "file->sound-data", "file->vct", "file-name", "fill-polygon", "fill-rectangle",
 "filter", "filter-channel", "filter-control-coeffs", "filter-control-envelope", "filter-control-in-dB", "filter-control-in-hz",
 "filter-control-order", "filter-control-waveform-color", "filter-control?", "filter-selection", "filter-selection-and-smooth", "filter-sound",
 "filter?", "filtered-comb", "filtered-comb?", "find-channel", "find-dialog", "find-mark",
 "find-mix", "find-sound", "finish-progress-report", "fir-filter", "fir-filter?", "firmant",
 "firmant?", "flocsig", "flocsig?", "flute model", "fm-bell", "fm-drum",
 "fm-noise", "fm-talker", "fm-trumpet", "fm-violin", "fm-voice", "focus-widget",
 "FOF synthesis", "for-each-child", "for-each-sound-file", "Forbidden Planet", "foreground-color", "forget-region",
 "formant", "formant?", "fourier-transform", "fractional-fourier-transform", "frame", "frame*",
 ...
 "fullmix", "gaussian-distribution", "gc-off", "gc-on", "gl-graph->ps", "glSpectrogram",
 ...
 "grid-density", "harmonicizer", "Hartley transform", "header-type", "hello-dentist", "help-dialog",
 "help-hook", "hide-widget", "highlight-color", "hilbert-transform", "hook-member", "html-dir",
 ...
 "jc-reverb", "just-sounds", "kalman-filter-channel", "key", "key-binding", "key-press-hook",
 "ladspa-descriptor", "ladspa-dir", "left-sample", "level meters", "linear->db", "linear-src-channel",
 ...
 "*load-hook*", "*load-path*", "locsig", "locsig-ref", "locsig-reverb-ref", "locsig-reverb-set!",
 "locsig-set!", "locsig-type", "locsig?", "log-freq-start", "loop-between-marks", "lpc-coeffs",
 "lpc-predict", "main-menu", "main-widgets", "make-all-pass", "make-asymmetric-fm", "make-bandpass",
 ...
 "make-graph-data", "make-hidden-controls-dialog", "make-highpass", "make-hilbert-transform", "make-iir-filter", "make-locsig",
 ...
 "make-polyshape", "make-polywave", "make-pulse-train", "make-rand", "make-rand-interp", "make-readin",
 ...
 "make-square-wave", "make-src", "make-ssb-am", "make-sync-frame-reader", "make-table-lookup", "make-triangle-wave",
 ...
 "print-length", "profile", "progress-report", "prompt-in-minibuffer", "ptree-channel", "pulse-train",
 "pulse-train?", "radians->degrees", "radians->hz", "ramp-channel", "rand", "rand-interp",
 "rand-interp?", "rand?", "read-frame", "read-hook", "read-mix-sample", "read-only",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "default_output_srate", "defgenerator", "define_envelope", "define_selection_via_marks", "definstrument", "defvar",
 ...
 "delete_selection", "delete_selection_and_smooth", "delete_transform", "delete_watcher", "describe_hook", "describe_mark",
 "dialog_widgets", "disable_control_panel", "display_bark_fft", "display_db", "display_edits", "display_scanned_synthesis",
 "dissolve_fade", "dither_channel", "dither_sound", "dlocsig", "do?", "dot_product",
 "dot_size", "draw_axes", "draw_dot", "draw_dots", "draw_line", "draw_lines",
 "draw_mark_hook", "draw_mix_hook", "draw_string", "drop_sites", "drop_hook", "during_open_hook",
 "edit_fragment", "edit_header_dialog", "edit_hook", "edit_list2function", "edit_position", "edit_properties",
 "edit_property", "edit_tree", "edits", "edot_product", "elliptic_filters", "emacs_style_save_as",
 "env", "env_any", "env_channel", "env_channel_with_base", "env_expt_channel", "env_interp",
 "env_mixes", "env_selection", "env_sound", "env_sound_interp", "env?", "enved_base",
 ...
 "envelope_interp", "enveloped_mix", "eps_bottom_margin", "eps_file", "eps_left_margin", "eps_size",
 "_error_hook_", "_error_info_", "eval_between_marks", "eval_over_selection", "every_sample?", "exit",
 "exit_hook", "expand_control", "expand_control_bounds", "expand_control_hop", "expand_control_jitter", "expand_control_length",
 "expand_control_ramp", "expand_control?", "explode_sf2", "exponentially_weighted_moving_average", "extract_channel", "extract_channels",
 "_features_", "feedback_fm", "fft", "fft_sizes", "fft_edit", "fft_log_frequency",
 "fft_log_magnitude", "fft_smoother", "fft_squelch", "fft_window", "fft_window_alpha", "fft_window_beta",
 "fft_with_phases", "file_database", "file2array", "file2frame", "file2frame?", "file2sample",
 "file2sample?", "file2sound_data", "file2vct", "file_name", "fill_polygon", "fill_rectangle",
 "filter", "filter_channel", "filter_control_coeffs", "filter_control_envelope", "filter_control_in_dB", "filter_control_in_hz",
 "filter_control_order", "filter_control_waveform_color", "filter_control?", "filter_selection", "filter_selection_and_smooth", "filter_sound",
 "filter?", "filtered_comb", "filtered_comb?", "find_channel", "find_dialog", "find_mark",
 "find_mix", "find_sound", "finish_progress_report", "fir_filter", "fir_filter?", "firmant",
 "firmant?", "flocsig", "flocsig?", "flute_model", "fm_bell", "fm_drum",
 "fm_noise", "fm_talker", "fm_trumpet", "fm_violin", "fm_voice", "focus_widget",
 "FOF_synthesis", "for_each_child", "for_each_sound_file", "Forbidden_Planet", "foreground_color", "forget_region",
 "formant", "formant?", "Fourier_transform", "fractional_fourier_transform", "frame", "frame_multiply",
 ...
 "fullmix", "gaussian_distribution", "gc_off", "gc_on", "gl_graph2ps", "glSpectrogram",
 ...
 "grid_density", "harmonicizer", "Hartley_transform", "header_type", "hello_dentist", "help_dialog",
 "help_hook", "hide_widget", "highlight_color", "hilbert_transform", "hook_member", "html_dir",
 ...
 "jc_reverb", "just_sounds", "kalman_filter_channel", "key", "key_binding", "key_press_hook",
 "ladspa_descriptor", "ladspa_dir", "left_sample", "level_meters", "linear2db", "linear_src_channel",
 ...
 "_load_hook_", "_load_path_", "locsig", "locsig_ref", "locsig_reverb_ref", "locsig_reverb_set!",
 "locsig_set!", "locsig_type", "locsig?", "log_freq_start", "loop_between_marks", "lpc_coeffs",
 "lpc_predict", "main_menu", "main_widgets", "make_all_pass", "make_asymmetric_fm", "make_bandpass",
 ...
 "make_graph_data", "make_hidden_controls_dialog", "make_highpass", "make_hilbert_transform", "make_iir_filter", "make_locsig",
 ...
 "make_polyshape", "make_polywave", "make_pulse_train", "make_rand", "make_rand_interp", "make_readin",
 ...
 "make_square_wave", "make_src", "make_ssb_am", "make_sync_frame_reader", "make_table_lookup", "make_triangle_wave",
 ...
 "print_length", "profile", "progress_report", "prompt_in_minibuffer", "ptree_channel", "pulse_train",
 "pulse_train?", "radians2degrees", "radians2hz", "ramp_channel", "rand", "rand_interp",
 "rand_interp?", "rand?", "read_frame", "read_hook", "read_mix_sample", "read_only",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "extsnd.html#defaultoutputsrate", "sndclm.html#defgenerator", "extsnd.html#defineenvelope", "sndscm.html#defineselectionviamarks",
 ...
 "extsnd.html#deletesample", "extsnd.html#deletesamples", "extsnd.html#deleteselection", "sndscm.html#deleteselectionandsmooth",
 "extsnd.html#deletetransform", "extsnd.html#deletewatcher", "sndscm.html#describehook", "sndscm.html#describemark",
 ...
 "sndscm.html#dithersound", "sndscm.html#dlocsig", "sndscm.html#dop", "sndclm.html#dot-product",
 ...
 "extsnd.html#edits", "sndclm.html#edot-product", "sndscm.html#analogfilterdoc", "sndscm.html#emacsstylesaveas",
 ...
 "extsnd.html#griddensity", "sndscm.html#harmonicizer", "sndscm.html#dht", "extsnd.html#headertype",
 ...
 "extsnd.html#regionsrate", "extsnd.html#regionok", "extsnd.html#eregions", "sndscm.html#remembersoundstate",
 ...
 "extsnd.html#tinyfont", "s7.html#tracehook", "extsnd.html#trackingcursorstyle", "extsnd.html#transformtointeger",
