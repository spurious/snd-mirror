...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "highlight-color", "hilbert-transform", "hook", "hook-apply", "hook-arity", "hook-documentation",
 "hook-functions", "hook-member", "hook?", "html-dir", "html-program", "hz->radians",
 ...
 "Instruments", "integer->colormap", "integer->mark", "integer->mix", "integer->region", "integer->sound",
 "integer->transform", "integrate-envelope", "jc-reverb", "just-sounds", "kalman-filter-channel", "key",
 ...
 "macroexpand", "main-menu", "main-widgets", "make-all-pass", "make-asymmetric-fm", "make-bandpass",
 "make-bandstop", "make-biquad", "make-birds", "make-color", "make-comb", "make-convolve",
 "make-delay", "make-differentiator", "make-env", "make-fft-window", "make-file->frame", "make-file->sample",
 ...
 "make-graph-data", "make-hash-table", "make-hash-table-iterator", "make-highpass", "make-hilbert-transform", "make-hook",
 ...
 "make-sync-frame-reader", "make-table-lookup", "make-triangle-wave", "make-two-pole", "make-two-zero", "make-type",
 ...
 "mus-prescaler", "mus-ramp", "mus-random", "mus-reset", "mus-run", "mus-scaler",
 ...
 "rand?", "random", "random-state?", "read-frame", "read-hook", "read-mix-sample",
 ...
 "selection-position", "selection-srate", "selection?", "set-samples", "shepard-tone", "short-file-name",
 ...
 "stretch-envelope", "superimpose-ffts", "swap-channels", "swap-selection-channels", "symbol->value", "symbol-access",
 "symbol-table", "sync", "sync-everything", "sync-max", "sync-style", "syncd-marks",
 "table-lookup", "table-lookup?", "tap", "telephone", "temp-dir", "text-focus-color",
 "time-graph-style", "time-graph-type", "time-graph?", "tiny-font", "trace", "*trace-hook*",
 ...
 "transform?", "transpose-mixes", "trap-segfault", "triangle-wave", "triangle-wave?", "tubular bell",
 "two-pole", "two-pole?", "two-zero", "two-zero?", "unbind-key", "*unbound-variable-hook*",
 "unclip-channel", "undo", "undo-channel", "undo-edit", "undo-hook", "unselect-all",
 ...
 "view-regions-dialog", "view-sound", "voice physical model", "voiced->unvoiced", "volterra-filter", "wave-train",
 ...
 "with-inset-graph", "with-interrupts", "with-local-hook", "with-marked-sound", "with-menu-icons", "with-mix-tags",
 "with-mixed-sound", "with-mixed-sound->notelist", "with-pointer-focus", "with-relative-panes", "with-smpte-label", "with-sound",
 "with-temp-sound", "with-temporary-selection", "with-toolbar", "with-tooltips", "with-tracking-cursor", "with-verbose-cursor",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "highlight_color", "hilbert_transform", "hook", "hook_apply", "hook_arity", "hook_documentation",
 "hook_functions", "hook_member", "hook?", "html_dir", "html_program", "hz2radians",
 ...
 "Instruments", "integer2colormap", "integer2mark", "integer2mix", "integer2region", "integer2sound",
 "integer2transform", "integrate_envelope", "jc_reverb", "just_sounds", "kalman_filter_channel", "key",
 ...
 "macroexpand", "main_menu", "main_widgets", "make_all_pass", "make_asymmetric_fm", "make_bandpass",
 "make_bandstop", "make_biquad", "make_birds", "make_color", "make_comb", "make_convolve",
 "make_delay", "make_differentiator", "make_env", "make_fft_window", "make_file2frame", "make_file2sample",
 ...
 "make_graph_data", "make_hash_table", "make_hash_table_iterator", "make_highpass", "make_hilbert_transform", "make_hook",
 ...
 "make_sync_frame_reader", "make_table_lookup", "make_triangle_wave", "make_two_pole", "make_two_zero", "make_type",
 ...
 "mus_prescaler", "mus_ramp", "mus_random", "mus_reset", "mus_run", "mus_scaler",
 ...
 "rand?", "random", "random_state?", "read_frame", "read_hook", "read_mix_sample",
 ...
 "selection_position", "selection_srate", "selection?", "set_samples", "shepard_tone", "short_file_name",
 ...
 "stretch_envelope", "superimpose_ffts", "swap_channels", "swap_selection_channels", "symbol2value", "symbol_access",
 "symbol_table", "sync", "sync_everything", "sync_max", "sync_style", "syncd_marks",
 "table_lookup", "table_lookup?", "tap", "telephone", "temp_dir", "text_focus_color",
 "time_graph_style", "time_graph_type", "time_graph?", "tiny_font", "trace", "_trace_hook_",
 ...
 "transform?", "transpose_mixes", "trap_segfault", "triangle_wave", "triangle_wave?", "tubular_bell",
 "two_pole", "two_pole?", "two_zero", "two_zero?", "unbind_key", "_unbound_variable_hook_",
 "unclip_channel", "undo", "undo_channel", "undo_edit", "undo_hook", "unselect_all",
 ...
 "view_regions_dialog", "view_sound", "voice_physical_model", "voiced2unvoiced", "volterra_filter", "wave_train",
 ...
 "with_inset_graph", "with_interrupts", "with_local_hook", "with_marked_sound", "with_menu_icons", "with_mix_tags",
 "with_mixed_sound", "with_mixed_sound2notelist", "with_pointer_focus", "with_relative_panes", "with_smpte_label", "with_sound",
 "with_temp_sound", "with_temporary_selection", "with_toolbar", "with_tooltips", "with_tracking_cursor", "with_verbose_cursor",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "s7.html#hook", "s7.html#hookapply", "s7.html#hookarity", "s7.html#hookdocumentation",
 "s7.html#hookfunctions", "sndscm.html#hookmember", "s7.html#hookp", "extsnd.html#htmldir",
 ...
 "s7.html#loadhook", "s7.html#loadpath", "sndclm.html#locsig", "sndclm.html#locsig-ref",
 ...
 "extsnd.html#makegraphdata", "s7.html#makehashtable", "s7.html#hashtableiterator", "sndscm.html#makehighpass",
 "sndscm.html#makehilberttransform", "s7.html#makehook", "sndclm.html#make-iir-filter", "sndclm.html#make-locsig",
 ...
 "s7.html#randomstatep", "sndscm.html#readframe", "extsnd.html#readhook", "extsnd.html#readmixsample",
