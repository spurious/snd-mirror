...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "with-file-monitor", "with-gl", "with-inset-graph", "with-local-hook", "with-marked-sound", "with-menu-icons",
 "with-mix-tags", "with-mixed-sound", "with-mixed-sound->notelist", "with-pointer-focus", "with-relative-panes", "with-smpte-label",
 "with-sound", "with-temp-sound", "with-temporary-selection", "with-threaded-channels", "with-threaded-sound", "with-toolbar",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "with_file_monitor", "with_gl", "with_inset_graph", "with_local_hook", "with_marked_sound", "with_menu_icons",
 "with_mix_tags", "with_mixed_sound", "with_mixed_sound2notelist", "with_pointer_focus", "with_relative_panes", "with_smpte_label",
 "with_sound", "with_temp_sound", "with_temporary_selection", "with_threaded_channels", "with_threaded_sound", "with_toolbar",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "extsnd.html#eregions", "s7.html#releaselock", "extsnd.html#remembersoundstate", "extsnd.html#removefrommenu",
 ...
 "sndscm.html#withthreadedsound", "extsnd.html#withtoolbar", "extsnd.html#withtooltips", "extsnd.html#withtrackingcursor",
...
static const char *autoload_names[AUTOLOAD_NAMES] = {
  ...
  "dither-channel", "dither-sound", "dlocsig", "dlya-methods", 
  "dlya?", "do-all-chans", "do-chans", "do-sound-chans", 
  ...
  "max-envelope", "maxfilter", "metal", "mfilter", 
  "mfilter-1", "mflt-methods", "mflt?", "min-envelope", 
  ...
  "offset-sound", "old-make-formant", "old-play", "olive-sided-flycatcher", 
  "one-pole-allpass", "one-pole-allpass-methods", "one-pole-allpass?", "one-pole-swept", 
  "one-pole-swept-methods", "one-pole-swept?", "one-turn-is", "open-buffer", 
...
static int autoload_indices[AUTOLOAD_NAMES] = {
  ...
  14, 41, 33, 1, 1, 22, 21, 21, 21, 42, 59, 21, 28, 59, 30, 42, 42, 55, 30, 51, 9, 23, 28, 11, 
  11, 11, 10, 14, 14, 14, 10, 10, 17, 9, 9, 9, 16, 16, 9, 42, 42, 14, 14, 14, 1, 11, 11, 11, 
  33, 8, 8, 8, 8, 8, 8, 8, 33, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 
  8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 
  8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 33, 8, 8, 
  8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7, 1, 1, 1, 1, 1, 1, 14, 
  41, 41, 41, 41, 41, 41, 41, 41, 11, 0, 16, 30, 14, 16, 12, 12, 12, 22, 16, 13, 21, 21, 21, 21, 
  21, 21, 21, 21, 21, 21, 28, 48, 1, 14, 22, 7, 15, 7, 14, 21, 21, 21, 38, 38, 38, 14, 14, 36, 
  44, 1, 52, 14, 14, 14, 14, 14, 14, 14, 14, 1, 18, 18, 34, 34, 33, 26, 14, 48, 14, 14, 59, 30, 
  21, 21, 37, 14, 11, 14, 59, 14, 9, 28, 1, 14, 11, 14, 26, 4, 4, 21, 21, 21, 11, 42, 7, 21, 
  11, 11, 7, 7, 35, 11, 7, 58, 26, 7, 21, 21, 21, 26, 51, 7, 41, 16, 14, 14, 1, 9, 1, 14, 
  21, 11, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19,