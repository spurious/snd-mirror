...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "cursor-update-interval", "dac-combines-channels", "dac-size", "data-color", "data-format", "data-location",
 ...
 "enved-wave?", "enved-waveform-color", "envelope-interp", "enveloped-mix", "environment", "environment*",
 ...
 "error-environment", "*error-hook*", "erssb", "erssb?", "even-multiple", "even-weight",
 ...
 "fit-selection-between-marks", "flatten-partials", "float-vector-polynomial", "flocsig", "flocsig?", "flute model",
 ...
 "ladspa-dir", "lambda*", "lbj-piano", "left-sample", "linear->db", "linear-src-channel",
 ...
 "make-file->frample", "make-file->sample", "make-filter", "make-filtered-comb", "make-filtered-comb-bank", "make-fir-coeffs",
 ...
 "make-sawtooth-wave", "make-selection", "make-sinc-train", "make-snd->sample", "make-sound-box", "make-spencer-filter",
 ...
 "mix-tag-width", "mix-tag-y", "mix-vct", "mix-waveform-height", "mix?", "mixes",
 ...
 "mus-sound-framples", "mus-sound-header-type", "mus-sound-length", "mus-sound-loop-info", "mus-sound-mark-info", "mus-sound-maxamp",
 "mus-sound-maxamp-exists?", "mus-sound-open-input", "mus-sound-open-output", "mus-sound-preload", "mus-sound-prune", "mus-sound-read",
 "mus-sound-reopen-output", "mus-sound-report-cache", "mus-sound-samples", "mus-sound-seek-frample", "mus-sound-srate", "mus-sound-type-specifier",
 ...
 "nxycos?", "nxysin", "nxysin?", "odd-multiple", "odd-weight", "offset-channel",
 ...
 "pad-channel", "pad-marks", "pad-sound", "pan-mix", "pan-mix-float-vector", "partials->polynomial",
 ...
 "random-state?", "rcos", "rcos?", "read-hook", "read-mix-sample", "read-only",
 "read-region-sample", "read-sample", "read-sample-with-direction", "readin", "readin?", "rectangular->magnitudes",
 ...
 "rxysin", "rxysin?", "sample", "sample->file", "sample->file?", "sampler-at-end?",
 ...
 "save-hook", "save-listener", "save-mark-properties", "save-marks", "save-mix", "save-region",
 ...
 "selection-color", "selection-context", "selection-creates-region", "selection-framples", "selection-maxamp", "selection-maxamp-position",
 ...
 "start-progress-report", "status-report", "stereo->mono", "stereo-flute", "stop-player", "stop-playing",
 ...
 "variable-graph?", "vct", "vct*", "vct+", "vct->channel", "vct->list",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "cursor_update_interval", "dac_combines_channels", "dac_size", "data_color", "data_format", "data_location",
 ...
 "enved_wave?", "enved_waveform_color", "envelope_interp", "enveloped_mix", "environment", "environment_",
 ...
 "error_environment", "_error_hook_", "erssb", "erssb?", "even_multiple", "even_weight",
 ...
 "fit_selection_between_marks", "flatten_partials", "float_vector_polynomial", "flocsig", "flocsig?", "flute_model",
 ...
 "ladspa_dir", "lambda_", "lbj_piano", "left_sample", "linear2db", "linear_src_channel",
 ...
 "make_file2frample", "make_file2sample", "make_filter", "make_filtered_comb", "make_filtered_comb_bank", "make_fir_coeffs",
 ...
 "make_sawtooth_wave", "make_selection", "make_sinc_train", "make_snd2sample", "make_sound_box", "make_spencer_filter",
 ...
 "mix_tag_width", "mix_tag_y", "mix_vct", "mix_waveform_height", "mix?", "mixes",
 ...
 "mus_sound_framples", "mus_sound_header_type", "mus_sound_length", "mus_sound_loop_info", "mus_sound_mark_info", "mus_sound_maxamp",
 "mus_sound_maxamp_exists?", "mus_sound_open_input", "mus_sound_open_output", "mus_sound_preload", "mus_sound_prune", "mus_sound_read",
 "mus_sound_reopen_output", "mus_sound_report_cache", "mus_sound_samples", "mus_sound_seek_frample", "mus_sound_srate", "mus_sound_type_specifier",
 ...
 "nrxysin?", "nsin", "nsin?", "nsincos", "nsincos?", "nssb",
 "nssb?", "nxy1cos", "nxy1cos?", "nxy1sin", "nxy1sin?", "nxycos",
 "nxycos?", "nxysin", "nxysin?", "odd_multiple", "odd_weight", "offset_channel",
 ...
 "pad_channel", "pad_marks", "pad_sound", "pan_mix", "pan_mix_float_vector", "partials2polynomial",
 ...
 "random_state?", "rcos", "rcos?", "read_hook", "read_mix_sample", "read_only",
 "read_region_sample", "read_sample", "read_sample_with_direction", "readin", "readin?", "rectangular2magnitudes",
 ...
 "rxycos", "rxycos?", "rxyk!cos", "rxyk!cos?", "rxyk!sin", "rxyk!sin?",
 "rxysin", "rxysin?", "sample", "sample2file", "sample2file?", "sampler_at_end?",
 ...
 "save_hook", "save_listener", "save_mark_properties", "save_marks", "save_mix", "save_region",
 ...
 "selection_color", "Selection_context", "selection_creates_region", "selection_framples", "selection_maxamp", "selection_maxamp_position",
 ...
 "start_progress_report", "status_report", "stereo2mono", "stereo_flute", "stop_player", "stop_playing",
 ...
 "variable_graph?", "vct", "vct_", "vct_", "vct2channel", "vct2list",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "extsnd.html#cursorupdateinterval", "extsnd.html#dacfolding", "extsnd.html#dacsize", "extsnd.html#datacolor",
 ...
 "sndclm.html#envelopeinterp", "sndscm.html#envelopedmix", "s7.html#environment", "s7.html#environmentstar",
 ...
 "sndscm.html#fitselectionbetweenmarks", "sndscm.html#flattenpartials", "sndscm.html#vctpolynomial", "sndclm.html#flocsig",
 ...
 "extsnd.html#initialgraphhook", "sndscm.html#insertchannel", "extsnd.html#insertfiledialog", "extsnd.html#insertregion",
 "extsnd.html#insertsample", "extsnd.html#insertsamples", "extsnd.html#insertselection", "extsnd.html#insertsilence",
 "extsnd.html#insertsound", "extsnd.html#integertocolormap", "extsnd.html#integertomark", "extsnd.html#integertomix",
 "extsnd.html#integertoregion", "extsnd.html#integertosound", "extsnd.html#integertotransform", "sndscm.html#integrateenvelope",
 "sndscm.html#invertfilter", "sndclm.html#izcos", "sndclm.html#izcos?", "sndclm.html#j0evencos",
 ...
 "sndscm.html#lbjpiano", "extsnd.html#leftsample", "sndclm.html#lineartodb", "sndscm.html#linearsrcchannel",
 ...
 "sndclm.html#make-locsig", "sndscm.html#makelowpass", "extsnd.html#makemixsampler", "sndclm.html#make-move-sound",
 ...
 "sndclm.html#make-moving-norm", "sndclm.html#make-moving-pitch", "sndclm.html#make-moving-scentroid", "sndclm.html#make-moving-spectrum",
 ...
 "extsnd.html#mussoundduration", "extsnd.html#mussoundforget", "extsnd.html#mussoundframples", "extsnd.html#mussoundheadertype",
 ...
 "extsnd.html#sample", "sndclm.html#sampletofile", "sndclm.html#sampletofile?", "extsnd.html#sampleratendQ",
