...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "copy-context", "copy-sampler", "correlate", "create-fmv-dialog", "create-ssb-dialog", "cross-fade (amplitude)",
 ...
 "define-macro*", "define-selection-via-marks", "defined?", "defvar", "degrees->radians", "delay",
 ...
 "display-scanned-synthesis", "dissolve-fade", "dither-channel", "dither-sound", "dolph", "dot-product",
 ...
 "enved-target", "enved-wave?", "enved-waveform-color", "envelope-interp", "enveloped-mix", "environment",
 "environment->list", "environment-ref", "environment-set!", "environment?", "eoddcos", "eoddcos?",
 ...
 "file->frame?", "file->sample", "file->sample?", "file-name", "fill-polygon", "fill-rectangle",
 "filter", "filter-channel", "filter-control-coeffs", "filter-control-envelope", "filter-control-in-dB", "filter-control-in-hz",
 "filter-control-order", "filter-control-waveform-color", "filter-control?", "filter-fft", "filter-selection", "filter-selection-and-smooth",
 "filter-sound", "filter?", "filtered-comb", "filtered-comb-bank", "filtered-comb-bank?", "filtered-comb?",
 ...
 "float-vector-polynomial", "flocsig", "flocsig?", "flute model", "fm-bell", "fm-drum",
 ...
 "for-each-sound-file", "Forbidden Planet", "foreground-color", "forget-region", "formant", "formant-bank",
 "formant-bank?", "formant?", "format", "fp", "fractional-fourier-transform", "frame",
 "frame*", "frame+", "frame->file", "frame->file?", "frame->frame", "frame->list",
 "frame->sample", "frame-ref", "frame-set!", "frame?", "frames", "free-player",
 ...
 "integrate-envelope", "invert-filter", "izcos", "izcos?", "j0evencos", "j0evencos?",
 ...
 "listener-click-hook", "listener-color", "listener-colorized", "listener-font", "listener-prompt", "listener-selection",
 ...
 "make-channel-drop-site", "make-color", "make-comb", "make-comb-bank", "make-convolve", "make-delay",
 "make-differentiator", "make-env", "make-eoddcos", "make-ercos", "make-erssb", "make-fft-window",
 "make-file->frame", "make-file->sample", "make-filter", "make-filtered-comb", "make-filtered-comb-bank", "make-fir-coeffs",
 "make-fir-filter", "make-firmant", "make-flocsig", "make-fmssb", "make-formant", "make-formant-bank",
 "make-frame", "make-frame!", "make-frame->file", "make-granulate", "make-graph-data", "make-green-noise",
 ...
 "make-selection", "make-sinc-train", "make-snd->sample", "make-sound-box", "make-sound-data", "make-spencer-filter",
 "make-square-wave", "make-src", "make-ssb-am", "make-table-lookup", "make-table-lookup-with-env", "make-tanhsin",
 ...
 "mix-file-dialog", "mix-home", "mix-length", "mix-maxamp", "mix-name", "mix-name->id",
 "mix-position", "mix-properties", "mix-property", "mix-region", "mix-release-hook", "mix-sampler?",
 "mix-selection", "mix-sound", "mix-speed", "mix-sync", "mix-sync-max", "mix-tag-height",
 "mix-tag-width", "mix-tag-y", "mix-vct", "mix-waveform-height", "mix?", "mixer",
 "mixer*", "mixer+", "mixer-ref", "mixer-set!", "mixer?", "mixes",
 ...
 "object-environment", "offset-channel", "offset-sound", "one-pole", "one-pole-all-pass", "one-pole-all-pass?",
 ...
 "open-sound", "orientation-hook", "oscil", "oscil-bank", "oscil-bank?", "oscil?",
 ...
 "pan-mix-float-vector", "partials->polynomial", "partials->wave", "pausing", "peak-env-dir", "peak-env-hook",
 ...
 "procedure-setter", "procedure-source", "profile", "progress-report", "pulse-train", "pulse-train?",
 ...
 "rand?", "random", "random-state?", "rcos", "rcos?", "read-hook",
 "read-mix-sample", "read-only", "read-region-sample", "read-sample", "readin", "readin?",
 "rectangular->magnitudes", "rectangular->polar", "redo", "region->integer", "region->vct", "region-chans",
 ...
 "sndwarp", "sound->amp-env", "sound->integer", "sound-data*", "sound-data+", "sound-data-add!",
 ...
 "start-playing-selection-hook", "start-progress-report", "status-report", "stereo->mono", "stereo-flute", "stop-dac-hook",
 ...
 "vct->channel", "vct->list", "vct->string", "vct->vector", "vct-add!", "vct-copy",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "Copy_context", "copy_sampler", "correlate", "create_fmv_dialog", "create_ssb_dialog", "cross_fade__amplitude_",
 ...
 "define_macro_", "define_selection_via_marks", "defined?", "defvar", "degrees2radians", "delay",
 ...
 "display_scanned_synthesis", "dissolve_fade", "dither_channel", "dither_sound", "dolph", "dot_product",
 ...
 "enved_target", "enved_wave?", "enved_waveform_color", "envelope_interp", "enveloped_mix", "environment",
 "environment2list", "environment_ref", "environment_set!", "environment?", "eoddcos", "eoddcos?",
 ...
 "file2frame?", "file2sample", "file2sample?", "file_name", "fill_polygon", "fill_rectangle",
 "filter", "filter_channel", "filter_control_coeffs", "filter_control_envelope", "filter_control_in_dB", "filter_control_in_hz",
 "filter_control_order", "filter_control_waveform_color", "filter_control?", "filter_fft", "filter_selection", "filter_selection_and_smooth",
 "filter_sound", "filter?", "filtered_comb", "filtered_comb_bank", "filtered_comb_bank?", "filtered_comb?",
 ...
 "float_vector_polynomial", "flocsig", "flocsig?", "flute_model", "fm_bell", "fm_drum",
 ...
 "formant_bank?", "formant?", "format", "fp", "fractional_fourier_transform", "frame",
 "frame_multiply", "frame_add", "frame2file", "frame2file?", "frame2frame", "frame2list",
 "frame2sample", "frame_ref", "frame_set!", "frame?", "frames", "free_player",
 ...
 "integrate_envelope", "invert_filter", "izcos", "izcos?", "j0evencos", "j0evencos?",
 ...
 "listener_click_hook", "listener_color", "listener_colorized", "listener_font", "listener_prompt", "listener_selection",
 ...
 "make_channel_drop_site", "make_color", "make_comb", "make_comb_bank", "make_convolve", "make_delay",
 "make_differentiator", "make_env", "make_eoddcos", "make_ercos", "make_erssb", "make_fft_window",
 "make_file2frame", "make_file2sample", "make_filter", "make_filtered_comb", "make_filtered_comb_bank", "make_fir_coeffs",
 "make_fir_filter", "make_firmant", "make_flocsig", "make_fmssb", "make_formant", "make_formant_bank",
 "make_frame", "make_frame!", "make_frame2file", "make_granulate", "make_graph_data", "make_green_noise",
 ...
 "make_selection", "make_sinc_train", "make_snd2sample", "make_sound_box", "make_sound_data", "make_spencer_filter",
 "make_square_wave", "make_src", "make_ssb_am", "make_table_lookup", "make_table_lookup_with_env", "make_tanhsin",
 ...
 "mix_file_dialog", "mix_home", "mix_length", "mix_maxamp", "mix_name", "mix_name2id",
 "mix_position", "mix_properties", "mix_property", "mix_region", "mix_release_hook", "mix_sampler?",
 "mix_selection", "mix_sound", "mix_speed", "mix_sync", "mix_sync_max", "mix_tag_height",
 "mix_tag_width", "mix_tag_y", "mix_vct", "mix_waveform_height", "mix?", "mixer",
 "mixer_multiply", "mixer_add", "mixer_ref", "mixer_set!", "mixer?", "mixes",
 ...
 "nsincos", "nsincos?", "nssb", "nssb?", "nxy1cos", "nxy1cos?",
 "nxy1sin", "nxy1sin?", "nxycos", "nxycos?", "nxysin", "nxysin?",
 "object_environment", "offset_channel", "offset_sound", "one_pole", "one_pole_all_pass", "one_pole_all_pass?",
 ...
 "open_sound", "orientation_hook", "oscil", "oscil_bank", "oscil_bank?", "oscil?",
 ...
 "pan_mix_float_vector", "partials2polynomial", "partials2wave", "pausing", "peak_env_dir", "peak_env_hook",
 ...
 "procedure_setter", "procedure_source", "profile", "progress_report", "pulse_train", "pulse_train?",
 ...
 "rand?", "random", "random_state?", "rcos", "rcos?", "read_hook",
 "read_mix_sample", "read_only", "read_region_sample", "read_sample", "readin", "readin?",
 "rectangular2magnitudes", "rectangular2polar", "redo_edit", "region2integer", "region2vct", "region_chans",
 ...
 "sndwarp", "sound2amp_env", "sound2integer", "sound_data_", "sound_data_", "sound_data_add!",
 ...
 "start_playing_selection_hook", "start_progress_report", "status_report", "stereo2mono", "stereo_flute", "stop_dac_hook",
 ...
 "user_interface_extensions", "variable_display", "variable_graph?", "vct", "vct_", "vct_",
 "vct2channel", "vct2list", "vct2string", "vct2vector", "vct_add!", "vct_copy",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "extsnd.html#convolvewith", "sndclm.html#convolve?", "extsnd.html#copycontext", "extsnd.html#copysampler",
 ...
 "extsnd.html#envedwaveformcolor", "sndclm.html#envelopeinterp", "sndscm.html#envelopedmix", "s7.html#environment",
 "s7.html#environmenttolist", "s7.html#environmentref", "s7.html#environmentset", "s7.html#environmentp",
 ...
 "sndclm.html#filetoframe?", "sndclm.html#filetosample", "sndclm.html#filetosample?", "extsnd.html#filename",
 ...
 "sndscm.html#vctpolynomial", "sndclm.html#flocsig", "sndclm.html#flocsig?", "sndscm.html#stereoflute",
 ...
 "sndclm.html#frametosample", "sndclm.html#frame-ref", "sndclm.html#frame-set!", "sndclm.html#frame?",
 "extsnd.html#frames", "extsnd.html#freeplayer", "extsnd.html#freesampler", "sndscm.html#freeverb",
 ...
 "extsnd.html#insertsilence", "extsnd.html#insertsound", "extsnd.html#integertocolormap", "extsnd.html#integertomark",
 "extsnd.html#integertomix", "extsnd.html#integertoregion", "extsnd.html#integertosound", "extsnd.html#integertotransform",
 "sndscm.html#integrateenvelope", "sndscm.html#invertfilter", "sndclm.html#izcos", "sndclm.html#izcos?",
 ...
 "extsnd.html#listenerclickhook", "extsnd.html#listenercolor", "extsnd.html#listenercolorized", "extsnd.html#listenerfont",
 ...
 "sndclm.html#make-frametofile", "sndclm.html#make-granulate", "extsnd.html#makegraphdata", "sndclm.html#make-green-noise",
 ...
 "sndclm.html#make-rcos", "sndclm.html#make-readin", "extsnd.html#makeregion", "extsnd.html#makeregionsampler",
 ...
 "extsnd.html#mixp", "sndclm.html#mixer1", "sndclm.html#mixermultiply", "sndclm.html#mixeradd",
 "sndclm.html#mixer-ref", "sndclm.html#mixer-set!", "sndclm.html#mixer?", "extsnd.html#mixes",
 ...
 "s7.html#randomstatep", "sndclm.html#rcos", "sndclm.html#rcos?", "extsnd.html#readhook",
 ...
 "extsnd.html#redo", "extsnd.html#regiontointeger", "extsnd.html#regiontovct", "extsnd.html#regionchans",
 ...
 "extsnd.html#soundtointeger", "extsnd.html#sounddata*", "extsnd.html#sounddata+", "extsnd.html#sounddataadd",
...
static const char *Copying_xrefs[] = {
  ...
  "copy region data: {region->vct}, {region->vct}, {save-region}",
...
static const char *snd_names[11014] = {
    ...
    "cblas_caxpy", "libgsl.scm",
    "cblas_ccopy", "libgsl.scm",
    "cblas_cdotc_sub", "libgsl.scm",
    "cblas_cdotu_sub", "libgsl.scm",
    "cblas_cgbmv", "libgsl.scm",
    "cblas_cgemm", "libgsl.scm",
    "cblas_cgemv", "libgsl.scm",
    "cblas_cgerc", "libgsl.scm",
    "cblas_cgeru", "libgsl.scm",
    "cblas_chbmv", "libgsl.scm",
    "cblas_chemm", "libgsl.scm",
    "cblas_chemv", "libgsl.scm",
    "cblas_cher", "libgsl.scm",
    "cblas_cher2", "libgsl.scm",
    "cblas_cher2k", "libgsl.scm",
    "cblas_cherk", "libgsl.scm",
    "cblas_chpmv", "libgsl.scm",
    "cblas_chpr", "libgsl.scm",
    "cblas_chpr2", "libgsl.scm",
    "cblas_cscal", "libgsl.scm",
    "cblas_csscal", "libgsl.scm",
    "cblas_cswap", "libgsl.scm",
    "cblas_csymm", "libgsl.scm",
    "cblas_csyr2k", "libgsl.scm",
    "cblas_csyrk", "libgsl.scm",
    "cblas_ctbmv", "libgsl.scm",
    "cblas_ctbsv", "libgsl.scm",
    "cblas_ctpmv", "libgsl.scm",
    "cblas_ctpsv", "libgsl.scm",
    "cblas_ctrmm", "libgsl.scm",
    "cblas_ctrmv", "libgsl.scm",
    "cblas_ctrsm", "libgsl.scm",
    "cblas_ctrsv", "libgsl.scm",
    ...
    "cblas_scasum", "libgsl.scm",
    "cblas_scnrm2", "libgsl.scm",
    ...
    "gsl-vector->float-vector", "libgsl.scm",
    "gsl_acosh", "libgsl.scm",
    "gsl_asinh", "libgsl.scm",
    "gsl_atanh", "libgsl.scm",
    "gsl_blas_ccopy", "libgsl.scm",
    "gsl_blas_cdotc", "libgsl.scm",
    "gsl_blas_cdotu", "libgsl.scm",
    "gsl_blas_cher", "libgsl.scm",
    "gsl_blas_cherk", "libgsl.scm",
    "gsl_blas_csscal", "libgsl.scm",
    "gsl_blas_cswap", "libgsl.scm",
    "gsl_blas_ctrmv", "libgsl.scm",
    "gsl_blas_ctrsv", "libgsl.scm",
    "gsl_blas_dasum", "libgsl.scm",
    "gsl_blas_daxpy", "libgsl.scm",
    "gsl_blas_dcopy", "libgsl.scm",
    "gsl_blas_ddot", "libgsl.scm",
    ...
    "gsl_blas_icamax", "libgsl.scm",
    "gsl_blas_idamax", "libgsl.scm",
    "gsl_blas_isamax", "libgsl.scm",
    "gsl_blas_izamax", "libgsl.scm",
    "gsl_blas_sasum", "libgsl.scm",
    "gsl_blas_saxpy", "libgsl.scm",
    "gsl_blas_scasum", "libgsl.scm",
    "gsl_blas_scnrm2", "libgsl.scm",
    "gsl_blas_scopy", "libgsl.scm",
    "gsl_blas_sgemm", "libgsl.scm",
    "gsl_blas_sgemv", "libgsl.scm",
    "gsl_blas_sger", "libgsl.scm",
    "gsl_blas_snrm2", "libgsl.scm",
    "gsl_blas_srot", "libgsl.scm",
    "gsl_blas_sscal", "libgsl.scm",
    "gsl_blas_sswap", "libgsl.scm",
    "gsl_blas_ssymm", "libgsl.scm",
    "gsl_blas_ssymv", "libgsl.scm",
    "gsl_blas_ssyr", "libgsl.scm",
    "gsl_blas_ssyr2", "libgsl.scm",
    "gsl_blas_ssyr2k", "libgsl.scm",
    "gsl_blas_ssyrk", "libgsl.scm",
    "gsl_blas_strmm", "libgsl.scm",
    "gsl_blas_strmv", "libgsl.scm",
    "gsl_blas_strsm", "libgsl.scm",
    "gsl_blas_strsv", "libgsl.scm",
    ...
    "gsl_combination_data", "libgsl.scm",
    ...
    "gsl_ieee_double_to_rep", "libgsl.scm",
    "gsl_ieee_env_setup", "libgsl.scm",
    "gsl_ieee_fprintf_double", "libgsl.scm",
    "gsl_ieee_printf_double", "libgsl.scm",
    "gsl_ieee_read_mode_string", "libgsl.scm",
    ...
    "gsl_multifit_fdfsolver_lmsder", "libgsl.scm",
    "gsl_multifit_fdfsolver_name", "libgsl.scm",
    ...
    "gsl_multimin_fdfminimizer_alloc", "libgsl.scm",
    "gsl_multimin_fdfminimizer_conjugate_fr", "libgsl.scm",
    "gsl_multimin_fdfminimizer_conjugate_pr", "libgsl.scm",
    "gsl_multimin_fdfminimizer_dx", "libgsl.scm",
    "gsl_multimin_fdfminimizer_free", "libgsl.scm",
    "gsl_multimin_fdfminimizer_gradient", "libgsl.scm",
    "gsl_multimin_fdfminimizer_iterate", "libgsl.scm",
    "gsl_multimin_fdfminimizer_minimum", "libgsl.scm",
    "gsl_multimin_fdfminimizer_name", "libgsl.scm",
    "gsl_multimin_fdfminimizer_restart", "libgsl.scm",
    "gsl_multimin_fdfminimizer_set", "libgsl.scm",
    "gsl_multimin_fdfminimizer_steepest_descent", "libgsl.scm",
    "gsl_multimin_fdfminimizer_vector_bfgs", "libgsl.scm",
    "gsl_multimin_fdfminimizer_vector_bfgs2", "libgsl.scm",
    "gsl_multimin_fdfminimizer_x", "libgsl.scm",
    ...
    "gsl_multiroot_fdfsolver_alloc", "libgsl.scm",
    "gsl_multiroot_fdfsolver_dx", "libgsl.scm",
    "gsl_multiroot_fdfsolver_f", "libgsl.scm",
    "gsl_multiroot_fdfsolver_free", "libgsl.scm",
    "gsl_multiroot_fdfsolver_gnewton", "libgsl.scm",
    "gsl_multiroot_fdfsolver_hybridj", "libgsl.scm",
    "gsl_multiroot_fdfsolver_hybridsj", "libgsl.scm",
    "gsl_multiroot_fdfsolver_iterate", "libgsl.scm",
    "gsl_multiroot_fdfsolver_name", "libgsl.scm",
    "gsl_multiroot_fdfsolver_newton", "libgsl.scm",
    "gsl_multiroot_fdfsolver_root", "libgsl.scm",
    "gsl_multiroot_fdfsolver_set", "libgsl.scm",
    ...
    "gsl_odeiv2_control_alloc", "libgsl.scm",
    "gsl_odeiv2_control_errlevel", "libgsl.scm",
    "gsl_odeiv2_control_free", "libgsl.scm",
    "gsl_odeiv2_control_hadjust", "libgsl.scm",
    "gsl_odeiv2_control_init", "libgsl.scm",
    "gsl_odeiv2_control_name", "libgsl.scm",
    "gsl_odeiv2_control_scaled_new", "libgsl.scm",
    "gsl_odeiv2_control_set_driver", "libgsl.scm",
    "gsl_odeiv2_control_standard_new", "libgsl.scm",
    "gsl_odeiv2_control_y_new", "libgsl.scm",
    "gsl_odeiv2_control_yp_new", "libgsl.scm",
    "gsl_odeiv2_driver_alloc_scaled_new", "libgsl.scm",
    "gsl_odeiv2_driver_alloc_standard_new", "libgsl.scm",
    "gsl_odeiv2_driver_alloc_y_new", "libgsl.scm",
    "gsl_odeiv2_driver_alloc_yp_new", "libgsl.scm",
    "gsl_odeiv2_driver_apply", "libgsl.scm",
    ...
    "gsl_odeiv2_evolve_alloc", "libgsl.scm",
    "gsl_odeiv2_evolve_apply", "libgsl.scm",
    "gsl_odeiv2_evolve_apply_fixed_step", "libgsl.scm",
    "gsl_odeiv2_evolve_free", "libgsl.scm",
    "gsl_odeiv2_evolve_reset", "libgsl.scm",
    "gsl_odeiv2_evolve_set_driver", "libgsl.scm",
    "gsl_odeiv2_step_alloc", "libgsl.scm",
    "gsl_odeiv2_step_apply", "libgsl.scm",
    "gsl_odeiv2_step_bsimp", "libgsl.scm",
    "gsl_odeiv2_step_free", "libgsl.scm",
    "gsl_odeiv2_step_msadams", "libgsl.scm",
    "gsl_odeiv2_step_msbdf", "libgsl.scm",
    "gsl_odeiv2_step_name", "libgsl.scm",
    "gsl_odeiv2_step_order", "libgsl.scm",
    "gsl_odeiv2_step_reset", "libgsl.scm",
    ...
    "gsl_odeiv2_step_set_driver", "libgsl.scm",
    "gsl_odeiv_control_alloc", "libgsl.scm",
    "gsl_odeiv_control_free", "libgsl.scm",
    "gsl_odeiv_control_hadjust", "libgsl.scm",
    "gsl_odeiv_control_init", "libgsl.scm",
    "gsl_odeiv_control_name", "libgsl.scm",
    "gsl_odeiv_control_scaled_new", "libgsl.scm",
    "gsl_odeiv_control_standard_new", "libgsl.scm",
    "gsl_odeiv_control_y_new", "libgsl.scm",
    "gsl_odeiv_control_yp_new", "libgsl.scm",
    "gsl_odeiv_evolve_alloc", "libgsl.scm",
    "gsl_odeiv_evolve_apply", "libgsl.scm",
    "gsl_odeiv_evolve_free", "libgsl.scm",
    "gsl_odeiv_evolve_reset", "libgsl.scm",
    "gsl_odeiv_step_alloc", "libgsl.scm",
    "gsl_odeiv_step_apply", "libgsl.scm",
    "gsl_odeiv_step_bsimp", "libgsl.scm",
    "gsl_odeiv_step_free", "libgsl.scm",
    "gsl_odeiv_step_gear1", "libgsl.scm",
    "gsl_odeiv_step_gear2", "libgsl.scm",
    "gsl_odeiv_step_name", "libgsl.scm",
    "gsl_odeiv_step_order", "libgsl.scm",
    "gsl_odeiv_step_reset", "libgsl.scm",
    ...
    "gsl_ran_multinomial", "libgsl.scm",
    "gsl_ran_multinomial_lnpdf", "libgsl.scm",
    "gsl_ran_multinomial_pdf", "libgsl.scm",
    ...
    "gsl_ran_poisson_array", "libgsl.scm",
    ...
    "gsl_root_fdfsolver_alloc", "libgsl.scm",
    "gsl_root_fdfsolver_free", "libgsl.scm",
    "gsl_root_fdfsolver_iterate", "libgsl.scm",
    "gsl_root_fdfsolver_name", "libgsl.scm",
    "gsl_root_fdfsolver_newton", "libgsl.scm",
    "gsl_root_fdfsolver_root", "libgsl.scm",
    "gsl_root_fdfsolver_secant", "libgsl.scm",
    "gsl_root_fdfsolver_set", "libgsl.scm",
    "gsl_root_fdfsolver_steffenson", "libgsl.scm",
    ...
    "gsl_sf_legendre_Plm_array", "libgsl.scm",
    "gsl_sf_legendre_Plm_deriv_array", "libgsl.scm",
    ...
    "gsl_sf_legendre_array_size", "libgsl.scm",
    "gsl_sf_legendre_sphPlm", "libgsl.scm",
    "gsl_sf_legendre_sphPlm_array", "libgsl.scm",
    "gsl_sf_legendre_sphPlm_deriv_array", "libgsl.scm",
...
{
  s7_autoload_set_names(sc, snd_names, 5507);
}
#endif
