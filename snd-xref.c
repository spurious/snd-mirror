...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "vct-set!", "vct-subseq", "vct-subtract!", "vct?", "vector->vct", "vibrating-uniform-circular-string",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "vct_set!", "vct_subseq", "vct_subtract!", "vct?", "vector2vct", "vibrating_uniform_circular_string",
