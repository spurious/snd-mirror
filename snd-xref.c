...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "procedure-setter", "procedure-signature", "procedure-source", "progress-report", "pulse-train", "pulse-train?",
 ...
 "rand?", "random", "random-state", "random-state?", "rcos", "rcos?",
 "*read-error-hook*", "read-hook", "read-mix-sample", "read-only", "read-region-sample", "read-sample",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "procedure_setter", "procedure_signature", "procedure_source", "progress_report", "pulse_train", "pulse_train?",
 ...
 "rand?", "random", "random_state", "random_state?", "rcos", "rcos?",
 "_read_error_hook_", "read_hook", "read_mix_sample", "read_only", "read_region_sample", "read_sample",
...
static const char *snd_names[11632] = {
...
{
  s7_autoload_set_names(sc, snd_names, 5816);
}
#endif
