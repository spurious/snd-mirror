...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "bigbird", "binary files", "bind-key", "bird", "bold-peaks-font", "bomb",
 "break", "brown-noise", "butterworth filters", "c-g!", "c-g?", "call_in",
 "cascade->canonical", "chain-dsps", "channel->vct", "channel-amp-envs", "channel-data", "channel-envelope",
 ...
 "cross-synthesis", "current-edit-position", "current-font", "cursor", "cursor-color", "cursor-follows-play",
 ...
 "formant?", "fourier-transform", "fractional-fourier-transform", "frame", "frame*", "frame+",
 ...
 "gaussian-distribution", "gc-off", "gc-on", "gl-graph->ps", "glSpectrogram", "goertzel",
 ...
 "harmonicizer", "Hartley transform", "header-type", "hello-dentist", "help-dialog", "help-hook",
 ...
 "*load-path*", "locsig", "locsig-ref", "locsig-reverb-ref", "locsig-reverb-set!", "locsig-set!",
 ...
 "make-hidden-controls-dialog", "make-highpass", "make-hilbert-transform", "make-iir-filter", "make-locsig", "make-lowpass",
 ...
 "make-polywave", "make-pulse-train", "make-rand", "make-rand-interp", "make-readin", "make-region",
 "make-region-frame-reader", "make-region-sampler", "make-sample->file", "make-sampler", "make-sawtooth-wave", "make-scalar-mixer",
 "make-selection", "make-selection-frame-reader", "make-snd->sample", "make-sound-box", "make-sound-data", "make-square-wave",
 "make-src", "make-ssb-am", "make-sync-frame-reader", "make-table-lookup", "make-triangle-wave", "make-two-pole",
 "make-two-zero", "make-variable-display", "make-variable-graph", "make-vct", "make-wave-train", "map-channel",
 ...
 "selection-member?", "selection-members", "selection-position", "selection-srate", "selection?", "set-global-sync",
 ...
 "show-selection-transform", "show-smpte-label", "show-sonogram-cursor", "show-transform-peaks", "show-widget", "show-y-zero",
 "silence-all-mixes", "silence-mixes", "sinc-train", "sinc-width", "sine-env-channel", "sine-ramp",
 ...
 "sound-interp", "sound-let", "sound-loop-info", "sound-properties", "sound-property", "sound-widgets",
 "sound?", "soundfont-info", "sounds", "spectral interpolation", "spectral-polynomial", "spectro-hop",
 ...
 "speed-control-style", "speed-control-tones", "square-wave", "square-wave?", "squelch-update", "squelch-vowels",
 "srate", "src", "src-channel", "src-duration", "src-mixes", "src-selection",
 "src-sound", "src?", "ssb-am", "ssb-am?", "ssb-bank", "ssb-bank-env",
 "ssb-fm", "start-hook", "start-playing", "start-playing-hook", "start-playing-selection-hook", "start-progress-report",
 "start-waterfall", "stereo->mono", "stop-dac-hook", "stop-player", "stop-playing", "stop-playing-hook",
 "stop-playing-selection-hook", "stretch-envelope", "superimpose-ffts", "swap-channels", "swap-selection-channels", "sync",
 ...
 "time-graph?", "tiny-font", "*trace-hook*", "tracking-cursor-style", "transform->integer", "transform->vct",
 ...
 "window-samples", "window-width", "window-x", "window-y", "with-background-processes", "with-file-monitor",
 "with-gl", "with-inset-graph", "with-local-hook", "with-marked-sound", "with-mix-tags", "with-mixed-sound",
 "with-mixed-sound->notelist", "with-pointer-focus", "with-relative-panes", "with-reopen-menu", "with-sound", "with-temp-sound",
 "with-temporary-selection", "with-threaded-channels", "with-threaded-sound", "with-tracking-cursor", "with-verbose-cursor", "x->position",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "bigbird", "binary_files", "bind_key", "bird", "bold_peaks_font", "bomb",
 "break", "brown_noise", "butterworth_filters", "c_g!", "c_g?", "call_in",
 "cascade2canonical", "chain_dsps", "channel2vct", "channel_amp_envs", "channel_data", "channel_envelope",
 ...
 "cross_synthesis", "Current_edit_position", "current_font", "cursor", "cursor_color", "cursor_follows_play",
 ...
 "formant?", "Fourier_transform", "fractional_fourier_transform", "frame", "frame_multiply", "frame_add",
 ...
 "gaussian_distribution", "gc_off", "gc_on", "gl_graph2ps", "glSpectrogram", "goertzel",
 ...
 "harmonicizer", "Hartley_transform", "header_type", "hello_dentist", "help_dialog", "help_hook",
 ...
 "_load_path_", "locsig", "locsig_ref", "locsig_reverb_ref", "locsig_reverb_set!", "locsig_set!",
 ...
 "make_hidden_controls_dialog", "make_highpass", "make_hilbert_transform", "make_iir_filter", "make_locsig", "make_lowpass",
 ...
 "make_polywave", "make_pulse_train", "make_rand", "make_rand_interp", "make_readin", "make_region",
 "make_region_frame_reader", "make_region_sampler", "make_sample2file", "make_sampler", "make_sawtooth_wave", "make_scalar_mixer",
 "make_selection", "make_selection_frame_reader", "make_snd2sample", "make_sound_box", "make_sound_data", "make_square_wave",
 "make_src", "make_ssb_am", "make_sync_frame_reader", "make_table_lookup", "make_triangle_wave", "make_two_pole",
 "make_two_zero", "make_variable_display", "make_variable_graph", "make_vct", "make_wave_train", "map_channel",
 ...
 "selection_member?", "selection_members", "selection_position", "selection_srate", "selection?", "set_global_sync",
 ...
 "show_selection_transform", "show_smpte_label", "show_sonogram_cursor", "show_transform_peaks", "show_widget", "show_y_zero",
 "silence_all_mixes", "silence_mixes", "sinc_train", "sinc_width", "sine_env_channel", "sine_ramp",
 ...
 "sound_interp", "sound_let", "sound_loop_info", "sound_properties", "sound_property", "sound_widgets",
 "sound?", "soundfont_info", "sounds", "spectral_interpolation", "spectral_polynomial", "spectro_hop",
 ...
 "speed_control_style", "speed_control_tones", "square_wave", "square_wave?", "squelch_update", "squelch_vowels",
 "srate", "src", "src_channel", "src_duration", "src_mixes", "src_selection",
 "src_sound", "src?", "ssb_am", "ssb_am?", "ssb_bank", "ssb_bank_env",
 "ssb_fm", "start_hook", "start_playing", "start_playing_hook", "start_playing_selection_hook", "start_progress_report",
 "start_waterfall", "stereo2mono", "stop_dac_hook", "stop_player", "stop_playing", "stop_playing_hook",
 "stop_playing_selection_hook", "stretch_envelope", "superimpose_ffts", "swap_channels", "swap_selection_channels", "sync",
 ...
 "time_graph?", "tiny_font", "_trace_hook_", "tracking_cursor_style", "transform2integer", "transform2vct",
 ...
 "window_samples", "window_width", "window_x", "window_y", "with_background_processes", "with_file_monitor",
 "with_gl", "with_inset_graph", "with_local_hook", "with_marked_sound", "with_mix_tags", "with_mixed_sound",
 "with_mixed_sound2notelist", "with_pointer_focus", "with_relative_panes", "with_reopen_menu", "with_sound", "with_temp_sound",
 "with_temporary_selection", "with_threaded_channels", "with_threaded_sound", "with_tracking_cursor", "with_verbose_cursor", "x2position",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "extsnd.html#beforetransformhook", "sndscm.html#analogfilterdoc", "sndscm.html#bigbird", "sndscm.html#binaryiodoc",
 ...
 "extsnd.html#cgp", "extsnd.html#callin", "sndscm.html#cascadetocanonical", "sndscm.html#chaindsps",
 ...
 "sndscm.html#channelsequal", "extsnd.html#channelstyleconstants", "sndscm.html#channels=", "extsnd.html#chans",
 "sndscm.html#analogfilterdoc", "sndscm.html#checkforunsavededits", "sndscm.html#checkmixtags", "sndscm.html#cleanchannel",
 "sndscm.html#cleansound", "sndclm.html#clear-array", "extsnd.html#clearlistener", "extsnd.html#clearminibuffer",
 "sndscm.html#clearselection", "extsnd.html#cliphook", "extsnd.html#clipping", "extsnd.html#clmchannel",
 ...
 "sndclm.html#convolve?", "sndscm.html#copyframereader", "extsnd.html#copysampler", "sndclm.html#correlate",
 "extsnd.html#countmatches", "sndscm.html#createssbdialog", "sndscm.html#mixdoc", "sndscm.html#fadedoc",
 "sndscm.html#crosssynthesis", "extsnd.html#currenteditposition", "extsnd.html#currentfont", "extsnd.html#cursor",
 ...
 "sndscm.html#lpccoeffs", "sndscm.html#lpcpredict", "extsnd.html#mainmenu", "extsnd.html#mainwidgets",
 ...
 "sndclm.html#rand-interp", "sndclm.html#rand-interp?", "sndclm.html#rand?", "sndscm.html#readframe",
 ...
 "extsnd.html#regionok", "extsnd.html#eregions", "sndscm.html#remembersoundstate", "extsnd.html#removefrommenu",
 ...
 "extsnd.html#selectionposition", "extsnd.html#selectionsrate", "extsnd.html#selectionok", "sndscm.html#setglobalsync",
