...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "info-dialog", "info-popup-hook", "init-ladspa", "initial-beg", "initial-dur", "initial-graph-hook",
 "inlet", "insert-channel", "insert-file-dialog", "insert-region", "insert-sample", "insert-samples",
 ...
 "open-next-file-in-directory", "open-play-output", "open-raw-sound", "open-raw-sound-hook", "open-sound", "openlet",
 "openlet?", "orientation-hook", "oscil", "oscil-bank", "oscil-bank?", "oscil?",
 "out-any", "out-bank", "outa", "outlet", "*output*", "output-comment-hook",
 "output-name-hook", "overlay-rms-env", "owlet", "pad-channel", "pad-marks", "pad-sound",
 ...
 "print-dialog", "print-length", "procedure-documentation", "procedure-setter", "procedure-source", "profile",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "info_dialog", "info_popup_hook", "init_ladspa", "initial_beg", "initial_dur", "initial_graph_hook",
 "inlet", "insert_channel", "insert_file_dialog", "insert_region", "insert_sample", "insert_samples",
 ...
 "open_next_file_in_directory", "open_play_output", "open_raw_sound", "open_raw_sound_hook", "open_sound", "openlet",
 "openlet?", "orientation_hook", "oscil", "oscil_bank", "oscil_bank?", "oscil?",
 "out_any", "out_bank", "outa", "outlet", "_output_", "output_comment_hook",
 "output_name_hook", "overlay_rms_env", "owlet", "pad_channel", "pad_marks", "pad_sound",
 ...
 "print_dialog", "print_length", "procedure_documentation", "procedure_setter", "procedure_source", "profile",
...
static const char *snd_names[11344] = {
...
{
  s7_autoload_set_names(sc, snd_names, 5672);
}
#endif
