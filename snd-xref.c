...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "hash-table-entries", "hash-table-iterator?", "hash-table-ref", "hash-table-set!", "hash-table-size", "hash-table?",
 ...
 "left-sample", "linear->db", "linear-src-channel", "lint for scheme", "lisp-graph-hook", "lisp-graph-style",
 "lisp-graph?", "list->vct", "list-ladspa", "listener-click-hook", "listener-color", "listener-colorized",
 ...
 "make-filtered-comb", "make-filtered-comb-bank", "make-fir-coeffs", "make-fir-filter", "make-firmant", "make-flocsig",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "hash_table_entries", "hash_table_iterator?", "hash_table_ref", "hash_table_set!", "hash_table_size", "hash_table?",
 ...
 "left_sample", "linear2db", "linear_src_channel", "lint_for_scheme", "lisp_graph_hook", "lisp_graph_style",
 "lisp_graph?", "list2vct", "list_ladspa", "listener_click_hook", "listener_color", "listener_colorized",
 ...
 "make_filtered_comb", "make_filtered_comb_bank", "make_fir_coeffs", "make_fir_filter", "make_firmant", "make_flocsig",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "s7.html#hashtableentries", "s7.html#hashtableiteratorp", "s7.html#hashtableref", "s7.html#hashtableset",
