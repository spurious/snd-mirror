...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "sound->integer", "sound-file-extensions", "sound-file?", "sound-files-in-directory", "sound-interp", "sound-loop-info",
 ...
 "start-playing-selection-hook", "start-progress-report", "status-report", "stereo->mono", "stereo-flute", "stop-player",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "sound2integer", "sound_file_extensions", "sound_file?", "sound_files_in_directory", "sound_interp", "sound_loop_info",
 ...
 "start_playing_selection_hook", "start_progress_report", "status_report", "stereo2mono", "stereo_flute", "stop_player",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "sndscm.html#sndwarp", "sndscm.html#soundtoamp_env", "extsnd.html#soundtointeger", "extsnd.html#soundfileextensions",
...
static const char *snd_names[11668] = {
...
{
  s7_autoload_set_names(sc, snd_names, 5834);
}
#endif
