...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "procedure-signature", "procedure-source", "profile", "progress-report", "pulse-train", "pulse-train?",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "procedure_signature", "procedure_source", "profile", "progress_report", "pulse_train", "pulse_train?",
