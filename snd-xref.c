...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "read-sample-with-direction", "reader-cond", "readin", "readin?", "rectangular->magnitudes", "rectangular->polar",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "read_sample_with_direction", "reader_cond", "readin", "readin?", "rectangular2magnitudes", "rectangular2polar",
