...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "byte-vector", "byte-vector?", "c-define", "c-g?", "call-with-exit", "canter",
 ...
 "complexify", "compute-uniform-circular-string", "concatenate-envelopes", "constant?", "continuation?", "continue-frample->file",
 ...
 "convolve-files", "convolve-selection-with", "convolve-with", "convolve?", "copy", "copy-context",
 ...
 "envelope-interp", "enveloped-mix", "eoddcos", "eoddcos?", "eps-bottom-margin", "eps-file",
 "eps-left-margin", "eps-size", "ercos", "ercos?", "*error-hook*", "erssb",
 "erssb?", "even-multiple", "even-weight", "every-sample?", "exit", "exit-hook",
 ...
 "fft-window-beta", "fft-with-phases", "file database", "file->array", "file->frample", "file->frample?",
 "file->sample", "file->sample?", "file-name", "fill!", "fill-polygon", "fill-rectangle",
 ...
 "float-vector", "float-vector*", "float-vector+", "float-vector->channel", "float-vector->list", "float-vector->string",
 "float-vector-abs!", "float-vector-add!", "float-vector-copy", "float-vector-equal?", "float-vector-fill!", "float-vector-length",
 ...
 "harmonicizer", "Hartley transform", "hash-table", "hash-table*", "hash-table-entries", "hash-table-function",
 ...
 "insert-sound", "int-vector", "int-vector?", "integer->colormap", "integer->mark", "integer->mix",
 ...
 "let-set!", "let?", "linear->db", "linear-src-channel", "lint for scheme", "lisp-graph-hook",
 "lisp-graph-style", "lisp-graph?", "list->float-vector", "list->vct", "list-ladspa", "listener-click-hook",
 ...
 "mus-run", "mus-sample-type->string", "mus-sample-type-name", "mus-scaler", "mus-sound-chans", "mus-sound-close-input",
 "mus-sound-close-output", "mus-sound-comment", "mus-sound-data-location", "mus-sound-datum-size", "mus-sound-duration", "mus-sound-forget",
 "mus-sound-framples", "mus-sound-header-type", "mus-sound-length", "mus-sound-loop-info", "mus-sound-mark-info", "mus-sound-maxamp",
 "mus-sound-maxamp-exists?", "mus-sound-open-input", "mus-sound-open-output", "mus-sound-path", "mus-sound-preload", "mus-sound-prune",
 "mus-sound-read", "mus-sound-reopen-output", "mus-sound-report-cache", "mus-sound-sample-type", "mus-sound-samples", "mus-sound-seek-frample",
 ...
 "nxy1sin?", "nxycos", "nxycos?", "nxysin", "nxysin?", "object->string",
 ...
 "overlay-rms-env", "owlet", "pad-channel", "pad-marks", "pad-sound", "pan-mix",
 ...
 "rxysin?", "sample", "sample->file", "sample->file?", "sample-type", "sampler-at-end?",
 ...
 "snd-version", "snd-warning", "snd-warning-hook", "sndwarp", "sort!", "sound->amp-env",
 ...
 "ssb-bank-env", "ssb-fm", "start-dac", "start-playing", "start-playing-hook", "start-playing-selection-hook",
 "start-progress-report", "status-report", "stereo->mono", "stereo-flute", "stop-player", "stop-playing",
 "stop-playing-hook", "stop-playing-selection-hook", "stretch-envelope", "stretch-sound-via-dft", "sublet", "superimpose-ffts",
 ...
 "unclip-channel", "undo", "undo-hook", "unlet", "unselect-all", "update-graphs",
 "update-hook", "update-lisp-graph", "update-sound", "update-time-graph", "update-transform-graph", "upon-save-yourself",
 "user interface extensions", "variable-display", "variable-graph?", "varlet", "vct", "vct*",
 "vct+", "vct->channel", "vct->list", "vct->string", "vct->vector", "vct-abs!",
 "vct-add!", "vct-copy", "vct-equal?", "vct-fill!", "vct-length", "vct-max",
 "vct-min", "vct-move!", "vct-multiply!", "vct-offset!", "vct-peak", "vct-ref",
 "vct-reverse!", "vct-scale!", "vct-set!", "vct-subseq", "vct-subtract!", "vct?",
 "vector->vct", "view-files-amp", "view-files-amp-env", "view-files-dialog", "view-files-files", "view-files-select-hook",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "byte_vector", "byte_vector?", "c_define", "c_g?", "call_with_exit", "canter",
 ...
 "complexify", "compute_uniform_circular_string", "concatenate_envelopes", "constant?", "continuation?", "continue_frample2file",
 ...
 "convolve_files", "convolve_selection_with", "convolve_with", "convolve?", "copy", "Copy_context",
 ...
 "envelope_interp", "enveloped_mix", "eoddcos", "eoddcos?", "eps_bottom_margin", "eps_file",
 "eps_left_margin", "eps_size", "ercos", "ercos?", "_error_hook_", "erssb",
 "erssb?", "even_multiple", "even_weight", "every_sample?", "exit", "exit_hook",
 ...
 "fft_window_beta", "fft_with_phases", "file_database", "file2array", "file2frample", "file2frample?",
 "file2sample", "file2sample?", "file_name", "fill!", "fill_polygon", "fill_rectangle",
 ...
 "float_vector", "float-vector_multiply", "float-vector_add", "float_vector2channel", "float_vector2list", "float_vector2string",
 "float_vector_abs!", "float_vector_add!", "float_vector_copy", "float_vector_equal?", "float_vector_fill!", "float_vector_length",
 ...
 "harmonicizer", "Hartley_transform", "hash_table", "hash_table_", "hash_table_entries", "hash_table_function",
 ...
 "insert_sound", "int_vector", "int_vector?", "integer2colormap", "integer2mark", "integer2mix",
 ...
 "let_set!", "let?", "linear2db", "linear_src_channel", "lint_for_scheme", "lisp_graph_hook",
 "lisp_graph_style", "lisp_graph?", "list2float_vector", "list2vct", "list_ladspa", "listener_click_hook",
 ...
 "mus_run", "mus_sample_type2string", "mus_sample_type_name", "mus_scaler", "mus_sound_chans", "mus_sound_close_input",
 "mus_sound_close_output", "mus_sound_comment", "mus_sound_data_location", "mus_sound_datum_size", "mus_sound_duration", "mus_sound_forget",
 "mus_sound_framples", "mus_sound_header_type", "mus_sound_length", "mus_sound_loop_info", "mus_sound_mark_info", "mus_sound_maxamp",
 "mus_sound_maxamp_exists?", "mus_sound_open_input", "mus_sound_open_output", "mus_sound_path", "mus_sound_preload", "mus_sound_prune",
 "mus_sound_read", "mus_sound_reopen_output", "mus_sound_report_cache", "mus_sound_sample_type", "mus_sound_samples", "mus_sound_seek_frample",
 ...
 "nrxycos?", "nrxysin", "nrxysin?", "nsin", "nsin?", "nsincos",
 "nsincos?", "nssb", "nssb?", "nxy1cos", "nxy1cos?", "nxy1sin",
 "nxy1sin?", "nxycos", "nxycos?", "nxysin", "nxysin?", "object2string",
 ...
 "overlay_rms_env", "owlet", "pad_channel", "pad_marks", "pad_sound", "pan_mix",
 ...
 "rxycos?", "rxyk!cos", "rxyk!cos?", "rxyk!sin", "rxyk!sin?", "rxysin",
 "rxysin?", "sample", "sample2file", "sample2file?", "sample_type", "sampler_at_end?",
 ...
 "snd_version", "snd_warning", "snd_warning_hook", "sndwarp", "sort!", "sound2amp_env",
 ...
 "ssb_bank_env", "ssb_fm", "start_dac", "start_playing", "start_playing_hook", "start_playing_selection_hook",
 "start_progress_report", "status_report", "stereo2mono", "stereo_flute", "stop_player", "stop_playing",
 "stop_playing_hook", "stop_playing_selection_hook", "stretch_envelope", "stretch_sound_via_dft", "sublet", "superimpose_ffts",
 ...
 "unclip_channel", "undo", "undo_hook", "unlet", "unselect_all", "update_graphs",
 "update_hook", "update_lisp_graph", "update_sound", "update_time_graph", "update_transform_graph", "upon_save_yourself",
 "user_interface_extensions", "variable_display", "variable_graph?", "varlet", "vct", "vct_",
 "vct_", "vct2channel", "vct2list", "vct2string", "vct2vector", "vct_abs!",
 "vct_add!", "vct_copy", "vct_equal?", "vct_fill!", "vct_length", "vct_max",
 "vct_min", "vct_move!", "vct_multiply!", "vct_offset!", "vct_peak", "vct_ref",
 "vct_reverse!", "vct_scale!", "vct_set!", "vct_subseq", "vct_subtract!", "vct?",
 "vector2vct", "view_files_amp", "view_files_amp_env", "view_files_dialog", "view_files_files", "view_files_select_hook",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "sndscm.html#chorus", "sndscm.html#cleanchannel", "sndscm.html#cleansound", "extsnd.html#clearlistener",
 ...
 "extsnd.html#fvabs", "extsnd.html#fvadd", "extsnd.html#fvcopy", "extsnd.html#fvequal",
 ...
 "sndscm.html#vctpolynomial", "extsnd.html#fvref", "extsnd.html#fvreverse", "extsnd.html#fvscale",
 ...
 "s7.html#hashtableentries", "s7.html#hashtablefunction", "s7.html#hashtableref", "s7.html#hashtableset",
 ...
 "s7.html#letset", "s7.html#letp", "sndclm.html#lineartodb", "sndscm.html#linearsrcchannel",
 ...
 "extsnd.html#mussampletypename", "sndclm.html#mus-scaler", "extsnd.html#mussoundchans", "extsnd.html#mussoundcloseinput",
 "extsnd.html#mussoundcloseoutput", "extsnd.html#mussoundcomment", "extsnd.html#mussounddatalocation", "extsnd.html#mussounddatumsize",
 ...
 "extsnd.html#mussoundmaxampexists", "extsnd.html#mussoundopeninput", "extsnd.html#mussoundopenoutput", "extsnd.html#mussoundpath",
 "extsnd.html#mussoundpreload", "extsnd.html#mussoundprune", "extsnd.html#mussoundread", "extsnd.html#mussoundreopenoutput",
 "extsnd.html#mussoundreportcache", "extsnd.html#mussoundsampletype", "extsnd.html#mussoundsamples", "extsnd.html#mussoundseekframple",
 ...
 "sndclm.html#nxycos?", "sndclm.html#nxysin", "sndclm.html#nxysin?", "s7.html#objecttostring",
 ...
 "s7.html#proceduredocumentation", "s7.html#proceduresetter", "s7.html#proceduresource", "s7.html#profile",
 ...
 "sndscm.html#stretchenvelope", "sndscm.html#stretchsoundviadft", "s7.html#sublet", "sndscm.html#superimposeffts",
 ...
 "extsnd.html#undohook", "s7.html#unlet", "extsnd.html#unselectall", "sndscm.html#updategraphs",
 ...
 "extsnd.html#variablegraphp", "s7.html#varlet", "extsnd.html#vct", "extsnd.html#vcttimes",
 "extsnd.html#vctplus", "extsnd.html#vcttochannel", "extsnd.html#vcttolist", "extsnd.html#vcttostring",
 "extsnd.html#vcttovector", "extsnd.html#vctabs", "extsnd.html#vctadd", "extsnd.html#vctcopy",
 "extsnd.html#vctequal", "extsnd.html#vctfill", "extsnd.html#vctlength", "extsnd.html#vctmax",
 ...
 "extsnd.html#vectortovct", "extsnd.html#viewfilesamp", "extsnd.html#viewfilesampenv", "extsnd.html#viewfilesdialog",
