...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "comment", "compand-channel", "compand-sound", "concatenate-envelopes", "constant?", "continue-frame->file",
 ...
 "current-edit-position", "current-environment", "current-font", "cursor", "cursor-color", "cursor-follows-play",
 "cursor-in-view", "cursor-location-offset", "cursor-position", "cursor-size", "cursor-style", "cursor-update-interval",
 ...
 "define-selection-via-marks", "definstrument", "defvar", "degrees->radians", "delay", "delay-channel-mixes",
 ...
 "delete-transform", "describe-hook", "describe-mark", "dialog-widgets", "disable-control-panel", "display-bark-fft",
 "display-db", "display-edits", "display-scanned-synthesis", "dissolve-fade", "dither-channel", "dither-sound",
 "dlocsig", "dot-product", "dot-size", "draw-axes", "draw-dot", "draw-dots",
 "draw-line", "draw-lines", "draw-mark-hook", "draw-mix-hook", "draw-string", "drop sites",
 ...
 "enved-wave?", "enved-waveform-color", "envelope-interp", "enveloped-mix", "eps-bottom-margin", "eps-file",
 "eps-left-margin", "eps-size", "*error-hook*", "*error-info*", "eval-between-marks", "eval-over-selection",
 ...
 "extract-channel", "extract-channels", "*features*", "feedback fm", "fft", "fft sizes",
 "fft-edit", "fft-log-frequency", "fft-log-magnitude", "fft-smoother", "fft-squelch", "fft-window",
 ...
 "filter-control-in-dB", "filter-control-in-hz", "filter-control-order", "filter-control-waveform-color", "filter-control?", "filter-selection",
 "filter-selection-and-smooth", "filter-sound", "filter?", "filtered-comb", "filtered-comb?", "find-channel",
 "find-dialog", "find-mark", "find-mix", "find-sound", "finish-progress-report", "fir-filter",
 "fir-filter?", "firmant", "firmant?", "flocsig", "flocsig?", "flute model",
 "fm-bell", "fm-drum", "fm-noise", "fm-talker", "fm-trumpet", "fm-violin",
 "fm-voice", "focus-widget", "FOF synthesis", "for-each-child", "for-each-sound-file", "Forbidden Planet",
 "foreground-color", "forget-region", "formant", "formant?", "format", "fourier-transform",
 ...
 "goto-listener-end", "grab-lock", "grani", "granulate", "granulate?", "granulated-sound-interp",
 "graph", "graph->ps", "graph-color", "graph-cursor", "graph-data", "graph-hook",
 "graph-lines", "graph-style", "graphic equalizer", "graphs-horizontal", "green-noise", "green-noise-interp",
 "grid-density", "harmonicizer", "Hartley transform", "hash-table", "header-type", "hello-dentist",
 "help-dialog", "help-hook", "hide-widget", "highlight-color", "hilbert-transform", "hook",
 "hook-arity", "hook-functions", "hook-member", "html-dir", "html-program", "hz->radians",
 "iir-filter", "iir-filter?", "in", "in-any", "ina", "inb",
 "info-dialog", "init-ladspa", "initial-beg", "initial-dur", "initial-graph-hook", "insert-channel",
 "insert-file-dialog", "insert-frame", "insert-region", "insert-sample", "insert-samples", "insert-selection",
 "insert-silence", "insert-sound", "insert-sound-data", "insert-vct", "Instruments", "integer->colormap",
 "integer->mark", "integer->mix", "integer->region", "integer->sound", "integer->transform", "integrate-envelope",
 "jc-reverb", "join-thread", "just-sounds", "kalman-filter-channel", "key", "key-binding",
 "key-press-hook", "ladspa-descriptor", "ladspa-dir", "lambda*", "left-sample", "level meters",
 "linear->db", "linear-src-channel", "lisp-graph-hook", "lisp-graph-style", "lisp-graph?", "list->vct",
 "list-ladspa", "listener-click-hook", "listener-color", "listener-font", "listener-prompt", "listener-selection",
 "listener-text-color", "little-endian?", "*load-hook*", "*load-path*", "locsig", "locsig-ref",
 ...
 "make-fir-coeffs", "make-fir-filter", "make-firmant", "make-flocsig", "make-formant", "make-frame",
 "make-frame!", "make-frame->file", "make-frame-reader", "make-granulate", "make-graph-data", "make-hash-table",
 "make-highpass", "make-hilbert-transform", "make-hook", "make-iir-filter", "make-lock", "make-locsig",
 "make-lowpass", "make-mix-sampler", "make-mixer", "make-mixer!", "make-move-sound", "make-moving-autocorrelation",
 "make-moving-average", "make-moving-fft", "make-moving-pitch", "make-moving-scentroid", "make-moving-spectrum", "make-ncos",
 "make-noid", "make-notch", "make-nrxycos", "make-nrxysin", "make-nsin", "make-one-pole",
 "make-one-zero", "make-oscil", "make-phase-vocoder", "make-pixmap", "make-player", "make-polyoid",
 "make-polyshape", "make-polywave", "make-pulse-train", "make-rand", "make-rand-interp", "make-random-state",
 ...
 "make-thread", "make-thread-variable", "make-triangle-wave", "make-two-pole", "make-two-zero", "make-type",
 "make-variable-display", "make-variable-graph", "make-vct", "make-wave-train", "map-channel", "map-sound",
 "map-sound-files", "maracas", "mark->integer", "mark-click-hook", "mark-color", "mark-drag-hook",
 ...
 "piano model", "pink-noise", "place-sound", "play", "play-arrow-size", "play-between-marks",
 "play-hook", "play-mixes", "play-sines", "play-syncd-marks", "player-home", "player?",
 ...
 "polywave?", "position->x", "position->y", "position-color", "power-env", "preferences-dialog",
 "previous-frame", "previous-sample", "print-dialog", "print-hook", "print-length", "procedure-source",
 "procedure-with-setter", "profile", "progress-report", "prompt-in-minibuffer", "ptree-channel", "pulse-train",
 "pulse-train?", "radians->degrees", "radians->hz", "ramp-channel", "rand", "rand-interp",
 "rand-interp?", "rand?", "random", "read-frame", "read-hook", "read-mix-sample",
 ...
 "region-sampler?", "region-srate", "region?", "regions", "release-lock", "remember-sound-state",
 "remove-from-menu", "report-in-minibuffer", "reset-all-hooks", "reset-controls", "reset-listener-cursor", "restore-controls",
 ...
 "reverb-control-scale", "reverb-control-scale-bounds", "reverb-control?", "reverse-channel", "reverse-channels", "reverse-envelope",
 "reverse-selection", "reverse-sound", "revert-sound", "right-sample", "ring-modulate", "rms",
 "rms, gain, balance gens", "rms-envelope", "rotate-channel", "rubber-sound", "run", "sample",
 ...
 "selection-members", "selection-position", "selection-srate", "selection?", "set-samples", "shepard-tone",
 "short-file-name", "show-axes", "show-controls", "show-disk-space", "show-full-duration", "show-grid",
 ...
 "smooth-selection", "smooth-sound", "SMS synthesis", "snap-mark-to-beat", "snap-mix-to-beat", "snd->sample",
 ...
 "sound-data?", "sound-file-extensions", "sound-file?", "sound-files-in-directory", "sound-interp", "sound-let",
 "sound-loop-info", "sound-properties", "sound-property", "sound-widgets", "sound?", "soundfont-info",
 "sounds", "spectral interpolation", "spectral-polynomial", "spectro-hop", "spectro-x-angle", "spectro-x-scale",
 ...
 "src-channel", "src-duration", "src-mixes", "src-selection", "src-sound", "src?",
 ...
 "stereo->mono", "stop-dac-hook", "stop-player", "stop-playing", "stop-playing-hook", "stop-playing-selection-hook",
 "stretch-envelope", "superimpose-ffts", "swap-channels", "swap-selection-channels", "symbol-access", "sync",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "comment", "compand_channel", "compand_sound", "concatenate_envelopes", "constant?", "continue_frame2file",
 ...
 "Current_edit_position", "current_environment", "current_font", "cursor", "cursor_color", "cursor_follows_play",
 "Cursor_in_view", "cursor_location_offset", "cursor_position", "cursor_size", "cursor_style", "cursor_update_interval",
 ...
 "define_selection_via_marks", "definstrument", "defvar", "degrees2radians", "delay", "delay_channel_mixes",
 ...
 "delete_transform", "describe_hook", "describe_mark", "dialog_widgets", "disable_control_panel", "display_bark_fft",
 "display_db", "display_edits", "display_scanned_synthesis", "dissolve_fade", "dither_channel", "dither_sound",
 "dlocsig", "dot_product", "dot_size", "draw_axes", "draw_dot", "draw_dots",
 "draw_line", "draw_lines", "draw_mark_hook", "draw_mix_hook", "draw_string", "drop_sites",
 ...
 "enved_wave?", "enved_waveform_color", "envelope_interp", "enveloped_mix", "eps_bottom_margin", "eps_file",
 "eps_left_margin", "eps_size", "_error_hook_", "_error_info_", "eval_between_marks", "eval_over_selection",
 ...
 "extract_channel", "extract_channels", "_features_", "feedback_fm", "fft", "fft_sizes",
 "fft_edit", "fft_log_frequency", "fft_log_magnitude", "fft_smoother", "fft_squelch", "fft_window",
 ...
 "filter_control_in_dB", "filter_control_in_hz", "filter_control_order", "filter_control_waveform_color", "filter_control?", "filter_selection",
 "filter_selection_and_smooth", "filter_sound", "filter?", "filtered_comb", "filtered_comb?", "find_channel",
 "find_dialog", "find_mark", "find_mix", "find_sound", "finish_progress_report", "fir_filter",
 "fir_filter?", "firmant", "firmant?", "flocsig", "flocsig?", "flute_model",
 "fm_bell", "fm_drum", "fm_noise", "fm_talker", "fm_trumpet", "fm_violin",
 "fm_voice", "focus_widget", "FOF_synthesis", "for_each_child", "for_each_sound_file", "Forbidden_Planet",
 "foreground_color", "forget_region", "formant", "formant?", "format", "Fourier_transform",
 ...
 "goto_listener_end", "grab_lock", "grani", "granulate", "granulate?", "granulated_sound_interp",
 "graph", "graph2ps", "graph_color", "graph_cursor", "graph_data", "graph_hook",
 "Graph_lines", "graph_style", "graphic_equalizer", "graphs_horizontal", "green_noise", "green_noise_interp",
 "grid_density", "harmonicizer", "Hartley_transform", "hash_table", "header_type", "hello_dentist",
 "help_dialog", "help_hook", "hide_widget", "highlight_color", "hilbert_transform", "hook",
 "hook_arity", "hook_functions", "hook_member", "html_dir", "html_program", "hz2radians",
 "iir_filter", "iir_filter?", "call_in", "in_any", "ina", "inb",
 "info_dialog", "init_ladspa", "initial_beg", "initial_dur", "initial_graph_hook", "insert_channel",
 "insert_file_dialog", "insert_frame", "insert_region", "insert_sample", "insert_samples", "insert_selection",
 "insert_silence", "insert_sound", "insert_sound_data", "insert_vct", "Instruments", "integer2colormap",
 "integer2mark", "integer2mix", "integer2region", "integer2sound", "integer2transform", "integrate_envelope",
 "jc_reverb", "join_thread", "just_sounds", "kalman_filter_channel", "key", "key_binding",
 "key_press_hook", "ladspa_descriptor", "ladspa_dir", "lambda_", "left_sample", "level_meters",
 "linear2db", "linear_src_channel", "lisp_graph_hook", "lisp_graph_style", "lisp_graph?", "list2vct",
 "list_ladspa", "listener_click_hook", "listener_color", "listener_font", "listener_prompt", "listener_selection",
 "listener_text_color", "little_endian?", "_load_hook_", "_load_path_", "locsig", "locsig_ref",
 ...
 "make_fir_coeffs", "make_fir_filter", "make_firmant", "make_flocsig", "make_formant", "make_frame",
 "make_frame!", "make_frame2file", "make_frame_reader", "make_granulate", "make_graph_data", "make_hash_table",
 "make_highpass", "make_hilbert_transform", "make_hook", "make_iir_filter", "make_lock", "make_locsig",
 "make_lowpass", "make_mix_sampler", "make_mixer", "make_mixer!", "make_move_sound", "make_moving_autocorrelation",
 "make_moving_average", "make_moving_fft", "make_moving_pitch", "make_moving_scentroid", "make_moving_spectrum", "make_ncos",
 "make_noid", "make_notch", "make_nrxycos", "make_nrxysin", "make_nsin", "make_one_pole",
 "make_one_zero", "make_oscil", "make_phase_vocoder", "make_pixmap", "make_player", "make_polyoid",
 "make_polyshape", "make_polywave", "make_pulse_train", "make_rand", "make_rand_interp", "make_random_state",
 ...
 "make_thread", "make_thread_variable", "make_triangle_wave", "make_two_pole", "make_two_zero", "make_type",
 "make_variable_display", "make_variable_graph", "make_vct", "make_wave_train", "map_channel", "map_sound",
 "map_sound_files", "maracas", "mark2integer", "mark_click_hook", "mark_color", "mark_drag_hook",
 ...
 "piano_model", "pink_noise", "place_sound", "play", "play_arrow_size", "play_between_marks",
 "play_hook", "play_mixes", "play_sines", "play_syncd_marks", "player_home", "player?",
 ...
 "polywave?", "position2x", "position2y", "position_color", "power_env", "preferences_dialog",
 "previous_frame", "previous_sample", "print_dialog", "print_hook", "print_length", "procedure_source",
 "procedure_with_setter", "profile", "progress_report", "prompt_in_minibuffer", "ptree_channel", "pulse_train",
 "pulse_train?", "radians2degrees", "radians2hz", "ramp_channel", "rand", "rand_interp",
 "rand_interp?", "rand?", "random", "read_frame", "read_hook", "read_mix_sample",
 ...
 "region_sampler?", "region_srate", "region?", "regions", "release_lock", "remember_sound_state",
 "remove_from_menu", "report_in_minibuffer", "reset_all_hooks", "reset_controls", "reset_listener_cursor", "restore_controls",
 ...
 "reverb_control_scale", "reverb_control_scale_bounds", "reverb_control?", "reverse_channel", "reverse_channels", "reverse_envelope",
 "reverse_selection", "reverse_sound", "revert_sound", "right_sample", "ring_modulate", "rms",
 "rms__gain__balance_gens", "rms_envelope", "rotate_channel", "rubber_sound", "run", "sample",
 ...
 "selection_members", "selection_position", "selection_srate", "selection?", "set_samples", "shepard_tone",
 "short_file_name", "show_axes", "show_controls", "show_disk_space", "show_full_duration", "show_grid",
 ...
 "smooth_selection", "smooth_sound", "SMS_synthesis", "snap_mark_to_beat", "snap_mix_to_beat", "snd2sample",
 ...
 "sound_data?", "sound_file_extensions", "sound_file?", "sound_files_in_directory", "sound_interp", "sound_let",
 "sound_loop_info", "sound_properties", "sound_property", "sound_widgets", "sound?", "soundfont_info",
 "sounds", "spectral_interpolation", "spectral_polynomial", "spectro_hop", "spectro_x_angle", "spectro_x_scale",
 ...
 "src_channel", "src_duration", "src_mixes", "src_selection", "src_sound", "src?",
 ...
 "stereo2mono", "stop_dac_hook", "stop_player", "stop_playing", "stop_playing_hook", "stop_playing_selection_hook",
 "stretch_envelope", "superimpose_ffts", "swap_channels", "swap_selection_channels", "symbol_access", "sync",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "extsnd.html#comment", "sndscm.html#compandchannel", "sndscm.html#compandsound", "sndscm.html#concatenateenvelopes",
 ...
 "sndscm.html#fadedoc", "sndscm.html#crosssynthesis", "extsnd.html#currenteditposition", "s7.html#currentenvironment",
 "extsnd.html#currentfont", "extsnd.html#cursor", "extsnd.html#cursorcolor", "extsnd.html#cursorfollowsplay",
 "extsnd.html#cursorchoices", "extsnd.html#cursorlocationoffset", "extsnd.html#cursorposition", "extsnd.html#cursorsize",
 ...
 "sndscm.html#ditherchannel", "sndscm.html#dithersound", "sndscm.html#dlocsig", "sndclm.html#dot-product",
 "extsnd.html#dotsize", "extsnd.html#drawaxes", "extsnd.html#drawdot", "extsnd.html#drawdots",
 "extsnd.html#drawline", "extsnd.html#drawlines", "extsnd.html#drawmarkhook", "extsnd.html#drawmixhook",
 "extsnd.html#drawstring", "sndscm.html#makedropsite", "extsnd.html#drophook", "extsnd.html#duringopenhook",
 ...
 "extsnd.html#envsound", "sndscm.html#envsoundinterp", "sndclm.html#env?", "extsnd.html#envedbase",
 ...
 "sndscm.html#envelopeinterp", "sndscm.html#envelopedmix", "extsnd.html#epsbottommargin", "extsnd.html#epsfile",
 "extsnd.html#epsleftmargin", "extsnd.html#epssize", "s7.html#errorhook", "s7.html#errorinfo",
 "sndscm.html#evalbetweenmarks", "sndscm.html#evaloverselection", "sndscm.html#everysample", "extsnd.html#exit",
 ...
 "sndscm.html#explodesf2", "sndclm.html#exponentially-weighted-moving-average", "extsnd.html#extractchannel", "extsnd.html#extractchannels",
 "s7.html#featureslist", "sndscm.html#cellon", "extsnd.html#fft", "snd.html#fftsize",
 "sndscm.html#fftedit", "extsnd.html#fftlogfrequency", "extsnd.html#fftlogmagnitude", "sndscm.html#fftsmoother",
 ...
 "extsnd.html#filtercontrolp", "extsnd.html#filterselection", "sndscm.html#filterselectionandsmooth", "extsnd.html#filtersound",
 ...
 "sndclm.html#firmant?", "sndclm.html#flocsig", "sndclm.html#flocsig?", "sndscm.html#stereoflute",
 "sndscm.html#fmbell", "sndscm.html#fmdrum", "sndscm.html#fmnoise", "sndscm.html#fmvox",
 "sndscm.html#fmtrumpet", "sndscm.html#vdoc", "sndscm.html#reson", "extsnd.html#focuswidget",
 ...
 "s7.html#format", "extsnd.html#fouriertransform", "sndscm.html#fractionalfouriertransform", "sndclm.html#frame1",
 ...
 "extsnd.html#glspectrogram", "sndscm.html#goertzel", "extsnd.html#gotolistenerend", "s7.html#grablock",
 ...
 "s7.html#hookarity", "s7.html#hookfunctions", "sndscm.html#hookmember", "extsnd.html#htmldir",
 ...
 "sndclm.html#instruments", "extsnd.html#integertocolormap", "extsnd.html#integertomark", "extsnd.html#integertomix",
 "extsnd.html#integertoregion", "extsnd.html#integertosound", "extsnd.html#integertotransform", "sndscm.html#integrateenvelope",
 "sndscm.html#jcreverb", "s7.html#jointhread", "extsnd.html#justsounds", "sndscm.html#kalmanfilterchannel",
 ...
 "s7.html#macroexpand", "extsnd.html#mainmenu", "extsnd.html#mainwidgets", "sndclm.html#make-all-pass",
 "sndclm.html#make-asymmetric-fm", "sndscm.html#makebandpass", "sndscm.html#makebandstop", "sndscm.html#makebiquad",
 "sndscm.html#makebirds", "extsnd.html#makecolor", "sndclm.html#make-comb", "sndclm.html#make-convolve",
 "sndclm.html#make-delay", "sndscm.html#makedifferentiator", "sndclm.html#make-env", "sndclm.html#make-fft-window",
 ...
 "sndscm.html#makeframereader", "sndclm.html#make-granulate", "extsnd.html#makegraphdata", "s7.html#makehashtable",
 "sndscm.html#makehighpass", "sndscm.html#makehilberttransform", "s7.html#makehook", "sndclm.html#make-iir-filter",
 "s7.html#makelock", "sndclm.html#make-locsig", "sndscm.html#makelowpass", "extsnd.html#makemixsampler",
 ...
 "sndclm.html#make-pulse-train", "sndclm.html#make-rand", "sndclm.html#make-rand-interp", "s7.html#makerandomstate",
 ...
 "sndscm.html#makesyncframereader", "sndclm.html#make-table-lookup", "s7.html#makethread", "s7.html#makethreadvariable",
 ...
 "extsnd.html#printdialog", "extsnd.html#printhook", "extsnd.html#printlength", "s7.html#proceduresource",
 "s7.html#procedurewithsetter", "sndscm.html#profile", "extsnd.html#progressreport", "extsnd.html#promptinminibuffer",
 "extsnd.html#ptreechannel", "sndclm.html#pulse-train", "sndclm.html#pulse-train?", "sndclm.html#radianstodegrees",
 "sndclm.html#radianstohz", "extsnd.html#rampchannel", "sndclm.html#rand", "sndclm.html#rand-interp",
 "sndclm.html#rand-interp?", "sndclm.html#rand?", "s7.html#random", "sndscm.html#readframe",
 "extsnd.html#readhook", "extsnd.html#readmixsample", "extsnd.html#readonly", "extsnd.html#readregionsample",
 "extsnd.html#readsample", "sndclm.html#readin", "sndclm.html#readin?", "extsnd.html#recorderdialog",
 "sndclm.html#rectangulartomagnitudes", "sndclm.html#rectangulartopolar", "extsnd.html#redo", "extsnd.html#redochannel",
 "extsnd.html#redoedit", "sndscm.html#regiontoframe", "extsnd.html#regiontointeger", "sndscm.html#regiontosounddata",
 ...
 "extsnd.html#regionposition", "extsnd.html#regionsample", "extsnd.html#regionsamplerQ", "extsnd.html#regionsrate",
 "extsnd.html#regionok", "extsnd.html#eregions", "s7.html#releaselock", "extsnd.html#remembersoundstate",
 "extsnd.html#removefrommenu", "extsnd.html#reportinminibuffer", "sndscm.html#resetallhooks", "extsnd.html#resetcontrols",
 "extsnd.html#resetlistenercursor", "extsnd.html#restorecontrols", "sndclm.html#*reverb*", "extsnd.html#reverbdecay",
 ...
 "extsnd.html#reverbcontrolscale", "extsnd.html#reverbcontrolscalebounds", "extsnd.html#reverbcontrolp", "extsnd.html#reversechannel",
 "extsnd.html#reversechannels", "sndscm.html#reverseenvelope", "extsnd.html#reverseselection", "extsnd.html#reversesound",
 "extsnd.html#revertsound", "extsnd.html#rightsample", "sndclm.html#ring-modulate", "sndscm.html#rmsgain",
 "sndscm.html#rmsgain", "sndscm.html#rmsenvelope", "extsnd.html#rotatechannel", "sndscm.html#rubbersound",
 "extsnd.html#run", "extsnd.html#sample", "sndclm.html#sampletofile", "sndclm.html#sampletofile?",
 ...
 "extsnd.html#selectionsrate", "extsnd.html#selectionok", "extsnd.html#setsamples", "sndscm.html#shepardtone",
 "extsnd.html#shortfilename", "extsnd.html#showaxes", "extsnd.html#showcontrols", "sndscm.html#showdiskspace",
 "extsnd.html#showfullduration", "extsnd.html#showgrid", "extsnd.html#showindices", "extsnd.html#showlistener",
 ...
 "s7.html#symbolaccess", "extsnd.html#sync", "sndscm.html#sync-everything", "extsnd.html#syncmax",
...
static const char *autoload_names[AUTOLOAD_NAMES] = {
  ...
  "clean-channel", "clean-sound", "click-for-listener-help", "click-middle-button-to-open-next-file-in-directory", 
  "click-to-sync", "clm-display-globals", "clm-expsrc", "clm-find-file", 
  "clm-load", "close-all-buffers", "close-buffer", "cnvrev", 
  ...
  "copy-frame-reader", "cosine-summation", "crawfish-frog", "create-initial-envelopes", 
  ...
  "fejer-sum", "fft-cancel", "fft-edit", "fft-env-data", 
  ...
  "get-speaker-configuration", "get-worst-overall", "glassy", "goertzel", 
  ...
  "make-chebyshev-highpass", "make-chebyshev-lowpass", "make-closed-path", "make-cosine-summation", 
  ...
  "make-k2sin", "make-k2ssb", "make-k3sin", "make-kosine-summation", 
  ...
  "make-onezero", "make-open-bezier-path", "make-oscil", "make-path", 
  "make-peaking-2", "make-penv", "make-pink-noise", "make-plsenv", 
  "make-pnoise", "make-polar-path", "make-polygon", "make-polyoid", 
  "make-power-env", "make-ppolar", "make-pulsed-env", "make-pvocoder", 
  ...
  "slightly-musical-conehead", "smooth-channel-via-ptree", "smooth-vct", "smoothing-filter", 
  ...
  "sound-let", "sounds->segment-data", "southeastern-field-cricket", "southern-cricket-frog", 
  "southern-mole-cricket", "southwestern-toad", "spectra", "spectral-polynomial", 
  "spectrum->coeffs", "sphagnum-ground-cricket", "spike", "spiral-render", 
  ...
  "sub-matrix", "sum-of-n-odd-cosines", "sum-of-n-odd-sines", "sum-of-n-sines", 
  ...
  "with-sound-helper", "with-temp-sound", "with-temporary-selection", "with-threaded-channels", 
  "with-threaded-sound", "wood-duck", "wrentit", "write-au-header", 
  ...
  "xb-close", "xb-open", "xparse-path", "yellow-bellied-flycatcher", 
  "yellow-green-vireo", "yellow-rumped-warbler", "yellow-warbler", "z-transform", 
  "za", "zc", "zcomb", "zdata-methods", 
...
static int autoload_indices[AUTOLOAD_NAMES] = {
  ...
  6, 6, 10, 14, 28, 58, 7, 58, 58, 14, 14, 7, 14, 30, 10, 14, 14, 1, 1, 1, 1, 1, 14, 14, 
  14, 11, 11, 12, 1, 9, 16, 16, 18, 51, 1, 13, 1, 52, 17, 14, 33, 1, 1, 22, 21, 21, 21, 41, 
  58, 21, 28, 58, 30, 41, 41, 54, 30, 50, 9, 23, 28, 11, 11, 11, 10, 14, 14, 14, 10, 10, 17, 9, 
  9, 9, 16, 16, 9, 41, 41, 14, 14, 14, 1, 11, 11, 11, 33, 8, 8, 8, 8, 8, 8, 8, 33, 8, 
  8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 
  8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 
  8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8,