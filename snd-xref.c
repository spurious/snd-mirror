...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "insert-selection", "insert-silence", "insert-sound", "int-vector", "int-vector?", "integer->colormap",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "insert_selection", "insert_silence", "insert_sound", "int_vector", "int_vector?", "integer2colormap",
