...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "outlet", "*output*", "output-comment-hook", "output-name-hook", "overlay-rms-env", "owlet",
 ...
 "pqw-vox", "preferences-dialog", "previous-sample", "print-dialog", "print-length", "procedure-documentation",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "outlet", "_output_", "output_comment_hook", "output_name_hook", "overlay_rms_env", "owlet",
 ...
 "pqw_vox", "preferences_dialog", "previous_sample", "print_dialog", "print_length", "procedure_documentation",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "s7.html#outlet", "sndclm.html#*output*", "extsnd.html#outputcommenthook", "extsnd.html#outputnamehook",
 ...
 "extsnd.html#printlength", "s7.html#proceduredocumentation", "s7.html#procedurename", "s7.html#proceduresetter",
