...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "define-bacro*", "define-constant", "define-envelope", "define-expansion", "define-macro", "define-macro*",
 ...
 "Hartley transform", "hash-code", "hash-table", "hash-table-entries", "hash-table-key-typer", "hash-table-ref",
 "hash-table-set!", "hash-table-value-typer", "hash-table?", "header-type", "hello-dentist", "help-dialog",
 ...
 "immutable!", "immutable?", "in", "in-any", "ina", "inb",
 ...
 "make-variable-graph", "make-vector", "make-wave-train", "make-wave-train-with-env", "make-weak-hash-table", "map-channel",
 ...
 "mix-color", "mix-dialog-mix", "mix-drag-hook", "mix-file-dialog", "mix-float-vector", "mix-home",
 ...
 "mix-waveform-height", "mix?", "mixes", "mono->stereo", "moog-filter", "mouse-click-hook",
 ...
 "mus-sound-chans", "mus-sound-comment", "mus-sound-data-location", "mus-sound-datum-size", "mus-sound-duration", "mus-sound-forget",
 "mus-sound-framples", "mus-sound-header-type", "mus-sound-length", "mus-sound-loop-info", "mus-sound-mark-info", "mus-sound-maxamp",
 "mus-sound-maxamp-exists?", "mus-sound-path", "mus-sound-preload", "mus-sound-prune", "mus-sound-report-cache", "mus-sound-sample-type",
 "mus-sound-samples", "mus-sound-srate", "mus-sound-type-specifier", "mus-sound-write-date", "mus-srate", "mus-width",
 ...
 "nxy1sin?", "nxycos", "nxycos?", "nxysin", "nxysin?", "object->let",
 ...
 "open-file-dialog-directory", "open-hook", "open-input-function", "open-next-file-in-directory", "open-output-function", "open-raw-sound",
 ...
 "polyoid?", "polyshape", "polyshape?", "polywave", "polywave?", "port-file",
 "port-filename", "port-line-number", "port-position", "position->x", "position->y", "position-color",
 ...
 "sublet", "subvector", "subvector-position", "subvector-vector", "subvector?", "superimpose-ffts",
 "swap-channels", "swap-selection-channels", "symbol->dynamic-value", "symbol->value", "symbol-table", "sync",
 ...
 "times->samples", "tiny-font", "touch-tone", "tracking-cursor-style", "transform->float-vector", "transform->integer",
 "transform-dialog", "transform-framples", "transform-graph-style", "transform-graph-type", "transform-graph?", "transform-normalization",
 "transform-sample", "transform-size", "transform-type", "transform?", "transpose-mixes", "tree-count",
 "tree-cyclic?", "tree-leaves", "tree-memq", "tree-set-memq", "triangle-wave", "triangle-wave?",
 "tubebell", "tubular bell", "two-pole", "two-pole?", "two-tab", "two-zero",
 "two-zero?", "type-of", "unbind-key", "*unbound-variable-hook*", "unclip-channel", "undo",
 ...
 "variable-graph?", "varlet", "vector-dimension", "vector-dimensions", "vector-rank", "vector-typer",
 ...
 "wave-train?", "wavelet-type", "waveshaping voice", "wavo-hop", "wavo-trace", "weak-hash-table",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "define_bacro_", "define_constant", "define_envelope", "define_expansion", "define_macro", "define_macro_",
 ...
 "Hartley_transform", "hash_code", "hash_table", "hash_table_entries", "hash_table_key_typer", "hash_table_ref",
 "hash_table_set!", "hash_table_value_typer", "hash_table?", "header_type", "hello_dentist", "help_dialog",
 ...
 "immutable!", "immutable?", "call_in", "in_any", "ina", "inb",
 ...
 "make_variable_graph", "make_vector", "make_wave_train", "make_wave_train_with_env", "make_weak_hash_table", "map_channel",
 ...
 "mix_color", "mix_dialog_mix", "mix_drag_hook", "mix_file_dialog", "mix_float_vector", "mix_home",
 ...
 "mix_waveform_height", "mix?", "mixes", "mono2stereo", "moog_filter", "mouse_click_hook",
 ...
 "mus_sound_chans", "mus_sound_comment", "mus_sound_data_location", "mus_sound_datum_size", "mus_sound_duration", "mus_sound_forget",
 "mus_sound_framples", "mus_sound_header_type", "mus_sound_length", "mus_sound_loop_info", "mus_sound_mark_info", "mus_sound_maxamp",
 "mus_sound_maxamp_exists?", "mus_sound_path", "mus_sound_preload", "mus_sound_prune", "mus_sound_report_cache", "mus_sound_sample_type",
 "mus_sound_samples", "mus_sound_srate", "mus_sound_type_specifier", "mus_sound_write_date", "mus_srate", "mus_width",
 ...
 "nrxycos?", "nrxysin", "nrxysin?", "nsin", "nsin?", "nsincos",
 "nsincos?", "nssb", "nssb?", "nxy1cos", "nxy1cos?", "nxy1sin",
 "nxy1sin?", "nxycos", "nxycos?", "nxysin", "nxysin?", "object2let",
 ...
 "open_file_dialog_directory", "open_hook", "open_input_function", "open_next_file_in_directory", "open_output_function", "open_raw_sound",
 ...
 "polyoid?", "polyshape", "polyshape?", "polywave", "polywave?", "port_file",
 "port_filename", "port_line_number", "port_position", "position2x", "position2y", "position_color",
 ...
 "sublet", "subvector", "subvector_position", "subvector_vector", "subvector?", "superimpose_ffts",
 "swap_channels", "swap_selection_channels", "symbol2dynamic_value", "symbol2value", "symbol_table", "sync",
 ...
 "times2samples", "tiny_font", "touch_tone", "tracking_cursor_style", "transform2float_vector", "transform2integer",
 "transform_dialog", "transform_framples", "transform_graph_style", "transform_graph_type", "transform_graph?", "transform_normalization",
 "transform_sample", "transform_size", "transform_type", "transform?", "transpose_mixes", "tree_count",
 "tree_cyclic?", "tree_leaves", "tree_memq", "tree_set_memq", "triangle_wave", "triangle_wave?",
 "tubebell", "tubular_bell", "two_pole", "two_pole?", "two_tab", "two_zero",
 "two_zero?", "type_of", "unbind_key", "_unbound_variable_hook_", "unclip_channel", "undo",
 ...
 "variable_graph?", "varlet", "vector_dimension", "vector_dimensions", "vector_rank", "vector_typer",
 ...
 "wave_train?", "wavelet_type", "waveshaping_voice", "wavo_hop", "wavo_trace", "weak_hash_table",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "s7.html#definebacrostar", "s7.html#defineconstant", "extsnd.html#defineenvelope", "s7.html#expansion",
 ...
 "extsnd.html#griddensity", "sndscm.html#harmonicizer", "sndscm.html#dht", "s7.html#hashcode",
 "s7.html#hashtable", "s7.html#hashtableentries", "s7.html#hashtablekeytyper", "s7.html#hashtableref",
 "s7.html#hashtableset", "s7.html#hashtablevaluetyper", "s7.html#hashtablep", "extsnd.html#headertype",
 ...
 "sndclm.html#iir-filter", "sndclm.html#iir-filter?", "s7.html#immutableb", "s7.html#immutablep",
 ...
 "extsnd.html#lispgraphstyle", "extsnd.html#lispgraphp", "extsnd.html#listtofv", "grfsnd.html#listladspa",
 ...
 "sndclm.html#make-two-zero", "sndscm.html#makevariabledisplay", "extsnd.html#makevariablegraph", "s7.html#makevector",
 "sndclm.html#make-wave-train", "sndclm.html#make-wave-train-with-env", "s7.html#makeweakhashtable", "extsnd.html#mapchannel",
 ...
 "extsnd.html#openfiledialogdirectory", "extsnd.html#openhook", "s7.html#openinputfunction", "sndscm.html#opennextfileindirectory",
 "s7.html#openoutputfunction", "extsnd.html#openrawsound", "extsnd.html#openrawsoundhook", "extsnd.html#opensound",
 ...
 "sndscm.html#telephone", "extsnd.html#trackingcursorstyle", "extsnd.html#transformtofv", "extsnd.html#transformtointeger",
 ...
 "s7.html#vectordimension", "s7.html#vectordimensions", "s7.html#vectorrank", "s7.html#vectortyper",
 ...
 "sndscm.html#pqwvox", "extsnd.html#wavohop", "extsnd.html#wavotrace", "s7.html#weakhashtable",
 "s7.html#weakhashtablep", "sndclm.html#weighted-moving-average", "extsnd.html#widgetposition", "extsnd.html#widgetsize",
...
static const char *snd_names[11850] = {
    ...
    "error-object-irritants", "r7rs.scm",
    "error-object-message", "r7rs.scm",
    "error-object?", "r7rs.scm",
    ...
    "r7rs-import-library-filename", "r7rs.scm",
