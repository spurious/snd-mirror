...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "regions", "remember-sound-state", "remove-clicks", "remove-from-menu", "replace-with-selection", "report-in-minibuffer",
 ...
 "save-macros", "save-mark-properties", "save-marks", "save-mix", "save-mixes", "save-region",
 ...
 "ssb-am", "ssb-am?", "ssb-bank", "ssb-bank-env", "ssb-fm", "stacktrace",
 "start-dac", "start-hook", "start-playing", "start-playing-hook", "start-playing-selection-hook", "start-progress-report",
 "start-waterfall", "stereo->mono", "stereo-flute", "stop-dac-hook", "stop-player", "stop-playing",
 ...
 "text-focus-color", "There's", "time-graph-style", "time-graph-type", "time-graph?", "times->samples",
 "tiny-font", "touch-tone", "trace", "*trace-hook*", "tracking-cursor-style", "transform->integer",
 ...
 "window-width", "window-x", "window-y", "with-background-processes", "with-environment", "with-file-monitor",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "regions", "remember_sound_state", "remove_clicks", "remove_from_menu", "replace_with_selection", "report_in_minibuffer",
 ...
 "save_macros", "save_mark_properties", "save_marks", "save_mix", "save_mixes", "save_region",
 ...
 "ssb_am", "ssb_am?", "ssb_bank", "ssb_bank_env", "ssb_fm", "stacktrace",
 "start_dac", "start_hook", "start_playing", "start_playing_hook", "start_playing_selection_hook", "start_progress_report",
 "start_waterfall", "stereo2mono", "stereo_flute", "stop_dac_hook", "stop_player", "stop_playing",
 ...
 "text_focus_color", "There_s", "time_graph_style", "time_graph_type", "time_graph?", "times2samples",
 "tiny_font", "touch_tone", "trace", "_trace_hook_", "tracking_cursor_style", "transform2integer",
 ...
 "window_width", "window_x", "window_y", "with_background_processes", "with_environment", "with_file_monitor",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "sndscm.html#removeclicks", "extsnd.html#removefrommenu", "sndscm.html#replacewithselection", "extsnd.html#reportinminibuffer",
