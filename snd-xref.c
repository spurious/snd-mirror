...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "start-hook", "start-playing", "start-playing-hook", "start-playing-selection-hook", "start-progress-report", "status-report",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "start_hook", "start_playing", "start_playing_hook", "start_playing_selection_hook", "start_progress_report", "status_report",
