...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "stdin-prompt", "stereo->mono", "stereo-flute", "stop-player", "stop-playing", "stop-playing-hook",
 "stop-playing-selection-hook", "stretch-envelope", "stretch-sound-via-dft", "string->byte-vector", "string-position", "sublet",
 ...
 "vct?", "vector->vct", "vibrating-uniform-circular-string", "view-files-amp", "view-files-amp-env", "view-files-dialog",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "stdin_prompt", "stereo2mono", "stereo_flute", "stop_player", "stop_playing", "stop_playing_hook",
 "stop_playing_selection_hook", "stretch_envelope", "stretch_sound_via_dft", "string2byte_vector", "string_position", "sublet",
 ...
 "vct?", "vector2vct", "vibrating_uniform_circular_string", "view_files_amp", "view_files_amp_env", "view_files_dialog",
