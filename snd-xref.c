...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "with-temporary-selection", "with-threaded-channels", "with-threaded-sound", "with-toolbar", "with-tooltips", "with-tracking-cursor",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "with_temporary_selection", "with_threaded_channels", "with_threaded_sound", "with_toolbar", "with_tooltips", "with_tracking_cursor",
