...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "print-length", "procedure-documentation", "procedure-setter", "procedure-signature", "procedure-source", "profile",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "print_length", "procedure_documentation", "procedure_setter", "procedure_signature", "procedure_source", "profile",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "s7.html#proceduresetter", "s7.html#proceduresignature", "s7.html#proceduresource", "s7.html#profile",
