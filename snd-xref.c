...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "*error-hook*", "*error-info*", "erssb", "erssb?", "every-sample?", "exit",
 ...
 "hook", "hook-apply", "hook-arity", "hook-documentation", "hook-functions", "hook-member",
 "hook?", "html", "html-dir", "html-program", "hz->radians", "If",
 "iir-filter", "iir-filter?", "in", "in-any", "ina", "inb",
 "info-dialog", "info-popup-hook", "init-ladspa", "initial-beg", "initial-dur", "initial-environment",
 "initial-graph-hook", "insert-channel", "insert-file-dialog", "insert-frame", "insert-region", "insert-sample",
 "insert-samples", "insert-selection", "insert-silence", "insert-sound", "insert-sound-data", "insert-vct",
 "integer->colormap", "integer->mark", "integer->mix", "integer->region", "integer->sound", "integer->transform",
 "integrate-envelope", "invert-filter", "invert-matrix", "izcos", "izcos?", "j0evencos",
 ...
 "ladspa-dir", "lambda*", "lbj-piano", "left-sample", "level meters", "linear->db",
 "linear-src-channel", "lint for scheme", "lisp-graph-hook", "lisp-graph-style", "lisp-graph?", "list->vct",
 "list-ladspa", "listener-click-hook", "listener-color", "listener-font", "listener-prompt", "listener-selection",
 "listener-text-color", "little-endian?", "*load-hook*", "*load-path*", "locate-zero", "locsig",
 ...
 "make-adjustable-triangle-wave", "make-all-pass", "make-asyfm", "make-asymmetric-fm", "make-bandpass", "make-bandstop",
 ...
 "make-eoddcos", "make-ercos", "make-erssb", "make-fft-window", "make-file->frame", "make-file->sample",
 "make-filter", "make-filtered-comb", "make-fir-coeffs", "make-fir-filter", "make-firmant", "make-flocsig",
 "make-fmssb", "make-formant", "make-frame", "make-frame!", "make-frame->file", "make-frame-reader",
 "make-granulate", "make-graph-data", "make-green-noise", "make-green-noise-interp", "make-hash-table", "make-hash-table-iterator",
 "make-highpass", "make-hilbert-transform", "make-hook", "make-iir-filter", "make-izcos", "make-j0evencos",
 "make-j0j1cos", "make-j2cos", "make-jjcos", "make-jncos", "make-jpcos", "make-jycos",
 "make-k2cos", "make-k2sin", "make-k2ssb", "make-k3sin", "make-krksin", "make-level-meter",
 ...
 "make-nxy1sin", "make-nxycos", "make-nxysin", "make-one-pole", "make-one-zero", "make-oscil",
 ...
 "make-table-lookup-with-env", "make-tanhsin", "make-triangle-wave", "make-two-pole", "make-two-zero", "make-type",
 ...
 "marks", "match-sound-files", "max-envelope", "max-regions", "max-transform-peaks", "max-virtual-ptrees",
 ...
 "nxycos", "nxycos?", "nxysin", "nxysin?", "offset-channel", "offset-sound",
 "one-pole", "one-pole?", "one-zero", "one-zero?", "open-file-dialog", "open-file-dialog-directory",
 ...
 "print-dialog", "print-hook", "print-length", "procedure-arity", "procedure-documentation", "procedure-environment",
 "procedure-name", "procedure-setter", "procedure-source", "procedure-with-setter", "progress-report", "ptree-channel",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "_error_hook_", "_error_info_", "erssb", "erssb?", "every_sample?", "exit",
 ...
 "hook", "hook_apply", "hook_arity", "hook_documentation", "hook_functions", "hook_member",
 "hook?", "html", "html_dir", "html_program", "hz2radians", "If",
 "iir_filter", "iir_filter?", "call_in", "in_any", "ina", "inb",
 "info_dialog", "info_popup_hook", "init_ladspa", "initial_beg", "initial_dur", "initial_environment",
 "initial_graph_hook", "insert_channel", "insert_file_dialog", "insert_frame", "insert_region", "insert_sample",
 "insert_samples", "insert_selection", "insert_silence", "insert_sound", "insert_sound_data", "insert_vct",
 "integer2colormap", "integer2mark", "integer2mix", "integer2region", "integer2sound", "integer2transform",
 "integrate_envelope", "invert_filter", "invert_matrix", "izcos", "izcos?", "j0evencos",
 ...
 "ladspa_dir", "lambda_", "lbj_piano", "left_sample", "level_meters", "linear2db",
 "linear_src_channel", "lint_for_scheme", "lisp_graph_hook", "lisp_graph_style", "lisp_graph?", "list2vct",
 "list_ladspa", "listener_click_hook", "listener_color", "listener_font", "listener_prompt", "listener_selection",
 "listener_text_color", "little_endian?", "_load_hook_", "_load_path_", "locate_zero", "locsig",
 ...
 "make_adjustable_triangle_wave", "make_all_pass", "make_asyfm", "make_asymmetric_fm", "make_bandpass", "make_bandstop",
 ...
 "make_eoddcos", "make_ercos", "make_erssb", "make_fft_window", "make_file2frame", "make_file2sample",
 "make_filter", "make_filtered_comb", "make_fir_coeffs", "make_fir_filter", "make_firmant", "make_flocsig",
 "make_fmssb", "make_formant", "make_frame", "make_frame!", "make_frame2file", "make_frame_reader",
 "make_granulate", "make_graph_data", "make_green_noise", "make_green_noise_interp", "make_hash_table", "make_hash_table_iterator",
 "make_highpass", "make_hilbert_transform", "make_hook", "make_iir_filter", "make_izcos", "make_j0evencos",
 "make_j0j1cos", "make_j2cos", "make_jjcos", "make_jncos", "make_jpcos", "make_jycos",
 "make_k2cos", "make_k2sin", "make_k2ssb", "make_k3sin", "make_krksin", "make_level_meter",
 ...
 "make_nxy1sin", "make_nxycos", "make_nxysin", "make_one_pole", "make_one_zero", "make_oscil",
 ...
 "make_table_lookup_with_env", "make_tanhsin", "make_triangle_wave", "make_two_pole", "make_two_zero", "make_type",
 ...
 "marks", "match_sound_files", "max_envelope", "max_regions", "max_transform_peaks", "max_virtual_ptrees",
 ...
 "nrxysin", "nrxysin?", "nsin", "nsin?", "nsincos", "nsincos?",
 "nssb", "nssb?", "nxy1cos", "nxy1cos?", "nxy1sin", "nxy1sin?",
 "nxycos", "nxycos?", "nxysin", "nxysin?", "offset_channel", "offset_sound",
 "one_pole", "one_pole?", "one_zero", "one_zero?", "open_file_dialog", "open_file_dialog_directory",
 ...
 "print_dialog", "print_hook", "print_length", "procedure_arity", "procedure_documentation", "procedure_environment",
 "procedure_name", "procedure_setter", "procedure_source", "procedure_with_setter", "progress_report", "ptree_channel",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "sndclm.html#ercos", "sndclm.html#ercos?", "s7.html#errorhook", "s7.html#errorinfo",
 ...
 "extsnd.html#highlightcolor", "sndscm.html#hilberttransform", "s7.html#hook", "s7.html#hookapply",
 "s7.html#hookarity", "s7.html#hookdocumentation", "s7.html#hookfunctions", "sndscm.html#hookmember",
 "s7.html#hookp", "sndscm.html#html", "extsnd.html#htmldir", "extsnd.html#htmlprogram",
 ...
 "sndclm.html#make-polywave", "sndclm.html#make-pulse-train", "sndclm.html#make-pulsed-env", "sndclm.html#make-r2k!cos",
 ...
 "sndclm.html#make-triangle-wave", "sndclm.html#make-two-pole", "sndclm.html#make-two-zero", "s7.html#maketype",
 ...
 "sndclm.html#moving-fft?", "sndclm.html#moving-length", "sndclm.html#moving-max", "sndclm.html#moving-pitch",
 ...
 "extsnd.html#musosssetbuffers", "sndclm.html#mus-output?", "sndclm.html#mus-phase", "extsnd.html#musprescaler",
 "sndclm.html#mus-ramp", "sndclm.html#mus-rand-seed", "sndclm.html#mus-random", "sndclm.html#mus-reset",
 "sndclm.html#mus-run", "sndclm.html#mus-scaler", "extsnd.html#mussoundchans", "extsnd.html#mussoundcloseinput",
 ...
 "extsnd.html#newwidgethook", "sndscm.html#nextframe", "extsnd.html#nextsample", "sndclm.html#nkssb",
 ...
 "sndclm.html#nxysin", "sndclm.html#nxysin?", "sndscm.html#offsetchannel", "sndscm.html#offsetsound",
 ...
 "extsnd.html#printdialog", "extsnd.html#printhook", "extsnd.html#printlength", "s7.html#procedurearity",
 "s7.html#proceduredocumentation", "s7.html#procedureenvironment", "s7.html#procedurename", "s7.html#proceduresetter",
 "s7.html#proceduresource", "s7.html#procedurewithsetter", "extsnd.html#progressreport", "extsnd.html#ptreechannel",
...
static const char *autoload_names[AUTOLOAD_NAMES] = {
  ...
  "->y", "Ci", "Si", "a-cricket", 
  "a-frog", "abcos", "abcos-methods", "abcos?", 
  "absin", "absin-methods", "absin?", "acadian-flycatcher", 
  ...
  "cross-correlate", "cross-fade", "cross-synthesis", "cursor-follows-play", 
  "curveto", "dark-eyed-junco", "davis-tree-cricket", "db-envelope", 
  ...
  "do-all-chans", "do-chans", "do-sound-chans", "dog-day-cicada", 
  ...
  "green-noise-interp-methods", "green-noise-interp?", "green-noise-methods", "green-noise?", 
  "green-tailed-towhee", "green-toad", "green-tree-frog", "grn-methods", 
  "grn?", "groove-billed-ani", "hairy-woodpecker", "hammondoid", 
  "hammonds-flycatcher", "handsome-trig", "hard-clipped", "harmonicizer", 
  "hello-dentist", "henslows-sparrow", "hermit-thrush", "hermite", 
  "hermite-polynomial", "highpass", "hilbert-transform", "hook-empty?", 
  ...
  "lip-set-freq", "list->hook", "list??", "listp", 
  ...
  "music-font", "mvm-methods", "mvm?", "n-choose-k", 
  "n1cos", "n1cos-methods", "n1cos?", "narrow-winged-tree-cricket", 
  "nashville-warbler", "nb", "nchoosekcos", "nchoosekcos-methods", 
  "nchoosekcos?", "ncos2", "ncos2-methods", "ncos2?", 
  "ncos4", "nearest-point", "next-frame", "next-peak", 
  "next-phrase", "nkssb", "nkssb-interp", "nkssb-methods", 
  "nkssb?", "nkssber", "noddcos", "noddcos-methods", 
  "noddcos?", "noddsin", "noddsin-methods", "noddsin?", 
  "noddssb", "noddssb-methods", "noddssb?", "noid", 
  ...
  "note-data->pitch", "npcos", "npcos-methods", "npcos?", 
  "nrcos", "nrcos-methods", "nrcos?", "nrev", 
  "nrsin", "nrsin-methods", "nrsin?", "nrssb", 
  "nrssb-interp", "nrssb-methods", "nrssb?", "nsincos", 
  "nsincos-methods", "nsincos?", "nssb", "nssb-methods", 
  "nssb?", "nxy1cos", "nxy1cos-methods", "nxy1cos?", 
  "nxy1sin", "nxy1sin-methods", "nxy1sin?", "nxycos", 
  "nxycos-methods", "nxycos?", "nxysin", "nxysin-methods", 
  ...
  "replace-with-selection", "report-mark-names", "reset-all-hooks", "reset-fit", 
  "reset-hook!", "reset-rendering", "reset-transformation", "resflt", 
  ...
  "save-mark-properties", "save-mixes", "says-phoebe", "sbfm-methods", 
  ...
  "sinc-train", "sinc-train-methods", "sinc-train?", "sine-bank", 
  "sine-env", "sine-env-channel", "sine-ramp", "singer", 
  "slightly-musical-conehead", "smooth-channel-via-ptree", "smooth-vct", "snap-mark-to-beat", 
  ...
  "ws-interrupt?", "ws-save-state", "wurley", "x-norm", 
...
static int autoload_indices[AUTOLOAD_NAMES] = {
  ...
  55, 55, 55, 31, 31, 35, 35, 1, 1, 19, 19, 19, 19, 19, 19, 1, 1, 12, 48, 14, 48, 24, 19, 19, 
  ...
  1, 1, 1, 1, 1, 1, 19, 19, 19, 15, 15, 19, 1, 1, 19, 53, 40, 40, 40, 19, 11, 11, 1, 1, 
  1, 1, 19, 19, 19, 1, 19, 1, 1, 11, 0, 9, 1, 1, 1, 1, 1, 19, 1, 1, 1, 1, 1, 1, 
  2, 7, 1, 44, 1, 1, 1, 11, 1, 1, 1, 7, 14, 11, 14, 11, 11, 11, 11, 11, 11, 11, 15, 11, 
  ...
  1, 9, 15, 15, 17, 1, 13, 1, 49, 16, 14, 48, 31, 1, 1, 20, 19, 19, 19, 40, 55, 19, 26, 55, 
  28, 40, 40, 51, 28, 48, 9, 21, 26, 11, 36, 11, 11, 10, 14, 14, 14, 10, 10, 16, 9, 9, 9, 15, 
  15, 9, 40, 40, 14, 14, 14, 1, 11, 11, 11, 31, 8, 8, 8, 8, 8, 8, 8, 31, 8, 8, 8, 8, 
  8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 
  8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 
  8, 8, 8, 8, 8, 8, 8, 8, 31, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 
  8, 8, 8, 7, 1, 1, 1, 1, 1, 1, 14, 11, 0, 15, 28, 14, 15, 12, 12, 12, 20, 15, 13, 19, 
  19, 19, 19, 19, 19, 19, 19, 19, 19,