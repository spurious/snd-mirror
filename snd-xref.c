...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "enved-waveform-color", "envelope-interp", "enveloped-mix", "environment", "environment*", "environment->list",
 ...
 "file->frample", "file->frample?", "file->sample", "file->sample?", "file-name", "fill-polygon",
 ...
 "lambda*", "lbj-piano", "left-sample", "linear->db", "linear-src-channel", "lint for scheme",
 ...
 "make-firmant", "make-flocsig", "make-fmssb", "make-formant", "make-formant-bank", "make-frample->file",
 ...
 "make-wave-train-with-env", "map-channel", "map-sound-files", "maracas", "mark->integer", "mark-click-hook",
 ...
 "mix->float-vector", "mix->integer", "mix-amp", "mix-amp-env", "mix-channel", "mix-click-hook",
 ...
 "moving-length", "moving-max", "moving-max?", "moving-norm", "moving-norm?", "moving-pitch",
 "moving-pitch?", "moving-rms", "moving-scentroid", "moving-scentroid?", "moving-spectrum", "moving-spectrum?",
 "moving-sum", "mpg", "mus-alsa-buffer-size", "mus-alsa-buffers", "mus-alsa-capture-device", "mus-alsa-device",
 ...
 "mus-file-buffer-size", "mus-file-clipping", "mus-file-mix", "mus-file-name", "mus-float-equal-fudge-factor", "mus-frequency",
 ...
 "mus-max-table-size", "mus-name", "mus-offset", "mus-order", "mus-oss-set-buffers", "mus-output?",
 ...
 "nxysin?", "odd-multiple", "odd-weight", "offset-channel", "offset-sound", "one-pole",
 ...
 "sample", "sample->file", "sample->file?", "sampler-at-end?", "sampler-home", "sampler-position",
 ...
 "snd-warning-hook", "sndwarp", "sound->amp-env", "sound->integer", "sound-file-extensions", "sound-file?",
 ...
 "with-gl", "with-inset-graph", "with-interrupts", "with-local-hook", "with-menu-icons", "with-mix-tags",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "enved_waveform_color", "envelope_interp", "enveloped_mix", "environment", "environment_", "environment2list",
 ...
 "file2frample", "file2frample?", "file2sample", "file2sample?", "file_name", "fill_polygon",
 ...
 "lambda_", "lbj_piano", "left_sample", "linear2db", "linear_src_channel", "lint_for_scheme",
 ...
 "make_firmant", "make_flocsig", "make_fmssb", "make_formant", "make_formant_bank", "make_frample2file",
 ...
 "make_wave_train_with_env", "map_channel", "map_sound_files", "maracas", "mark2integer", "mark_click_hook",
 ...
 "mix2float_vector", "mix2integer", "mix_amp", "mix_amp_env", "mix_channel", "mix_click_hook",
 ...
 "mix_tag_y", "mix_vct", "mix_waveform_height", "mix?", "mixes", "mono2stereo",
 ...
 "moving_length", "moving_max", "moving_max?", "moving_norm", "moving_norm?", "moving_pitch",
 "moving_pitch?", "moving_rms", "moving_scentroid", "moving_scentroid?", "moving_spectrum", "moving_spectrum?",
 "moving_sum", "mpg", "mus_alsa_buffer_size", "mus_alsa_buffers", "mus_alsa_capture_device", "mus_alsa_device",
 ...
 "mus_file_buffer_size", "mus_file_clipping", "mus_file_mix", "mus_file_name", "mus_float_equal_fudge_factor", "mus_frequency",
 ...
 "mus_max_table_size", "mus_name", "mus_offset", "mus_order", "mus_oss_set_buffers", "mus_output?",
 ...
 "nsin?", "nsincos", "nsincos?", "nssb", "nssb?", "nxy1cos",
 "nxy1cos?", "nxy1sin", "nxy1sin?", "nxycos", "nxycos?", "nxysin",
 "nxysin?", "odd_multiple", "odd_weight", "offset_channel", "offset_sound", "one_pole",
 ...
 "rxyk!cos", "rxyk!cos?", "rxyk!sin", "rxyk!sin?", "rxysin", "rxysin?",
 "sample", "sample2file", "sample2file?", "sampler_at_end?", "sampler_home", "sampler_position",
 ...
 "snd_warning_hook", "sndwarp", "sound2amp_env", "sound2integer", "sound_file_extensions", "sound_file?",
 ...
 "with_gl", "with_inset_graph", "with_interrupts", "with_local_hook", "with_menu_icons", "with_mix_tags",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "sndscm.html#envelopedmix", "s7.html#environment", "s7.html#environmentstar", "s7.html#environmenttolist",
 ...
 "extsnd.html#leftsample", "sndclm.html#lineartodb", "sndscm.html#linearsrcchannel", "sndscm.html#lintdoc",
 ...
 "sndclm.html#make-fmssb", "sndclm.html#make-formant", "sndclm.html#makeformantbank", "sndclm.html#make-frampletofile",
...
static const char *snd_names[11362] = {
...
{
  s7_autoload_set_names(sc, snd_names, 5681);
}
#endif
