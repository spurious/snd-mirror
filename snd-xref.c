...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "correlate", "coverlet", "cross-fade (amplitude)", "cross-fade (frequency domain)", "cross-synthesis", "curlet",
 "current-font", "cursor", "cursor-color", "cursor-context", "cursor-location-offset", "cursor-position",
 "cursor-size", "cursor-style", "cursor-update-interval", "cutlet", "cyclic-sequences", "dac-combines-channels",
 "dac-size", "data-color", "data-location", "data-size", "db->linear", "default-output-chans",
 "default-output-header-type", "default-output-sample-type", "default-output-srate", "defgenerator", "define*", "define-bacro",
 "define-constant", "define-envelope", "define-expansion", "define-macro", "define-macro*", "define-nacro*",
 ...
 "dither-channel", "dither-sound", "documentation", "dolph", "dot-product", "dot-size",
 ...
 "during-open-hook", "dynamic-unwind", "edit-fragment", "edit-header-dialog", "edit-hook", "edit-list->function",
 ...
 "eoddcos?", "eps-bottom-margin", "eps-file", "eps-left-margin", "eps-size", "equivalent?",
 ...
 "funclet?", "*function*", "gaussian-distribution", "gc-off", "gc-on", "gensym",
 "gensym?", "gl-graph->ps", "glSpectrogram", "goertzel", "goto-listener-end", "grani",
 ...
 "Hartley transform", "hash-table", "hash-table-entries", "hash-table-ref", "hash-table-set!", "hash-table?",
 ...
 "make-two-pole", "make-two-zero", "make-variable-display", "make-variable-graph", "make-vector", "make-wave-train",
 "make-wave-train-with-env", "make-weak-hash-table", "map-channel", "map-sound-files", "maracas", "mark->integer",
 ...
 "mus-sample-type->string", "mus-sample-type-name", "mus-scaler", "mus-sound-chans", "mus-sound-comment", "mus-sound-data-location",
 "mus-sound-datum-size", "mus-sound-duration", "mus-sound-forget", "mus-sound-framples", "mus-sound-header-type", "mus-sound-length",
 "mus-sound-loop-info", "mus-sound-mark-info", "mus-sound-maxamp", "mus-sound-maxamp-exists?", "mus-sound-path", "mus-sound-preload",
 "mus-sound-prune", "mus-sound-report-cache", "mus-sound-sample-type", "mus-sound-samples", "mus-sound-srate", "mus-sound-type-specifier",
 ...
 "one-zero", "one-zero?", "open-file-dialog", "open-file-dialog-directory", "open-hook", "open-input-function",
 "open-next-file-in-directory", "open-output-function", "open-raw-sound", "open-raw-sound-hook", "open-sound", "openlet",
 ...
 "polywave", "polywave?", "port-file", "port-filename", "port-line-number", "port-position",
 "position->x", "position->y", "position-color", "power-env", "pqw", "pqw-vox",
 "preferences-dialog", "previous-sample", "print-dialog", "print-length", "procedure-source", "progress-report",
 ...
 "rcos", "rcos?", "*read-error-hook*", "read-hook", "read-mix-sample", "read-only",
 "read-region-sample", "read-sample", "read-sample-with-direction", "reader-cond", "readin", "readin?",
 "rectangular->magnitudes", "rectangular->polar", "redo", "region->float-vector", "region->integer", "region-chans",
 ...
 "reverb-control-scale", "reverb-control-scale-bounds", "reverb-control?", "reverse!", "reverse-by-blocks", "reverse-channel",
 ...
 "rms", "rms, gain, balance gens", "rms-envelope", "rootlet", "*rootlet-redefinition-hook*", "round-interp",
 ...
 "set-samples", "setter", "short-file-name", "show-axes", "show-controls", "show-disk-space",
 ...
 "show-y-zero", "signature", "silence-all-mixes", "silence-mixes", "sinc-train", "sinc-train?",
 ...
 "stretch-sound-via-dft", "string->byte-vector", "string-position", "sublet", "subvector", "subvector-position",
 "subvector-vector", "subvector?", "superimpose-ffts", "swap-channels", "swap-selection-channels", "symbol->dynamic-value",
 "symbol->value", "symbol-table", "sync", "sync-everything", "sync-max", "sync-style",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "correlate", "coverlet", "cross_fade__amplitude_", "cross_fade__frequency_domain_", "cross_synthesis", "curlet",
 "current_font", "cursor", "cursor_color", "Cursor_context", "cursor_location_offset", "cursor_position",
 "cursor_size", "cursor_style", "cursor_update_interval", "cutlet", "cyclic_sequences", "dac_combines_channels",
 "dac_size", "data_color", "data_location", "data_size", "db2linear", "default_output_chans",
 "default_output_header_type", "default_output_sample_type", "default_output_srate", "defgenerator", "define_", "define_bacro",
 "define_constant", "define_envelope", "define_expansion", "define_macro", "define_macro_", "define_nacro_",
 ...
 "dither_channel", "dither_sound", "documentation", "dolph", "dot_product", "dot_size",
 ...
 "during_open_hook", "dynamic_unwind", "edit_fragment", "edit_header_dialog", "edit_hook", "edit_list2function",
 ...
 "eoddcos?", "eps_bottom_margin", "eps_file", "eps_left_margin", "eps_size", "equivalent?",
 ...
 "funclet?", "_function_", "gaussian_distribution", "gc_off", "gc_on", "gensym",
 "gensym?", "gl_graph2ps", "glSpectrogram", "goertzel", "goto_listener_end", "grani",
 ...
 "Hartley_transform", "hash_table", "hash_table_entries", "hash_table_ref", "hash_table_set!", "hash_table?",
 ...
 "make_two_pole", "make_two_zero", "make_variable_display", "make_variable_graph", "make_vector", "make_wave_train",
 "make_wave_train_with_env", "make_weak_hash_table", "map_channel", "map_sound_files", "maracas", "mark2integer",
 ...
 "mus_sample_type2string", "mus_sample_type_name", "mus_scaler", "mus_sound_chans", "mus_sound_comment", "mus_sound_data_location",
 "mus_sound_datum_size", "mus_sound_duration", "mus_sound_forget", "mus_sound_framples", "mus_sound_header_type", "mus_sound_length",
 "mus_sound_loop_info", "mus_sound_mark_info", "mus_sound_maxamp", "mus_sound_maxamp_exists?", "mus_sound_path", "mus_sound_preload",
 "mus_sound_prune", "mus_sound_report_cache", "mus_sound_sample_type", "mus_sound_samples", "mus_sound_srate", "mus_sound_type_specifier",
 ...
 "one_zero", "one_zero?", "open_file_dialog", "open_file_dialog_directory", "open_hook", "open_input_function",
 "open_next_file_in_directory", "open_output_function", "open_raw_sound", "open_raw_sound_hook", "open_sound", "openlet",
 ...
 "polywave", "polywave?", "port_file", "port_filename", "port_line_number", "port_position",
 "position2x", "position2y", "position_color", "power_env", "pqw", "pqw_vox",
 "preferences_dialog", "previous_sample", "print_dialog", "print_length", "procedure_source", "progress_report",
 ...
 "rcos", "rcos?", "_read_error_hook_", "read_hook", "read_mix_sample", "read_only",
 "read_region_sample", "read_sample", "read_sample_with_direction", "reader_cond", "readin", "readin?",
 "rectangular2magnitudes", "rectangular2polar", "redo_edit", "region2float_vector", "region2integer", "region_chans",
 ...
 "reverb_control_scale", "reverb_control_scale_bounds", "reverb_control?", "reverse!", "reverse_by_blocks", "reverse_channel",
 "reverse_envelope", "reverse_selection", "reverse_sound", "revert_sound", "right_sample", "ring_modulate",
 "rk!cos", "rk!cos?", "rk!ssb", "rk!ssb?", "rkcos", "rkcos?",
 "rkoddssb", "rkoddssb?", "rksin", "rksin?", "rkssb", "rkssb?",
 "rms", "rms__gain__balance_gens", "rms_envelope", "rootlet", "_rootlet_redefinition_hook_", "round_interp",
 ...
 "set_samples", "setter", "short_file_name", "show_axes", "show_controls", "show_disk_space",
 ...
 "show_y_zero", "signature", "silence_all_mixes", "silence_mixes", "sinc_train", "sinc_train?",
 ...
 "stretch_sound_via_dft", "string2byte_vector", "string_position", "sublet", "subvector", "subvector_position",
 "subvector_vector", "subvector?", "superimpose_ffts", "swap_channels", "swap_selection_channels", "symbol2dynamic_value",
 "symbol2value", "symbol_table", "sync", "sync_everything", "sync_max", "sync_style",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "extsnd.html#defaultoutputsrate", "sndclm.html#defgenerator", "s7.html#definestar", "s7.html#definebacro",
 "s7.html#defineconstant", "extsnd.html#defineenvelope", "s7.html#expansion", "s7.html#definemacro",
 "s7.html#definemacrostar", "s7.html#definebacrostar", "sndscm.html#defineselectionviamarks", "s7.html#definedp",
 ...
 "sndscm.html#makedropsite", "extsnd.html#drophook", "extsnd.html#duringopenhook", "s7.html#dynamicunwind",
 ...
 "extsnd.html#epssize", "s7.html#equivalentp", "sndclm.html#ercos", "sndclm.html#ercos?",
 ...
 "s7.html#isfunclet", "s7.html#currentfunction", "sndscm.html#gaussiandistribution", "extsnd.html#gcoff",
 ...
 "extsnd.html#openfiledialog", "extsnd.html#openfiledialogdirectory", "extsnd.html#openhook", "s7.html#openinputfunction",
 "sndscm.html#opennextfileindirectory", "s7.html#openoutputfunction", "extsnd.html#openrawsound", "extsnd.html#openrawsoundhook",
 ...
 "s7.html#pairlinenumber", "sndscm.html#panmix", "sndscm.html#panmixfv", "sndclm.html#partialstopolynomial",
 ...
 "s7.html#portfile", "s7.html#portfilename", "s7.html#portlinenumber", "s7.html#portposition",
 ...
 "extsnd.html#printdialog", "extsnd.html#printlength", "s7.html#proceduresource", "extsnd.html#progressreport",
 ...
 "s7.html#readerrorhook", "extsnd.html#readhook", "extsnd.html#readmixsample", "extsnd.html#readonly",
 "extsnd.html#readregionsample", "extsnd.html#readsample", "extsnd.html#readsamplewithdirection", "s7.html#readercond",
 "sndclm.html#readin", "sndclm.html#readin?", "sndclm.html#rectangulartomagnitudes", "sndclm.html#rectangulartopolar",
 "extsnd.html#redo", "extsnd.html#regiontofv", "extsnd.html#regiontointeger", "extsnd.html#regionchans",
 ...
 "extsnd.html#reverbcontrolp", "s7.html#reverseb", "sndscm.html#reversebyblocks", "extsnd.html#reversechannel",
 ...
 "sndscm.html#rmsenvelope", "s7.html#rootlet", "s7.html#rootletredefinitionhook", "sndclm.html#round-interp",
 ...
 "extsnd.html#selectionsrate", "extsnd.html#selectionok", "extsnd.html#setsamples", "s7.html#setter",
 ...
 "extsnd.html#showyzero", "s7.html#signature", "sndscm.html#silenceallmixes", "sndscm.html#silencemixes",
 ...
 "s7.html#stringposition", "s7.html#sublet", "s7.html#subvector", "s7.html#subvectorposition",
 "s7.html#subvectorvector", "s7.html#subvectorp", "sndscm.html#superimposeffts", "extsnd.html#swapchannels",
 "sndscm.html#swapselectionchannels", "s7.html#symboltodynamicvalue", "s7.html#symboltovalue", "s7.html#symboltable",
 ...
 "extsnd.html#tinyfont", "sndscm.html#telephone", "extsnd.html#trackingcursorstyle", "extsnd.html#transformtofv",
...
static const char *snd_names[11892] = {
    ...
    "REG_EBRACE", "libc.scm",
    "REG_EBRACK", "libc.scm",
    "REG_ECOLLATE", "libc.scm",
    "REG_ECTYPE", "libc.scm",
    "REG_EESCAPE", "libc.scm",
    "REG_EPAREN", "libc.scm",
    "REG_ERANGE", "libc.scm",
    "REG_ESPACE", "libc.scm",
    "REG_ESUBREG", "libc.scm",
    "REG_EXTENDED", "libc.scm",
    "REG_ICASE", "libc.scm",
    "REG_NEWLINE", "libc.scm",
    "REG_NOMATCH", "libc.scm",
    "REG_NOSUB", "libc.scm",
    "REG_NOTBOL", "libc.scm",
    "REG_NOTEOL", "libc.scm",
    "RE_DUP_MAX", "libc.scm",
    ...
    "gsl_interp2d_eval_extrap_e", "libgsl.scm",
    ...
    "gsl_linalg_LQ_QTvec", "libgsl.scm",
    "gsl_linalg_LQ_decomp", "libgsl.scm",
    "gsl_linalg_LQ_lssolve", "libgsl.scm",
    ...
    "gsl_linalg_ldlt_band_decomp", "libgsl.scm",
    "gsl_linalg_ldlt_band_rcond", "libgsl.scm",
    "gsl_linalg_ldlt_band_solve", "libgsl.scm",
    "gsl_linalg_ldlt_band_svx", "libgsl.scm",
    "gsl_linalg_ldlt_band_unpack", "libgsl.scm",
    "gsl_linalg_ldlt_decomp", "libgsl.scm",
    "gsl_linalg_ldlt_rcond", "libgsl.scm",
    "gsl_linalg_ldlt_solve", "libgsl.scm",
    "gsl_linalg_ldlt_svx", "libgsl.scm",
    ...
    "gsl_sf_hermite", "libgsl.scm",
    "gsl_sf_hermite_array", "libgsl.scm",
    "gsl_sf_hermite_array_deriv", "libgsl.scm",
    "gsl_sf_hermite_deriv", "libgsl.scm",
    "gsl_sf_hermite_deriv_array", "libgsl.scm",
    "gsl_sf_hermite_deriv_e", "libgsl.scm",
    "gsl_sf_hermite_e", "libgsl.scm",
    ...
    "gsl_sf_hermite_func_fast", "libgsl.scm",
    "gsl_sf_hermite_func_fast_e", "libgsl.scm",
    ...
    "gsl_sf_hermite_prob_array_deriv", "libgsl.scm",
    "gsl_sf_hermite_prob_deriv", "libgsl.scm",
    "gsl_sf_hermite_prob_deriv_array", "libgsl.scm",
    "gsl_sf_hermite_prob_deriv_e", "libgsl.scm",
    ...
    "gsl_sf_hermite_series", "libgsl.scm",
    "gsl_sf_hermite_series_e", "libgsl.scm",
    "gsl_sf_hermite_zero", "libgsl.scm",
    "gsl_sf_hermite_zero_e", "libgsl.scm",
...
{
  s7_autoload_set_names(sc, snd_names, 5946);
}
#endif
