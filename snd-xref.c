...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "previous-sample", "print-dialog", "print-hook", "print-length", "procedure-environment", "procedure-source",
 "procedure-with-setter", "progress-report", "prompt-in-minibuffer", "ptree-channel", "pulse-train", "pulse-train?",
 "radians->degrees", "radians->hz", "ramp-channel", "rand", "rand-interp", "rand-interp?",
 "rand?", "random", "read-frame", "read-hook", "read-mix-sample", "read-only",
 "read-region-sample", "read-sample", "readin", "readin?", "recorder-dialog", "rectangular->magnitudes",
 "rectangular->polar", "redo", "redo-channel", "redo-edit", "region->frame", "region->integer",
 "region->sound-data", "region->vct", "region-chans", "region-frames", "region-graph-style", "region-home",
 "region-maxamp", "region-maxamp-position", "region-play-list", "region-position", "region-sample", "region-sampler?",
 "region-srate", "region?", "regions", "remember-sound-state", "remove-from-menu", "report-in-minibuffer",
 "reset-all-hooks", "reset-controls", "reset-listener-cursor", "restore-controls", "*reverb*", "reverb-control-decay",
 ...
 "save-edit-history", "save-envelopes", "save-hook", "save-listener", "save-macros", "save-mark-properties",
 ...
 "scale-to", "scan-channel", "scan-sound", "scanned synthesis", "scentroid", "script-arg",
 "script-args", "search-procedure", "seconds->samples", "select-all", "select-channel", "select-channel-hook",
 "select-sound", "select-sound-hook", "selected-channel", "selected-data-color", "selected-graph-color", "selected-sound",
 "selection", "selection->mix", "selection->sound-data", "selection-chans", "selection-color", "selection-creates-region",
 "selection-frames", "selection-maxamp", "selection-maxamp-position", "selection-member?", "selection-members", "selection-position",
 "selection-srate", "selection?", "set-samples", "shepard-tone", "short-file-name", "show-axes",
 ...
 "smooth-sound", "SMS synthesis", "snap-mark-to-beat", "snap-mix-to-beat", "snd->sample", "snd->sample?",
 ...
 "sound-file-extensions", "sound-file?", "sound-files-in-directory", "sound-interp", "sound-let", "sound-loop-info",
 ...
 "spectrum-start", "speed-control", "speed-control-bounds", "speed-control-style", "speed-control-tones", "square-wave",
 "square-wave?", "squelch-update", "squelch-vowels", "srate", "src", "src-channel",
 "src-duration", "src-mixes", "src-selection", "src-sound", "src?", "ssb-am",
 "ssb-am?", "ssb-bank", "ssb-bank-env", "ssb-fm", "stacktrace", "start-hook",
 "start-playing", "start-playing-hook", "start-playing-selection-hook", "start-progress-report", "start-waterfall", "stereo->mono",
 ...
 "with-interrupts", "with-local-hook", "with-marked-sound", "with-menu-icons", "with-mix-tags", "with-mixed-sound",
 "with-mixed-sound->notelist", "with-pointer-focus", "with-relative-panes", "with-smpte-label", "with-sound", "with-temp-sound",
 "with-temporary-selection", "with-toolbar", "with-tooltips", "with-tracking-cursor", "with-verbose-cursor", "x->position",
 "x-axis-label", "x-axis-style", "x-bounds", "x-position-slider", "x-zoom-slider", "xramp-channel",
 "y->position", "y-axis-label", "y-bounds", "y-position-slider", "y-zoom-slider", "z-transform",
 "zero-pad", "zip-sound", "zipper", "zoom-color", "zoom-focus-style"};
#endif
#if HAVE_RUBY
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "previous_sample", "print_dialog", "print_hook", "print_length", "procedure_environment", "procedure_source",
 "procedure_with_setter", "progress_report", "prompt_in_minibuffer", "ptree_channel", "pulse_train", "pulse_train?",
 "radians2degrees", "radians2hz", "ramp_channel", "rand", "rand_interp", "rand_interp?",
 "rand?", "random", "read_frame", "read_hook", "read_mix_sample", "read_only",
 "read_region_sample", "read_sample", "readin", "readin?", "recorder_dialog", "rectangular2magnitudes",
 "rectangular2polar", "redo_edit", "redo_channel", "redo_edit", "region2frame", "region2integer",
 "region2sound_data", "region2vct", "region_chans", "region_frames", "region_graph_style", "region_home",
 "region_maxamp", "region_maxamp_position", "region_play_list", "region_position", "region_sample", "region_sampler?",
 "region_srate", "region?", "regions", "remember_sound_state", "remove_from_menu", "report_in_minibuffer",
 "reset_all_hooks", "reset_controls", "reset_listener_cursor", "restore_controls", "_reverb_", "reverb_control_decay",
 ...
 "save_edit_history", "save_envelopes", "save_hook", "save_listener", "save_macros", "save_mark_properties",
 ...
 "scale_to", "scan_channel", "scan_sound", "scanned_synthesis", "scentroid", "script_arg",
 "script_args", "search_procedure", "seconds2samples", "select_all", "select_channel", "select_channel_hook",
 "select_sound", "select_sound_hook", "selected_channel", "selected_data_color", "selected_graph_color", "selected_sound",
 "selection", "selection2mix", "selection2sound_data", "selection_chans", "selection_color", "selection_creates_region",
 "selection_frames", "selection_maxamp", "selection_maxamp_position", "selection_member?", "selection_members", "selection_position",
 "selection_srate", "selection?", "set_samples", "shepard_tone", "short_file_name", "show_axes",
 ...
 "smooth_sound", "SMS_synthesis", "snap_mark_to_beat", "snap_mix_to_beat", "snd2sample", "snd2sample?",
 ...
 "sound_file_extensions", "sound_file?", "sound_files_in_directory", "sound_interp", "sound_let", "sound_loop_info",
 ...
 "spectrum_start", "speed_control", "speed_control_bounds", "speed_control_style", "speed_control_tones", "square_wave",
 "square_wave?", "squelch_update", "squelch_vowels", "srate", "src", "src_channel",
 "src_duration", "src_mixes", "src_selection", "src_sound", "src?", "ssb_am",
 "ssb_am?", "ssb_bank", "ssb_bank_env", "ssb_fm", "stacktrace", "start_hook",
 "start_playing", "start_playing_hook", "start_playing_selection_hook", "start_progress_report", "start_waterfall", "stereo2mono",
 ...
 "with_interrupts", "with_local_hook", "with_marked_sound", "with_menu_icons", "with_mix_tags", "with_mixed_sound",
 "with_mixed_sound2notelist", "with_pointer_focus", "with_relative_panes", "with_smpte_label", "with_sound", "with_temp_sound",
 "with_temporary_selection", "with_toolbar", "with_tooltips", "with_tracking_cursor", "with_verbose_cursor", "x2position",
 "x_axis_label", "x_axis_style", "x_bounds", "x_position_slider", "x_zoom_slider", "xramp_channel",
 "y2position", "y_axis_label", "y_bounds", "y_position_slider", "y_zoom_slider", "z_transform",
 "zero_pad", "zip_sound", "zipper", "zoom_color", "zoom_focus_style"};
#endif
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "extsnd.html#printhook", "extsnd.html#printlength", "s7.html#procedureenvironment", "s7.html#proceduresource",
...
static const char *autoload_names[AUTOLOAD_NAMES] = {
  ...
  "open-current-buffer", "open-next-file-in-directory", "open-play-output", "orange-crowned-warbler", 
  ...
  "polyoid-methods", "polyoid?", "powenv-channel", "power-env", 
  ...
  "region-play-sequence", "region-rms", "remove-clicks", "remove-if", 
...
static int autoload_indices[AUTOLOAD_NAMES] = {
  ...
  55, 55, 55, 31, 31, 22, 35, 35, 1, 1, 19, 19, 19, 19, 19, 19, 1, 1, 12, 14, 48, 24, 19, 19, 
  ...
  14, 26, 55, 7, 55, 55, 14, 7, 14, 28, 10, 14, 14, 1, 1, 1, 1, 1, 14, 14, 14, 11, 11, 12, 
  ...
  35, 35, 11, 11, 21, 1, 1, 44, 22, 1, 11, 14, 44, 1, 1, 1, 55, 15, 17, 17, 17, 4, 4, 12, 
  ...
  19, 19, 11, 7, 46, 17, 20, 19, 48, 14, 9, 11, 9, 7, 48, 48, 17, 19, 19, 11, 19, 19, 19, 56, 
  29, 56, 12, 17, 15, 25, 26, 26, 51, 14, 26, 51, 1, 15, 12, 27, 7, 12, 9, 28, 15, 28, 28, 17, 
  ...
  14, 14, 38, 1, 19, 1, 14, 43, 31, 10, 10, 37, 1, 1, 26, 15, 28, 28, 28, 28, 11, 9, 9, 19, 
  9, 9, 9, 9, 12, 12, 11, 1, 1, 51, 51, 19, 19, 19, 1, 1, 1, 1, 19, 19, 19, 7, 1, 14, 
  1, 1, 14, 48, 26, 48, 48, 28, 38, 13, 51, 48, 38, 48, 38, 38, 38, 26, 38, 38, 13, 35, 19, 19, 
  7, 40, 1, 1, 37, 37, 37, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 39, 
  39, 39, 19, 19, 19, 19, 12, 12, 12, 41, 7, 7, 41, 41, 17, 51, 0, 32, 14, 19, 19, 1, 43, 43, 
  1, 19, 19, 19, 19, 19, 19, 19, 20, 14, 15, 15, 19, 19, 19, 4, 14, 4, 4, 4, 4, 4, 4, 4, 
  4, 14, 17, 4, 4, 4, 4, 4, 14, 14, 4, 1, 1, 1, 1, 15, 40, 17, 17, 14, 14, 14, 14, 15, 
  6, 6, 9, 12, 46, 26, 21, 9, 9, 9, 7, 7, 14, 12, 41, 14, 7, 14, 14, 1, 19, 19, 19, 19, 
  19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 31, 31, 7, 12, 7, 7, 9, 11, 19, 19, 
  19, 19, 19, 19, 19, 45, 1, 1, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 
  ...
  19, 1, 29, 1, 14, 1, 46, 14, 28, 14, 28, 26, 19, 19, 19, 6, 6, 6, 6, 19, 1, 9, 55, 1, 
  ...
  4, 4, 14, 14, 4, 55, 55, 7, 9, 14, 14, 9, 1, 1, 1, 1, 11, 7, 7, 14, 56, 56, 14, 14, 
  11, 56, 56, 7, 1, 14};
