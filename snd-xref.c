...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "let->list", "let-iterator?", "let-ref", "let-set!", "let?", "linear->db",
 ...
 "make-k2ssb", "make-k3sin", "make-krksin", "make-let-iterator", "make-locsig", "make-lowpass",
 ...
 "stretch-envelope", "stretch-sound-via-dft", "sublet", "superimpose-ffts", "swap-channels", "swap-selection-channels",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "let2list", "let_iterator?", "let_ref", "let_set!", "let?", "linear2db",
 ...
 "make_k2ssb", "make_k3sin", "make_krksin", "make_let_iterator", "make_locsig", "make_lowpass",
 ...
 "stretch_envelope", "stretch_sound_via_dft", "sublet", "superimpose_ffts", "swap_channels", "swap_selection_channels",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "sndscm.html#lbjpiano", "extsnd.html#leftsample", "s7.html#lettolist", "s7.html#letiteratorp",
 ...
 "sndclm.html#make-k2ssb", "sndclm.html#make-k3sin", "sndclm.html#make-krksin", "s7.html#letiterator",
 ...
 "extsnd.html#outputnamehook", "sndscm.html#overlayrmsenv", "s7.html#owlet", "extsnd.html#padchannel",
