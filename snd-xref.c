...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "insert-silence", "insert-sound", "integer->colormap", "integer->mark", "integer->mix", "integer->region",
 "integer->sound", "integer->transform", "integrate-envelope", "invert-filter", "izcos", "izcos?",
 ...
 "make-formant", "make-formant-bank", "make-frame", "make-frame!", "make-frame->file", "make-granulate",
 ...
 "make-rcos", "make-readin", "make-region", "make-region-sampler", "make-rk!cos", "make-rk!ssb",
 ...
 "make-sawtooth-wave", "make-scalar-mixer", "make-selection", "make-sinc-train", "make-snd->sample", "make-sound-box",
 "make-sound-data", "make-spencer-filter", "make-square-wave", "make-src", "make-ssb-am", "make-table-lookup",
 ...
 "mix?", "mixer", "mixer*", "mixer+", "mixer-ref", "mixer-set!",
 ...
 "mus-feedforward", "mus-fft", "mus-file-buffer-size", "mus-file-clipping", "mus-file-name", "mus-float-equal-fudge-factor",
 ...
 "mus-sound-maxamp-exists?", "mus-sound-open-input", "mus-sound-open-output", "mus-sound-preload", "mus-sound-prune", "mus-sound-read",
 ...
 "preferences-dialog", "previous-sample", "print-dialog", "print-length", "procedure-arity", "procedure-documentation",
 ...
 "rcos?", "read-hook", "read-mix-sample", "read-only", "read-region-sample", "read-sample",
 "read-sample-with-direction", "readin", "readin?", "rectangular->magnitudes", "rectangular->polar", "redo",
 "region->integer", "region->vct", "region-chans", "region-frames", "region-graph-style", "region-home",
 ...
 "scale-sound", "scale-tempo", "scale-to", "scan-channel", "scanned synthesis", "scentroid",
 ...
 "selected-data-color", "selected-graph-color", "selected-sound", "selection", "selection->mix", "selection-chans",
 ...
 "silence-all-mixes", "silence-mixes", "sinc-train", "sinc-train?", "sinc-width", "sine-env-channel",
 ...
 "snd-version", "snd-warning", "snd-warning-hook", "sndwarp", "sound->amp-env", "sound->integer",
 "sound-data*", "sound-data+", "sound-data-add!", "sound-data-chans", "sound-data-copy", "sound-data-fill!",
 ...
 "vct-min", "vct-move!", "vct-multiply!", "vct-offset!", "vct-peak", "vct-ref",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "insert_silence", "insert_sound", "integer2colormap", "integer2mark", "integer2mix", "integer2region",
 "integer2sound", "integer2transform", "integrate_envelope", "invert_filter", "izcos", "izcos?",
 "j0evencos", "j0evencos?", "j0j1cos", "j0j1cos?", "j2cos", "j2cos?",
 ...
 "make_formant", "make_formant_bank", "make_frame", "make_frame!", "make_frame2file", "make_granulate",
 ...
 "make_rcos", "make_readin", "make_region", "make_region_sampler", "make_rk!cos", "make_rk!ssb",
 ...
 "make_sawtooth_wave", "make_scalar_mixer", "make_selection", "make_sinc_train", "make_snd2sample", "make_sound_box",
 "make_sound_data", "make_spencer_filter", "make_square_wave", "make_src", "make_ssb_am", "make_table_lookup",
 ...
 "mix?", "mixer", "mixer_multiply", "mixer_add", "mixer_ref", "mixer_set!",
 ...
 "mus_feedforward", "mus_fft", "mus_file_buffer_size", "mus_file_clipping", "mus_file_name", "mus_float_equal_fudge_factor",
 ...
 "mus_sound_maxamp_exists?", "mus_sound_open_input", "mus_sound_open_output", "mus_sound_preload", "mus_sound_prune", "mus_sound_read",
 ...
 "preferences_dialog", "previous_sample", "print_dialog", "print_length", "procedure_arity", "procedure_documentation",
 ...
 "rcos?", "read_hook", "read_mix_sample", "read_only", "read_region_sample", "read_sample",
 "read_sample_with_direction", "readin", "readin?", "rectangular2magnitudes", "rectangular2polar", "redo_edit",
 "region2integer", "region2vct", "region_chans", "region_frames", "region_graph_style", "region_home",
 ...
 "selected_data_color", "selected_graph_color", "selected_sound", "selection", "selection2mix", "selection_chans",
 ...
 "silence_all_mixes", "silence_mixes", "sinc_train", "sinc_train?", "sinc_width", "sine_env_channel",
 ...
 "snd_version", "snd_warning", "snd_warning_hook", "sndwarp", "sound2amp_env", "sound2integer",
 "sound_data_", "sound_data_", "sound_data_add!", "sound_data_chans", "sound_data_copy", "sound_data_fill!",
 ...
 "vct_min", "vct_move!", "vct_multiply!", "vct_offset!", "vct_peak", "vct_ref",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "sndclm.html#make-frame", "sndclm.html#make-frame!", "sndclm.html#make-frametofile", "sndclm.html#make-granulate",
 ...
 "sndclm.html#make-sawtooth-wave", "sndclm.html#make-scalar-mixer", "sndscm.html#makeselection", "sndclm.html#make-sinc-train",
 ...
 "sndclm.html#mixermultiply", "sndclm.html#mixeradd", "sndclm.html#mixer-ref", "sndclm.html#mixer-set!",
 ...
 "extsnd.html#mussoundopenoutput", "extsnd.html#mussoundpreload", "extsnd.html#mussoundprune", "extsnd.html#mussoundread",
