...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "print-length", "procedure-documentation", "procedure-setter", "procedure-source", "profile", "progress-report",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "print_length", "procedure_documentation", "procedure_setter", "procedure_source", "profile", "progress_report",
