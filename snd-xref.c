...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "swap-channels", "swap-selection-channels", "symbol-access", "sync", "sync-all", "sync-max",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "swap_channels", "swap_selection_channels", "symbol_access", "sync", "sync_all", "sync_max",
