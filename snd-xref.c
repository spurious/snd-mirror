...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "effects-hook", "elliptic filters", "emacs-style-save-as", "env", "env-any", "env-channel",
 ...
 "make-frame->file", "make-frame-reader", "make-granulate", "make-graph-data", "make-hash-table", "make-hidden-controls-dialog",
 ...
 "sampler?", "samples", "samples->seconds", "sash-color", "save-controls", "save-dir",
 ...
 "swap-channels", "swap-selection-channels", "symbol-access", "sync", "sync-everything", "sync-max",
 "sync-style", "syncd-marks", "table-lookup", "table-lookup?", "tap", "telephone",
 "temp-dir", "text-focus-color", "time-graph-hook", "time-graph-style", "time-graph-type", "time-graph?",
 ...
 "undo-edit", "undo-hook", "update-graphs", "update-hook", "update-lisp-graph", "update-sound",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "effects_hook", "elliptic_filters", "emacs_style_save_as", "env", "env_any", "env_channel",
 ...
 "make_frame2file", "make_frame_reader", "make_granulate", "make_graph_data", "make_hash_table", "make_hidden_controls_dialog",
 ...
 "sampler?", "samples", "samples2seconds", "sash_color", "save_controls", "save_dir",
 ...
 "swap_channels", "swap_selection_channels", "symbol_access", "sync", "sync_everything", "sync_max",
 "sync_style", "syncd_marks", "table_lookup", "table_lookup?", "tap", "telephone",
 "temp_dir", "text_focus_color", "time_graph_hook", "time_graph_style", "time_graph_type", "time_graph?",
 ...
 "undo_edit", "undo_hook", "update_graphs", "update_hook", "update_lisp_graph", "update_sound",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "sndclm.html#make-granulate", "extsnd.html#makegraphdata", "s7.html#makehashtable", "sndscm.html#makehiddencontrolsdialog",
 ...
 "extsnd.html#regionok", "extsnd.html#eregions", "s7.html#releaselock", "sndscm.html#remembersoundstate",
 ...
 "extsnd.html#swapchannels", "sndscm.html#swapselectionchannels", "s7.html#symbolaccess", "extsnd.html#sync",
 ...
 "extsnd.html#timegraphtype", "extsnd.html#timegraphp", "extsnd.html#tinyfont", "s7.html#trace",
...
static const char *autoload_names[AUTOLOAD_NAMES] = {
  ...
  "eastern-wood-pewee-2", "echo", "edhist-apply-edits", "edhist-clear-edits", 
  "edhist-help-edits", "edhist-reapply-edits", "edhist-save-edits", "edit-fft-popup-menu", 
  "edit-graph-popup-menu", "edit-history-popup-menu", "eliminate-hum", "elliptic-prototype", 
  ...
  "focus-follows-mouse", "fofins", "for-each-child", "for-each-sound-file", 
  ...
  "get-best", "get-speaker-configuration", "get-worst-overall", "glassy", 
...
static int autoload_indices[AUTOLOAD_NAMES] = {
  ...
  28, 11, 11, 11, 10, 14, 14, 14, 10, 10, 17, 9, 9, 9, 16, 16, 9, 42, 42, 14, 14, 14, 1, 11, 
  11, 11, 33, 8, 8, 8, 8, 8, 8, 8, 33, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 
  8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 
  8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 33, 
  8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7, 1, 1, 1, 1, 1, 
  1, 14, 41, 41, 41, 41, 41, 41, 41, 41, 11, 0, 16, 30, 14, 16, 12, 12, 12, 22, 16, 13, 21, 21, 
  21, 21, 21, 21, 21, 21, 21, 21, 28, 48, 1, 14, 22, 7, 15, 7, 14, 21, 21, 21, 38, 38, 38, 14, 
  14, 36, 44, 1, 52, 14, 14, 14, 14, 14, 14, 14, 14, 1, 18, 18, 34, 34, 33, 26, 14, 48, 14, 14, 
  59, 30, 21, 21, 37, 14, 11, 14, 59, 14, 9, 28, 1, 14, 11, 14, 26, 4, 4, 21, 21, 21, 11, 42, 
  7, 21, 11, 11, 7, 7, 35, 11, 7, 58, 26, 7, 21, 21, 21, 26, 51, 7, 41, 16, 14, 14, 1, 9, 
  1, 14, 21, 11, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 