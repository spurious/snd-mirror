    ...
    _OP_DEF(opexe_0, "defined?",                       1,  2,       TST_SYMBOL TST_PAIR,           OP_DEFP             )
    ...
    _OP_DEF(opexe_2, "numerator",                      1,  1,       TST_RATIONAL,                    OP_NUMERATOR        )
    _OP_DEF(opexe_2, "denominator",                    1,  1,       TST_RATIONAL,                    OP_DENOMINATOR      )
    _OP_DEF(opexe_2, "rationalize",                    1,  2,       TST_REAL,                        OP_RATIONALIZE      )
    _OP_DEF(opexe_2, "exact?",                         1,  1,       TST_NUMBER,                      OP_EXACTP           )
    _OP_DEF(opexe_2, "inexact?",                       1,  1,       TST_NUMBER,                      OP_INEXACTP         )
    _OP_DEF(opexe_2, "even?",                          1,  1,       TST_INTEGER,                     OP_EVENP            )
    _OP_DEF(opexe_2, "odd?",                           1,  1,       TST_INTEGER,                     OP_ODDP             )
    _OP_DEF(opexe_2, "zero?",                          1,  1,       TST_NUMBER,                      OP_ZEROP            )
    _OP_DEF(opexe_2, "positive?",                      1,  1,       TST_REAL,                        OP_POSITIVEP        )
    _OP_DEF(opexe_2, "negative?",                      1,  1,       TST_REAL,                        OP_NEGATIVEP        )
    ...
    _OP_DEF(opexe_2, "sinh",                           1,  1,       TST_NUMBER,                      OP_SINH             )
    _OP_DEF(opexe_2, "cosh",                           1,  1,       TST_NUMBER,                      OP_COSH             )
    _OP_DEF(opexe_2, "tanh",                           1,  1,       TST_NUMBER,                      OP_TANH             )
    _OP_DEF(opexe_2, "asinh",                          1,  1,       TST_NUMBER,                      OP_ASINH            )
    _OP_DEF(opexe_2, "acosh",                          1,  1,       TST_NUMBER,                      OP_ACOSH            )
    _OP_DEF(opexe_2, "atanh",                          1,  1,       TST_NUMBER,                      OP_ATANH            )
    _OP_DEF(opexe_2, "sqrt",                           1,  1,       TST_NUMBER,                      OP_SQRT             )
    _OP_DEF(opexe_2, "expt",                           2,  2,       TST_NUMBER,                      OP_EXPT             )
    _OP_DEF(opexe_2, "floor",                          1,  1,       TST_REAL,                        OP_FLOOR            )
    _OP_DEF(opexe_2, "ceiling",                        1,  1,       TST_REAL,                        OP_CEILING          )
    _OP_DEF(opexe_2, "truncate",                       1,  1,       TST_REAL,                        OP_TRUNCATE         )
    _OP_DEF(opexe_2, "round",                          1,  1,       TST_REAL,                        OP_ROUND            )
    ...
    _OP_DEF(opexe_2, "max",                            1,  INF_ARG, TST_REAL,                        OP_MAX              )
    _OP_DEF(opexe_2, "min",                            1,  INF_ARG, TST_REAL,                        OP_MIN              )
    _OP_DEF(opexe_2, "quotient",                       2,  2,       TST_INTEGER,                     OP_QUOTIENT         )
    ...
    _OP_DEF(opexe_3, "<",                              2,  INF_ARG, TST_REAL,                      OP_LESS             )
    _OP_DEF(opexe_3, ">",                              2,  INF_ARG, TST_REAL,                      OP_GRE              )
    _OP_DEF(opexe_3, "<=",                             2,  INF_ARG, TST_REAL,                      OP_LEQ              )
    _OP_DEF(opexe_3, ">=",                             2,  INF_ARG, TST_REAL,                      OP_GEQ              )
    ...
    _OP_DEF(opexe_4, "open-output-string",             0,  0,       0,                               OP_OPEN_OUTPUT_STRING   )
    ...
    _OP_DEF(opexe_6, "object->string",                 1,  1,       TST_NONE,                        OP_OBJECT_TO_STRING )
