...
Widget view_no_axes_menu(void);
Widget view_all_axes_menu(void);
Widget view_just_x_axis_menu(void);
Widget view_all_axes_unlabelled_menu(void);
Widget view_just_x_axis_unlabelled_menu(void);
...
Widget popup_apply_menu(void);
Widget popup_reset_menu(void);
