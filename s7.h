...
int s7_is_number(pointer p);
long s7_ivalue(pointer p);
double s7_rvalue(pointer p);
int s7_is_integer(pointer p);
int s7_is_real(pointer p);
int s7_is_character(pointer p);
long s7_charvalue(pointer p);
int s7_is_vector(pointer p);

int s7_is_port(pointer p);
int s7_is_proc(pointer p);

int s7_is_pair(pointer p);
...
int s7_is_continuation(pointer p);
int s7_is_environment(pointer p);
int s7_is_immutable(pointer p);
