...
io_error_t snd_write_header(const char *name, int type, int srate, int chans, off_t samples, int format, const char *comment, int *loops);
...
Float string_to_Float(const char *str, Float lo, const char *file_name);
