  ...
  if ((nd - bg) >= sd->length)
    XEN_ERROR(XEN_ERROR_TYPE("out-of-range"),
	      XEN_LIST_3(C_TO_XEN_STRING(S_mus_sound_read),
			 ...
			 XEN_LIST_3(end, beg, C_TO_XEN_INT64_T(sd->length))));
  ...
  if (loc >= sd->length)
    XEN_ERROR(XEN_ERROR_TYPE("out-of-range"),
	      XEN_LIST_3(C_TO_XEN_STRING(S_sound_data_ref),
			 ...
			 XEN_LIST_2(frame_num, C_TO_XEN_INT64_T(sd->length))));
...
void mus_sndlib_xen_initialize(void)
{
  ...
  XEN_DEFINE_SET_PROCEDURE(S_sound_data_addB,      g_sound_data_addB_w,            2, 0, 0, H_sound_data_addB);
  XEN_DEFINE_SET_PROCEDURE(S_sound_data_add,       g_sound_data_add_w,             2, 0, 0, H_sound_data_add);
  XEN_DEFINE_SET_PROCEDURE(S_sound_data_offsetB,   g_sound_data_offsetB_w,         2, 0, 0, H_sound_data_offsetB);
  XEN_DEFINE_SET_PROCEDURE(S_sound_data_multiplyB, g_sound_data_multiplyB_w,       2, 0, 0, H_sound_data_multiplyB);
  XEN_DEFINE_SET_PROCEDURE(S_sound_data_multiply,  g_sound_data_multiply_w,        2, 0, 0, H_sound_data_multiply);
  ...
  XEN_DEFINE_SET_PROCEDURE(S_sound_data_setB,      g_sound_data_set_w,             4, 0, 0, H_sound_data_setB);
  XEN_DEFINE_SET_PROCEDURE(S_sound_data_scaleB,    g_sound_data_scaleB_w,          2, 0, 0, H_sound_data_scaleB);
  XEN_DEFINE_SET_PROCEDURE(S_sound_data_fillB,     g_sound_data_fillB_w,           2, 0, 0, H_sound_data_fillB);
  XEN_DEFINE_SET_PROCEDURE(S_sound_data_reverseB,  g_sound_data_reverseB_w,        1, 0, 0, H_sound_data_reverseB);
