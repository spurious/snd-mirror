...
all_args = [1.5, "/hiho", [0, 1], 1234, make_vct(3), make_color(0.95, 0.95, 0.95), :mus_error, make_oscil(440.0), Proc.new {|| true}, make_sound_data(2, 3), :order, 0, 1, -1, false, true, ?c, 0.0, 1.0, -1.0, nil, 3, 4, 2, 8, 16, 64]
length_all_args = 27
