...
#if HAVE_RUBY
  XEN_EVAL_C_STRING((char *)"def axis_info (s c a) false end");
  XEN_EVAL_C_STRING((char *)"def channel_widgets (s c) false end");
  XEN_EVAL_C_STRING((char *)"def color? (a) false end");
  XEN_EVAL_C_STRING((char *)"def color_to_list (a) false end");
  XEN_EVAL_C_STRING((char *)"def current_font () false end");
  XEN_EVAL_C_STRING((char *)"def dialog_widgets () false end");
  XEN_EVAL_C_STRING((char *)"def enved_filter () false end");
  XEN_EVAL_C_STRING((char *)"def main_widgets (s) false end");
  XEN_EVAL_C_STRING((char *)"def make_color (r g b) false end");
  XEN_EVAL_C_STRING((char *)"def menu_widgets (s) false end");
  XEN_EVAL_C_STRING((char *)"def reset_listener_cursor () false end");
  XEN_EVAL_C_STRING((char *)"def sound_widgets (s) false end");
  XEN_EVAL_C_STRING((char *)"def view_regions_dialog () false end");
  XEN_EVAL_C_STRING((char *)"def find_dialog () false end");
  XEN_EVAL_C_STRING((char *)"def x_axis_label () false end");
  XEN_EVAL_C_STRING((char *)"def y_axis_label () false(char *) end");

  XEN_EVAL_C_STRING((char *)"def basic_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_basic_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def colormap () false end");
  XEN_EVAL_C_STRING((char *)"def set_colormap (a) false end");
  XEN_EVAL_C_STRING((char *)"def colormap_size () false end");
  XEN_EVAL_C_STRING((char *)"def set_colormap_size (a) false end");
  XEN_EVAL_C_STRING((char *)"def cursor_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_cursor_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def data_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_data_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def enved_envelope () false end");
  XEN_EVAL_C_STRING((char *)"def set_enved_envelope (a) false end");
  XEN_EVAL_C_STRING((char *)"def enved_waveform_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_enved_waveform_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def filter_control_waveform_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_filter_control_waveform_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def graph_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_graph_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def graph_cursor () false end");
  XEN_EVAL_C_STRING((char *)"def set_graph_cursor (a) false end");
  XEN_EVAL_C_STRING((char *)"def highlight_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_highlight_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def listener_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_listener_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def listener_text_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_listener_text_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def mark_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_mark_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def position_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_position_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def pushed_button_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_pushed_button_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def reset_button_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_reset_button_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def help_button_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_help_button_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def doit_button_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_doit_button_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def doit_again_button_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_doit_again_button_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def quit_button_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_quit_button_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def foreground_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_foreground_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def sash_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_sash_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def selected_data_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_selected_data_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def selected_graph_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_selected_graph_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def selection_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_selection_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def text_focus_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_text_focus_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def zoom_color () false end");
  XEN_EVAL_C_STRING((char *)"def set_zoom_color (a) false end");
  XEN_EVAL_C_STRING((char *)"def widget_size () false end");
  XEN_EVAL_C_STRING((char *)"def set_widget_size (a) false end");
  XEN_EVAL_C_STRING((char *)"def widget_position () false end");
  XEN_EVAL_C_STRING((char *)"def set_widget_position (a) false end");
  XEN_EVAL_C_STRING((char *)"def colormap? (a) false end");
  XEN_EVAL_C_STRING((char *)"def in (a b) false end");
  XEN_EVAL_C_STRING((char *)"def send_mozilla (a) false end");
  XEN_EVAL_C_STRING((char *)"def widget_text (a) false end");

  XEN_EVAL_C_STRING((char *)"def y2position (a) false end");
  XEN_EVAL_C_STRING((char *)"def x2position (a) false end");
  XEN_EVAL_C_STRING((char *)"def position2y (a) false end");
  XEN_EVAL_C_STRING((char *)"def position2x (a) false end");
  XEN_EVAL_C_STRING((char *)"def window_property (a) false end");
  XEN_EVAL_C_STRING((char *)"def snd_gcs (a) false end");
  XEN_EVAL_C_STRING((char *)"def show_widget (a) false end");
  XEN_EVAL_C_STRING((char *)"def listener_selection (a) false end");
  XEN_EVAL_C_STRING((char *)"def hide_widget (a) false end");
  XEN_EVAL_C_STRING((char *)"def focus_widget (a) false end");
  XEN_EVAL_C_STRING((char *)"def fill_rectangle (a) false end");
  XEN_EVAL_C_STRING((char *)"def fill_polygon (a) false end");
  XEN_EVAL_C_STRING((char *)"def draw_string (a) false end");
  XEN_EVAL_C_STRING((char *)"def draw_lines (a) false end");
  XEN_EVAL_C_STRING((char *)"def draw_line (a) false end");
  XEN_EVAL_C_STRING((char *)"def draw_dots (a) false end");
  XEN_EVAL_C_STRING((char *)"def draw_dot (a) false end");
  XEN_EVAL_C_STRING((char *)"def draw_axes (a) false end");
  XEN_EVAL_C_STRING((char *)"def delete_colormap (a) false end");
  XEN_EVAL_C_STRING((char *)"def colormap_ref (a) false end");
  XEN_EVAL_C_STRING((char *)"def colormap_name (a) false end");
  XEN_EVAL_C_STRING((char *)"def add_colormap (a) false end");

  XEN_EVAL_C_STRING((char *)"def make_graph_data (a b c) false end");
  XEN_EVAL_C_STRING((char *)"def graph_data (a b c) false end");

  XEN_EVAL_C_STRING((char *)"$drop_hook = false");
  XEN_EVAL_C_STRING((char *)"$listener_click_hook = false");
  XEN_EVAL_C_STRING((char *)"$mouse_enter_graph_hook = false");
  XEN_EVAL_C_STRING((char *)"$mouse_enter_label_hook = false");
  XEN_EVAL_C_STRING((char *)"$mouse_enter_listener_hook = false");
  XEN_EVAL_C_STRING((char *)"$mouse_enter_text_hook = false");
  XEN_EVAL_C_STRING((char *)"$mouse_leave_graph_hook = false");
  XEN_EVAL_C_STRING((char *)"$mouse_leave_label_hook = false");
  XEN_EVAL_C_STRING((char *)"$mouse_leave_listener_hook = false");
  XEN_EVAL_C_STRING((char *)"$mouse_leave_text_hook = false");
  XEN_EVAL_C_STRING((char *)"$new_widget_hook = false");
  XEN_EVAL_C_STRING((char *)"$orientation_hook = false");
  XEN_EVAL_C_STRING((char *)"$window_property_changed_hook = false");

  XEN_EVAL_C_STRING((char *)"Copy_context = 0");
  XEN_EVAL_C_STRING((char *)"Cursor_context = 3");
  XEN_EVAL_C_STRING((char *)"Lisp_graph = 2");
  XEN_EVAL_C_STRING((char *)"Mark_context = 4");
  XEN_EVAL_C_STRING((char *)"Selection_context = 2");
  XEN_EVAL_C_STRING((char *)"Time_graph = 0");
  XEN_EVAL_C_STRING((char *)"Transform_graph = 1");
#endif
