...
static s7_sig_t pl_t, pl_tirriit, pl_tirriirriit, pl_tirr, pl_tirrirr, pl_tir, pl_tibiit, pl_tt, pl_i, pl_irrrtttttt, pl_irrrrtttrrtttt, pl_ti, pl_bi, pl_iiiiitiiit, pl_iiiiiiiit, pl_iiiiiiiiiiit, pl_iiiiiiit, pl_iiiiiiiiiit, pl_iiiiiit, pl_iiiiiiiiit, pl_tttti, pl_ttttb, pl_ttt, pl_tttt, pl_ttttt, pl_bttt, pl_btt, pl_ttiii, pl_ttii, pl_ttit, pl_ttir, pl_tti, pl_ttitii, pl_ttititiitiii, pl_ttititii, pl_ii, pl_tr, pl_tit, pl_tb, pl_bitt, pl_trrrrrr, pl_trrr, pl_trr, pl_trrrrt, pl_trrrr, pl_trrrrrrrrr, pl_tiiii, pl_tiirrrrt, pl_tiiiit, pl_tiiit, pl_tiiiiiiit, pl_tiiiiiiiit, pl_tiiiiiii, pl_tiiiiiiii, pl_tii, pl_tiiiiiiiiit, pl_tiiiiiiiiiit, pl_tiiiiiiiii, pl_tiiib, pl_tiib, pl_tiit, pl_tiiiiit, pl_tiiiiiit, pl_tiir, pl_tiii, pl_tiiiii, pl_tiiiiii, pl_tiiiiiitt, pl_ttrrr, pl_ttrii, pl_ttrriirr, pl_ttrrii, pl_ttrrrii, pl_ttb, pl_tbbbb, pl_ittit, pl_unused;
  ...
  pl_tirriit = s7_make_signature(s7, 7, s_any, s_integer, s_real, s_real, s_integer, s_integer, s_any);
  pl_tirriirriit = s7_make_signature(s7, 11, s_any, s_integer, s_real, s_real, s_integer, s_integer, s_real, s_real, s_integer, s_integer, s_any);
  pl_tirr = s7_make_signature(s7, 4, s_any, s_integer, s_real, s_real);
  pl_tirrirr = s7_make_signature(s7, 7, s_any, s_integer, s_real, s_real, s_integer, s_real, s_real);
  pl_tir = s7_make_signature(s7, 3, s_any, s_integer, s_real);
  pl_tibiit = s7_make_signature(s7, 6, s_any, s_integer, s_boolean, s_integer, s_integer, s_any);
  pl_tt = s7_make_signature(s7, 2, s_any, s_any);
  pl_i = s7_make_signature(s7, 1, s_integer);
  pl_irrrtttttt = s7_make_signature(s7, 10, s_integer, s_real, s_real, s_real, s_any, s_any, s_any, s_any, s_any, s_any);
  pl_irrrrtttrrtttt = s7_make_signature(s7, 14, s_integer, s_real, s_real, s_real, s_real, s_any, s_any, s_any, s_real, s_real, s_any, s_any, s_any, s_any);
  pl_ti = s7_make_signature(s7, 2, s_any, s_integer);
  pl_bi = s7_make_signature(s7, 2, s_boolean, s_integer);
  pl_iiiiitiiit = s7_make_signature(s7, 10, s_integer, s_integer, s_integer, s_integer, s_integer, s_any, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiiiit = s7_make_signature(s7, 9, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiiiiiiit = s7_make_signature(s7, 12, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiiit = s7_make_signature(s7, 8, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiiiiiit = s7_make_signature(s7, 11, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiit = s7_make_signature(s7, 7, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiiiiit = s7_make_signature(s7, 10, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tttti = s7_make_signature(s7, 5, s_any, s_any, s_any, s_any, s_integer);
  pl_ttttb = s7_make_signature(s7, 5, s_any, s_any, s_any, s_any, s_boolean);
  pl_ttt = s7_make_signature(s7, 3, s_any, s_any, s_any);
  pl_tttt = s7_make_signature(s7, 4, s_any, s_any, s_any, s_any);
  pl_ttttt = s7_make_signature(s7, 5, s_any, s_any, s_any, s_any, s_any);
  pl_bttt = s7_make_signature(s7, 4, s_boolean, s_any, s_any, s_any);
  pl_btt = s7_make_signature(s7, 3, s_boolean, s_any, s_any);
  pl_ttiii = s7_make_signature(s7, 5, s_any, s_any, s_integer, s_integer, s_integer);
  pl_ttii = s7_make_signature(s7, 4, s_any, s_any, s_integer, s_integer);
  pl_ttit = s7_make_signature(s7, 4, s_any, s_any, s_integer, s_any);
  pl_ttir = s7_make_signature(s7, 4, s_any, s_any, s_integer, s_real);
  pl_tti = s7_make_signature(s7, 3, s_any, s_any, s_integer);
  pl_ttitii = s7_make_signature(s7, 6, s_any, s_any, s_integer, s_any, s_integer, s_integer);
  pl_ttititiitiii = s7_make_signature(s7, 12, s_any, s_any, s_integer, s_any, s_integer, s_any, s_integer, s_integer, s_any, s_integer, s_integer, s_integer);
  pl_ttititii = s7_make_signature(s7, 8, s_any, s_any, s_integer, s_any, s_integer, s_any, s_integer, s_integer);
  pl_ii = s7_make_signature(s7, 2, s_integer, s_integer);
  pl_tr = s7_make_signature(s7, 2, s_any, s_real);
  pl_tit = s7_make_signature(s7, 3, s_any, s_integer, s_any);
  pl_tb = s7_make_signature(s7, 2, s_any, s_boolean);
  pl_bitt = s7_make_signature(s7, 4, s_boolean, s_integer, s_any, s_any);
  pl_trrrrrr = s7_make_signature(s7, 7, s_any, s_real, s_real, s_real, s_real, s_real, s_real);
  pl_trrr = s7_make_signature(s7, 4, s_any, s_real, s_real, s_real);
  pl_trr = s7_make_signature(s7, 3, s_any, s_real, s_real);
  pl_trrrrt = s7_make_signature(s7, 6, s_any, s_real, s_real, s_real, s_real, s_any);
  pl_trrrr = s7_make_signature(s7, 5, s_any, s_real, s_real, s_real, s_real);
  pl_trrrrrrrrr = s7_make_signature(s7, 10, s_any, s_real, s_real, s_real, s_real, s_real, s_real, s_real, s_real, s_real);
  pl_tiiii = s7_make_signature(s7, 5, s_any, s_integer, s_integer, s_integer, s_integer);
  pl_tiirrrrt = s7_make_signature(s7, 8, s_any, s_integer, s_integer, s_real, s_real, s_real, s_real, s_any);
  pl_tiiiit = s7_make_signature(s7, 6, s_any, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiit = s7_make_signature(s7, 5, s_any, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiiit = s7_make_signature(s7, 9, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiiiit = s7_make_signature(s7, 10, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiii = s7_make_signature(s7, 8, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer);
  pl_tiiiiiiii = s7_make_signature(s7, 9, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer);
  pl_tii = s7_make_signature(s7, 3, s_any, s_integer, s_integer);
  pl_tiiiiiiiiit = s7_make_signature(s7, 11, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiiiiiit = s7_make_signature(s7, 12, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiiiii = s7_make_signature(s7, 10, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer);
  pl_tiiib = s7_make_signature(s7, 5, s_any, s_integer, s_integer, s_integer, s_boolean);
  pl_tiib = s7_make_signature(s7, 4, s_any, s_integer, s_integer, s_boolean);
  pl_tiit = s7_make_signature(s7, 4, s_any, s_integer, s_integer, s_any);
  pl_tiiiiit = s7_make_signature(s7, 7, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiit = s7_make_signature(s7, 8, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiir = s7_make_signature(s7, 4, s_any, s_integer, s_integer, s_real);
  pl_tiii = s7_make_signature(s7, 4, s_any, s_integer, s_integer, s_integer);
  pl_tiiiii = s7_make_signature(s7, 6, s_any, s_integer, s_integer, s_integer, s_integer, s_integer);
  pl_tiiiiii = s7_make_signature(s7, 7, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer);
  pl_tiiiiiitt = s7_make_signature(s7, 9, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any, s_any);
  pl_ttrrr = s7_make_signature(s7, 5, s_any, s_any, s_real, s_real, s_real);
  pl_ttrii = s7_make_signature(s7, 5, s_any, s_any, s_real, s_integer, s_integer);
  pl_ttrriirr = s7_make_signature(s7, 8, s_any, s_any, s_real, s_real, s_integer, s_integer, s_real, s_real);
  pl_ttrrii = s7_make_signature(s7, 6, s_any, s_any, s_real, s_real, s_integer, s_integer);
  pl_ttrrrii = s7_make_signature(s7, 7, s_any, s_any, s_real, s_real, s_real, s_integer, s_integer);
  pl_ttb = s7_make_signature(s7, 3, s_any, s_any, s_boolean);
  pl_tbbbb = s7_make_signature(s7, 5, s_any, s_boolean, s_boolean, s_boolean, s_boolean);
  pl_ittit = s7_make_signature(s7, 5, s_integer, s_any, s_any, s_integer, s_any);
pl_unused = NULL;
#endif
  ...
  if (!gl_already_inited)
    {
      ...
      Xen_define("gl-version", C_string_to_Xen_string("24-Aug-15"));
