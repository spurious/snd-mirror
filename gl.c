...
static s7_pointer pl_t, pl_tirriit, pl_tirriirriit, pl_tirr, pl_tirrirr, pl_tir, pl_tibiit, pl_tt, pl_i, pl_irrrtttttt, pl_irrrrtttrrtttt, pl_ti, pl_bi, pl_iiiiitiiit, pl_iiiiiiiit, pl_iiiiiiiiiiit, pl_iiiiiiit, pl_iiiiiiiiiit, pl_iiiiiit, pl_iiiiiiiiit, pl_tttti, pl_ttttb, pl_ttt, pl_tttt, pl_ttttt, pl_bttt, pl_btt, pl_ttiii, pl_ttii, pl_ttit, pl_ttir, pl_tti, pl_ttitii, pl_ttititiitiii, pl_ttititii, pl_ii, pl_tr, pl_tit, pl_tb, pl_bitt, pl_trrrrrr, pl_trrr, pl_trr, pl_trrrrt, pl_trrrr, pl_trrrrrrrrr, pl_tiiii, pl_tiirrrrt, pl_tiiiit, pl_tiiit, pl_tiiiiiiit, pl_tiiiiiiiit, pl_tiiiiiii, pl_tiiiiiiii, pl_tii, pl_tiiiiiiiiit, pl_tiiiiiiiiiit, pl_tiiiiiiiii, pl_tiiib, pl_tiib, pl_tiit, pl_tiiiiit, pl_tiiiiiit, pl_tiir, pl_tiii, pl_tiiiii, pl_tiiiiii, pl_tiiiiiitt, pl_ttrrr, pl_ttrii, pl_ttrriirr, pl_ttrrii, pl_ttrrrii, pl_ttb, pl_tbbbb, pl_ittit, pl_unused;
  ...
  pl_t = s7_make_permanent_list(s7, 1, s_any);
  pl_tirriit = s7_make_permanent_list(s7, 7, s_any, s_integer, s_real, s_real, s_integer, s_integer, s_any);
  pl_tirriirriit = s7_make_permanent_list(s7, 11, s_any, s_integer, s_real, s_real, s_integer, s_integer, s_real, s_real, s_integer, s_integer, s_any);
  pl_tirr = s7_make_permanent_list(s7, 4, s_any, s_integer, s_real, s_real);
  pl_tirrirr = s7_make_permanent_list(s7, 7, s_any, s_integer, s_real, s_real, s_integer, s_real, s_real);
  pl_tir = s7_make_permanent_list(s7, 3, s_any, s_integer, s_real);
  pl_tibiit = s7_make_permanent_list(s7, 6, s_any, s_integer, s_boolean, s_integer, s_integer, s_any);
  pl_tt = s7_make_permanent_list(s7, 2, s_any, s_any);
  pl_i = s7_make_permanent_list(s7, 1, s_integer);
  pl_irrrtttttt = s7_make_permanent_list(s7, 10, s_integer, s_real, s_real, s_real, s_any, s_any, s_any, s_any, s_any, s_any);
  pl_irrrrtttrrtttt = s7_make_permanent_list(s7, 14, s_integer, s_real, s_real, s_real, s_real, s_any, s_any, s_any, s_real, s_real, s_any, s_any, s_any, s_any);
  pl_ti = s7_make_permanent_list(s7, 2, s_any, s_integer);
  pl_bi = s7_make_permanent_list(s7, 2, s_boolean, s_integer);
  pl_iiiiitiiit = s7_make_permanent_list(s7, 10, s_integer, s_integer, s_integer, s_integer, s_integer, s_any, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiiiit = s7_make_permanent_list(s7, 9, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiiiiiiit = s7_make_permanent_list(s7, 12, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiiit = s7_make_permanent_list(s7, 8, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiiiiiit = s7_make_permanent_list(s7, 11, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiit = s7_make_permanent_list(s7, 7, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_iiiiiiiiit = s7_make_permanent_list(s7, 10, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tttti = s7_make_permanent_list(s7, 5, s_any, s_any, s_any, s_any, s_integer);
  pl_ttttb = s7_make_permanent_list(s7, 5, s_any, s_any, s_any, s_any, s_boolean);
  pl_ttt = s7_make_permanent_list(s7, 3, s_any, s_any, s_any);
  pl_tttt = s7_make_permanent_list(s7, 4, s_any, s_any, s_any, s_any);
  pl_ttttt = s7_make_permanent_list(s7, 5, s_any, s_any, s_any, s_any, s_any);
  pl_bttt = s7_make_permanent_list(s7, 4, s_boolean, s_any, s_any, s_any);
  pl_btt = s7_make_permanent_list(s7, 3, s_boolean, s_any, s_any);
  pl_ttiii = s7_make_permanent_list(s7, 5, s_any, s_any, s_integer, s_integer, s_integer);
  pl_ttii = s7_make_permanent_list(s7, 4, s_any, s_any, s_integer, s_integer);
  pl_ttit = s7_make_permanent_list(s7, 4, s_any, s_any, s_integer, s_any);
  pl_ttir = s7_make_permanent_list(s7, 4, s_any, s_any, s_integer, s_real);
  pl_tti = s7_make_permanent_list(s7, 3, s_any, s_any, s_integer);
  pl_ttitii = s7_make_permanent_list(s7, 6, s_any, s_any, s_integer, s_any, s_integer, s_integer);
  pl_ttititiitiii = s7_make_permanent_list(s7, 12, s_any, s_any, s_integer, s_any, s_integer, s_any, s_integer, s_integer, s_any, s_integer, s_integer, s_integer);
  pl_ttititii = s7_make_permanent_list(s7, 8, s_any, s_any, s_integer, s_any, s_integer, s_any, s_integer, s_integer);
  pl_ii = s7_make_permanent_list(s7, 2, s_integer, s_integer);
  pl_tr = s7_make_permanent_list(s7, 2, s_any, s_real);
  pl_tit = s7_make_permanent_list(s7, 3, s_any, s_integer, s_any);
  pl_tb = s7_make_permanent_list(s7, 2, s_any, s_boolean);
  pl_bitt = s7_make_permanent_list(s7, 4, s_boolean, s_integer, s_any, s_any);
  pl_trrrrrr = s7_make_permanent_list(s7, 7, s_any, s_real, s_real, s_real, s_real, s_real, s_real);
  pl_trrr = s7_make_permanent_list(s7, 4, s_any, s_real, s_real, s_real);
  pl_trr = s7_make_permanent_list(s7, 3, s_any, s_real, s_real);
  pl_trrrrt = s7_make_permanent_list(s7, 6, s_any, s_real, s_real, s_real, s_real, s_any);
  pl_trrrr = s7_make_permanent_list(s7, 5, s_any, s_real, s_real, s_real, s_real);
  pl_trrrrrrrrr = s7_make_permanent_list(s7, 10, s_any, s_real, s_real, s_real, s_real, s_real, s_real, s_real, s_real, s_real);
  pl_tiiii = s7_make_permanent_list(s7, 5, s_any, s_integer, s_integer, s_integer, s_integer);
  pl_tiirrrrt = s7_make_permanent_list(s7, 8, s_any, s_integer, s_integer, s_real, s_real, s_real, s_real, s_any);
  pl_tiiiit = s7_make_permanent_list(s7, 6, s_any, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiit = s7_make_permanent_list(s7, 5, s_any, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiiit = s7_make_permanent_list(s7, 9, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiiiit = s7_make_permanent_list(s7, 10, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiii = s7_make_permanent_list(s7, 8, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer);
  pl_tiiiiiiii = s7_make_permanent_list(s7, 9, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer);
  pl_tii = s7_make_permanent_list(s7, 3, s_any, s_integer, s_integer);
  pl_tiiiiiiiiit = s7_make_permanent_list(s7, 11, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiiiiiit = s7_make_permanent_list(s7, 12, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiiiii = s7_make_permanent_list(s7, 10, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer);
  pl_tiiib = s7_make_permanent_list(s7, 5, s_any, s_integer, s_integer, s_integer, s_boolean);
  pl_tiib = s7_make_permanent_list(s7, 4, s_any, s_integer, s_integer, s_boolean);
  pl_tiit = s7_make_permanent_list(s7, 4, s_any, s_integer, s_integer, s_any);
  pl_tiiiiit = s7_make_permanent_list(s7, 7, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiiiiiit = s7_make_permanent_list(s7, 8, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any);
  pl_tiir = s7_make_permanent_list(s7, 4, s_any, s_integer, s_integer, s_real);
  pl_tiii = s7_make_permanent_list(s7, 4, s_any, s_integer, s_integer, s_integer);
  pl_tiiiii = s7_make_permanent_list(s7, 6, s_any, s_integer, s_integer, s_integer, s_integer, s_integer);
  pl_tiiiiii = s7_make_permanent_list(s7, 7, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer);
  pl_tiiiiiitt = s7_make_permanent_list(s7, 9, s_any, s_integer, s_integer, s_integer, s_integer, s_integer, s_integer, s_any, s_any);
  pl_ttrrr = s7_make_permanent_list(s7, 5, s_any, s_any, s_real, s_real, s_real);
  pl_ttrii = s7_make_permanent_list(s7, 5, s_any, s_any, s_real, s_integer, s_integer);
  pl_ttrriirr = s7_make_permanent_list(s7, 8, s_any, s_any, s_real, s_real, s_integer, s_integer, s_real, s_real);
  pl_ttrrii = s7_make_permanent_list(s7, 6, s_any, s_any, s_real, s_real, s_integer, s_integer);
  pl_ttrrrii = s7_make_permanent_list(s7, 7, s_any, s_any, s_real, s_real, s_real, s_integer, s_integer);
  pl_ttb = s7_make_permanent_list(s7, 3, s_any, s_any, s_boolean);
  pl_tbbbb = s7_make_permanent_list(s7, 5, s_any, s_boolean, s_boolean, s_boolean, s_boolean);
  pl_ittit = s7_make_permanent_list(s7, 5, s_integer, s_any, s_any, s_integer, s_any);
pl_unused = NULL;
#endif
  ...
  gl_define_procedure(glXCreateGLXPixmap, gxg_glXCreateGLXPixmap_w, 3, 0, 0, H_glXCreateGLXPixmap, pl_tttt);
  gl_define_procedure(glXDestroyContext, gxg_glXDestroyContext_w, 2, 0, 0, H_glXDestroyContext, pl_ttt);
  gl_define_procedure(glXDestroyGLXPixmap, gxg_glXDestroyGLXPixmap_w, 2, 0, 0, H_glXDestroyGLXPixmap, pl_ttt);
  ...
  gl_define_procedure(glXIsDirect, gxg_glXIsDirect_w, 2, 0, 0, H_glXIsDirect, pl_btt);
  gl_define_procedure(glXMakeCurrent, gxg_glXMakeCurrent_w, 3, 0, 0, H_glXMakeCurrent, pl_bttt);
  gl_define_procedure(glXQueryExtension, gxg_glXQueryExtension_w, 1, 2, 0, H_glXQueryExtension, pl_bttt);
  gl_define_procedure(glXQueryVersion, gxg_glXQueryVersion_w, 1, 2, 0, H_glXQueryVersion, pl_bttt);
  gl_define_procedure(glXSwapBuffers, gxg_glXSwapBuffers_w, 2, 0, 0, H_glXSwapBuffers, pl_ttt);
  gl_define_procedure(glXUseXFont, gxg_glXUseXFont_w, 4, 0, 0, H_glXUseXFont, pl_ttiii);
  ...
  gl_define_procedure(glXQueryServerString, gxg_glXQueryServerString_w, 3, 0, 0, H_glXQueryServerString, pl_ttii);
  ...
  gl_define_procedure(glClearColor, gxg_glClearColor_w, 4, 0, 0, H_glClearColor, pl_trrrr);
  ...
  gl_define_procedure(glColorMask, gxg_glColorMask_w, 4, 0, 0, H_glColorMask, pl_tbbbb);
  gl_define_procedure(glAlphaFunc, gxg_glAlphaFunc_w, 2, 0, 0, H_glAlphaFunc, pl_tir);
  gl_define_procedure(glBlendFunc, gxg_glBlendFunc_w, 2, 0, 0, H_glBlendFunc, pl_tii);
  ...
  gl_define_procedure(glLineStipple, gxg_glLineStipple_w, 2, 0, 0, H_glLineStipple, pl_tii);
  gl_define_procedure(glPolygonMode, gxg_glPolygonMode_w, 2, 0, 0, H_glPolygonMode, pl_tii);
  gl_define_procedure(glPolygonOffset, gxg_glPolygonOffset_w, 2, 0, 0, H_glPolygonOffset, pl_trr);
  gl_define_procedure(glPolygonStipple, gxg_glPolygonStipple_w, 1, 0, 0, H_glPolygonStipple, pl_tt);
  gl_define_procedure(glEdgeFlag, gxg_glEdgeFlag_w, 1, 0, 0, H_glEdgeFlag, pl_tb);
  gl_define_procedure(glScissor, gxg_glScissor_w, 4, 0, 0, H_glScissor, pl_tiiii);
  ...
  gl_define_procedure(glRenderMode, gxg_glRenderMode_w, 1, 0, 0, H_glRenderMode, pl_ii);
  ...
  gl_define_procedure(glHint, gxg_glHint_w, 2, 0, 0, H_glHint, pl_tii);
  ...
  gl_define_procedure(glDepthRange, gxg_glDepthRange_w, 2, 0, 0, H_glDepthRange, pl_trr);
  gl_define_procedure(glClearAccum, gxg_glClearAccum_w, 4, 0, 0, H_glClearAccum, pl_trrrr);
  ...
  gl_define_procedure(glOrtho, gxg_glOrtho_w, 6, 0, 0, H_glOrtho, pl_trrrrrr);
  gl_define_procedure(glFrustum, gxg_glFrustum_w, 6, 0, 0, H_glFrustum, pl_trrrrrr);
  gl_define_procedure(glViewport, gxg_glViewport_w, 4, 0, 0, H_glViewport, pl_tiiii);
  ...
  gl_define_procedure(glLoadMatrixd, gxg_glLoadMatrixd_w, 1, 0, 0, H_glLoadMatrixd, pl_tt);
  gl_define_procedure(glLoadMatrixf, gxg_glLoadMatrixf_w, 1, 0, 0, H_glLoadMatrixf, pl_tt);
  gl_define_procedure(glMultMatrixd, gxg_glMultMatrixd_w, 1, 0, 0, H_glMultMatrixd, pl_tt);
  gl_define_procedure(glMultMatrixf, gxg_glMultMatrixf_w, 1, 0, 0, H_glMultMatrixf, pl_tt);
  gl_define_procedure(glRotated, gxg_glRotated_w, 4, 0, 0, H_glRotated, pl_trrrr);
  gl_define_procedure(glRotatef, gxg_glRotatef_w, 4, 0, 0, H_glRotatef, pl_trrrr);
  gl_define_procedure(glScaled, gxg_glScaled_w, 3, 0, 0, H_glScaled, pl_trrr);
  gl_define_procedure(glScalef, gxg_glScalef_w, 3, 0, 0, H_glScalef, pl_trrr);
  gl_define_procedure(glTranslated, gxg_glTranslated_w, 3, 0, 0, H_glTranslated, pl_trrr);
  gl_define_procedure(glTranslatef, gxg_glTranslatef_w, 3, 0, 0, H_glTranslatef, pl_trrr);
  gl_define_procedure(glIsList, gxg_glIsList_w, 1, 0, 0, H_glIsList, pl_bi);
  gl_define_procedure(glDeleteLists, gxg_glDeleteLists_w, 2, 0, 0, H_glDeleteLists, pl_tii);
  gl_define_procedure(glGenLists, gxg_glGenLists_w, 1, 0, 0, H_glGenLists, pl_ii);
  gl_define_procedure(glNewList, gxg_glNewList_w, 2, 0, 0, H_glNewList, pl_tii);
  ...
  gl_define_procedure(glVertex2d, gxg_glVertex2d_w, 2, 0, 0, H_glVertex2d, pl_trr);
  gl_define_procedure(glVertex2f, gxg_glVertex2f_w, 2, 0, 0, H_glVertex2f, pl_trr);
  gl_define_procedure(glVertex2i, gxg_glVertex2i_w, 2, 0, 0, H_glVertex2i, pl_tii);
  gl_define_procedure(glVertex2s, gxg_glVertex2s_w, 2, 0, 0, H_glVertex2s, pl_tii);
  gl_define_procedure(glVertex3d, gxg_glVertex3d_w, 3, 0, 0, H_glVertex3d, pl_trrr);
  gl_define_procedure(glVertex3f, gxg_glVertex3f_w, 3, 0, 0, H_glVertex3f, pl_trrr);
  gl_define_procedure(glVertex3i, gxg_glVertex3i_w, 3, 0, 0, H_glVertex3i, pl_tiii);
  gl_define_procedure(glVertex3s, gxg_glVertex3s_w, 3, 0, 0, H_glVertex3s, pl_tiii);
  gl_define_procedure(glVertex4d, gxg_glVertex4d_w, 4, 0, 0, H_glVertex4d, pl_trrrr);
  gl_define_procedure(glVertex4f, gxg_glVertex4f_w, 4, 0, 0, H_glVertex4f, pl_trrrr);
  gl_define_procedure(glVertex4i, gxg_glVertex4i_w, 4, 0, 0, H_glVertex4i, pl_tiiii);
  gl_define_procedure(glVertex4s, gxg_glVertex4s_w, 4, 0, 0, H_glVertex4s, pl_tiiii);
  gl_define_procedure(glNormal3b, gxg_glNormal3b_w, 3, 0, 0, H_glNormal3b, pl_tiii);
  gl_define_procedure(glNormal3d, gxg_glNormal3d_w, 3, 0, 0, H_glNormal3d, pl_trrr);
  gl_define_procedure(glNormal3f, gxg_glNormal3f_w, 3, 0, 0, H_glNormal3f, pl_trrr);
  gl_define_procedure(glNormal3i, gxg_glNormal3i_w, 3, 0, 0, H_glNormal3i, pl_tiii);
  gl_define_procedure(glNormal3s, gxg_glNormal3s_w, 3, 0, 0, H_glNormal3s, pl_tiii);
  ...
  gl_define_procedure(glColor3b, gxg_glColor3b_w, 3, 0, 0, H_glColor3b, pl_tiii);
  gl_define_procedure(glColor3d, gxg_glColor3d_w, 3, 0, 0, H_glColor3d, pl_trrr);
  gl_define_procedure(glColor3f, gxg_glColor3f_w, 3, 0, 0, H_glColor3f, pl_trrr);
  gl_define_procedure(glColor3i, gxg_glColor3i_w, 3, 0, 0, H_glColor3i, pl_tiii);
  gl_define_procedure(glColor3s, gxg_glColor3s_w, 3, 0, 0, H_glColor3s, pl_tiii);
  gl_define_procedure(glColor3ub, gxg_glColor3ub_w, 3, 0, 0, H_glColor3ub, pl_tiii);
  gl_define_procedure(glColor3ui, gxg_glColor3ui_w, 3, 0, 0, H_glColor3ui, pl_tiii);
  gl_define_procedure(glColor3us, gxg_glColor3us_w, 3, 0, 0, H_glColor3us, pl_tiii);
  gl_define_procedure(glColor4b, gxg_glColor4b_w, 4, 0, 0, H_glColor4b, pl_tiiii);
  gl_define_procedure(glColor4d, gxg_glColor4d_w, 4, 0, 0, H_glColor4d, pl_trrrr);
  gl_define_procedure(glColor4f, gxg_glColor4f_w, 4, 0, 0, H_glColor4f, pl_trrrr);
  gl_define_procedure(glColor4i, gxg_glColor4i_w, 4, 0, 0, H_glColor4i, pl_tiiii);
  gl_define_procedure(glColor4s, gxg_glColor4s_w, 4, 0, 0, H_glColor4s, pl_tiiii);
  gl_define_procedure(glColor4ub, gxg_glColor4ub_w, 4, 0, 0, H_glColor4ub, pl_tiiii);
  gl_define_procedure(glColor4ui, gxg_glColor4ui_w, 4, 0, 0, H_glColor4ui, pl_tiiii);
  gl_define_procedure(glColor4us, gxg_glColor4us_w, 4, 0, 0, H_glColor4us, pl_tiiii);
  ...
  gl_define_procedure(glTexCoord2d, gxg_glTexCoord2d_w, 2, 0, 0, H_glTexCoord2d, pl_trr);
  gl_define_procedure(glTexCoord2f, gxg_glTexCoord2f_w, 2, 0, 0, H_glTexCoord2f, pl_trr);
  gl_define_procedure(glTexCoord2i, gxg_glTexCoord2i_w, 2, 0, 0, H_glTexCoord2i, pl_tii);
  gl_define_procedure(glTexCoord2s, gxg_glTexCoord2s_w, 2, 0, 0, H_glTexCoord2s, pl_tii);
  gl_define_procedure(glTexCoord3d, gxg_glTexCoord3d_w, 3, 0, 0, H_glTexCoord3d, pl_trrr);
  gl_define_procedure(glTexCoord3f, gxg_glTexCoord3f_w, 3, 0, 0, H_glTexCoord3f, pl_trrr);
  gl_define_procedure(glTexCoord3i, gxg_glTexCoord3i_w, 3, 0, 0, H_glTexCoord3i, pl_tiii);
  gl_define_procedure(glTexCoord3s, gxg_glTexCoord3s_w, 3, 0, 0, H_glTexCoord3s, pl_tiii);
  gl_define_procedure(glTexCoord4d, gxg_glTexCoord4d_w, 4, 0, 0, H_glTexCoord4d, pl_trrrr);
  gl_define_procedure(glTexCoord4f, gxg_glTexCoord4f_w, 4, 0, 0, H_glTexCoord4f, pl_trrrr);
  gl_define_procedure(glTexCoord4i, gxg_glTexCoord4i_w, 4, 0, 0, H_glTexCoord4i, pl_tiiii);
  gl_define_procedure(glTexCoord4s, gxg_glTexCoord4s_w, 4, 0, 0, H_glTexCoord4s, pl_tiiii);
  gl_define_procedure(glRasterPos2d, gxg_glRasterPos2d_w, 2, 0, 0, H_glRasterPos2d, pl_trr);
  gl_define_procedure(glRasterPos2f, gxg_glRasterPos2f_w, 2, 0, 0, H_glRasterPos2f, pl_trr);
  gl_define_procedure(glRasterPos2i, gxg_glRasterPos2i_w, 2, 0, 0, H_glRasterPos2i, pl_tii);
  gl_define_procedure(glRasterPos2s, gxg_glRasterPos2s_w, 2, 0, 0, H_glRasterPos2s, pl_tii);
  gl_define_procedure(glRasterPos3d, gxg_glRasterPos3d_w, 3, 0, 0, H_glRasterPos3d, pl_trrr);
  gl_define_procedure(glRasterPos3f, gxg_glRasterPos3f_w, 3, 0, 0, H_glRasterPos3f, pl_trrr);
  gl_define_procedure(glRasterPos3i, gxg_glRasterPos3i_w, 3, 0, 0, H_glRasterPos3i, pl_tiii);
  gl_define_procedure(glRasterPos3s, gxg_glRasterPos3s_w, 3, 0, 0, H_glRasterPos3s, pl_tiii);
  gl_define_procedure(glRasterPos4d, gxg_glRasterPos4d_w, 4, 0, 0, H_glRasterPos4d, pl_trrrr);
  gl_define_procedure(glRasterPos4f, gxg_glRasterPos4f_w, 4, 0, 0, H_glRasterPos4f, pl_trrrr);
  gl_define_procedure(glRasterPos4i, gxg_glRasterPos4i_w, 4, 0, 0, H_glRasterPos4i, pl_tiiii);
  gl_define_procedure(glRasterPos4s, gxg_glRasterPos4s_w, 4, 0, 0, H_glRasterPos4s, pl_tiiii);
  gl_define_procedure(glRectd, gxg_glRectd_w, 4, 0, 0, H_glRectd, pl_trrrr);
  gl_define_procedure(glRectf, gxg_glRectf_w, 4, 0, 0, H_glRectf, pl_trrrr);
  gl_define_procedure(glRecti, gxg_glRecti_w, 4, 0, 0, H_glRecti, pl_tiiii);
  gl_define_procedure(glRects, gxg_glRects_w, 4, 0, 0, H_glRects, pl_tiiii);
  ...
  gl_define_procedure(glDrawArrays, gxg_glDrawArrays_w, 3, 0, 0, H_glDrawArrays, pl_tiii);
  ...
  gl_define_procedure(glLighti, gxg_glLighti_w, 3, 0, 0, H_glLighti, pl_tiii);
  ...
  gl_define_procedure(glLightModeli, gxg_glLightModeli_w, 2, 0, 0, H_glLightModeli, pl_tii);
  gl_define_procedure(glMaterialf, gxg_glMaterialf_w, 3, 0, 0, H_glMaterialf, pl_tiir);
  gl_define_procedure(glMateriali, gxg_glMateriali_w, 3, 0, 0, H_glMateriali, pl_tiii);
  ...
  gl_define_procedure(glColorMaterial, gxg_glColorMaterial_w, 2, 0, 0, H_glColorMaterial, pl_tii);
  gl_define_procedure(glPixelZoom, gxg_glPixelZoom_w, 2, 0, 0, H_glPixelZoom, pl_trr);
  gl_define_procedure(glPixelStoref, gxg_glPixelStoref_w, 2, 0, 0, H_glPixelStoref, pl_tir);
  gl_define_procedure(glPixelStorei, gxg_glPixelStorei_w, 2, 0, 0, H_glPixelStorei, pl_tii);
  gl_define_procedure(glPixelTransferf, gxg_glPixelTransferf_w, 2, 0, 0, H_glPixelTransferf, pl_tir);
  gl_define_procedure(glPixelTransferi, gxg_glPixelTransferi_w, 2, 0, 0, H_glPixelTransferi, pl_tii);
  ...
  gl_define_procedure(glCopyPixels, gxg_glCopyPixels_w, 5, 0, 0, H_glCopyPixels, pl_tiiiii);
  gl_define_procedure(glStencilFunc, gxg_glStencilFunc_w, 3, 0, 0, H_glStencilFunc, pl_tiii);
  gl_define_procedure(glStencilMask, gxg_glStencilMask_w, 1, 0, 0, H_glStencilMask, pl_ti);
  gl_define_procedure(glStencilOp, gxg_glStencilOp_w, 3, 0, 0, H_glStencilOp, pl_tiii);
  ...
  gl_define_procedure(glTexGeni, gxg_glTexGeni_w, 3, 0, 0, H_glTexGeni, pl_tiii);
  ...
  gl_define_procedure(glTexEnvi, gxg_glTexEnvi_w, 3, 0, 0, H_glTexEnvi, pl_tiii);
  ...
  gl_define_procedure(glTexParameteri, gxg_glTexParameteri_w, 3, 0, 0, H_glTexParameteri, pl_tiii);
  ...
  gl_define_procedure(glBindTexture, gxg_glBindTexture_w, 2, 0, 0, H_glBindTexture, pl_tii);
  gl_define_procedure(glAreTexturesResident, gxg_glAreTexturesResident_w, 3, 0, 0, H_glAreTexturesResident, pl_bitt);
  ...
  gl_define_procedure(glCopyTexImage1D, gxg_glCopyTexImage1D_w, 7, 0, 0, H_glCopyTexImage1D, pl_tiiiiiii);
  gl_define_procedure(glCopyTexImage2D, gxg_glCopyTexImage2D_w, 0, 0, 1, H_glCopyTexImage2D, pl_tiiiiiiii);
  gl_define_procedure(glCopyTexSubImage1D, gxg_glCopyTexSubImage1D_w, 6, 0, 0, H_glCopyTexSubImage1D, pl_tiiiiii);
  gl_define_procedure(glCopyTexSubImage2D, gxg_glCopyTexSubImage2D_w, 0, 0, 1, H_glCopyTexSubImage2D, pl_tiiiiiiii);
  ...
  gl_define_procedure(glEvalCoord2d, gxg_glEvalCoord2d_w, 2, 0, 0, H_glEvalCoord2d, pl_trr);
  gl_define_procedure(glEvalCoord2f, gxg_glEvalCoord2f_w, 2, 0, 0, H_glEvalCoord2f, pl_trr);
  gl_define_procedure(glMapGrid1d, gxg_glMapGrid1d_w, 3, 0, 0, H_glMapGrid1d, pl_tirr);
  gl_define_procedure(glMapGrid1f, gxg_glMapGrid1f_w, 3, 0, 0, H_glMapGrid1f, pl_tirr);
  gl_define_procedure(glMapGrid2d, gxg_glMapGrid2d_w, 6, 0, 0, H_glMapGrid2d, pl_tirrirr);
  gl_define_procedure(glMapGrid2f, gxg_glMapGrid2f_w, 6, 0, 0, H_glMapGrid2f, pl_tirrirr);
  gl_define_procedure(glEvalPoint1, gxg_glEvalPoint1_w, 1, 0, 0, H_glEvalPoint1, pl_ti);
  gl_define_procedure(glEvalPoint2, gxg_glEvalPoint2_w, 2, 0, 0, H_glEvalPoint2, pl_tii);
  gl_define_procedure(glEvalMesh1, gxg_glEvalMesh1_w, 3, 0, 0, H_glEvalMesh1, pl_tiii);
  gl_define_procedure(glEvalMesh2, gxg_glEvalMesh2_w, 5, 0, 0, H_glEvalMesh2, pl_tiiiii);
  gl_define_procedure(glFogf, gxg_glFogf_w, 2, 0, 0, H_glFogf, pl_tir);
  gl_define_procedure(glFogi, gxg_glFogi_w, 2, 0, 0, H_glFogi, pl_tii);
  ...
  gl_define_procedure(glCopyTexSubImage3D, gxg_glCopyTexSubImage3D_w, 0, 0, 1, H_glCopyTexSubImage3D, pl_tiiiiiiiii);
  ...
  gl_define_procedure(glCopyColorSubTable, gxg_glCopyColorSubTable_w, 5, 0, 0, H_glCopyColorSubTable, pl_tiiiii);
  gl_define_procedure(glCopyColorTable, gxg_glCopyColorTable_w, 5, 0, 0, H_glCopyColorTable, pl_tiiiii);
  ...
  gl_define_procedure(glBlendColor, gxg_glBlendColor_w, 4, 0, 0, H_glBlendColor, pl_trrrr);
  ...
  gl_define_procedure(glConvolutionParameteri, gxg_glConvolutionParameteri_w, 3, 0, 0, H_glConvolutionParameteri, pl_tiii);
  gl_define_procedure(glCopyConvolutionFilter1D, gxg_glCopyConvolutionFilter1D_w, 5, 0, 0, H_glCopyConvolutionFilter1D, pl_tiiiii);
  gl_define_procedure(glCopyConvolutionFilter2D, gxg_glCopyConvolutionFilter2D_w, 6, 0, 0, H_glCopyConvolutionFilter2D, pl_tiiiiii);
  gl_define_procedure(glSeparableFilter2D, gxg_glSeparableFilter2D_w, 0, 0, 1, H_glSeparableFilter2D, pl_tiiiiiitt);
#if HAVE_GLU
  gl_define_procedure(gluBeginCurve, gxg_gluBeginCurve_w, 1, 0, 0, H_gluBeginCurve, pl_tt);
#ifdef GLU_VERSION_1_2
  gl_define_procedure(gluBeginPolygon, gxg_gluBeginPolygon_w, 1, 0, 0, H_gluBeginPolygon, pl_tt);
#endif
  gl_define_procedure(gluBeginSurface, gxg_gluBeginSurface_w, 1, 0, 0, H_gluBeginSurface, pl_tt);
  gl_define_procedure(gluBeginTrim, gxg_gluBeginTrim_w, 1, 0, 0, H_gluBeginTrim, pl_tt);
  ...
  gl_define_procedure(gluCheckExtension, gxg_gluCheckExtension_w, 2, 0, 0, H_gluCheckExtension, pl_btt);
  gl_define_procedure(gluCylinder, gxg_gluCylinder_w, 6, 0, 0, H_gluCylinder, pl_ttrrrii);
  gl_define_procedure(gluDeleteNurbsRenderer, gxg_gluDeleteNurbsRenderer_w, 1, 0, 0, H_gluDeleteNurbsRenderer, pl_tt);
  gl_define_procedure(gluDeleteQuadric, gxg_gluDeleteQuadric_w, 1, 0, 0, H_gluDeleteQuadric, pl_tt);
#ifdef GLU_VERSION_1_2
  gl_define_procedure(gluDeleteTess, gxg_gluDeleteTess_w, 1, 0, 0, H_gluDeleteTess, pl_tt);
#endif
  gl_define_procedure(gluDisk, gxg_gluDisk_w, 5, 0, 0, H_gluDisk, pl_ttrrii);
  gl_define_procedure(gluEndCurve, gxg_gluEndCurve_w, 1, 0, 0, H_gluEndCurve, pl_tt);
#ifdef GLU_VERSION_1_2
  gl_define_procedure(gluEndPolygon, gxg_gluEndPolygon_w, 1, 0, 0, H_gluEndPolygon, pl_tt);
#endif
  gl_define_procedure(gluEndSurface, gxg_gluEndSurface_w, 1, 0, 0, H_gluEndSurface, pl_tt);
  gl_define_procedure(gluEndTrim, gxg_gluEndTrim_w, 1, 0, 0, H_gluEndTrim, pl_tt);
...
#endif
  gl_define_procedure(gluLoadSamplingMatrices, gxg_gluLoadSamplingMatrices_w, 4, 0, 0, H_gluLoadSamplingMatrices, pl_ttttt);
  gl_define_procedure(gluLookAt, gxg_gluLookAt_w, 0, 0, 1, H_gluLookAt, pl_trrrrrrrrr);
  ...
  gl_define_procedure(gluNurbsCallbackData, gxg_gluNurbsCallbackData_w, 2, 0, 0, H_gluNurbsCallbackData, pl_ttt);
  gl_define_procedure(gluNurbsCurve, gxg_gluNurbsCurve_w, 7, 0, 0, H_gluNurbsCurve, pl_ttititii);
  gl_define_procedure(gluNurbsProperty, gxg_gluNurbsProperty_w, 3, 0, 0, H_gluNurbsProperty, pl_ttir);
  gl_define_procedure(gluNurbsSurface, gxg_gluNurbsSurface_w, 0, 0, 1, H_gluNurbsSurface, pl_ttititiitiii);
  gl_define_procedure(gluOrtho2D, gxg_gluOrtho2D_w, 4, 0, 0, H_gluOrtho2D, pl_trrrr);
  gl_define_procedure(gluPartialDisk, gxg_gluPartialDisk_w, 7, 0, 0, H_gluPartialDisk, pl_ttrriirr);
  gl_define_procedure(gluPerspective, gxg_gluPerspective_w, 4, 0, 0, H_gluPerspective, pl_trrrr);
  gl_define_procedure(gluPickMatrix, gxg_gluPickMatrix_w, 5, 0, 0, H_gluPickMatrix, pl_trrrrt);
  gl_define_procedure(gluProject, gxg_gluProject_w, 0, 0, 1, H_gluProject, pl_irrrtttttt);
  gl_define_procedure(gluPwlCurve, gxg_gluPwlCurve_w, 5, 0, 0, H_gluPwlCurve, pl_ttitii);
  ...
  gl_define_procedure(gluSphere, gxg_gluSphere_w, 4, 0, 0, H_gluSphere, pl_ttrii);
#ifdef GLU_VERSION_1_2
  gl_define_procedure(gluTessBeginContour, gxg_gluTessBeginContour_w, 1, 0, 0, H_gluTessBeginContour, pl_tt);
#endif
#ifdef GLU_VERSION_1_2
  gl_define_procedure(gluTessBeginPolygon, gxg_gluTessBeginPolygon_w, 2, 0, 0, H_gluTessBeginPolygon, pl_ttt);
#endif
  gl_define_procedure(gluTessCallback, gxg_gluTessCallback_w, 3, 0, 0, H_gluTessCallback, pl_ttit);
#ifdef GLU_VERSION_1_2
  gl_define_procedure(gluTessEndContour, gxg_gluTessEndContour_w, 1, 0, 0, H_gluTessEndContour, pl_tt);
#endif
#ifdef GLU_VERSION_1_2
  gl_define_procedure(gluTessEndPolygon, gxg_gluTessEndPolygon_w, 1, 0, 0, H_gluTessEndPolygon, pl_tt);
#endif
#ifdef GLU_VERSION_1_2
  gl_define_procedure(gluTessNormal, gxg_gluTessNormal_w, 4, 0, 0, H_gluTessNormal, pl_ttrrr);
#endif
#ifdef GLU_VERSION_1_2
  gl_define_procedure(gluTessProperty, gxg_gluTessProperty_w, 3, 0, 0, H_gluTessProperty, pl_ttir);
#endif
#ifdef GLU_VERSION_1_2
  gl_define_procedure(gluTessVertex, gxg_gluTessVertex_w, 3, 0, 0, H_gluTessVertex, pl_tttt);
#endif
  gl_define_procedure(gluUnProject, gxg_gluUnProject_w, 0, 0, 1, H_gluUnProject, pl_irrrtttttt);
  gl_define_procedure(gluUnProject4, gxg_gluUnProject4_w, 0, 0, 1, H_gluUnProject4, pl_irrrrtttrrtttt);
#endif
}
  ...
  if (!gl_already_inited)
    {
      ...
      Xen_define("gl-version", C_string_to_Xen_string("19-Aug-15"));
