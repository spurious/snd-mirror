...
static s7_sig_t pl_t, pl_tirriit, pl_tirriirriit, pl_tirrir, pl_tir, pl_tibiit, pl_bt, pl_i, pl_irrrt, pl_irrrrtttrrt, pl_ti, pl_bi, pl_iiiiitiiit, pl_iiiiiiiit, pl_iiiiiiiiiiit, pl_iiiiiiit, pl_iiiiiiiiiit, pl_iiiiiit, pl_iiiiiiiiit, pl_tttti, pl_ttttb, pl_ttit, pl_ttir, pl_tti, pl_ttiti, pl_ttititiiti, pl_ttititi, pl_tr, pl_tit, pl_tb, pl_bit, pl_trrrrt, pl_tiirrrrt, pl_tiiiit, pl_tiiit, pl_tiiiiiiit, pl_tiiiiiiiit, pl_tiiiiiiiiit, pl_tiiiiiiiiiit, pl_tiiib, pl_tiiiiiit, pl_tiir, pl_tiiiiit, pl_tiit, pl_tiib, pl_ttri, pl_ttr, pl_ttrriir, pl_ttrri, pl_ttrrri, pl_ttb, pl_ittit, pl_unused;
  ...
  if (!gl_already_inited)
    {
      ...
      Xen_define("gl-version", C_string_to_Xen_string("26-Aug-15"));
