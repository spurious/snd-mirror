...
static int play_track(snd_state *ss, chan_info **ucps, int chans, int track_num, off_t beg, bool from_gui)
{
  track_fd **fds;
  chan_info **cps;
  snd_info *sp;
...
static void play_mix(snd_state *ss, mix_info *md, off_t beg, bool from_gui)
{
  chan_info *cp;
  snd_info *sp;
  mix_fd *mf;
