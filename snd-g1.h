...
GtkWidget *view_no_axes_menu(void);
GtkWidget *view_all_axes_menu(void);
GtkWidget *view_all_axes_unlabelled_menu(void);
GtkWidget *view_just_x_axis_menu(void);
GtkWidget *view_just_x_axis_unlabelled_menu(void);
...
GtkWidget *popup_apply_menu(void);
GtkWidget *popup_reset_menu(void);
