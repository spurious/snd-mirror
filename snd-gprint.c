  ...
  if (!print_dialog)
    {
      ...
      gtk_box_pack_end(GTK_BOX(DIALOG_ACTION_AREA(print_dialog)), help_button, true, true, 4);
      ...
      gtk_box_pack_start(GTK_BOX(DIALOG_CONTENT_AREA(print_dialog)), print_message, false, false, 6);
      gtk_widget_show(print_message);

      epsbox = gtk_hbox_new(false, 0);
      gtk_box_pack_start(GTK_BOX(DIALOG_CONTENT_AREA(print_dialog)), epsbox, false, false, 6);
      ...
      gtk_box_pack_start(GTK_BOX(DIALOG_CONTENT_AREA(print_dialog)), print_eps_or_lpr, false, false, 6);
      gtk_widget_show(print_eps_or_lpr);
      set_dialog_widget(PRINT_DIALOG, print_dialog);

      print_error_text = make_info_widget();
      gtk_box_pack_end(GTK_BOX(DIALOG_CONTENT_AREA(print_dialog)), print_error_text, false, false, 0);
      gtk_widget_hide(print_error_text);
    }
}
