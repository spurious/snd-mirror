...
/* if markplay, wrong pay button responds?
 * (/ a b) and (- a b)
 ...
 * use gf_parse_arg elsewhere [and cleanup snd-sig]
 */
...
static mus_float_t gf_2_s1(void *p)    {gf *g = (gf *)p; return(g->func_2(g->gen, s7_cell_real(s7_slot_value(g->s1))));}
