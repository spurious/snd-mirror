...
static void define_structs(void)
{
  ...
  XGS_DEFINE_PROCEDURE(frame_right, gxg_frame_right_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(frame_top, gxg_frame_top_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(frame_left, gxg_frame_left_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(gravity, gxg_gravity_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(type_hint, gxg_type_hint_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(decorated, gxg_decorated_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(maximize_initially, gxg_maximize_initially_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(stick_initially, gxg_stick_initially_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(iconify_initially, gxg_iconify_initially_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(destroy_with_parent, gxg_destroy_with_parent_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(modal, gxg_modal_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(has_focus, gxg_has_focus_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(need_default_size, gxg_need_default_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(need_default_position, gxg_need_default_position_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(configure_notify_received, gxg_configure_notify_received_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(allow_grow, gxg_allow_grow_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(allow_shrink, gxg_allow_shrink_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(configure_request_count, gxg_configure_request_count_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(transient_parent, gxg_transient_parent_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(default_widget, gxg_default_widget_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(focus_widget, gxg_focus_widget_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(wm_role, gxg_wm_role_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(saved_state, gxg_saved_state_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(reorderable, gxg_reorderable_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(maybe_reordered, gxg_maybe_reordered_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(show_sort_indicator, gxg_show_sort_indicator_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(dirty, gxg_dirty_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(clickable, gxg_clickable_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(resizable, gxg_resizable_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(sort_order, gxg_sort_order_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(sort_column_changed_signal, gxg_sort_column_changed_signal_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(sort_clicked_signal, gxg_sort_clicked_signal_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(cell_list, gxg_cell_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(drag_y, gxg_drag_y_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(drag_x, gxg_drag_x_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fixed_width, gxg_fixed_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(resized_width, gxg_resized_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(button_request, gxg_button_request_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(requested_width, gxg_requested_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(column_type, gxg_column_type_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(property_changed_signal, gxg_property_changed_signal_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(editable_widget, gxg_editable_widget_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(alignment, gxg_alignment_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(arrow, gxg_arrow_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(destroy, gxg_destroy_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(user_func, gxg_user_func_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tree_view, gxg_tree_view_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(reordered_id, gxg_reordered_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(deleted_id, gxg_deleted_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(has_child_toggled_id, gxg_has_child_toggled_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(inserted_id, gxg_inserted_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(changed_id, gxg_changed_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(zero_ref_count, gxg_zero_ref_count_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child_model, gxg_child_model_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child_flags, gxg_child_flags_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(use_sticky_delay, gxg_use_sticky_delay_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(timer_tag, gxg_timer_tag_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(enabled, gxg_enabled_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(delay, gxg_delay_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tips_data_list, gxg_tips_data_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(active_tips_data, gxg_active_tips_data_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tip_label, gxg_tip_label_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tip_window, gxg_tip_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tip_text, gxg_tip_text_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(widget, gxg_widget_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(style_set, gxg_style_set_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(icon_size_connection, gxg_icon_size_connection_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(style_set_connection, gxg_style_set_connection_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(button_maxh, gxg_button_maxh_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(button_maxw, gxg_button_maxw_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tooltips, gxg_tooltips_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(icon_size, gxg_icon_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(style, gxg_style_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(num_children, gxg_num_children_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(draw_indicator, gxg_draw_indicator_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(log_attr_cache, gxg_log_attr_cache_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(selection_clipboards, gxg_selection_clipboards_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(clipboard_contents_buffers, gxg_clipboard_contents_buffers_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(btree, gxg_btree_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tag_table, gxg_tag_table_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(row_spacing, gxg_row_spacing_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(column_spacing, gxg_column_spacing_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ncols, gxg_ncols_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(nrows, gxg_nrows_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(cols, gxg_cols_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(rows, gxg_rows_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(has_resize_grip, gxg_has_resize_grip_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(grip_window, gxg_grip_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(seq_message_id, gxg_seq_message_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(seq_context_id, gxg_seq_context_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(messages, gxg_messages_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(frame, gxg_frame_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(bottom, gxg_bottom_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(top, gxg_top_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(right, gxg_right_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(left, gxg_left_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(icon_factories, gxg_icon_factories_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(property_cache, gxg_property_cache_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(styles, gxg_styles_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(rc_style, gxg_rc_style_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(attach_count, gxg_attach_count_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(white_gc, gxg_white_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(black_gc, gxg_black_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(text_aa_gc, gxg_text_aa_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(base_gc, gxg_base_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(text_gc, gxg_text_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(mid_gc, gxg_mid_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(dark_gc, gxg_dark_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(light_gc, gxg_light_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(bg_gc, gxg_bg_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fg_gc, gxg_fg_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ythickness, gxg_ythickness_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(xthickness, gxg_xthickness_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(font_desc, gxg_font_desc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(text_aa, gxg_text_aa_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(base, gxg_base_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(mid, gxg_mid_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(dark, gxg_dark_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(light, gxg_light_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(bg, gxg_bg_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fg, gxg_fg_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(translation_domain, gxg_translation_domain_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(modifier, gxg_modifier_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(stock_id, gxg_stock_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(numeric, gxg_numeric_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(timer_calls, gxg_timer_calls_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(timer_step, gxg_timer_step_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(climb_rate, gxg_climb_rate_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(panel, gxg_panel_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(is_mapped, gxg_is_mapped_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(need_map, gxg_need_map_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(have_size, gxg_have_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(focus_in, gxg_focus_in_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(same_app, gxg_same_app_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(xembed_version, gxg_xembed_version_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(plug_widget, gxg_plug_widget_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(plug_window, gxg_plug_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(current_height, gxg_current_height_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(current_width, gxg_current_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(request_height, gxg_request_height_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(request_width, gxg_request_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(have_height, gxg_have_height_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(have_width, gxg_have_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(widgets, gxg_widgets_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(rc_context, gxg_rc_context_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(property_values, gxg_property_values_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(queued_settings, gxg_queued_settings_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(info, gxg_info_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(data, gxg_data_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(format, gxg_format_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(window_placement, gxg_window_placement_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(vscrollbar_visible, gxg_vscrollbar_visible_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(hscrollbar_visible, gxg_hscrollbar_visible_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(vscrollbar_policy, gxg_vscrollbar_policy_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(hscrollbar_policy, gxg_hscrollbar_policy_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(vscrollbar, gxg_vscrollbar_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(hscrollbar, gxg_hscrollbar_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(draw_value, gxg_draw_value_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(digits, gxg_digits_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(max_size, gxg_max_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(position, gxg_position_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(slider_size, gxg_slider_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ysrc, gxg_ysrc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(xsrc, gxg_xsrc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(metric, gxg_metric_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(non_gr_exp_gc, gxg_non_gr_exp_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(backing_store, gxg_backing_store_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(subdivide, gxg_subdivide_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ruler_scale, gxg_ruler_scale_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(pixels_per_unit, gxg_pixels_per_unit_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(abbrev, gxg_abbrev_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(metric_name, gxg_metric_name_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(update_timeout_id, gxg_update_timeout_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(slide_initial_coordinate, gxg_slide_initial_coordinate_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(slide_initial_slider_position, gxg_slide_initial_slider_position_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(update_pending, gxg_update_pending_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(trough_click_forward, gxg_trough_click_forward_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(round_digits, gxg_round_digits_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(slider_end, gxg_slider_end_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(slider_start, gxg_slider_start_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(orientation, gxg_orientation_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(min_slider_size, gxg_min_slider_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(slider_size_fixed, gxg_slider_size_fixed_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(need_recalc, gxg_need_recalc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(has_stepper_d, gxg_has_stepper_d_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(has_stepper_c, gxg_has_stepper_c_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(has_stepper_b, gxg_has_stepper_b_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(has_stepper_a, gxg_has_stepper_a_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(flippable, gxg_flippable_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(inverted, gxg_inverted_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(update_policy, gxg_update_policy_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(adjustment, gxg_adjustment_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(modality_group, gxg_modality_group_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(modality_window, gxg_modality_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(socket_window, gxg_socket_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child2_resize, gxg_child2_resize_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child2_shrink, gxg_child2_shrink_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child1_resize, gxg_child1_resize_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child1_shrink, gxg_child1_shrink_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(position_set, gxg_position_set_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(max_position, gxg_max_position_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(min_position, gxg_min_position_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(last_allocation, gxg_last_allocation_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child1_size, gxg_child1_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(xor_gc, gxg_xor_gc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(handle, gxg_handle_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child2, gxg_child2_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child1, gxg_child1_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(menu_item, gxg_menu_item_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(flags, gxg_flags_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child_has_focus, gxg_child_has_focus_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(need_timer, gxg_need_timer_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(click_child, gxg_click_child_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(in_child, gxg_in_child_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(scrollable, gxg_scrollable_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tab_pos, gxg_tab_pos_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(show_border, gxg_show_border_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(homogeneous, gxg_homogeneous_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(show_tabs, gxg_show_tabs_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tab_vborder, gxg_tab_vborder_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tab_hborder, gxg_tab_hborder_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(menu, gxg_menu_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(focus_tab, gxg_focus_tab_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(first_tab, gxg_first_tab_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(cur_page, gxg_cur_page_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ignore_enter, gxg_ignore_enter_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(menu_flag, gxg_menu_flag_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ignore_leave, gxg_ignore_leave_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(have_xgrab, gxg_have_xgrab_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(have_grab, gxg_have_grab_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(activate_time, gxg_activate_time_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(parent_menu_shell, gxg_parent_menu_shell_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(active_menu_item, gxg_active_menu_item_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(timer, gxg_timer_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(right_justify, gxg_right_justify_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(submenu_direction, gxg_submenu_direction_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(submenu_placement, gxg_submenu_placement_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(show_submenu_indicator, gxg_show_submenu_indicator_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(accelerator_width, gxg_accelerator_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(submenu, gxg_submenu_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(upper_arrow_prelight, gxg_upper_arrow_prelight_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(lower_arrow_visible, gxg_lower_arrow_visible_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(upper_arrow_visible, gxg_upper_arrow_visible_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(scroll_fast, gxg_scroll_fast_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tearoff_active, gxg_tearoff_active_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(torn_off, gxg_torn_off_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(needs_destruction_ref_count, gxg_needs_destruction_ref_count_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(navigation_timeout, gxg_navigation_timeout_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(navigation_region, gxg_navigation_region_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(timeout_id, gxg_timeout_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(scroll_step, gxg_scroll_step_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(saved_scroll_offset, gxg_saved_scroll_offset_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(view_window, gxg_view_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tearoff_adjustment, gxg_tearoff_adjustment_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tearoff_scrollbar, gxg_tearoff_scrollbar_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tearoff_hbox, gxg_tearoff_hbox_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tearoff_window, gxg_tearoff_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(toplevel, gxg_toplevel_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(toggle_size, gxg_toggle_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(position_func_data, gxg_position_func_data_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(position_func, gxg_position_func_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(accel_path, gxg_accel_path_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(old_active_menu_item, gxg_old_active_menu_item_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(parent_menu_item, gxg_parent_menu_item_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(default_sort_destroy, gxg_default_sort_destroy_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(default_sort_data, gxg_default_sort_data_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(default_sort_func, gxg_default_sort_func_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(column_headers, gxg_column_headers_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(order, gxg_order_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(sort_column_id, gxg_sort_column_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(n_columns, gxg_n_columns_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(sort_list, gxg_sort_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tail, gxg_tail_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(root, gxg_root_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(stamp, gxg_stamp_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(freeze_count, gxg_freeze_count_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(scroll_y, gxg_scroll_y_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(scroll_x, gxg_scroll_x_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(visibility, gxg_visibility_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(vadjustment, gxg_vadjustment_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(hadjustment, gxg_hadjustment_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(select_info, gxg_select_info_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(mnemonic_window, gxg_mnemonic_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(mnemonic_widget, gxg_mnemonic_widget_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(layout, gxg_layout_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(effective_attrs, gxg_effective_attrs_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(attrs, gxg_attrs_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(mnemonic_keyval, gxg_mnemonic_keyval_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(use_markup, gxg_use_markup_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(wrap, gxg_wrap_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(jtype, gxg_jtype_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(label, gxg_label_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(extra_data, gxg_extra_data_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(item_type, gxg_item_type_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(callback_action, gxg_callback_action_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(callback, gxg_callback_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(accelerator, gxg_accelerator_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(path, gxg_path_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(gtk_reserved1, gxg_gtk_reserved1_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(has_user_ref_count, gxg_has_user_ref_count_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(keys_listbox, gxg_keys_listbox_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(keys_list, gxg_keys_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(current_device, gxg_current_device_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(axis_items, gxg_axis_items_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(save_button, gxg_save_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(close_button, gxg_close_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(mode_optionmenu, gxg_mode_optionmenu_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(axis_listbox, gxg_axis_listbox_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(axis_list, gxg_axis_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(context_id, gxg_context_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(client_window, gxg_client_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(slave, gxg_slave_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(image, gxg_image_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(deskoff_y, gxg_deskoff_y_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(deskoff_x, gxg_deskoff_x_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(snap_edge, gxg_snap_edge_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(shrink_on_detach, gxg_shrink_on_detach_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child_detached, gxg_child_detached_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(float_window_mapped, gxg_float_window_mapped_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(handle_position, gxg_handle_position_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(float_window, gxg_float_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(bin_window, gxg_bin_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(gamma_text, gxg_gamma_text_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(gamma_dialog, gxg_gamma_dialog_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(gamma, gxg_gamma_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(curve, gxg_curve_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(table, gxg_table_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(label_yalign, gxg_label_yalign_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(label_xalign, gxg_label_xalign_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(label_widget, gxg_label_widget_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(auto_resize, gxg_auto_resize_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(dialog_width, gxg_dialog_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(apply_button, gxg_apply_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fontsel, gxg_fontsel_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(face, gxg_face_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(preview_entry, gxg_preview_entry_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(filter_button, gxg_filter_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(points_button, gxg_points_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(pixels_button, gxg_pixels_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(size_list, gxg_size_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(size_entry, gxg_size_entry_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(face_list, gxg_face_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(font_style_entry, gxg_font_style_entry_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(family_list, gxg_family_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(font_entry, gxg_font_entry_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(button_area, gxg_button_area_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fileop_ren_file, gxg_fileop_ren_file_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fileop_del_file, gxg_fileop_del_file_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fileop_c_dir, gxg_fileop_c_dir_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(cmpl_state, gxg_cmpl_state_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fileop_file, gxg_fileop_file_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fileop_entry, gxg_fileop_entry_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fileop_dialog, gxg_fileop_dialog_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(history_list, gxg_history_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(history_menu, gxg_history_menu_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(history_pulldown, gxg_history_pulldown_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(main_vbox, gxg_main_vbox_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(selection_text, gxg_selection_text_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(selection_entry, gxg_selection_entry_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(file_list, gxg_file_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(dir_list, gxg_dir_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(width_chars, gxg_width_chars_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(invisible_char, gxg_invisible_char_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(drag_start_y, gxg_drag_start_y_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(drag_start_x, gxg_drag_start_x_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(dnd_position, gxg_dnd_position_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(preedit_cursor, gxg_preedit_cursor_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(preedit_length, gxg_preedit_length_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(n_bytes, gxg_n_bytes_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(text_size, gxg_text_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(descent, gxg_descent_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ascent, gxg_ascent_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(scroll_offset, gxg_scroll_offset_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(recompute_idle, gxg_recompute_idle_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(blink_timeout, gxg_blink_timeout_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(mouse_cursor_obscured, gxg_mouse_cursor_obscured_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(editing_canceled, gxg_editing_canceled_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(is_cell_renderer, gxg_is_cell_renderer_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(in_click, gxg_in_click_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(cursor_visible, gxg_cursor_visible_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(activates_default, gxg_activates_default_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(has_frame, gxg_has_frame_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(need_im_reset, gxg_need_im_reset_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(cache_includes_preedit, gxg_cache_includes_preedit_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(cached_layout, gxg_cached_layout_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(selection_bound, gxg_selection_bound_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(current_pos, gxg_current_pos_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(popup_menu, gxg_popup_menu_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(im_context, gxg_im_context_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(text_area, gxg_text_area_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(text_max_length, gxg_text_max_length_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(text_length, gxg_text_length_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(in_drag, gxg_in_drag_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(overwrite_mode, gxg_overwrite_mode_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(draw_data, gxg_draw_data_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(separator, gxg_separator_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(action_area, gxg_action_area_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(vbox, gxg_vbox_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(num_ctlpoints, gxg_num_ctlpoints_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(point, gxg_point_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(num_points, gxg_num_points_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(last, gxg_last_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(grab_point, gxg_grab_point_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(curve_type, gxg_curve_type_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(pixmap, gxg_pixmap_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(max_y, gxg_max_y_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(min_y, gxg_min_y_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(max_x, gxg_max_x_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(min_x, gxg_min_x_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(cursor_type, gxg_cursor_type_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(reallocate_redraws, gxg_reallocate_redraws_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(resize_mode, gxg_resize_mode_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(need_resize, gxg_need_resize_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(border_width, gxg_border_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(focus_child, gxg_focus_child_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(activate_id, gxg_activate_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(current_button, gxg_current_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(use_arrows_always, gxg_use_arrows_always_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(use_arrows, gxg_use_arrows_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(case_sensitive, gxg_case_sensitive_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ok_if_empty, gxg_ok_if_empty_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(value_in_list, gxg_value_in_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(list_change_id, gxg_list_change_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(entry_change_id, gxg_entry_change_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(list, gxg_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(popwin, gxg_popwin_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(popup, gxg_popup_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(entry, gxg_entry_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(help_button, gxg_help_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(cancel_button, gxg_cancel_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ok_button, gxg_ok_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(colorsel, gxg_colorsel_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(always_show_toggle, gxg_always_show_toggle_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(pixbuf_expander_closed, gxg_pixbuf_expander_closed_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(pixbuf_expander_open, gxg_pixbuf_expander_open_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(pixbuf, gxg_pixbuf_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(activatable, gxg_activatable_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(active, gxg_active_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(editable_set, gxg_editable_set_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(strikethrough_set, gxg_strikethrough_set_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(rise_set, gxg_rise_set_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(underline_set, gxg_underline_set_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(background_set, gxg_background_set_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(foreground_set, gxg_foreground_set_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(scale_set, gxg_scale_set_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(editable, gxg_editable_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(strikethrough, gxg_strikethrough_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fixed_height_rows, gxg_fixed_height_rows_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(rise, gxg_rise_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(underline_style, gxg_underline_style_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(extra_attrs, gxg_extra_attrs_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(font_scale, gxg_font_scale_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(font, gxg_font_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(text, gxg_text_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(is_expander, gxg_is_expander_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(visible, gxg_visible_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ypad, gxg_ypad_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(xpad, gxg_xpad_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(use_stock, gxg_use_stock_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(use_underline, gxg_use_underline_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(relief, gxg_relief_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(button_down, gxg_button_down_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(in_button, gxg_in_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(constructed, gxg_constructed_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(activate_timeout, gxg_activate_timeout_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(label_text, gxg_label_text_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(event_window, gxg_event_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(spacing, gxg_spacing_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(child, gxg_child_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(shadow_type, gxg_shadow_type_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(arrow_type, gxg_arrow_type_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(obey_child, gxg_obey_child_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ratio, gxg_ratio_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(yscale, gxg_yscale_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(xscale, gxg_xscale_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(yalign, gxg_yalign_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(xalign, gxg_xalign_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(page_size, gxg_page_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(page_increment, gxg_page_increment_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(step_increment, gxg_step_increment_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(value, gxg_value_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(upper, gxg_upper_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(lower, gxg_lower_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(accel_string_width, gxg_accel_string_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(accel_string, gxg_accel_string_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(accel_group, gxg_accel_group_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(accel_closure, gxg_accel_closure_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(accel_widget, gxg_accel_widget_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(accel_padding, gxg_accel_padding_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(queue_id, gxg_queue_id_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(priv_accels, gxg_priv_accels_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(n_accels, gxg_n_accels_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(acceleratables, gxg_acceleratables_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(modifier_mask, gxg_modifier_mask_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(lock_count, gxg_lock_count_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(modal_hint, gxg_modal_hint_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(input_only, gxg_input_only_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(guffaw_gravity, gxg_guffaw_gravity_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(resize_count, gxg_resize_count_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(update_freeze_count, gxg_update_freeze_count_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(update_area, gxg_update_area_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(paint_stack, gxg_paint_stack_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(bg_pixmap, gxg_bg_pixmap_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(children, gxg_children_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(filters, gxg_filters_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(extension_events, gxg_extension_events_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(user_data, gxg_user_data_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(parent, gxg_parent_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(impl, gxg_impl_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(win_gravity, gxg_win_gravity_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(max_aspect, gxg_max_aspect_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(min_aspect, gxg_min_aspect_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(height_inc, gxg_height_inc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(width_inc, gxg_width_inc_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(base_height, gxg_base_height_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(base_width, gxg_base_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(max_height, gxg_max_height_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(max_width, gxg_max_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(min_height, gxg_min_height_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(min_width, gxg_min_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(override_redirect, gxg_override_redirect_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(wmclass_class, gxg_wmclass_class_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(wmclass_name, gxg_wmclass_name_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(cursor, gxg_cursor_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(window_type, gxg_window_type_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(event_mask, gxg_event_mask_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(title, gxg_title_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(blue_prec, gxg_blue_prec_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(blue_shift, gxg_blue_shift_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(blue_mask, gxg_blue_mask_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(green_prec, gxg_green_prec_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(green_shift, gxg_green_shift_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(green_mask, gxg_green_mask_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(red_prec, gxg_red_prec_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(red_shift, gxg_red_shift_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(red_mask, gxg_red_mask_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(bits_per_rgb, gxg_bits_per_rgb_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(colormap_size, gxg_colormap_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(y2, gxg_y2_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(x2, gxg_x2_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(y1, gxg_y1_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(x1, gxg_x1_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(info_list, gxg_info_list_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(n_colors, gxg_n_colors_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(level, gxg_level_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(keycode, gxg_keycode_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(keys, gxg_keys_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(num_keys, gxg_num_keys_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(num_axes, gxg_num_axes_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(has_cursor, gxg_has_cursor_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(source, gxg_source_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(mem, gxg_mem_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(bits_per_pixel, gxg_bits_per_pixel_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(bpl, gxg_bpl_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(bpp, gxg_bpp_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(depth, gxg_depth_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(byte_order, gxg_byte_order_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(colormap, gxg_colormap_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(join_style, gxg_join_style_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(cap_style, gxg_cap_style_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(line_style, gxg_line_style_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(line_width, gxg_line_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(graphics_exposures, gxg_graphics_exposures_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(clip_y_origin, gxg_clip_y_origin_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(clip_x_origin, gxg_clip_x_origin_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ts_y_origin, gxg_ts_y_origin_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ts_x_origin, gxg_ts_x_origin_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(subwindow_mode, gxg_subwindow_mode_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(clip_mask, gxg_clip_mask_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(stipple, gxg_stipple_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(tile, gxg_tile_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(fill, gxg_fill_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(function, gxg_function_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(context, gxg_context_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(new_window_state, gxg_new_window_state_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(changed_mask, gxg_changed_mask_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(name, gxg_name_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(requestor, gxg_requestor_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(property, gxg_property_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(target, gxg_target_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(selection, gxg_selection_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(atom, gxg_atom_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(height, gxg_height_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(width, gxg_width_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(in, gxg_in_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(focus, gxg_focus_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(detail, gxg_detail_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(mode, gxg_mode_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(subwindow, gxg_subwindow_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(group, gxg_group_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(hardware_keycode, gxg_hardware_keycode_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(string, gxg_string_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(length, gxg_length_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(keyval, gxg_keyval_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(direction, gxg_direction_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(button, gxg_button_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(y_root, gxg_y_root_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(x_root, gxg_x_root_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(device, gxg_device_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(is_hint, gxg_is_hint_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(axes, gxg_axes_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(y, gxg_y_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(x, gxg_x_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(time, gxg_time_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(state, gxg_state_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(count, gxg_count_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(region, gxg_region_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(send_event, gxg_send_event_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(window, gxg_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(start_time, gxg_start_time_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(action, gxg_action_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(suggested_action, gxg_suggested_action_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(actions, gxg_actions_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(targets, gxg_targets_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(dest_window, gxg_dest_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(source_window, gxg_source_window_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(is_source, gxg_is_source_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(protocol, gxg_protocol_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(ref_count, gxg_ref_count_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(type, gxg_type_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(windowing_data, gxg_windowing_data_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(visual, gxg_visual_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(colors, gxg_colors_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(size, gxg_size_w, 1, 0, 0, NULL);
  XGS_DEFINE_PROCEDURE(blue, gxg_blue_w, 1, 0, 0, NULL);
