...
(define (type-it type)
  (if (and (not (string=? type "void"))
	   ...
	   (not (string=? type "gunichar2")) ; guint16
...
(hey "#define C_TO_XEN_gunichar2(Arg) C_TO_XEN_INT(Arg)~%")
...
(hey "#define XEN_gunichar2_P(Arg) XEN_INT_P(Arg)~%")
...
(hey "#define XEN_TO_C_gunichar2(Arg) XEN_TO_C_INT(Arg)~%")
