 ...
 * () (pins 0 3 "oboe.snd" 1.0 :max-peaks 8)           1207     783     660     700    544    5955  10.9    
 * (load "popi.scm")                                  11042    6391    5923    4756   4154   34163   8.2     
 * () (singer 0 .1                                     1015     641     562     674    363    7089  19.5    
 *     (list (list .4 ehh.shp test.glt 523.0 .8 0.0 .01) 
 *           (list .6 oo.shp test.glt 523.0 .7 .1 .01))))
 * (:channels 2)                                        206     139      93     107     72     240   3.4    
 *   (let ((file "oboe.snd")) 
 *     (grani 0 1 .5 "oboe.snd" 
 *       :grain-envelope '(0 0 0.2 0.2 0.5 1 0.8 0.2 1 0))))
 * () (do ((i 0 (+ i 1)))                              7120    5069    4064    3996   3560   21380   6.0     
 *       ((= i 10000)) 
 *     (fm-violin (* i .001) .01 440 .001)))
 * (:channels 2)                                        283     220     158     167    101     286   2.8    
