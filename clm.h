...
Float mus_oscil_bank __P((Float *amps, mus_any **oscils, Float *inputs, int size));
...
Float mus_formant_bank __P((Float *amps, mus_any **formants, Float *inputs, int size));
...
int mus_buffer_full_p __P((mus_any *ptr));
...
mus_any *mus_make_file2sample __P((const char *filename));
Float mus_file2sample __P((mus_any *ptr, int samp, int chan));

Float mus_readin __P((mus_any *rd));
mus_any *mus_make_readin __P((const char *filename, int chan, int start, int direction));
int mus_readin_p __P((mus_any *ptr));
Float mus_increment __P((mus_any *rd));
Float mus_set_increment __P((mus_any *rd, Float dir));
int mus_location __P((mus_any *rd));
int mus_set_location __P((mus_any *rd, int loc));
...
mus_any *mus_make_file2frame __P((const char *filename));
...
mus_any *mus_make_sample2file __P((const char *filename, int chans, int out_format, int out_type));
Float mus_sample2file __P((mus_any *ptr, int samp, int chan, Float val));
int mus_close_file __P((mus_any *ptr));

Float mus_out_any __P((int frame, Float val, int chan, mus_output *IO));
Float mus_outa __P((int frame, Float val, mus_output *IO));
Float mus_outb __P((int frame, Float val, mus_output *IO));
Float mus_outc __P((int frame, Float val, mus_output *IO));
Float mus_outd __P((int frame, Float val, mus_output *IO));

mus_any *mus_make_frame2file __P((const char *filename, int chans, int out_format, int out_type));
...
void mus_fft __P((Float *rl, Float *im, int n, int is));
Float *mus_make_fft_window __P((int type, int size, Float beta));
Float *mus_make_fft_window_with_window __P((int type, int size, Float beta, Float *window));
void mus_convolution __P((Float* rl1, Float* rl2, int n));
void mus_convolve_files __P((const char *file1, const char *file2, Float maxamp, const char *output_file));
...
int mus_ramp __P((mus_any *ptr));
int mus_set_ramp __P((mus_any *ptr, int val));
...
void mus_mix __P((const char *outfile, const char *infile, int out_start, int out_samps, int in_start, mus_mixer *mx, mus_any ***envs));
int mus_file2fltarray __P((const char *filename, int chan, int start, int samples, Float *array));
int mus_fltarray2file __P((const char *filename, Float *ddata, int len, int srate, int channels));

Float mus_bessi0 __P((Float x));
Float mus_apply __P((mus_any *gen, ...));
