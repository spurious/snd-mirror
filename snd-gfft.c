...
{
  snd_state *ss = (snd_state *)clientData;
  in_set_normalize_fft(ss,GTK_TOGGLE_BUTTON(w)->active);
  map_over_chans(ss,calculate_fft,NULL);
}
...
#define Sg_transform_size_widget        "sg-transform-size-widget"
#define Sg_transform_window_widget      "sg-transform-window-widget"
#define Sg_transform_wavelet_widget     "sg-transform-wavelet-widget"
#define Sg_transform_db_widget          "sg-transform-db-widget"
#define Sg_transform_peaks_widget       "sg-transform-peaks-widget"
#define Sg_transform_logfreq_widget     "sg-transform-logfreq-widget"
#define Sg_transform_sono_widget        "sg-transform-sono-widget"
#define Sg_transform_spectro_widget     "sg-transform-spectro-widget"
#define Sg_transform_normal_fft_widget  "sg-transform-normal-fft-widget"
#define Sg_transform_normalize_widget   "sg-transform-normalize-widget"
#define Sg_transform_selection_widget   "sg-transform-selection-widget"
#define Sg_transform_window_beta_widget "sg-transform-window-beta-widget"
#define Sg_transform_graph_widget       "sg-transform-graph-widget"
#define Sg_transform_beta_adjustment    "sg-transform-beta-adjustment"
#define Sg_transform_gc                 "sg-transform-gc"
#define Sg_transform_fgc                "sg-transform-fgc"

static SCM sg_transform_dialog_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)(transform_dialog)));}
static SCM sg_transform_transform_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)transform_list));}
static SCM sg_transform_size_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)size_list));}
static SCM sg_transform_window_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)window_list));}
static SCM sg_transform_wavelet_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)wavelet_list));}
static SCM sg_transform_db_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)db_button));}
static SCM sg_transform_peaks_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)peaks_button));}
static SCM sg_transform_logfreq_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)logfreq_button));}
static SCM sg_transform_sono_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)sono_button));}
static SCM sg_transform_spectro_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)spectro_button));}
static SCM sg_transform_normal_fft_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)normal_fft_button));}
static SCM sg_transform_normalize_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)normalize_button));}
static SCM sg_transform_selection_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)selection_button));}
static SCM sg_transform_window_beta_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)window_beta_scale));}
static SCM sg_transform_graph_widget(void) {return(sgtk_wrap_gtkobj((GtkObject *)graph_drawer));}
static SCM sg_transform_beta_adjustment(void) {return(sgtk_wrap_gtkobj((GtkObject *)beta_adj));}
static SCM sg_transform_gc(void) {return(sgtk_wrap_gtkobj((GtkObject *)gc));}
static SCM sg_transform_fgc(void) {return(sgtk_wrap_gtkobj((GtkObject *)fgc));}
