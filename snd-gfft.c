...
rectangular-window hann-window welch-window parzen-window bartlett-window hamming-window blackman2-window 
      ...
      add_menu_item(fft_popup_menu, "Graph type",     NULL, NULL);

		(list "once" "sonogram" "spectrogram")
		(list graph-once graph-as-sonogram graph-as-spectrogram))


      add_menu_item(fft_popup_menu, "Transform",      NULL, NULL);

	    (list "Fourier" "Wavelet" "Autocorrelate" "Cepstrum" "Walsh" "Haar")

      add_menu_item(fft_popup_menu, "Colormap",       NULL, NULL);
