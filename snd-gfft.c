...
static SCM sg_transform_dialog_widget(void) 
{
  #define H_transform_dialog_widget "HELP"
  return(sgtk_wrap_gtkobj((GtkObject *)(transform_dialog)));
}

void init_fft_widgets(SCM local_doc)
{
  DEFINE_PROC(gh_new_procedure0_0(Sg_transform_dialog_widget,sg_transform_dialog_widget),H_transform_dialog_widget);
}
