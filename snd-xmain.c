...
static XtResource resources[] = {
  {"highlightcol" STR_OR,"Highlightcolor",XmRString,sizeof(char *),XtOffset(sndres *,highlight_color),XmRString,HIGHLIGHT_COLOR},
  {"basiccol" STR_OR,"Basiccolor",XmRString,sizeof(char *),XtOffset(sndres *,basic_color),XmRString,BASIC_COLOR},
  {"positioncol" STR_OR,"Positioncolor",XmRString,sizeof(char *),XtOffset(sndres *,position_color),XmRString,POSITION_COLOR},
  {"zoomcol" STR_OR,"Zoomcolor",XmRString,sizeof(char *),XtOffset(sndres *,zoom_color),XmRString,ZOOM_COLOR},
  {"listenercol" STR_OR,"Listenercolor",XmRString,sizeof(char *),XtOffset(sndres *,listener_color),XmRString,LISTENER_COLOR},
  ...
  {"whitecol" STR_OR,"Whitecolor",XmRString,sizeof(char *),XtOffset(sndres *,white_color),XmRString,WHITE_COLOR},
  {"blackcol" STR_OR,"Blackcolor",XmRString,sizeof(char *),XtOffset(sndres *,black_color),XmRString,BLACK_COLOR},
  {"lightbluecol" STR_OR,"Lightbluecolor",XmRString,sizeof(char *),XtOffset(sndres *,light_blue_color),XmRString,LIGHT_BLUE_COLOR},
  ...
  {"datacol" STR_OR,"Datacolor",XmRString,sizeof(char *),XtOffset(sndres *,data_color),XmRString,DATA_COLOR},
  {"selecteddatacol" STR_OR,"Selecteddatacolor",XmRString,sizeof(char *),XtOffset(sndres *,selected_data_color),XmRString,SELECTED_DATA_COLOR},
  {"markcol" STR_OR,"Markcolor",XmRString,sizeof(char *),XtOffset(sndres *,mark_color),XmRString,MARK_COLOR},
  {"sashcol" STR_OR,"Sashcolor",XmRString,sizeof(char *),XtOffset(sndres *,sash_color),XmRString,SASH_COLOR},
  {"pushedbuttoncol" STR_OR,"Pushedbuttoncolor",XmRString,sizeof(char *),XtOffset(sndres *,pushed_button_color),XmRString,PUSHED_BUTTON_COLOR},
  {"useSchemes","UseSchemes",XmRString,sizeof(char *),XtOffset(sndres *,use_schemes),XmRString,"none"},
  {"buttonFont","ButtonFont",XmRString,sizeof(char *),XtOffset(sndres *,button_font),XmRString,DEFAULT_BUTTON_FONT},
  {"listenerFont","ListenerFont",XmRString,sizeof(char *),XtOffset(sndres *,listener_font),XmRString,NULL},
  {"boldbuttonFont","BoldbuttonFont",XmRString,sizeof(char *),XtOffset(sndres *,bold_button_font),XmRString,DEFAULT_BOLD_BUTTON_FONT},
  {"axisLabelFont","AxisLabelFont",XmRString,sizeof(char *),XtOffset(sndres *,axis_label_font),XmRString,DEFAULT_AXIS_LABEL_FONT},
  {"axisNumbersFont","AxisNumbersFont",XmRString,sizeof(char *),XtOffset(sndres *,axis_numbers_font),XmRString,DEFAULT_AXIS_NUMBERS_FONT},
  {"helpTextFont","HelpTextFont",XmRString,sizeof(char *),XtOffset(sndres *,help_text_font),XmRString,DEFAULT_HELP_TEXT_FONT},
