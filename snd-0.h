...
typedef enum {COLOR_DIALOG, ORIENTATION_DIALOG, ENVED_DIALOG, UNUSED_DIALOG, ANOTHER_UNUSED_DIALOG, TRANSFORM_DIALOG,
	      ...
	      FILE_MIX_DIALOG, EDIT_HEADER_DIALOG, FIND_DIALOG, HELP_DIALOG, THIRD_UNUSED_DIALOG, MIX_DIALOG,
	      PRINT_DIALOG, RECORDER_DIALOG, REGION_DIALOG, POST_IT_DIALOG, OBSOLETE_DIALOG, SELECTION_SAVE_AS_DIALOG,
...
typedef enum {SAMPLE_READER, REGION_READER, MIX_READER} reader_t;
...
enum {BLACK_AND_WHITE_COLORMAP, GRAY_COLORMAP, HOT_COLORMAP, COOL_COLORMAP, BONE_COLORMAP, COPPER_COLORMAP, PINK_COLORMAP, JET_COLORMAP, PRISM_COLORMAP,
      AUTUMN_COLORMAP, WINTER_COLORMAP, SPRING_COLORMAP, SUMMER_COLORMAP, RAINBOW_COLORMAP, FLAG_COLORMAP, PHASES_COLORMAP, BUILTIN_COLORMAPS};
...
typedef enum {SS_ANY_WATCHER, SS_FILE_OPEN_WATCHER, SS_MUS_ERROR_WATCHER} ss_watcher_t;
typedef enum {SS_FILE_OPENED, SS_FILE_CLOSED, SS_MUS_ERROR} ss_watcher_reason_t;
...
#define NUM_CHANNEL_STYLES NOT_A_CHANNEL_STYLE
...
typedef enum {NO_REQUESTOR, FROM_UPDATE, FROM_VIEW_FILES, FROM_DRAG_AND_DROP, FROM_OPEN_DIALOG,
	      ...
	      FROM_OPEN_RECENT_MENU, FROM_OPEN_DIALOG_POPUP} open_requestor_t;

#if MUS_DEBUGGING
enum {PRINT_NOT, PRINT_CHAR, PRINT_CLM, PRINT_REGION, PRINT_SYNC, PRINT_SND_FD, PRINT_FAM_INFO, PRINT_SOUND_DATA, 
      PRINT_SND_DATA, PRINT_ED_LIST, PRINT_ED_FRAGMENT, PRINT_XEN_VALUE, PRINT_PTREE};
#endif
