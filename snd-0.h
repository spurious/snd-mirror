...
typedef enum {COLOR_ORIENTATION_DIALOG, UNUSED_DIALOG_1, ENVED_DIALOG, UNUSED_DIALOG_2, UNUSED_DIALOG_3, TRANSFORM_DIALOG,
	      ...
	      PRINT_DIALOG, UNUSED_DIALOG_5, REGION_DIALOG, POST_IT_DIALOG, CONTROLS_DIALOG, SELECTION_SAVE_AS_DIALOG,
...
typedef enum {NOT_FILING, INPUT_FILING, CHANNEL_FILING, CHANGE_FILING, DOIT_CHANNEL_FILING, SAVE_EDITS_FILING} sp_filing_t;
