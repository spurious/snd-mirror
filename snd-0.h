...
typedef enum {COLOR_DIALOG, ORIENTATION_DIALOG, ENVED_DIALOG, UNUSED_DIALOG, YES_OR_NO_DIALOG, TRANSFORM_DIALOG,
	      ...
	      PRINT_DIALOG, RECORDER_DIALOG, REGION_DIALOG, POST_IT_DIALOG, TRACK_DIALOG, SELECTION_SAVE_AS_DIALOG} snd_dialog_t;
#define NUM_DIALOGS 23
...
typedef enum {AFTER_GRAPH_HOOK, LISP_GRAPH_HOOK, BEFORE_TRANSFORM_HOOK, MIX_RELEASE_HOOK, SAVE_HOOK, MUS_ERROR_HOOK, 
	      ...
	      MARK_HOOK, PREVIOUS_FILES_SELECT_HOOK, DAC_HOOK, STOP_DAC_HOOK, STOP_PLAYING_SELECTION_HOOK, AFTER_APPLY_HOOK, 
