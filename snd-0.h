...
typedef enum {NO_REQUESTOR, FROM_UPDATE, FROM_VIEW_PREVIOUS_FILES, FROM_SAVE_AS_DIALOG, FROM_DRAG_AND_DROP, FROM_OPEN_DIALOG,
	      FROM_RECORDER, FROM_KEYBOARD, FROM_STARTUP, FROM_REGION_EDIT, FROM_SND_NEW_FILE, FROM_OPEN_SOUND, 
	      FROM_OPEN_RAW_SOUND, FROM_VIEW_SOUND, FROM_NEW_SOUND, FROM_RAW_DATA_DIALOG} open_requestor_t;
