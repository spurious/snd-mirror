...
enum {SORT_BY_NAME, SORT_BY_DATE, SORT_BY_SIZE, SORT_BY_ENTRY};
...
typedef enum {AFTER_APPLY_HOOK, AFTER_EDIT_HOOK, AFTER_GRAPH_HOOK, AFTER_OPEN_HOOK, AFTER_SAVE_AS_HOOK, 
	      AFTER_SAVE_STATE_HOOK, AFTER_TRANSFORM_HOOK, BAD_HEADER_HOOK, BEFORE_CLOSE_HOOK, BEFORE_EXIT_HOOK,
	      BEFORE_SAVE_AS_HOOK, BEFORE_SAVE_STATE_HOOK, BEFORE_TRANSFORM_HOOK, CLOSE_HOOK, COLOR_HOOK, 
	      DAC_HOOK, DRAW_MARK_HOOK, DROP_HOOK, DURING_OPEN_HOOK, EDIT_HOOK, ENVED_HOOK, EXIT_HOOK, 
	      GRAPH_HOOK, HELP_HOOK, INITIAL_GRAPH_HOOK, JUST_SOUNDS_HOOK, KEY_PRESS_HOOK, LISP_GRAPH_HOOK, 
	      LISTENER_CLICK_HOOK, MARK_CLICK_HOOK, MARK_DRAG_HOOK, MARK_DRAG_TRIANGLE_HOOK, MARK_HOOK, 
	      MIX_CLICK_HOOK, MIX_DRAG_HOOK, MIX_RELEASE_HOOK, MOUSE_CLICK_HOOK, MOUSE_DRAG_HOOK, MOUSE_ENTER_GRAPH_HOOK, 
	      MOUSE_ENTER_LABEL_HOOK, MOUSE_ENTER_LISTENER_HOOK, MOUSE_ENTER_TEXT_HOOK, MOUSE_LEAVE_GRAPH_HOOK, 
	      MOUSE_LEAVE_LABEL_HOOK, MOUSE_LEAVE_LISTENER_HOOK, MOUSE_LEAVE_TEXT_HOOK, MOUSE_PRESS_HOOK, 
	      MUS_ERROR_HOOK, NAME_CLICK_HOOK, NEW_SOUND_HOOK, NEW_WIDGET_HOOK, OPEN_HOOK, OPEN_RAW_SOUND_HOOK, 
	      OPTIMIZATION_HOOK, ORIENTATION_HOOK, OUTPUT_COMMENT_HOOK, OUTPUT_NAME_HOOK, PLAY_HOOK, PRINT_HOOK, 
	      READ_HOOK, RECORDER_FILE_HOOK, SAVE_HOOK, SAVE_STATE_HOOK, SELECTION_CHANGED_HOOK, SELECT_CHANNEL_HOOK, 
	      SELECT_SOUND_HOOK, SND_ERROR_HOOK, SND_WARNING_HOOK, START_HOOK, START_PLAYING_HOOK, START_PLAYING_SELECTION_HOOK, 
	      STOP_DAC_HOOK, STOP_PLAYING_HOOK, STOP_PLAYING_SELECTION_HOOK, UNDO_HOOK, UPDATE_HOOK, VIEW_FILES_SELECT_HOOK, 
	      WINDOW_PROPERTY_CHANGED_HOOK} eval_hook_t;
