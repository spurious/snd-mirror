...
;;; 2.91.0 (CCAST "GDK_COLORMAP(object)" "GdkColormap*")
;;; 2.91.0 (CCHK "GDK_IS_COLORMAP(object)" "GdkColormap*")
;;;;(CFNC "GType gdk_colormap_get_type void")
;;; 2.91.0 (CFNC "GdkColormap* gdk_colormap_new GdkVisual* visual gboolean allocate")
;;; 2.91.0 (CFNC "GdkColormap* gdk_colormap_get_system void")
;;; 2.91.0 (CFNC "gint gdk_colormap_alloc_colors GdkColormap* colormap GdkColor* colors gint ncolors gboolean writeable gboolean best_match gboolean* success")
;;; 2.91.0 (CFNC "gboolean gdk_colormap_alloc_color GdkColormap* colormap GdkColor* color gboolean writeable gboolean best_match")
...
;;; 2.91.0 (CFNC "GdkVisual* gdk_colormap_get_visual GdkColormap* colormap")
...
;;; 2.91.0 (CFNC "void gdk_drawable_get_size GdkDrawable* drawable gint* [width] gint* [height]")
;;; 2.91.0 (CFNC "void gdk_drawable_set_colormap GdkDrawable* drawable GdkColormap* colormap")
;;; 2.91.0 (CFNC "GdkColormap* gdk_drawable_get_colormap GdkDrawable* drawable")
;;; 2.91.0 (CFNC "GdkVisual* gdk_drawable_get_visual GdkDrawable* drawable")
;;; 2.91.0 (CFNC "gint gdk_drawable_get_depth GdkDrawable* drawable")
...
;;; 2.91.0 (CFNC "void gdk_pixbuf_render_threshold_alpha GdkPixbuf* pixbuf GdkBitmap* bitmap int src_x int src_y int dest_x int dest_y int width int height int alpha_threshold")
...
;;; 2.91.0 (CFNC "void gdk_pixbuf_render_pixmap_and_mask_for_colormap GdkPixbuf* pixbuf GdkColormap* colormap GdkPixmap** [pixmap_return] GdkBitmap** [mask_return] int alpha_threshold")
;;; 2.91.0 (CFNC "void gdk_pixbuf_render_pixmap_and_mask GdkPixbuf* pixbuf GdkPixmap** [pixmap_return] GdkBitmap** [mask_return] int alpha_threshold")
;;; 2.91.0 (CFNC "GdkPixbuf* gdk_pixbuf_get_from_drawable GdkPixbuf* @dest GdkDrawable* src GdkColormap* @cmap int src_x int src_y int dest_x int dest_y int width int height")
...
;;; 2.91.0 (CCAST "GDK_PIXMAP(object)" "GdkPixmap*")
;;; 2.91.0 (CCHK "GDK_IS_PIXMAP(object)" "GdkPixmap*")
...
;;; 2.90.6 (CFNC "void gdk_rgb_find_color GdkColormap* colormap GdkColor* color")
...
;;; 2.91.0 (CFNC "void gdk_window_clear GdkWindow* window")
;;; 2.91.0 (CFNC "void gdk_window_clear_area GdkWindow* window gint x gint y gint width gint height")
;;; 2.91.0 (CFNC "void gdk_window_clear_area_e GdkWindow* window gint x gint y gint width gint height")
...
;;; 2.91.0 (CFNC "void gdk_window_shape_combine_mask GdkWindow* window GdkBitmap* mask gint x gint y")
...
;;; 2.91.0 (CFNC "void gdk_window_set_icon GdkWindow* window GdkWindow* icon_window GdkPixmap* pixmap GdkBitmap* mask")
...
;;; 2.91.0 (CFNC "void gdk_window_get_internal_paint_info GdkWindow* window GdkDrawable** [real_drawable] gint* [x_offset] gint* [y_offset]")
...
;;; 2.91.0 (CFNC "void gdk_window_set_back_pixmap GdkWindow* window GdkPixmap* pixmap gboolean parent_relative")
...
;;; 2.91.0 (CFNC "gboolean gtk_bindings_activate GtkObject* object guint keyval GdkModifierType modifiers")
;;; 2.91.0 (CFNC "gboolean gtk_binding_set_activate GtkBindingSet* binding_set guint keyval GdkModifierType modifiers GtkObject* object")
...
;;; 2.90.1 (CFNC "void gtk_cell_renderer_render GtkCellRenderer* cell GdkWindow* window GtkWidget* widget GdkRectangle* background_area GdkRectangle* cell_area GdkRectangle* expose_area GtkCellRendererState flags")
...
;;; 2.91.0 (CFNC "void gtk_drag_source_set_icon GtkWidget* widget GdkColormap* colormap GdkPixmap* pixmap GdkBitmap* mask")
...
;;; 2.91.0 (CFNC "void gtk_drag_set_icon_pixmap GdkDragContext* context GdkColormap* colormap GdkPixmap* pixmap GdkBitmap* mask gint hot_x gint hot_y")
...
;;; 2.91.0 (CFNC "void gtk_quit_add_destroy guint main_level GtkObject* object")
...
;;; 2.91.0 (CFNC "void gtk_ruler_draw_ticks GtkRuler* ruler")
;;; 2.91.0 (CFNC "void gtk_ruler_draw_pos GtkRuler* ruler")
...
;;; 2.91.0 (CFNC "void gtk_style_apply_default_background GtkStyle* style GdkWindow* window gboolean set_bg GtkStateType state_type GdkRectangle* area gint x gint y gint width gint height")
...
;;; 2.91.0 (CFNC "void gtk_paint_hline GtkStyle* style GdkWindow* window GtkStateType state_type GdkRectangle* area GtkWidget* widget gchar* detail gint x1 gint x2 gint y")
;;; 2.91.0 (CFNC "void gtk_paint_vline GtkStyle* style GdkWindow* window GtkStateType state_type GdkRectangle* area GtkWidget* widget gchar* detail gint y1 gint y2 gint x")
;;; 2.91.0 (CFNC "void gtk_paint_shadow GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height")
...
;;; 2.91.0 (CFNC "void gtk_paint_arrow GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail GtkArrowType arrow_type gboolean fill gint x gint y gint width gint height")
;;; 2.91.0 (CFNC "void gtk_paint_diamond GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height")
;;; 2.91.0 (CFNC "void gtk_paint_box GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height")
;;; 2.91.0 (CFNC "void gtk_paint_flat_box GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height")
;;; 2.91.0 (CFNC "void gtk_paint_check GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height")
;;; 2.91.0 (CFNC "void gtk_paint_option GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height")
;;; 2.91.0 (CFNC "void gtk_paint_tab GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height")
;;; 2.91.0 (CFNC "void gtk_paint_shadow_gap GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height GtkPositionType gap_side gint gap_x gint gap_width")
;;; 2.91.0 (CFNC "void gtk_paint_box_gap GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height GtkPositionType gap_side gint gap_x gint gap_width")
;;; 2.91.0 (CFNC "void gtk_paint_extension GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height GtkPositionType gap_side")
;;; 2.91.0 (CFNC "void gtk_paint_focus GtkStyle* style GdkWindow* window GtkStateType state_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height")
;;; 2.91.0 (CFNC "void gtk_paint_slider GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height GtkOrientation orientation")
;;; 2.91.0 (CFNC "void gtk_paint_handle GtkStyle* style GdkWindow* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y gint width gint height GtkOrientation orientation")
;;; 2.91.0 (CFNC "void gtk_paint_expander GtkStyle* style GdkWindow* window GtkStateType state_type GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y GtkExpanderStyle expander_style")
;;; 2.91.0 (CFNC "void gtk_paint_layout GtkStyle* style GdkWindow* window GtkStateType state_type gboolean use_text GdkRectangle* area GtkWidget* widget gchar* detail gint x gint y PangoLayout* layout")
;;; 2.91.0 (CFNC "void gtk_paint_resize_grip GtkStyle* style GdkWindow* window GtkStateType state_type GdkRectangle* area GtkWidget* widget gchar* detail GdkWindowEdge edge gint x gint y gint width gint height")
...
;;; 2.91.0 (CFNC "GdkPixmap* gtk_tree_view_create_row_drag_icon GtkTreeView* tree_view GtkTreePath* path")
...
;;; 2.91.0 (CFNC "void gtk_widget_size_request GtkWidget* widget GtkRequisition* requisition")
(CFNC "void gtk_widget_size_allocate GtkWidget* widget GtkAllocation* allocation")
;;; 2.91.0 (CFNC "void gtk_widget_get_child_requisition GtkWidget* widget GtkRequisition* requisition")
...
;;; 2.91.0 (CFNC "GdkColormap* gtk_widget_get_colormap GtkWidget* widget")
...
;;; 2.91.0 (CFNC "void gtk_widget_set_colormap GtkWidget* widget GdkColormap* colormap")
...
;;; 2.91.0 (CFNC "void gtk_widget_push_colormap GdkColormap* cmap")
(CFNC "void gtk_widget_push_composite_child void")
(CFNC "void gtk_widget_pop_composite_child void")
;;; 2.91.0 (CFNC "void gtk_widget_pop_colormap void")
...
;;; gtype vals
;;; 2.91.0 (CFNC "void gtk_widget_set_default_colormap GdkColormap* colormap")
(CFNC "GtkStyle* gtk_widget_get_default_style void")
;;; 2.91.0 (CFNC "GdkColormap* gtk_widget_get_default_colormap void")
;;; 2.91.0 (CFNC "GdkVisual* gtk_widget_get_default_visual void")
...
;;; 2.91.0 (CFNC "void gtk_widget_shape_combine_mask GtkWidget* widget GdkBitmap* @shape_mask gint offset_x gint offset_y")
...
;;; 2.90.6 (CLNG "GDK_TYPE_CAP_STYLE")
;;; 2.90.6 (CLNG "GDK_TYPE_FILL")
;;; 2.90.6 (CLNG "GDK_TYPE_FUNCTION")
;;; 2.90.6 (CLNG "GDK_TYPE_JOIN_STYLE")
;;; 2.90.6 (CLNG "GDK_TYPE_LINE_STYLE")
;;; 2.90.6 (CLNG "GDK_TYPE_SUBWINDOW_MODE")
;;; 2.90.6 (CLNG "GDK_TYPE_GC_VALUES_MASK")
;;; 2.90.6 (CLNG "GDK_TYPE_IMAGE_TYPE")
...
;;; 2.90.6 (CLNG "GDK_TYPE_RGB_DITHER")
...
;;; 2.91.0 (CFNC "GdkColormap* gdk_screen_get_default_colormap GdkScreen* screen")
;;; 2.91.0 (CFNC "void gdk_screen_set_default_colormap GdkScreen* screen GdkColormap* colormap")
;;; 2.91.0 (CFNC "GdkColormap* gdk_screen_get_system_colormap GdkScreen* screen")
...
(CLNG "GDK_TYPE_SCREEN")
(CLNG "GDK_TYPE_DISPLAY")
...
(CLNG "GTK_TYPE_FILE_CHOOSER_DIALOG")
(CLNG "GTK_TYPE_FILE_CHOOSER_WIDGET")
(CLNG "GTK_TYPE_TREE_MODEL_FILTER")
(CLNG "GTK_TYPE_ACTION")
(CLNG "GTK_TYPE_ACTION_GROUP")
(CLNG "GTK_TYPE_COMBO_BOX")
(CLNG "GTK_TYPE_COMBO_BOX_ENTRY")
(CLNG "GTK_TYPE_EXPANDER")
(CLNG "GTK_TYPE_FONT_BUTTON")
(CLNG "GTK_TYPE_COLOR_BUTTON")
(CLNG "GTK_TYPE_ENTRY_COMPLETION")
(CLNG "GTK_TYPE_UI_MANAGER")
(CLNG "GTK_TYPE_RADIO_TOOL_BUTTON")
(CLNG "GTK_TYPE_RADIO_ACTION")
(CLNG "GTK_TYPE_SEPARATOR_TOOL_ITEM")
(CLNG "GTK_TYPE_TOGGLE_ACTION")
(CLNG "GTK_TYPE_TOGGLE_TOOL_BUTTON")
(CLNG "GTK_TYPE_FILE_FILTER")
(CLNG "GTK_TYPE_CELL_LAYOUT")
(CLNG "GTK_TYPE_CLIPBOARD")
(CLNG "GTK_TYPE_FILE_CHOOSER")
(CLNG "GTK_TYPE_ICON_INFO")
(CLNG "GTK_TYPE_ICON_THEME")
(CLNG "GTK_TYPE_TOOL_BUTTON")
(CLNG "GTK_TYPE_TOOL_ITEM")
...
(CCAST "GTK_COMBO_BOX_ENTRY(obj)" "GtkComboBoxEntry*")
(CCHK "GTK_IS_COMBO_BOX_ENTRY(obj)" "GtkComboBoxEntry*")
...
(CFNC "void gtk_combo_box_remove_text GtkComboBox* combo_box gint position")
...
(CFNC "GtkWidget* gtk_combo_box_new_text void") 
(CFNC "void gtk_combo_box_append_text GtkComboBox* combo_box gchar* text") 
(CFNC "void gtk_combo_box_insert_text GtkComboBox* combo_box gint position gchar* text") 
(CFNC "void gtk_combo_box_prepend_text GtkComboBox* combo_box gchar* text") 
;;;;(CFNC "GType gtk_combo_box_entry_get_type void") 
;;; (CFNC "GtkWidget* gtk_combo_box_entry_new GtkTreeModel* model gint text_column")
;;; changed in 2.3.1
(CFNC "GtkWidget* gtk_combo_box_entry_new void")
(CFNC "GtkWidget* gtk_combo_box_entry_new_with_model GtkTreeModel* model gint text_column")
(CFNC "void gtk_combo_box_entry_set_text_column GtkComboBoxEntry* entry_box gint text_column")
(CFNC "gint gtk_combo_box_entry_get_text_column GtkComboBoxEntry* entry_box") 
...
(CFNC "GtkWidget* gtk_combo_box_entry_new_text void")
...
;(CFNC "void gtk_rc_reset_styles GtkSettings* settings")
...
;;; 2.91.0 (CFNC "gboolean gtk_cell_view_get_size_of_row GtkCellView* cell_view GtkTreePath* path GtkRequisition* requisition") ; assumes requisition is alloc'd
...
;;; changed in 2.5.1
(CFNC "gchar* gtk_combo_box_get_active_text GtkComboBox* combo_box" 'free)
...
(CLNG "GTK_TYPE_FILE_CHOOSER_BUTTON")
...
(CLNG "GTK_TYPE_MENU_TOOL_BUTTON")
...
;;; 2.90.6 (CLNG "GDK_TYPE_PANGO_RENDERER")
...
(CLNG "GTK_TYPE_RECENT_INFO")
(CLNG "GTK_TYPE_CELL_RENDERER_ACCEL")
(CLNG "GTK_TYPE_ASSISTANT")
(CLNG "GTK_TYPE_CELL_RENDERER_SPIN")
(CLNG "GTK_TYPE_LINK_BUTTON")
(CLNG "GTK_TYPE_RECENT_CHOOSER_DIALOG")
(CLNG "GTK_TYPE_RECENT_CHOOSER")
(CLNG "GTK_TYPE_RECENT_CHOOSER_MENU")
(CLNG "GTK_TYPE_RECENT_CHOOSER_WIDGET")
(CLNG "GTK_TYPE_STATUS_ICON")
(CLNG "GTK_TYPE_RECENT_MANAGER")
(CLNG "GTK_TYPE_RECENT_FILTER")
...
(CFNC "gboolean gtk_style_lookup_color GtkStyle* style gchar* color_name GdkColor* color")
...
;;; 2.90.1 (CFNC-210 "void gtk_notebook_set_window_creation_hook GtkNotebookWindowCreationFunc func gpointer data GDestroyNotify destroy")
...
;;; 2.91.0 (CFNC-210 "void gdk_cairo_set_source_pixmap cairo_t* cr GdkPixmap* pixmap double pixmap_x double pixmap_y")
...
(CFNC-29x "GtkAdjustment* gtk_text_view_get_hadjustment GtkTextView* text_view")
(CFNC-29x "GtkAdjustment* gtk_text_view_get_vadjustment GtkTextView* text_view")
...
(CFNC-29x "void gdk_display_warp_device GdkDisplay* display GdkDevice* device GdkScreen* screen gint x gint y")
...
(CFNC-29x "GtkWidget* gtk_ruler_new GtkOrientation orientation")
...
(CINT-29x "GTK_WRAP_ALLOCATE_FREE" "GtkWrapAllocationMode")
(CINT-29x "GTK_WRAP_ALLOCATE_ALIGNED" "GtkWrapAllocationMode")
(CINT-29x "GTK_WRAP_ALLOCATE_HOMOGENEOUS" "GtkWrapAllocationMode")
(CINT-29x "GTK_WRAP_BOX_SPREAD_START" "GtkWrapBoxSpreading")
(CINT-29x "GTK_WRAP_BOX_SPREAD_END" "GtkWrapBoxSpreading")
(CINT-29x "GTK_WRAP_BOX_SPREAD_EVEN" "GtkWrapBoxSpreading")
(CINT-29x "GTK_WRAP_BOX_SPREAD_EXPAND" "GtkWrapBoxSpreading")
(CINT-29x "GTK_WRAP_BOX_H_EXPAND" "GtkWrapBoxPacking")
;;; 2.91.0 (CINT-29x "GTK_WRAP_BOX_H_FILL" "GtkWrapBoxPacking")
(CINT-29x "GTK_WRAP_BOX_V_EXPAND" "GtkWrapBoxPacking")
;;; 2.91.0 (CINT-29x "GTK_WRAP_BOX_V_FILL" "GtkWrapBoxPacking")
...
(CCAST-29x "GTK_WRAP_BOX(obj)" "GtkWrapBox*")
(CCHK-29x "GTK_IS_WRAP_BOX(obj)" "GtkWrapBox*")
...
(CFNC-29x "void gtk_quit_add_destroy guint main_level GtkWidget* object")
;;; (CFNC-29x "cairo_surface_t* gdk_offscreen_window_get_pixmap GdkOffscreenWindow* window")
(CFNC-29x "void gtk_style_apply_default_background GtkStyle* style cairo_t* cr GdkWindow* window GtkStateType state_type gint x gint y gint width gint height")
(CFNC-29x "void gtk_paint_hline GtkStyle* style cairo_t* cr GtkStateType state_type GtkWidget* widget gchar* detail gint x1 gint x2 gint y")
(CFNC-29x "void gtk_paint_vline GtkStyle* style cairo_t* cr GtkStateType state_type GtkWidget* widget gchar* detail gint y1 gint y2 gint x")
(CFNC-29x "void gtk_paint_shadow GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height")
(CFNC-29x "void gtk_paint_arrow GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail GtkArrowType arrow_type gboolean fill gint x gint y gint width gint height")
(CFNC-29x "void gtk_paint_diamond GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height")
(CFNC-29x "void gtk_paint_box GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height")
(CFNC-29x "void gtk_paint_flat_box GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height")
(CFNC-29x "void gtk_paint_check GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height")
(CFNC-29x "void gtk_paint_option GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height")
(CFNC-29x "void gtk_paint_tab GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height")
(CFNC-29x "void gtk_paint_shadow_gap GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height GtkPositionType gap_side gint gap_x gint gap_width")
(CFNC-29x "void gtk_paint_box_gap GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height GtkPositionType gap_side gint gap_x gint gap_width")
(CFNC-29x "void gtk_paint_extension GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height GtkPositionType gap_side")
(CFNC-29x "void gtk_paint_focus GtkStyle* style cairo_t* cr GtkStateType state_type GtkWidget* widget gchar* detail gint x gint y gint width gint height")
(CFNC-29x "void gtk_paint_slider GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height GtkOrientation orientation")
(CFNC-29x "void gtk_paint_handle GtkStyle* style cairo_t* cr GtkStateType state_type GtkShadowType shadow_type GtkWidget* widget gchar* detail gint x gint y gint width gint height GtkOrientation orientation")
(CFNC-29x "void gtk_paint_expander GtkStyle* style cairo_t* cr GtkStateType state_type GtkWidget* widget gchar* detail gint x gint y GtkExpanderStyle expander_style")
(CFNC-29x "void gtk_paint_layout GtkStyle* style cairo_t* cr GtkStateType state_type gboolean use_text GtkWidget* widget gchar* detail gint x gint y PangoLayout* layout")
(CFNC-29x "void gtk_paint_resize_grip GtkStyle* style cairo_t* cr GtkStateType state_type GtkWidget* widget gchar* detail GdkWindowEdge edge gint x gint y gint width gint height")
...
(CFNC-29x "GtkWidget* gtk_wrap_box_new GtkWrapAllocationMode mode GtkWrapBoxSpreading horizontal_spreading GtkWrapBoxSpreading vertical_spreading guint horizontal_spacing guint vertical_spacing")
(CFNC-29x "void gtk_wrap_box_set_allocation_mode GtkWrapBox* box GtkWrapAllocationMode mode")
(CFNC-29x "GtkWrapAllocationMode gtk_wrap_box_get_allocation_mode GtkWrapBox* box")
(CFNC-29x "void gtk_wrap_box_set_horizontal_spreading GtkWrapBox* box GtkWrapBoxSpreading spreading")
(CFNC-29x "GtkWrapBoxSpreading gtk_wrap_box_get_horizontal_spreading GtkWrapBox* box")
(CFNC-29x "void gtk_wrap_box_set_vertical_spreading GtkWrapBox* box GtkWrapBoxSpreading spreading")
(CFNC-29x "GtkWrapBoxSpreading gtk_wrap_box_get_vertical_spreading GtkWrapBox* box")
(CFNC-29x "void gtk_wrap_box_set_vertical_spacing GtkWrapBox* box guint spacing")
(CFNC-29x "guint gtk_wrap_box_get_vertical_spacing GtkWrapBox* box")
(CFNC-29x "void gtk_wrap_box_set_horizontal_spacing GtkWrapBox* box guint spacing")
(CFNC-29x "guint gtk_wrap_box_get_horizontal_spacing GtkWrapBox* box")
(CFNC-29x "void gtk_wrap_box_set_minimum_line_children GtkWrapBox* box guint n_children")
(CFNC-29x "guint gtk_wrap_box_get_minimum_line_children GtkWrapBox* box")
(CFNC-29x "void gtk_wrap_box_set_natural_line_children GtkWrapBox* box guint n_children")
(CFNC-29x "guint gtk_wrap_box_get_natural_line_children GtkWrapBox* box")
(CFNC-29x "void gtk_wrap_box_insert_child GtkWrapBox* box GtkWidget* widget gint index GtkWrapBoxPacking packing")
(CFNC-29x "void gtk_wrap_box_reorder_child GtkWrapBox* box GtkWidget* widget guint index")
