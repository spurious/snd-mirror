...
;;; out 2.3 (CFNC "GtkWidget* gtk_toolbar_append_item GtkToolbar* toolbar char* text char* tooltip_text char* tooltip_private_text GtkWidget* icon GtkSignalFunc func lambda_data #func_info")
;;; out 2.3 (CFNC "GtkWidget* gtk_toolbar_prepend_item GtkToolbar* toolbar char* text char* tooltip_text char* tooltip_private_text GtkWidget* icon GtkSignalFunc func lambda_data #func_info")
;;; out 2.3 (CFNC "GtkWidget* gtk_toolbar_insert_item GtkToolbar* toolbar char* text char* tooltip_text char* tooltip_private_text GtkWidget* icon GtkSignalFunc func lambda_data func_info gint position")
;;; out 2.3 (CFNC "GtkWidget* gtk_toolbar_insert_stock GtkToolbar* toolbar gchar* stock_id char* tooltip_text char* tooltip_private_text GtkSignalFunc func lambda_data func_info gint position")
...
;;; out 2.3 (CFNC "GtkWidget* gtk_toolbar_append_element GtkToolbar* toolbar GtkToolbarChildType type GtkWidget* widget char* text char* tooltip_text char* tooltip_private_text GtkWidget* icon GtkSignalFunc func lambda_data #func_info")
;;; out 2.3 (CFNC "GtkWidget* gtk_toolbar_prepend_element GtkToolbar* toolbar GtkToolbarChildType type GtkWidget* widget char* text char* tooltip_text char* tooltip_private_text GtkWidget* icon GtkSignalFunc func lambda_data #func_info")
;;; out 2.3 (CFNC "GtkWidget* gtk_toolbar_insert_element GtkToolbar* toolbar GtkToolbarChildType type GtkWidget* @widget char* text char* tooltip_text char* tooltip_private_text GtkWidget* icon GtkSignalFunc func lambda_data func_info gint position")
