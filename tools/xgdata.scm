...
(CINT-gtk2 "GDK_INPUT_OUTPUT" "GdkWindowClass")
(CINT-gtk2 "GDK_INPUT_ONLY" "GdkWindowClass")

(CINT-29x "GDK_INPUT_OUTPUT" "GdkWindowWindowClass")
(CINT-29x "GDK_INPUT_ONLY" "GdkWindowWindowClass")
...
;;; not sure whether these need to be in xg
