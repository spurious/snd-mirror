...
(CINT "GDK_RGB_DITHER_NONE" "GdkRgbDither")
(CINT "GDK_RGB_DITHER_NORMAL" "GdkRgbDither")
(CINT "GDK_RGB_DITHER_MAX" "GdkRgbDither")
...
;;; (CFNC "void gtk_rc_style_ref GtkRcStyle* rc_style") ; out 2.11.0
...
;; these are for "theme engines" -- I can't see any use for them in this context
...
;;; 2.11.6 ;;;;(CFNC "GtkType gtk_tooltips_get_type void")
...
;;; (CFNC-250 "gchar* gtk_about_dialog_get_name GtkAboutDialog* about") ; name changed in 2.11.0
...
;;; order matters here
(CFNC-211 "gchar* gtk_about_dialog_get_program_name GtkAboutDialog* about")
(CFNC-211 "void gtk_about_dialog_set_program_name GtkAboutDialog* about gchar* name")
...
;;; out 2.11.6 (CFNC-256 "void gtk_menu_tool_button_set_arrow_tooltip GtkMenuToolButton* button GtkTooltips* tooltips gchar* tip_text gchar* tip_private")
...
;;; (CFNC-290 "void gtk_notebook_set_group_id GtkNotebook* notebook gint group_id") ; out 2.11.0
;;; (CFNC-290 "gint gtk_notebook_get_group_id GtkNotebook* notebook")
(CFNC-211 "void gtk_notebook_set_group GtkNotebook* notebook gpointer group")
(CFNC-211 "gpointer gtk_notebook_get_group GtkNotebook* notebook")
...
;;; out 12.0 (CFNC-290 "void gtk_recent_chooser_set_show_numbers GtkRecentChooser* chooser gboolean show_numbers")
...
;;; out 2.11.4 (CFNC-290 "GtkRecentManager* gtk_recent_manager_get_for_screen GdkScreen* screen")
;;; out 2.11.4 (CFNC-290 "void gtk_recent_manager_set_screen GtkRecentManager* manager GdkScreen* screen")
...
(CINT-211 "GTK_PRINT_ERROR_INVALID_FILE" "GtkPrintError")
...
(CAIRO-FUNC "cairo_font_type_t cairo_font_face_get_type cairo_font_face_t* font_face")
...
(CAIRO-FUNC "cairo_font_type_t cairo_scaled_font_get_type cairo_scaled_font_t* scaled_font")
...
(CAIRO-FUNC "cairo_surface_type_t cairo_surface_get_type cairo_surface_t* surface")
(CAIRO-FUNC "cairo_content_t cairo_surface_get_content cairo_surface_t* surface")
(CAIRO-FUNC "gpointer cairo_surface_get_user_data cairo_surface_t* surface cairo_user_data_key_t* key")
(CAIRO-FUNC "cairo_status_t cairo_surface_set_user_data cairo_surface_t* surface cairo_user_data_key_t* key gpointer user_data cairo_destroy_func_t destroy")
...
(CAIRO-FUNC "cairo_pattern_type_t cairo_pattern_get_type cairo_pattern_t* pattern")
...
(CFNC-210 "void pango_cairo_context_set_font_options PangoContext* context cairo_font_options_t* options")
(CFNC-210 "cairo_font_options_t* pango_cairo_context_get_font_options PangoContext* context" 'const-return)
(CFNC-210 "void pango_cairo_context_set_resolution PangoContext* context gdouble dpi")
(CFNC-210 "gdouble pango_cairo_context_get_resolution PangoContext* context")
(CFNC-210 "void pango_cairo_show_glyph_string cairo_t* cr PangoFont* font PangoGlyphString* glyphs")
(CFNC-210 "void pango_cairo_show_layout_line cairo_t* cr PangoLayoutLine* line")
(CFNC-210 "void pango_cairo_show_layout cairo_t* cr PangoLayout* layout")
(CFNC-210 "void pango_cairo_show_error_underline cairo_t* cr gdouble x gdouble y gdouble width gdouble height")
(CFNC-210 "void pango_cairo_glyph_string_path cairo_t* cr PangoFont* font PangoGlyphString* glyphs")
(CFNC-210 "void pango_cairo_layout_line_path cairo_t* cr PangoLayoutLine* line")
...
(CINT-211 "GTK_DRAG_RESULT_SUCCESS" "GtkDragResult")
(CINT-211 "GTK_DRAG_RESULT_NO_TARGET" "GtkDragResult")
(CINT-211 "GTK_DRAG_RESULT_USER_CANCELLED" "GtkDragResult")
(CINT-211 "GTK_DRAG_RESULT_TIMEOUT_EXPIRED" "GtkDragResult")
(CINT-211 "GTK_DRAG_RESULT_GRAB_BROKEN" "GtkDragResult")
(CINT-211 "GTK_DRAG_RESULT_ERROR" "GtkDragResult")


(CFNC-211 "gchar* gdk_color_to_string GdkColor* color")
(CFNC-211 "void gdk_event_request_motions GdkEventMotion* event")
(CFNC-211 "void gdk_notify_startup_complete_with_id gchar* startup_id")

(CFNC-211 "guint gdk_threads_add_idle_full gint priority GSourceFunc func lambda_data func_data GDestroyNotify notify")
(CFNC-211 "guint gdk_threads_add_idle GSourceFunc func lambda_data #func_data")
(CFNC-211 "guint gdk_threads_add_timeout_full gint priority guint interval GSourceFunc func lambda_data func_data GDestroyNotify notify")
(CFNC-211 "guint gdk_threads_add_timeout guint interval GSourceFunc func lambda_data #func_data")
...
(CFNC-211 "void gtk_binding_entry_skip GtkBindingSet* binding_set guint keyval GdkModifierType modifiers")
(CFNC-211 "GList* gtk_cell_layout_get_cells GtkCellLayout* cell_layout")
(CFNC-211 "void gtk_entry_completion_set_inline_selection GtkEntryCompletion* completion gboolean inline_selection")
(CFNC-211 "gboolean gtk_entry_completion_get_inline_selection GtkEntryCompletion* completion")
(CFNC-211 "gchar* gtk_entry_completion_get_completion_prefix GtkEntryCompletion* completion" 'const)
(CFNC-211 "void gtk_entry_set_cursor_hadjustment GtkEntry* entry GtkAdjustment* adjustment")
(CFNC-211 "GtkAdjustment* gtk_entry_get_cursor_hadjustment GtkEntry* entry")
(CFNC-211 "GList* gtk_icon_theme_list_contexts GtkIconTheme* icon_theme")
(CFNC-211 "GtkPageSetup* gtk_page_setup_new_from_file gchar* file_name GError** [error]")
(CFNC-211 "gboolean gtk_page_setup_to_file GtkPageSetup* setup char* file_name GError** [error]")
;(CFNC-211 "GtkPageSetup* gtk_page_setup_new_from_key_file GKeyFile* key_file gchar* group_name GError** [error]")
;(CFNC-211 "void gtk_page_setup_to_key_file GtkPageSetup* setup GKeyFile* key_file gchar* group_name")
;(CFNC-211 "GtkPaperSize* gtk_paper_size_new_from_key_file GKeyFile* key_file gchar* group_name GError** [error]")
;(CFNC-211 "void gtk_paper_size_to_key_file GtkPaperSize* size GKeyFile* key_file gchar* group_name")
;(CFNC-211 "GList* gtk_printer_list_papers GtkPrinter* printer")
;(CFNC-211 "gboolean gtk_printer_has_details GtkPrinter* printer")
;(CFNC-211 "void gtk_printer_request_details GtkPrinter* printer")
;(CFNC-211 "GtkPrintCapabilities gtk_printer_get_capabilities GtkPrinter* printer")
(CFNC-211 "GtkPrintSettings* gtk_print_settings_new_from_file gchar* file_name GError** [error]")
(CFNC-211 "gboolean gtk_print_settings_to_file GtkPrintSettings* settings gchar* file_name GError** [error]")
;(CFNC-211 "GtkPrintSettings* gtk_print_settings_new_from_key_file GKeyFile* key_file gchar* group_name GError** [error]")
;(CFNC-211 "void gtk_print_settings_to_key_file GtkPrintSettings* settings GKeyFile* key_file gchar* group_name")
(CFNC-211 "void gtk_range_set_show_fill_level GtkRange* range  gboolean show_fill_level")
(CFNC-211 "gboolean gtk_range_get_show_fill_level GtkRange* range")
(CFNC-211 "void gtk_range_set_restrict_to_fill_level GtkRange* range  gboolean restrict_to_fill_level")
(CFNC-211 "gboolean gtk_range_get_restrict_to_fill_level GtkRange* range")
(CFNC-211 "void gtk_range_set_fill_level GtkRange* range  gdouble fill_level")
(CFNC-211 "gdouble gtk_range_get_fill_level GtkRange* range")
(CFNC-211 "void gtk_status_icon_set_screen GtkStatusIcon* status_icon GdkScreen* screen")
(CFNC-211 "GdkScreen* gtk_status_icon_get_screen GtkStatusIcon* status_icon")
(CFNC-211 "void gtk_tree_view_set_show_expanders GtkTreeView* tree_view gboolean enabled")
(CFNC-211 "gboolean gtk_tree_view_get_show_expanders GtkTreeView* tree_view")
(CFNC-211 "void gtk_tree_view_set_level_indentation GtkTreeView* tree_view gint indentation")
(CFNC-211 "gint gtk_tree_view_get_level_indentation GtkTreeView* tree_view")
(CFNC-211 "gboolean gtk_widget_keynav_failed GtkWidget* widget GtkDirectionType direction")
(CFNC-211 "void gtk_widget_error_bell GtkWidget* widget")
(CFNC-211 "void gtk_widget_set_tooltip_window GtkWidget* widget GtkWindow* custom_window")
(CFNC-211 "GtkWindow* gtk_widget_get_tooltip_window GtkWidget* widget")
(CFNC-211 "void gtk_widget_trigger_tooltip_query GtkWidget* widget")
...
(CFNC-211 "gboolean gdk_display_supports_composite GdkDisplay* display")
(CFNC-211 "void gdk_window_set_composited GdkWindow* window gboolean composited")
(CFNC-211 "void gtk_text_buffer_add_mark GtkTextBuffer* buffer GtkTextMark* mark GtkTextIter* where")
;;;(CFNC-211 "void gtk_text_layout_invalidate_cursors GtkTextLayout* layout GtkTextIter* start GtkTextIter* end")
;;;(CFNC-211 "void gtk_text_layout_cursors_changed GtkTextLayout* layout gint y gint old_height gint new_height")
(CFNC-211 "GtkTextMark* gtk_text_mark_new gchar* name gboolean left_gravity")
;;; this enum is commented out above (CINT-211 "GTK_PRINT_CAPABILITY_NUMBER_UP" "GtkPrintCapabilities")


;;; for 2.11.2:

(CFNC-211 "GtkWidget* gtk_tree_view_column_get_tree_view GtkTreeViewColumn* tree_column")


;;; for 2.11.3
;;; new headers gtkbuildable builder (XML UI builder -- not important)

(CSTR-211 "GTK_STOCK_DISCARD")
;;;(CFNC-211 "void gtk_text_layout_set_overwrite_mode GtkTextLayout* layout gboolean overwrite")
(CFNC-211 "void gtk_tooltip_set_text GtkTooltip* tooltip gchar* text" 'const)
(CFNC-211 "void gtk_tree_view_convert_widget_to_tree_coords GtkTreeView* tree_view gint wx gint wy gint* [tx] gint* [ty]")
(CFNC-211 "void gtk_tree_view_convert_tree_to_widget_coords GtkTreeView* tree_view gint tx gint ty gint* [wx] gint* [wy]")
(CFNC-211 "void gtk_tree_view_convert_widget_to_bin_window_coords GtkTreeView* tree_view gint wx gint wy gint* [bx] gint* [by]")
(CFNC-211 "void gtk_tree_view_convert_bin_window_to_widget_coords GtkTreeView* tree_view gint bx gint by gint* [wx] gint* [wy]")
(CFNC-211 "void gtk_tree_view_convert_tree_to_bin_window_coords GtkTreeView* tree_view gint tx gint ty gint* [bx] gint* [by]")
(CFNC-211 "void gtk_tree_view_convert_bin_window_to_tree_coords GtkTreeView* tree_view gint bx gint by gint* [tx] gint* [ty]")
(CFNC-211 "void gtk_widget_modify_cursor GtkWidget* widget GdkColor* primary GdkColor* secondary")
(CFNC-211 "void gtk_widget_set_tooltip_text GtkWidget* widget gchar* text" 'const)
(CFNC-211 "gchar* gtk_widget_get_tooltip_text GtkWidget* widget")
(CFNC-211 "void gtk_widget_set_tooltip_markup GtkWidget* widget gchar* markup" 'const)
(CFNC-211 "gchar* gtk_widget_get_tooltip_markup GtkWidget* widget")

;;; for 2.11.5
(CFNC-211 "gboolean gtk_tree_view_is_rubber_banding_active GtkTreeView* tree_view")

;;; for 2.11.6
(CFNC-211 "void gtk_icon_view_convert_widget_to_bin_window_coords GtkIconView* icon_view gint wx gint wy gint* [bx] gint* [by]")
(CFNC-211 "void gtk_icon_view_set_tooltip_item GtkIconView* icon_view GtkTooltip* tooltip GtkTreePath* path")
(CFNC-211 "void gtk_icon_view_set_tooltip_cell GtkIconView* icon_view GtkTooltip* tooltip GtkTreePath* path GtkCellRenderer* cell")
(CFNC-211 "gboolean gtk_icon_view_get_tooltip_context GtkIconView* icon_view gint* [x] gint* [y] gboolean keyboard_tip GtkTreeModel** [model] GtkTreePath** [path] GtkTreeIter* @iter")
(CFNC-211 "void gtk_icon_view_set_tooltip_column GtkIconView* icon_view gint column")
(CFNC-211 "gint gtk_icon_view_get_tooltip_column GtkIconView* icon_view ")
(CFNC-211 "void gtk_menu_tool_button_set_arrow_tooltip_text GtkMenuToolButton* button gchar* text" 'const)
(CFNC-211 "void gtk_menu_tool_button_set_arrow_tooltip_markup GtkMenuToolButton* button gchar* markup" 'const)
(CFNC-211 "void gtk_tool_item_set_tooltip_text GtkToolItem* tool_item gchar* text" 'const)
(CFNC-211 "void gtk_tool_item_set_tooltip_markup GtkToolItem* tool_item gchar* markup" 'const)
(CFNC-211 "void gtk_tooltip_set_tip_area GtkTooltip* tooltip GdkRectangle* rect")
(CFNC-211 "void gtk_tree_view_set_tooltip_row GtkTreeView* tree_view GtkTooltip* tooltip GtkTreePath* path")
(CFNC-211 "void gtk_tree_view_set_tooltip_cell GtkTreeView* tree_view GtkTooltip* tooltip GtkTreePath* path GtkTreeViewColumn* column GtkCellRenderer* cell")
(CFNC-211 "gboolean gtk_tree_view_get_tooltip_context GtkTreeView* tree_view gint* [x] gint* [y] gboolean keyboard_tip GtkTreeModel** [model] GtkTreePath** [path] GtkTreeIter* @iter")
(CFNC-211 "void gtk_tree_view_set_tooltip_column GtkTreeView* tree_view gint column")
(CFNC-211 "gint gtk_tree_view_get_tooltip_column GtkTreeView* tree_view ")
(CFNC-211 "void gtk_widget_set_has_tooltip GtkWidget* widget gboolean has_tooltip")
(CFNC-211 "gboolean gtk_widget_get_has_tooltip GtkWidget* widget")
