...
;#define GTK_MODIFIER_STYLE(o)
;#define GTK_IS_MODIFIER_STYLE(o)

;#define GTK_STYLE_CONTEXT(o)
;#define GTK_IS_STYLE_CONTEXT(o)

;#define GTK_STYLE_PROPERTIES(o)
;#define GTK_IS_STYLE_PROPERTIES(o)
...
;void gtk_modifier_style_set_background_color GtkModifierStyle* style GtkStateFlags state const GdkRGBA* color)
;void gtk_modifier_style_set_color GtkModifierStyle* style GtkStateFlags state const GdkRGBA* color)
;void gtk_modifier_style_set_font GtkModifierStyle* style const PangoFontDescription* font_desc)
;void gtk_modifier_style_map_color GtkModifierStyle* style const gchar* name const GdkRGBA* color)
;void gtk_modifier_style_set_color_property GtkModifierStyle* style GType widget_type const gchar* prop_name const GdkRGBA* color)
...
;void gtk_style_properties_set_valist GtkStyleProperties* props GtkStateFlags state va_list args)void gtk_style_properties_set GtkStyleProperties* props GtkStateFlags state ...)
