...
(CINT "GTK_BUTTONBOX_CENTER" "GtkButtonBoxStyle")
...
(CFNC "guint gdk_threads_add_timeout_full gint priority guint interval GSourceFunc func lambda_data func_info GDestroyNotify notify")
(CFNC "guint gdk_threads_add_timeout guint interval GSourceFunc func lambda_data #func_info")
