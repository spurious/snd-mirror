...
;;; 2.90.5 (CFNC "void gdk_gc_set_clip_region GdkGC* gc GdkRegion* region")
...
;;; (CFNC "void gdk_window_invalidate_maybe_recurse GdkWindow* window GdkRegion* region lambda2 func lambda_data #func_info")
...
;;;;(CFNC "GType gtk_item_get_type void")
...
(CFNC "void gtk_init_add GtkFunction func lambda_data #func_info")
(CFNC "void gtk_quit_add_destroy guint main_level GtkObject* object")
(CFNC "guint gtk_quit_add guint main_level GtkFunction func lambda_data #func_info")
;(CFNC "guint gtk_quit_add_full guint main_level GtkFunction func GtkCallbackMarshal marshal lambda_data func_info GtkDestroyNotify destroy")
...
(CFNC-236 "void gtk_clipboard_request_targets GtkClipboard* clipboard GtkClipboardTargetsReceivedFunc func lambda_data #func_info")
...
(CFNC-250 "void gtk_tree_view_set_row_separator_func GtkTreeView* tree_view GtkTreeViewRowSeparatorFunc func lambda_data func_info GtkDestroyNotify destroy")
...
(CFNC-250 "void gtk_icon_view_selected_foreach GtkIconView* icon_view GtkIconViewForeachFunc func lambda_data #func_info")
...
(CFNC-256 "void gtk_combo_box_set_row_separator_func GtkComboBox* combo_box GtkTreeViewRowSeparatorFunc func lambda_data func_info GtkDestroyNotify destroy")
...
(CFNC-256 "void gtk_clipboard_request_image GtkClipboard* clipboard GtkClipboardImageReceivedFunc func lambda_data #func_info")
...
;;; -- not defined? (CFNC-256 "void gdk_display_add_client_message_filter_full GdkDisplay* display GdkAtom message_type GdkFilterFunc func lambda_data func_info GtkDestroyNotify destroy")
...
(CFNC-256 "guint g_log_set_handler gchar* log_domain GLogLevelFlags log_levels GLogFunc func lambda_data #func_info")
...
;(CFNC-270 "void gtk_stock_set_translate_func gchar* domain GtkTranslateFunc func lambda_data func_info GtkDestroyNotify notify" 'const)
...
(CFNC-290 "void gtk_clipboard_request_rich_text GtkClipboard* clipboard GtkTextBuffer* buffer GtkClipboardRichTextReceivedFunc func lambda_data #func_info")
...
(CFNC-290 "void gtk_tree_view_set_search_position_func GtkTreeView* tree_view GtkTreeViewSearchPositionFunc func lambda_data #func_info GDestroyNotify destroy")
...
(CFNC-290 "void gtk_assistant_set_forward_page_func GtkAssistant* assistant GtkAssistantPageFunc page_func lambda_data #func_info GDestroyNotify destroy")
...
(CFNC-290 "GtkLinkButtonUriFunc gtk_link_button_set_uri_hook GtkLinkButtonUriFunc func lambda_data #func_info GDestroyNotify destroy")
...
(CFNC-290 "void gtk_recent_chooser_set_sort_func GtkRecentChooser* chooser GtkRecentSortFunc func lambda_data #func_info GDestroyNotify data_destroy")
...
(CFNC-290 "void gtk_recent_filter_add_custom GtkRecentFilter* filter GtkRecentFilterFlags needed GtkRecentFilterFunc func lambda_data #func_info GDestroyNotify data_destroy")
...
(CFNC-211 "guint gdk_threads_add_idle_full gint priority GSourceFunc func lambda_data func_info GDestroyNotify notify")
(CFNC-211 "guint gdk_threads_add_idle GSourceFunc func lambda_data #func_info")
...
(CFNC-2190 "GtkOrientation gtk_tool_shell_get_text_orientation GtkToolShell* shell")
(CFNC-2190 "gfloat gtk_tool_shell_get_text_alignment GtkToolShell* shell")
(CFNC-2190 "PangoEllipsizeMode gtk_tool_shell_get_ellipsize_mode GtkToolShell* shell")
...
(CFNC-2902 "cairo_region_t* gdk_drawable_get_clip_region GdkDrawable* drawable")
(CFNC-2902 "cairo_region_t* gdk_drawable_get_visible_region GdkDrawable* drawable")
(CFNC-2902 "void gdk_gc_set_clip_region GdkGC* gc cairo_region_t* region")
(CFNC-2902 "cairo_region_t* gdk_pango_layout_line_get_clip_region PangoLayoutLine* line gint x_origin gint y_origin gint* index_ranges gint n_ranges")
(CFNC-2902 "cairo_region_t* gdk_pango_layout_get_clip_region PangoLayout* layout gint x_origin gint y_origin gint* index_ranges gint n_ranges")
(CFNC-2902 "cairo_region_t* gdk_region_new void")
(CFNC-2902 "cairo_region_t* gdk_region_polygon GdkPoint* points gint npoints GdkFillRule fill_rule")
(CFNC-2902 "cairo_region_t* gdk_region_copy cairo_region_t* region")
(CFNC-2902 "cairo_region_t* gdk_region_rectangle GdkRectangle* rectangle")
(CFNC-2902 "void gdk_region_destroy cairo_region_t* region")
(CFNC-2902 "void gdk_region_get_clipbox cairo_region_t* region GdkRectangle* rectangle")
(CFNC-2902 "void gdk_region_get_rectangles cairo_region_t* region GdkRectangle** [rectangles] gint* [n_rectangles]") ; FREE: returned rect arr
(CFNC-2902 "gboolean gdk_region_empty cairo_region_t* region")
(CFNC-2902 "gboolean gdk_region_equal cairo_region_t* region1 cairo_region_t* region2")
(CFNC-2902 "gboolean gdk_region_point_in cairo_region_t* region int x int y")
;(CFNC-2902 "GdkOverlapType gdk_region_rect_in cairo_region_t* region GdkRectangle* rect")
(CFNC-2902 "void gdk_region_offset cairo_region_t* region gint dx gint dy")
(CFNC-2902 "void gdk_region_shrink cairo_region_t* region gint dx gint dy")
(CFNC-2902 "void gdk_region_union_with_rect cairo_region_t* region GdkRectangle* rect")
(CFNC-2902 "void gdk_region_intersect cairo_region_t* source1 cairo_region_t* source2")
(CFNC-2902 "void gdk_region_union cairo_region_t* source1 cairo_region_t* source2")
(CFNC-2902 "void gdk_region_subtract cairo_region_t* source1 cairo_region_t* source2")
(CFNC-2902 "void gdk_region_xor cairo_region_t* source1 cairo_region_t* source2")
;(CFNC-2902 "void gdk_region_spans_intersect_foreach cairo_region_t* region GdkSpan* spans int n_spans gboolean sorted GdkSpanFunc func lambda_data #func_info")
(CFNC-2902 "void gdk_window_shape_combine_region GdkWindow* window cairo_region_t* shape_region gint offset_x gint offset_y")
(CFNC-2902 "void gdk_window_invalidate_region GdkWindow* window cairo_region_t* region gboolean invalidate_children")
(CFNC-2902 "void gdk_window_invalidate_maybe_recurse GdkWindow* window cairo_region_t* region lambda2 func lambda_data #func_info")
(CFNC-2902 "cairo_region_t* gdk_window_get_update_area GdkWindow* window")
(CFNC-2902 "void gdk_window_begin_paint_region GdkWindow* window cairo_region_t* region")
(CFNC-2902 "cairo_region_t* gtk_widget_region_intersect GtkWidget* widget cairo_region_t* region") ; FREE
(CFNC-2902 "void gdk_window_move_region GdkWindow* window cairo_region_t* region gint dx gint dy")
(CFNC-2902 "gboolean gdk_region_rect_equal cairo_region_t* region GdkRectangle* rectangle" 'const)
;;; (CFNC-210 "void gdk_cairo_region cairo_t* cr cairo_region_t* region")

(CFNC-2902 "gboolean gdk_keymap_get_num_lock_state GdkKeymap* keymap")
(CFNC-2902 "gboolean gdk_window_has_native GdkWindow* window")
|#
