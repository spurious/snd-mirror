...
#|
;;; 2.15.1
(CINT "GDK_BLANK_CURSOR " "GdkCursorType")
(CSTR "GTK_STOCK_CAPS_LOCK_WARNING")
(CFNC "void gtk_action_set_label GtkAction* action const gchar* label")
(CFNC "const gchar* gtk_action_get_label GtkAction* action")
(CFNC "void gtk_action_set_short_label GtkAction* action const gchar* short_label")
(CFNC "const gchar* gtk_action_get_short_label GtkAction* action")
(CFNC "void gtk_action_set_tooltip GtkAction* action const gchar* tooltip")
(CFNC "const gchar* gtk_action_get_tooltip GtkAction* action")
(CFNC "void gtk_action_set_stock_id GtkAction* action const gchar* stock_id")
(CFNC "const gchar* gtk_action_get_stock_id GtkAction* action")
(CFNC "void gtk_action_set_gicon GtkAction* action GIcon* icon")
(CFNC "GIcon* gtk_action_get_gicon GtkAction* action")
(CFNC "void gtk_action_set_icon_name GtkAction* action const gchar* icon_name")
(CFNC "const gchar* gtk_action_get_icon_name GtkAction* action")
...
(CFNC "void gtk_scale_add_mark GtkScale* scale gdouble value GtkPositionType position const gchar* markup")
