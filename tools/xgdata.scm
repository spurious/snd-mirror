...
;;; 3.0.0 (CFNC-29x "void gtk_modifier_style_set_background_color GtkModifierStyle* style GtkStateFlags state GdkRGBA* color" 'const)
;;; 3.0.0 (CFNC-29x "void gtk_modifier_style_set_color GtkModifierStyle* style GtkStateFlags state GdkRGBA* color" 'const)
;;; 3.0.0 (CFNC-29x "void gtk_modifier_style_set_font GtkModifierStyle* style PangoFontDescription* font_desc" 'const)
;;; 3.0.0 (CFNC-29x "void gtk_modifier_style_map_color GtkModifierStyle* style gchar* name GdkRGBA* color" 'const)
;;; 3.0.0 (CFNC-29x "void gtk_modifier_style_set_color_property GtkModifierStyle* style GType widget_type gchar* prop_name GdkRGBA* color" 'const)
