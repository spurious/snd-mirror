...
(CFNC-231 "GdkImage* gdk_drawable_copy_to_image GdkDrawable* drawable GdkImage* image gint src_x gint src_y gint dest_x gint dest_y gint width gint height")
...
(CFNC-231 "gboolean gtk_accel_group_activate GtkAccelGroup* accel_group GQuark accel_quark GObject* acceleratable guint accel_key GdkModifierType accel_mods")
...
(CFNC-231 "void gtk_menu_set_monitor GtkMenu* menu gint monitor_num")
...
(CFNC-232 "gint gtk_notebook_append_page GtkNotebook* notebook GtkWidget* child GtkWidget* @tab_label")
(CFNC-232 "gint gtk_notebook_append_page_menu GtkNotebook* notebook GtkWidget* child GtkWidget* @tab_label GtkWidget* @menu_label")
(CFNC-232 "gint gtk_notebook_prepend_page GtkNotebook* notebook GtkWidget* child GtkWidget* @tab_label")
(CFNC-232 "gint gtk_notebook_prepend_page_menu GtkNotebook* notebook GtkWidget* child GtkWidget* @tab_label GtkWidget* @menu_label")
(CFNC-232 "gint gtk_notebook_insert_page GtkNotebook* notebook GtkWidget* child GtkWidget* @tab_label gint position")
(CFNC-232 "gint gtk_notebook_insert_page_menu GtkNotebook* notebook GtkWidget* child GtkWidget* @tab_label GtkWidget* @menu_label gint position")
...
(CSTR-232 "GTK_STOCK_COLOR_PICKER")
...
(CFNC-231 "gboolean gtk_widget_can_activate_accel GtkWidget* widget guint signal_id")
(CFNC-231 "gboolean gtk_window_is_active GtkWindow* window")
(CFNC-231 "gboolean gtk_window_has_toplevel_focus GtkWindow* window")
...
;;; changed 2.3.1
(CFNC-231 "GtkWidget* gtk_combo_box_new void") 
(CFNC-231 "GtkWidget* gtk_combo_box_new_with_model GtkTreeModel* model") 
(CFNC-231 "void gtk_combo_box_set_model GtkComboBox* combo_box GtkTreeModel* @model")
(CFNC-231 "void gtk_combo_box_remove_text GtkComboBox* combo_box gint position")
...
;;; changed in 2.3.1
(CFNC-231 "GtkWidget* gtk_combo_box_entry_new void")
(CFNC-231 "GtkWidget* gtk_combo_box_entry_new_with_model GtkTreeModel* model gint text_column")
(CFNC-231 "void gtk_combo_box_entry_set_text_column GtkComboBoxEntry* entry_box gint text_column")
...
(CFNC-231 "void gtk_expander_set_use_markup GtkExpander* expander gboolean use_markup")
(CFNC-231 "gboolean gtk_expander_get_use_markup GtkExpander* expander")
...
;;; changed 2.3.1
(CFNC-231 "GtkToolItem* gtk_radio_tool_button_new_from_widget GtkRadioToolButton* group") 
(CFNC-232 "GtkToolItem* gtk_radio_tool_button_new_with_stock_from_widget GtkRadioToolButton* group gchar* stock_id") 
...
(CFNC-231 "gboolean gtk_separator_tool_item_get_draw GtkSeparatorToolItem* item")
(CFNC-231 "void gtk_separator_tool_item_set_draw GtkSeparatorToolItem* tool_item gboolean draw")
...
(CFNC-232 "void gdk_display_set_double_click_distance GdkDisplay* display guint distance")
(CFNC-232 "GdkWindow* gdk_display_get_default_group GdkDisplay* display") 
(CFNC-232 "void gdk_window_set_accept_focus GdkWindow* window gboolean accept_focus")
(CFNC-232 "GdkWindow* gdk_window_get_group GdkWindow* window")
(CFNC-232 "gboolean gtk_action_group_get_sensitive GtkActionGroup* action_group")
(CFNC-232 "void gtk_action_group_set_sensitive GtkActionGroup* action_group gboolean sensitive")
(CFNC-232 "gboolean gtk_action_group_get_visible GtkActionGroup* action_group")
(CFNC-232 "void gtk_action_group_set_visible GtkActionGroup* action_group gboolean visible")
(CFNC-232 "void gtk_action_group_add_action_with_accel GtkActionGroup* action_group GtkAction* action gchar* accelerator")
(CFNC-232 "GtkAction* gtk_action_new gchar* name gchar* label gchar* tooltip gchar* stock_id")
(CFNC-232 "gboolean gtk_action_is_sensitive GtkAction* action")
(CFNC-232 "gboolean gtk_action_get_sensitive GtkAction* action")
(CFNC-232 "gboolean gtk_action_is_visible GtkAction* action")
(CFNC-232 "gboolean gtk_action_get_visible GtkAction* action")
(CFNC-232 "void gtk_button_set_alignment GtkButton* button gfloat xalign gfloat yalign")
...
(CFNC-232 "GtkRadioAction* gtk_radio_action_new gchar* name gchar* label gchar* tooltip gchar* stock_id gint value")
...
(CFNC-251 "void gtk_combo_box_set_row_separator_func GtkComboBox* combo_box GtkTreeViewRowSeparatorFunc func lambda_data func_data GtkDestroyNotify destroy")
(CFNC-251 "void gtk_label_set_ellipsize GtkLabel* label PangoEllipsizeMode mode")
(CFNC-251 "PangoEllipsizeMode gtk_label_get_ellipsize GtkLabel* label")

(CINT-251 "PANGO_ATTR_FALLBACK" "PangoAttrType")
(CINT-251 "PANGO_ATTR_LETTER_SPACING" "PangoAttrType")

(CINT-251 "PANGO_UNDERLINE_ERROR" "PangoUnderline")

(CINT-251 "PANGO_WRAP_WORD_CHAR" "PangoWrapMode")

(CINT-251 "PANGO_ELLIPSIZE_NONE" "PangoEllipsizeMode")
(CINT-251 "PANGO_ELLIPSIZE_START" "PangoEllipsizeMode")
(CINT-251 "PANGO_ELLIPSIZE_MIDDLE" "PangoEllipsizeMode")
(CINT-251 "PANGO_ELLIPSIZE_END" "PangoEllipsizeMode")

(CINT-251 "PANGO_SCRIPT_INVALID_CODE" "PangoScript")
(CINT-251 "PANGO_SCRIPT_COMMON" "PangoScript")
(CINT-251 "PANGO_SCRIPT_INHERITED" "PangoScript")
(CINT-251 "PANGO_SCRIPT_ARABIC" "PangoScript")
(CINT-251 "PANGO_SCRIPT_ARMENIAN" "PangoScript")
(CINT-251 "PANGO_SCRIPT_BENGALI" "PangoScript")
(CINT-251 "PANGO_SCRIPT_BOPOMOFO" "PangoScript")
(CINT-251 "PANGO_SCRIPT_CHEROKEE" "PangoScript")
(CINT-251 "PANGO_SCRIPT_COPTIC" "PangoScript")
(CINT-251 "PANGO_SCRIPT_CYRILLIC" "PangoScript")
(CINT-251 "PANGO_SCRIPT_DESERET" "PangoScript")
(CINT-251 "PANGO_SCRIPT_DEVANAGARI" "PangoScript")
(CINT-251 "PANGO_SCRIPT_ETHIOPIC" "PangoScript")
(CINT-251 "PANGO_SCRIPT_GEORGIAN" "PangoScript")
(CINT-251 "PANGO_SCRIPT_GOTHIC" "PangoScript")
(CINT-251 "PANGO_SCRIPT_GREEK" "PangoScript")
(CINT-251 "PANGO_SCRIPT_GUJARATI" "PangoScript")
(CINT-251 "PANGO_SCRIPT_GURMUKHI" "PangoScript")
(CINT-251 "PANGO_SCRIPT_HAN" "PangoScript")
(CINT-251 "PANGO_SCRIPT_HANGUL" "PangoScript")
(CINT-251 "PANGO_SCRIPT_HEBREW" "PangoScript")
(CINT-251 "PANGO_SCRIPT_HIRAGANA" "PangoScript")
(CINT-251 "PANGO_SCRIPT_KANNADA" "PangoScript")
(CINT-251 "PANGO_SCRIPT_KATAKANA" "PangoScript")
(CINT-251 "PANGO_SCRIPT_KHMER" "PangoScript")
(CINT-251 "PANGO_SCRIPT_LAO" "PangoScript")
(CINT-251 "PANGO_SCRIPT_LATIN" "PangoScript")
(CINT-251 "PANGO_SCRIPT_MALAYALAM" "PangoScript")
(CINT-251 "PANGO_SCRIPT_MONGOLIAN" "PangoScript")
(CINT-251 "PANGO_SCRIPT_MYANMAR" "PangoScript")
(CINT-251 "PANGO_SCRIPT_OGHAM" "PangoScript")
(CINT-251 "PANGO_SCRIPT_OLD_ITALIC" "PangoScript")
(CINT-251 "PANGO_SCRIPT_ORIYA" "PangoScript")
(CINT-251 "PANGO_SCRIPT_RUNIC" "PangoScript")
(CINT-251 "PANGO_SCRIPT_SINHALA" "PangoScript")
(CINT-251 "PANGO_SCRIPT_SYRIAC" "PangoScript")
(CINT-251 "PANGO_SCRIPT_TAMIL" "PangoScript")
(CINT-251 "PANGO_SCRIPT_TELUGU" "PangoScript")
(CINT-251 "PANGO_SCRIPT_THAANA" "PangoScript")
(CINT-251 "PANGO_SCRIPT_THAI" "PangoScript")
(CINT-251 "PANGO_SCRIPT_TIBETAN" "PangoScript")
(CINT-251 "PANGO_SCRIPT_CANADIAN_ABORIGINAL" "PangoScript")
(CINT-251 "PANGO_SCRIPT_YI" "PangoScript")
(CINT-251 "PANGO_SCRIPT_TAGALOG" "PangoScript")
(CINT-251 "PANGO_SCRIPT_HANUNOO" "PangoScript")
(CINT-251 "PANGO_SCRIPT_BUHID" "PangoScript")
(CINT-251 "PANGO_SCRIPT_TAGBANWA" "PangoScript")
(CINT-251 "PANGO_SCRIPT_BRAILLE" "PangoScript")
(CINT-251 "PANGO_SCRIPT_CYPRIOT" "PangoScript")
(CINT-251 "PANGO_SCRIPT_LIMBU" "PangoScript")
(CINT-251 "PANGO_SCRIPT_OSMANYA" "PangoScript")
(CINT-251 "PANGO_SCRIPT_SHAVIAN" "PangoScript")
(CINT-251 "PANGO_SCRIPT_LINEAR_B" "PangoScript")
(CINT-251 "PANGO_SCRIPT_TAI_LE" "PangoScript")
(CINT-251 "PANGO_SCRIPT_UGARITIC" "PangoScript")

(CINT-251 "PANGO_TAB_LEFT" "PangoTabAlign")

(CINT-251 "PANGO_DIRECTION_WEAK_LTR" "PangoDirection")
(CINT-251 "PANGO_DIRECTION_WEAK_RTL" "PangoDirection")
(CINT-251 "PANGO_DIRECTION_NEUTRAL" "PangoDirection")
...
(CFNC-251 "int pango_font_metrics_get_strikethrough_position PangoFontMetrics* metrics")
(CFNC-251 "int pango_font_metrics_get_strikethrough_thickness PangoFontMetrics* metrics")
(CFNC-251 "gboolean pango_font_family_is_monospace PangoFontFamily* family")
(CFNC-251 "void pango_font_face_list_sizes PangoFontFace* face int** [sizes] int* [n_sizes]")
...
;;; args changed 2.6.0
;;; (CFNC-252 "GtkWidget* gtk_file_chooser_button_new_with_backend gchar* title gchar* backend")
(CFNC-252 "GtkWidget* gtk_file_chooser_button_new_with_dialog GtkWidget* dialog")
(CFNC-252 "gchar* gtk_file_chooser_button_get_title GtkFileChooserButton* button")
(CFNC-252 "void gtk_file_chooser_button_set_title GtkFileChooserButton* button gchar* title")
;;; out in 256 (CFNC-252 "gboolean gtk_file_chooser_button_get_active GtkFileChooserButton* button")
;;; ditto      (CFNC-252 "void gtk_file_chooser_button_set_active GtkFileChooserButton* button gboolean is_active")
(CFNC-252 "gboolean gdk_drag_drop_succeeded GdkDragContext* context")
(CFNC-252 "gboolean gdk_rgb_colormap_ditherable GdkColormap* cmap")
(CFNC-252 "void gtk_action_set_sensitive GtkAction* action gboolean sensitive")
(CFNC-252 "void gtk_action_set_visible GtkAction* action gboolean visible")
(CFNC-252 "gboolean gtk_combo_box_get_focus_on_click GtkComboBox* combo")
(CFNC-252 "void gtk_combo_box_set_focus_on_click GtkComboBox* combo gboolean focus_on_click")
;;; already included? (CFNC-252 "PangoLayout* gtk_entry_get_layout GtkEntry* entry")
(CFNC-252 "gint gtk_entry_layout_index_to_text_index GtkEntry* entry gint layout_index")
(CFNC-252 "gint gtk_entry_text_index_to_layout_index GtkEntry* entry gint text_index")
(CFNC-252 "void gtk_file_chooser_set_show_hidden GtkFileChooser* chooser gboolean show_hidden")
...
(CFNC-255 "void gtk_clipboard_set_image GtkClipboard* clipboard GdkPixbuf* pixbuf")
(CFNC-255 "void gtk_clipboard_request_image GtkClipboard* clipboard GtkClipboardImageReceivedFunc func lambda_data #func_data")
(CFNC-255 "GdkPixbuf* gtk_clipboard_wait_for_image GtkClipboard* clipboard")
(CFNC-255 "gboolean gtk_clipboard_wait_is_image_available GtkClipboard* clipboard")
(CFNC-255 "void gtk_file_filter_add_pixbuf_formats GtkFileFilter* filter")
(CFNC-255 "void gtk_label_set_single_line_mode GtkLabel* label gboolean single_line_mode")
(CFNC-255 "gboolean gtk_label_get_single_line_mode GtkLabel* label")
