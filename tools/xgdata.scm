...
;;; 3.89 (CFNC "GdkWindow* gdk_window_new GdkWindow* parent GdkWindowAttr* attributes gint attributes_mask")
...
;;; 3.89 (CFNC "void gdk_window_set_override_redirect GdkWindow* window gboolean override_redirect")
...
;;; 3.89 (CFNC "void gdk_window_set_geometry_hints GdkWindow* window GdkGeometry* geometry GdkWindowHints geom_mask")
...
;;; 3.89 (CFNC-3.0 "GdkWindow* gdk_window_get_effective_parent GdkWindow* window")
;;; 3.89 (CFNC-3.0 "GdkWindow* gdk_window_get_effective_toplevel GdkWindow* window")
...
;;; 3.89 (CFNC-3.0 "GdkWindow* gtk_button_get_event_window GtkButton* button")
