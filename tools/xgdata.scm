...
(CINT-2.16 "GTK_ARROWS_BOTH" "GtkArrowPlacement")
(CINT-2.16 "GTK_ARROWS_START" "GtkArrowPlacement")
(CINT-2.16 "GTK_ARROWS_END" "GtkArrowPlacement")
...
(CFNC-2.18 "void gtk_status_icon_set_title GtkStatusIcon* status_icon gchar* title")
(CFNC-2.18 "gchar* gtk_status_icon_get_title GtkStatusIcon* status_icon")
...
(CFNC-2.18 "gboolean gtk_widget_get_double_buffered GtkWidget* widget")
...
;;; 2.18.0
(CFNC-2.18 "void gdk_window_flush GdkWindow* window")
...
(CFNC-2.20 "void gtk_status_icon_set_name GtkStatusIcon* status_icon gchar* name") ; const gchar
...
(CFNC-3.0 "gboolean gdk_window_get_composited GdkWindow* window")
...
(CINT-3.0 "GTK_ARROW_NONE" "GtkArrowType")
...
(CFNC-3.0 "void gtk_container_set_reallocate_redraws GtkContainer* container gboolean needs_redraws")
...
(CFNC-3.0 "GtkStatusIcon* gtk_status_icon_new_from_gicon GIcon* icon")
(CFNC-3.0 "void gtk_status_icon_set_from_gicon GtkStatusIcon* status_icon GIcon* icon")
(CFNC-3.0 "GIcon* gtk_status_icon_get_gicon GtkStatusIcon* status_icon")
(CFNC-3.0 "void gtk_status_icon_set_has_tooltip GtkStatusIcon* status_icon gboolean has_tooltip")
(CFNC-3.0 "void gtk_status_icon_set_tooltip_text GtkStatusIcon* status_icon gchar* text" 'const)
(CFNC-3.0 "void gtk_status_icon_set_tooltip_markup GtkStatusIcon* status_icon gchar* markup" 'const)
(CFNC-3.0 "gboolean gtk_status_icon_get_has_tooltip GtkStatusIcon* status_icon")
(CFNC-3.0 "gchar* gtk_status_icon_get_tooltip_text GtkStatusIcon* status_icon")
(CFNC-3.0 "gchar* gtk_status_icon_get_tooltip_markup GtkStatusIcon* status_icon")
...
(CFNC-3.0 "void gtk_widget_override_color GtkWidget* widget GtkStateFlags state GdkRGBA* color" 'const)
(CFNC-3.0 "void gtk_widget_override_background_color GtkWidget* widget GtkStateFlags state GdkRGBA* color" 'const)
(CFNC-3.0 "void gtk_widget_override_font GtkWidget* widget PangoFontDescription* font_desc" 'const)
;;; 3.7.4 (CFNC-3.0 "void gtk_widget_override_symbolic_color GtkWidget* widget gchar* name GdkRGBA* color" 'const)
(CFNC-3.0 "void gtk_widget_override_cursor GtkWidget* widget GdkRGBA* cursor GdkRGBA* secondary_cursor" 'const)
...
(CFNC-3.6 "void gtk_menu_button_set_direction GtkMenuButton* menu_button GtkArrowType direction")
(CFNC-3.6 "GtkArrowType gtk_menu_button_get_direction GtkMenuButton* menu_button")
...
(CFNC-3.10 "GtkWidget* gtk_stack_get_visible_child GtkStack* stack")
(CFNC-3.10 "void gtk_stack_set_visible_child_name GtkStack* stack gchar* name" 'const)
(CFNC-3.10 "gchar* gtk_stack_get_visible_child_name GtkStack* stack" 'const)
...
;;; lockbutton
(CFNC-3.2 "GtkWidget* gtk_lock_button_new GPermission* permission")
(CFNC-3.2 "GPermission* gtk_lock_button_get_permission GtkLockButton* button")
(CFNC-3.2 "void gtk_lock_button_set_permission GtkLockButton* button GPermission* permission")
(CCAST-3.2 "GTK_LOCK_BUTTON" "GtkLockButton*")
(CCHK-3.2 "GTK_IS_LOCK_BUTTON" "GtkLockButton*")


(CCAST-3.0 "GTK_CSS_PROVIDER" "GtkCssProvider*")
(CCHK-3.0 "GTK_IS_CSS_PROVIDER" "GtkCssProvider*")
(CINT-3.0 "GTK_CSS_PROVIDER_ERROR_FAILED" "GtkCssProviderError")
(CFNC-3.0 "GtkCssProvider* gtk_css_provider_new void")
(CFNC-3.0 "gboolean gtk_css_provider_load_from_data GtkCssProvider* css_provider gchar* data gssize length GError** [error]" 'const)
(CFNC-3.0 "gboolean gtk_css_provider_load_from_file GtkCssProvider* css_provider GFile* file GError** [error]")
(CFNC-3.0 "gboolean gtk_css_provider_load_from_path GtkCssProvider* css_provider gchar* path GError** [error]" 'const)
(CFNC-3.0 "GtkCssProvider* gtk_css_provider_get_default void")
(CFNC-3.0 "GtkCssProvider* gtk_css_provider_get_named gchar* name gchar* variant" 'const)

(CFNC-3.0 "GtkWidgetPath* gtk_container_get_path_for_child GtkContainer* container GtkWidget* child")
(CFNC-3.0 "GtkWidgetPath* gtk_widget_get_path GtkWidget* widget")
(CFNC-3.0 "void gtk_widget_path GtkWidget* widget guint* path_length gchar** [path] gchar** [path_reversed]")
(CFNC-3.0 "void gtk_widget_class_path GtkWidget* widget guint* path_length gchar** [path] gchar** [path_reversed]")

(CCAST-3.0 "GTK_STYLE_PROVIDER" "GtkStyleProvider*")
(CCHK-3.0 "GTK_IS_STYLE_PROVIDER" "GtkStyleProvider*")
(CINT-3.0 "GTK_STYLE_PROVIDER_PRIORITY_FALLBACK")
(CINT-3.0 "GTK_STYLE_PROVIDER_PRIORITY_THEME")
(CINT-3.0 "GTK_STYLE_PROVIDER_PRIORITY_SETTINGS")
(CINT-3.0 "GTK_STYLE_PROVIDER_PRIORITY_APPLICATION")
(CINT-3.0 "GTK_STYLE_PROVIDER_PRIORITY_USER")
;;; 3.7.4 (CFNC-3.0 "GtkStyleProperties* gtk_style_provider_get_style GtkStyleProvider* provider GtkWidgetPath* path")
(CFNC-3.0 "gboolean gtk_style_provider_get_style_property GtkStyleProvider* provider GtkWidgetPath* path GtkStateFlags state GParamSpec* pspec GValue* [value]")
;;; 3.7.4 (CFNC-3.0 "GtkIconFactory* gtk_style_provider_get_icon_factory GtkStyleProvider* provider GtkWidgetPath* path")

(CSTR-3.0 "GTK_STYLE_PROPERTY_BACKGROUND_COLOR")
(CSTR-3.0 "GTK_STYLE_PROPERTY_COLOR")
(CSTR-3.0 "GTK_STYLE_PROPERTY_FONT")
(CSTR-3.0 "GTK_STYLE_PROPERTY_MARGIN")
(CSTR-3.0 "GTK_STYLE_PROPERTY_PADDING")
(CSTR-3.0 "GTK_STYLE_PROPERTY_BORDER_WIDTH")
(CSTR-3.0 "GTK_STYLE_PROPERTY_BORDER_RADIUS")
(CSTR-3.0 "GTK_STYLE_PROPERTY_BORDER_STYLE")
(CSTR-3.0 "GTK_STYLE_PROPERTY_BORDER_COLOR")
(CSTR-3.0 "GTK_STYLE_PROPERTY_BACKGROUND_IMAGE")
(CSTR-3.0 "GTK_STYLE_CLASS_CELL")
(CSTR-3.0 "GTK_STYLE_CLASS_ENTRY")
(CSTR-3.0 "GTK_STYLE_CLASS_BUTTON")
(CSTR-3.0 "GTK_STYLE_CLASS_CALENDAR")
(CSTR-3.0 "GTK_STYLE_CLASS_SLIDER")
(CSTR-3.0 "GTK_STYLE_CLASS_BACKGROUND")
(CSTR-3.0 "GTK_STYLE_CLASS_RUBBERBAND")
(CSTR-3.0 "GTK_STYLE_CLASS_TOOLTIP")
(CSTR-3.0 "GTK_STYLE_CLASS_MENU")
(CSTR-3.0 "GTK_STYLE_CLASS_MENUBAR")
(CSTR-3.0 "GTK_STYLE_CLASS_MENUITEM")
(CSTR-3.0 "GTK_STYLE_CLASS_TOOLBAR")
(CSTR-3.0 "GTK_STYLE_CLASS_RADIO")
(CSTR-3.0 "GTK_STYLE_CLASS_CHECK")
(CSTR-3.0 "GTK_STYLE_CLASS_DEFAULT")
(CSTR-3.0 "GTK_STYLE_CLASS_TROUGH")
(CSTR-3.0 "GTK_STYLE_CLASS_SCROLLBAR")
(CSTR-3.0 "GTK_STYLE_CLASS_HEADER")
(CSTR-3.0 "GTK_STYLE_CLASS_ACCELERATOR")
(CSTR-3.0 "GTK_STYLE_CLASS_GRIP")
(CSTR-3.0 "GTK_STYLE_CLASS_DOCK")
(CSTR-3.0 "GTK_STYLE_CLASS_PROGRESSBAR")
(CSTR-3.0 "GTK_STYLE_CLASS_SPINNER")
(CSTR-3.0 "GTK_STYLE_REGION_ROW")
(CSTR-3.0 "GTK_STYLE_REGION_COLUMN")
(CSTR-3.0 "GTK_STYLE_REGION_COLUMN_HEADER")
(CSTR-3.0 "GTK_STYLE_REGION_TAB")
(CSTR-3.0 "GTK_STYLE_CLASS_SCALE")
(CSTR-3.0 "GTK_STYLE_CLASS_MARK")
(CSTR-3.0 "GTK_STYLE_CLASS_EXPANDER")
(CSTR-3.0 "GTK_STYLE_CLASS_SPINBUTTON")
(CSTR-3.0 "GTK_STYLE_CLASS_NOTEBOOK")
(CSTR-3.0 "GTK_STYLE_CLASS_VIEW")
(CSTR-3.0 "GTK_STYLE_CLASS_INFO")
(CSTR-3.0 "GTK_STYLE_CLASS_WARNING")
(CSTR-3.0 "GTK_STYLE_CLASS_QUESTION")
(CSTR-3.0 "GTK_STYLE_CLASS_ERROR")


(CSTR-304 "GTK_STYLE_CLASS_INLINE_TOOLBAR")
(CSTR-304 "GTK_STYLE_CLASS_SIDEBAR")


(CINT-3.0 "GTK_REGION_EVEN" "GtkRegionFlags")
(CINT-3.0 "GTK_REGION_ODD" "GtkRegionFlags")
(CINT-3.0 "GTK_REGION_FIRST" "GtkRegionFlags")
(CINT-3.0 "GTK_REGION_LAST" "GtkRegionFlags")
(CINT-3.0 "GTK_REGION_SORTED" "GtkRegionFlags")

(CINT-3.0 "GTK_JUNCTION_NONE" "GtkJunctionSides")
(CINT-3.0 "GTK_JUNCTION_CORNER_TOPLEFT" "GtkJunctionSides")
(CINT-3.0 "GTK_JUNCTION_CORNER_TOPRIGHT" "GtkJunctionSides")
(CINT-3.0 "GTK_JUNCTION_CORNER_BOTTOMLEFT" "GtkJunctionSides")
(CINT-3.0 "GTK_JUNCTION_CORNER_BOTTOMRIGHT" "GtkJunctionSides")
(CINT-3.0 "GTK_JUNCTION_TOP" "GtkJunctionSides")
(CINT-3.0 "GTK_JUNCTION_BOTTOM" "GtkJunctionSides")
(CINT-3.0 "GTK_JUNCTION_LEFT" "GtkJunctionSides")
(CINT-3.0 "GTK_JUNCTION_RIGHT" "GtkJunctionSides")

(CINT-3.0 "GTK_BORDER_STYLE_NONE" "GtkBorderStyle")
(CINT-3.0 "GTK_BORDER_STYLE_SOLID" "GtkBorderStyle")
(CINT-3.0 "GTK_BORDER_STYLE_INSET" "GtkBorderStyle")
(CINT-3.0 "GTK_BORDER_STYLE_OUTSET" "GtkBorderStyle")

(CCAST-3.0 "GTK_MODIFIER_STYLE" "GtkModifierStyle*")
(CCHK-3.0 "GTK_IS_MODIFIER_STYLE" "GtkModifierStyle*")

(CCAST-3.0 "GTK_STYLE_CONTEXT" "GtkStyleContext*")
(CCHK-3.0 "GTK_IS_STYLE_CONTEXT" "GtkStyleContext*")

(CCAST-3.0 "GTK_STYLE_PROPERTIES" "GtkStyleProperties*")
(CCHK-3.0 "GTK_IS_STYLE_PROPERTIES" "GtkStyleProperties*")

;;; 3.0.0 (CFNC-3.0 "void gtk_modifier_style_set_background_color GtkModifierStyle* style GtkStateFlags state GdkRGBA* color" 'const)
;;; 3.0.0 (CFNC-3.0 "void gtk_modifier_style_set_color GtkModifierStyle* style GtkStateFlags state GdkRGBA* color" 'const)
;;; 3.0.0 (CFNC-3.0 "void gtk_modifier_style_set_font GtkModifierStyle* style PangoFontDescription* font_desc" 'const)
;;; 3.0.0 (CFNC-3.0 "void gtk_modifier_style_map_color GtkModifierStyle* style gchar* name GdkRGBA* color" 'const)
;;; 3.0.0 (CFNC-3.0 "void gtk_modifier_style_set_color_property GtkModifierStyle* style GType widget_type gchar* prop_name GdkRGBA* color" 'const)
(CFNC-3.0 "GtkStyleContext* gtk_style_context_new void")
(CFNC-3.0 "void gtk_style_context_add_provider_for_screen GdkScreen* screen GtkStyleProvider* provider guint priority")
(CFNC-3.0 "void gtk_style_context_remove_provider_for_screen GdkScreen* screen GtkStyleProvider* provider")
(CFNC-3.0 "void gtk_style_context_add_provider GtkStyleContext* context GtkStyleProvider* provider guint priority")
(CFNC-3.0 "void gtk_style_context_remove_provider GtkStyleContext* context GtkStyleProvider* provider")
(CFNC-3.0 "void gtk_style_context_save GtkStyleContext* context")
(CFNC-3.0 "void gtk_style_context_restore GtkStyleContext* context")
(CFNC-3.0 "void gtk_style_context_get_property GtkStyleContext* context gchar* property GtkStateFlags state GValue* value" 'const)
;(CFNC-3.0 "void gtk_style_context_get_valist GtkStyleContext* context GtkStateFlags state va_list args")
;(CFNC-3.0 "void gtk_style_context_get GtkStyleContext* context GtkStateFlags state ...") 
(CFNC-3.0 "void gtk_style_context_set_state GtkStyleContext* context GtkStateFlags flags")
(CFNC-3.0 "GtkStateFlags gtk_style_context_get_state GtkStyleContext* context")
;;; 3.6 (CFNC-3.0 "gboolean gtk_style_context_state_is_running GtkStyleContext* context GtkStateType state gdouble* progress")
(CFNC-3.0 "void gtk_style_context_set_path GtkStyleContext* context GtkWidgetPath* path")
(CFNC-3.0 "GtkWidgetPath* gtk_style_context_get_path GtkStyleContext* context" 'const)
(CFNC-3.0 "GList* gtk_style_context_list_classes GtkStyleContext* context")
(CFNC-3.0 "void gtk_style_context_add_class GtkStyleContext* context gchar* class_name" 'const)
(CFNC-3.0 "void gtk_style_context_remove_class GtkStyleContext* context gchar* class_name" 'const)
(CFNC-3.0 "gboolean gtk_style_context_has_class GtkStyleContext* context gchar* class_name" 'const)
(CFNC-3.0 "GList* gtk_style_context_list_regions GtkStyleContext* context")
(CFNC-3.0 "void gtk_style_context_add_region GtkStyleContext* context gchar* region_name GtkRegionFlags flags" 'const)
(CFNC-3.0 "void gtk_style_context_remove_region GtkStyleContext* context gchar* region_name" 'const)
(CFNC-3.0 "gboolean gtk_style_context_has_region GtkStyleContext* context gchar* region_name GtkRegionFlags* flags_return" 'const)
(CFNC-3.0 "void gtk_style_context_get_style_property GtkStyleContext* context gchar* property_name GValue* value" 'const)
;(CFNC-3.0 "void gtk_style_context_get_style_valist GtkStyleContext* context va_list args")
;(CFNC-3.0 "void gtk_style_context_get_style GtkStyleContext* context ...")
(CFNC-3.0 "GtkIconSet* gtk_style_context_lookup_icon_set GtkStyleContext* context gchar* stock_id" 'const)
;;; (CFNC-3.0 "gtk_icon_set_render_icon_pixbuf GtkIconSet* icon_set GtkStyleContext* context GtkIconSize size")
(CFNC-3.0 "void gtk_style_context_set_screen GtkStyleContext* context GdkScreen* screen")
(CFNC-3.0 "GdkScreen* gtk_style_context_get_screen GtkStyleContext* context")
(CFNC-3.0 "void gtk_style_context_set_direction GtkStyleContext* context GtkTextDirection direction")
(CFNC-3.0 "GtkTextDirection gtk_style_context_get_direction GtkStyleContext* context")
(CFNC-3.0 "void gtk_style_context_set_junction_sides GtkStyleContext* context GtkJunctionSides sides")
(CFNC-3.0 "GtkJunctionSides gtk_style_context_get_junction_sides GtkStyleContext* context")
(CFNC-3.0 "gboolean gtk_style_context_lookup_color GtkStyleContext* context gchar* color_name GdkRGBA* color" 'const)
;;; 3.6 (CFNC-3.0 "void gtk_style_context_notify_state_change GtkStyleContext* context GdkWindow* window gpointer region_id GtkStateType state gboolean state_value")
;;; 3.6 (CFNC-3.0 "void gtk_style_context_push_animatable_region GtkStyleContext* context gpointer region_id")
;;; 3.6 (CFNC-3.0 "void gtk_style_context_pop_animatable_region GtkStyleContext* context")
(CFNC-3.0 "void gtk_style_context_get_color GtkStyleContext* context GtkStateFlags state GdkRGBA* color")
(CFNC-3.0 "void gtk_style_context_get_background_color GtkStyleContext* context GtkStateFlags state GdkRGBA* color")
(CFNC-3.0 "void gtk_style_context_get_border_color GtkStyleContext* context GtkStateFlags state GdkRGBA* color")
(CFNC-3.0 "void gtk_style_context_get_border GtkStyleContext* context GtkStateFlags state GtkBorder* border")
(CFNC-3.0 "void gtk_style_context_get_padding GtkStyleContext* context GtkStateFlags state GtkBorder* padding")
(CFNC-3.0 "void gtk_style_context_get_margin GtkStyleContext* context GtkStateFlags state GtkBorder* margin")
(CFNC-3.0 "void gtk_style_context_invalidate GtkStyleContext* context")
(CFNC-3.0 "void gtk_style_context_reset_widgets GdkScreen* screen")
(CFNC-3.0 "void gtk_style_context_set_background GtkStyleContext* context GdkWindow* window")
(CFNC-3.0 "void gtk_render_check GtkStyleContext* context cairo_t* cr gdouble x gdouble y gdouble width gdouble height")
(CFNC-3.0 "void gtk_render_option GtkStyleContext* context cairo_t* cr gdouble x gdouble y gdouble width gdouble height")
(CFNC-3.0 "void gtk_render_arrow GtkStyleContext* context cairo_t* cr gdouble angle gdouble x gdouble y gdouble size")
(CFNC-3.0 "void gtk_render_background GtkStyleContext* context cairo_t* cr gdouble x gdouble y gdouble width gdouble height")
(CFNC-3.0 "void gtk_render_frame GtkStyleContext* context cairo_t* cr gdouble x gdouble y gdouble width gdouble height")
(CFNC-3.0 "void gtk_render_expander GtkStyleContext* context cairo_t* cr gdouble x gdouble y gdouble width gdouble height")
(CFNC-3.0 "void gtk_render_focus GtkStyleContext* context cairo_t* cr gdouble x gdouble y gdouble width gdouble height")
(CFNC-3.0 "void gtk_render_layout GtkStyleContext* context cairo_t* cr gdouble x gdouble y PangoLayout* layout")
(CFNC-3.0 "void gtk_render_line GtkStyleContext* context cairo_t* cr gdouble x0 gdouble y0 gdouble x1 gdouble y1")
(CFNC-3.0 "void gtk_render_slider GtkStyleContext* context cairo_t* cr gdouble x gdouble y gdouble width gdouble height GtkOrientation orientation")
(CFNC-3.0 "void gtk_render_frame_gap GtkStyleContext* context cairo_t* cr gdouble x gdouble y gdouble width gdouble height GtkPositionType gap_side gdouble xy0_gap gdouble xy1_gap")
(CFNC-3.0 "void gtk_render_extension GtkStyleContext* context cairo_t* cr gdouble x gdouble y gdouble width gdouble height GtkPositionType gap_side")
(CFNC-3.0 "void gtk_render_handle GtkStyleContext* context cairo_t* cr gdouble x gdouble y gdouble width gdouble height")
(CFNC-3.0 "void gtk_render_activity GtkStyleContext* context cairo_t* cr gdouble x gdouble y gdouble width gdouble height")
;;; (CFNC-3.0 "GdkPixbuf* gtk_render_icon_pixbuf GtkStyleContext* context GtkIconSource* source GtkIconSize size" 'const)

;;; 3.6 (CFNC-3.0 "void gtk_style_context_cancel_animations GtkStyleContext* context gpointer region_id")
;;; 3.6 (CFNC-3.0 "void gtk_style_context_scroll_animations GtkStyleContext* context GdkWindow* window gint dx gint dy")

;;; 3.7.4 (CFNC-3.0 "void gtk_style_properties_register_property GtkStylePropertyParser parse_func GParamSpec* pspec")
;;; 3.7.4 (CFNC-3.0 "gboolean gtk_style_properties_lookup_property gchar* property_name GtkStylePropertyParser* parse_func GParamSpec** [pspec]" 'const)
(CFNC-3.0 "GtkStyleProperties* gtk_style_properties_new void")
;;; 3.7.4 (CFNC-3.0 "void gtk_style_properties_map_color GtkStyleProperties* props gchar* name GtkSymbolicColor* color" 'const)
;;; 3.7.4 (CFNC-3.0 "GtkSymbolicColor* gtk_style_properties_lookup_color GtkStyleProperties* props gchar* name" 'const)
(CFNC-3.0 "void gtk_style_properties_set_property GtkStyleProperties* props gchar* property GtkStateFlags state GValue* value" 'const)
;(CFNC-3.0 "void gtk_style_properties_set_valist GtkStyleProperties* props GtkStateFlags state va_list args")void gtk_style_properties_set GtkStyleProperties* props GtkStateFlags state ...)
(CFNC-3.0 "gboolean gtk_style_properties_get_property GtkStyleProperties* props gchar* property GtkStateFlags state GValue* value" 'const)
;(CFNC-3.0 "void gtk_style_properties_get_valist GtkStyleProperties* props GtkStateFlags state va_list args")
;(CFNC-3.0 "void gtk_style_properties_get GtkStyleProperties* props GtkStateFlags state ...")
(CFNC-3.0 "void gtk_style_properties_unset_property GtkStyleProperties* props gchar* property GtkStateFlags state" 'const)
(CFNC-3.0 "void gtk_style_properties_clear GtkStyleProperties* props")
(CFNC-3.0 "void gtk_style_properties_merge GtkStyleProperties* props GtkStyleProperties* props_to_merge gboolean replace" 'const)
;;; 3.7.4 (CFNC-3.0 "GtkSymbolicColor* gtk_symbolic_color_new_literal GdkRGBA* color" 'const)
;;; 3.7.4 (CFNC-3.0 "GtkSymbolicColor* gtk_symbolic_color_new_name gchar* name" 'const)
;;; 3.7.4 (CFNC-3.0 "GtkSymbolicColor* gtk_symbolic_color_new_shade GtkSymbolicColor* color gdouble factor")
;;; 3.7.4 (CFNC-3.0 "GtkSymbolicColor* gtk_symbolic_color_new_alpha GtkSymbolicColor* color gdouble factor")
;;; 3.7.4 (CFNC-3.0 "GtkSymbolicColor* gtk_symbolic_color_new_mix GtkSymbolicColor* color1 GtkSymbolicColor* color2 gdouble factor")
;;; 3.7.4 (CFNC-3.0 "GtkSymbolicColor* gtk_symbolic_color_ref GtkSymbolicColor* color")
;;; 3.7.4 (CFNC-3.0 "void gtk_symbolic_color_unref GtkSymbolicColor* color")
;;; 3.7.4 (CFNC-3.0 "gboolean gtk_symbolic_color_resolve GtkSymbolicColor* color GtkStyleProperties* props GdkRGBA* resolved_color")

(CFNC-3.0 "GtkStyleContext* gtk_widget_get_style_context GtkWidget* widget")


;;; 2.91.7 -- is any of this useful? -- docs say they're for people writing their own widgets

(CCAST-3.0 "GDK_CURSOR" "GdkCursor*")
(CCHK-3.0 "GDK_IS_CURSOR "GdkCursor*")

(CCAST-3.0 "GTK_CELL_AREA" "GtkCellArea*")
(CCHK-3.0 "GTK_IS_CELL_AREA" "GtkCellArea*")
;;; typedef gboolean* GtkCellCallback) GtkCellRenderer* renderer gpointer data

(CCAST-3.0 "GTK_CELL_AREA_BOX" "GtkCellAreaBox*")
(CCHK-3.0 "GTK_IS_CELL_AREA_BOX" "GtkCellAreaBox*")

(CCAST-3.0 "GTK_CELL_AREA_BOX_CONTEXT" "GtkCellAreaBoxContext*")
(CCHK-3.0 "GTK_IS_CELL_AREA_BOX_CONTEXT" "GtkCellAreaBoxContext*")

(CCAST-3.0 "GTK_CELL_AREA_CONTEXT" "GtkCellAreaContext*")
(CCHK-3.0 "GTK_IS_CELL_AREA_CONTEXT" "GtkCellAreaContext*")

(CFNC-3.0 "GtkWidget* gtk_cell_view_new_with_context GtkCellArea* area GtkCellAreaContext* context")

(CFNC-3.0 "void gtk_cell_area_add GtkCellArea* area GtkCellRenderer* renderer")
(CFNC-3.0 "void gtk_cell_area_remove GtkCellArea* area GtkCellRenderer* renderer")
(CFNC-3.0 "gboolean gtk_cell_area_has_renderer GtkCellArea* area GtkCellRenderer* renderer")
(CFNC-3.0 "void gtk_cell_area_foreach GtkCellArea* area GtkCellCallback callback gpointer callback_data")
(CFNC-3.0 "void gtk_cell_area_foreach_alloc GtkCellArea* area GtkCellAreaContext* context GtkWidget* widget GdkRectangle* cell_area GdkRectangle* background_area GtkCellAllocCallback callback gpointer callback_data" 'const)
(CFNC-3.0 "gint gtk_cell_area_event GtkCellArea* area GtkCellAreaContext* context GtkWidget* widget GdkEvent* event GdkRectangle* cell_area GtkCellRendererState flags" 'const)
(CFNC-3.0 "void gtk_cell_area_render GtkCellArea* area GtkCellAreaContext* context GtkWidget* widget cairo_t* cr GdkRectangle* background_area GdkRectangle* cell_area GtkCellRendererState flags gboolean paint_focus" 'const)
(CFNC-3.0 "void gtk_cell_area_set_style_detail GtkCellArea* area gchar* detail" 'const)
(CFNC-3.0 "gchar* gtk_cell_area_get_style_detail GtkCellArea* area" 'const)
(CFNC-3.0 "void gtk_cell_area_get_cell_allocation GtkCellArea* area GtkCellAreaContext* context GtkWidget* widget GtkCellRenderer* renderer GdkRectangle* cell_area GdkRectangle* allocation" 'const)
(CFNC-3.0 "GtkCellRenderer* gtk_cell_area_get_cell_at_position GtkCellArea* area GtkCellAreaContext* context GtkWidget* widget GdkRectangle* cell_area gint x gint y GdkRectangle* alloc_area" 'const)
(CFNC-3.0 "GtkCellAreaContext* gtk_cell_area_create_context GtkCellArea* area")
(CFNC-3.0 "GtkCellAreaContext* gtk_cell_area_copy_context GtkCellArea* area GtkCellAreaContext* context")
(CFNC-3.0 "GtkSizeRequestMode gtk_cell_area_get_request_mode GtkCellArea* area")
(CFNC-3.0 "void gtk_cell_area_get_preferred_width GtkCellArea* area GtkCellAreaContext* context GtkWidget* widget gint* [minimum_width] gint* [natural_width]")
(CFNC-3.0 "void gtk_cell_area_get_preferred_height_for_width GtkCellArea* area GtkCellAreaContext* context GtkWidget* widget gint width gint* [minimum_height] gint* [natural_height]")
(CFNC-3.0 "void gtk_cell_area_get_preferred_height GtkCellArea* area GtkCellAreaContext* context GtkWidget* widget gint* [minimum_height] gint* [natural_height]")
(CFNC-3.0 "void gtk_cell_area_get_preferred_width_for_height GtkCellArea* area GtkCellAreaContext* context GtkWidget* widget gint height gint* [minimum_width] gint* [natural_width]")
(CFNC-3.0 "gchar* gtk_cell_area_get_current_path_string GtkCellArea* area" 'const)
(CFNC-3.0 "void gtk_cell_area_apply_attributes GtkCellArea* area GtkTreeModel* tree_model GtkTreeIter* iter gboolean is_expander gboolean is_expanded")
(CFNC-3.0 "void gtk_cell_area_attribute_connect GtkCellArea* area GtkCellRenderer* renderer gchar* attribute gint column" 'const)
(CFNC-3.0 "void gtk_cell_area_attribute_disconnect GtkCellArea* area GtkCellRenderer* renderer gchar* attribute" 'const)
(CFNC-3.0 "void gtk_cell_area_class_install_cell_property GtkCellAreaClass* aclass guint property_id GParamSpec* pspec")
(CFNC-3.0 "GParamSpec* gtk_cell_area_class_find_cell_property GtkCellAreaClass* aclass gchar* property_name" 'const)
(CFNC-3.0 "GParamSpec** gtk_cell_area_class_list_cell_properties GtkCellAreaClass* aclass guint* n_properties")
;(CFNC-3.0 "void gtk_cell_area_add_with_properties GtkCellArea* area GtkCellRenderer* renderer gchar* first_prop_name ..." 'const) G_GNUC_NULL_TERMINATED
;(CFNC-3.0 "void gtk_cell_area_cell_set GtkCellArea* area GtkCellRenderer* renderer gchar* first_prop_name ..." 'const) G_GNUC_NULL_TERMINATED
;(CFNC-3.0 "void gtk_cell_area_cell_get GtkCellArea* area GtkCellRenderer* renderer gchar* first_prop_name ..." 'const) G_GNUC_NULL_TERMINATED
;(CFNC-3.0 "void gtk_cell_area_cell_set_valist GtkCellArea* area GtkCellRenderer* renderer gchar* first_property_name va_list var_args" 'const)
;(CFNC-3.0 "void gtk_cell_area_cell_get_valist GtkCellArea* area GtkCellRenderer* renderer gchar* first_property_name va_list var_args" 'const)
(CFNC-3.0 "void gtk_cell_area_cell_set_property GtkCellArea* area GtkCellRenderer* renderer gchar* property_name GValue* value" 'const)
(CFNC-3.0 "void gtk_cell_area_cell_get_property GtkCellArea* area GtkCellRenderer* renderer gchar* property_name GValue* value" 'const)
(CFNC-3.0 "gboolean gtk_cell_area_is_activatable GtkCellArea* area")
(CFNC-3.0 "gboolean gtk_cell_area_activate GtkCellArea* area GtkCellAreaContext* context GtkWidget* widget GdkRectangle* cell_area GtkCellRendererState flags gboolean edit_only" 'const)
(CFNC-3.0 "gboolean gtk_cell_area_focus GtkCellArea* area GtkDirectionType direction")
(CFNC-3.0 "void gtk_cell_area_set_focus_cell GtkCellArea* area GtkCellRenderer* renderer")
(CFNC-3.0 "GtkCellRenderer* gtk_cell_area_get_focus_cell GtkCellArea* area")
(CFNC-3.0 "void gtk_cell_area_add_focus_sibling GtkCellArea* area GtkCellRenderer* renderer GtkCellRenderer* sibling")
(CFNC-3.0 "void gtk_cell_area_remove_focus_sibling GtkCellArea* area GtkCellRenderer* renderer GtkCellRenderer* sibling")
(CFNC-3.0 "gboolean gtk_cell_area_is_focus_sibling GtkCellArea* area GtkCellRenderer* renderer GtkCellRenderer* sibling")
(CFNC-3.0 "GList* gtk_cell_area_get_focus_siblings GtkCellArea* area GtkCellRenderer* renderer" 'const)
(CFNC-3.0 "GtkCellRenderer* gtk_cell_area_get_focus_from_sibling GtkCellArea* area GtkCellRenderer* renderer")
(CFNC-3.0 "GtkCellRenderer* gtk_cell_area_get_edited_cell GtkCellArea* area")
(CFNC-3.0 "GtkCellEditable* gtk_cell_area_get_edit_widget GtkCellArea* area")
(CFNC-3.0 "gboolean gtk_cell_area_activate_cell GtkCellArea* area GtkWidget* widget GtkCellRenderer* renderer GdkEvent* event GdkRectangle* cell_area GtkCellRendererState flags" 'const)
(CFNC-3.0 "void gtk_cell_area_stop_editing GtkCellArea* area gboolean canceled")
(CFNC-3.0 "void gtk_cell_area_inner_cell_area GtkCellArea* area GtkWidget* widget GdkRectangle* cell_area GdkRectangle* inner_area" 'const)
(CFNC-3.0 "void gtk_cell_area_request_renderer GtkCellArea* area GtkCellRenderer* renderer GtkOrientation orientation GtkWidget* widget gint for_size gint* minimum_size gint* natural_size")
(CFNC-3.0 "void _gtk_cell_area_set_cell_data_func_with_proxy GtkCellArea* area GtkCellRenderer* cell GFunc func gpointer func_data GDestroyNotify destroy gpointer proxy")
(CFNC-3.0 "GtkCellArea* gtk_cell_area_box_new void")
(CFNC-3.0 "void gtk_cell_area_box_pack_start GtkCellAreaBox* box GtkCellRenderer* renderer gboolean expand gboolean align gboolean fixed")
(CFNC-3.0 "void gtk_cell_area_box_pack_end GtkCellAreaBox* box GtkCellRenderer* renderer gboolean expand gboolean align gboolean fixed")
(CFNC-3.0 "gint gtk_cell_area_box_get_spacing GtkCellAreaBox* box")
(CFNC-3.0 "void gtk_cell_area_box_set_spacing GtkCellAreaBox* box gint spacing")
(CFNC-3.0 "GtkCellAreaBoxContext* gtk_cell_area_box_context_copy GtkCellAreaBox* box GtkCellAreaBoxContext* box_context")
(CFNC-3.0 "void gtk_cell_area_box_init_groups GtkCellAreaBoxContext* box_context guint n_groups gboolean* expand_groups gboolean* align_groups")
(CFNC-3.0 "void gtk_cell_area_box_context_push_group_width GtkCellAreaBoxContext* box_context gint group_idx gint minimum_width gint natural_width")
(CFNC-3.0 "void gtk_cell_area_box_context_push_group_height_for_width GtkCellAreaBoxContext* box_context gint group_idx gint for_width gint minimum_height gint natural_height")
(CFNC-3.0 "void gtk_cell_area_box_context_push_group_height GtkCellAreaBoxContext* box_context gint group_idx gint minimum_height gint natural_height")
(CFNC-3.0 "void gtk_cell_area_box_context_push_group_width_for_height GtkCellAreaBoxContext* box_context gint group_idx gint for_height gint minimum_width gint natural_width")
(CFNC-3.0 "void gtk_cell_area_box_context_get_group_width GtkCellAreaBoxContext* box_context gint group_idx gint* [minimum_width] gint* [natural_width]")
(CFNC-3.0 "void gtk_cell_area_box_context_get_group_height_for_width GtkCellAreaBoxContext* box_context gint group_idx gint for_width gint* [minimum_height] gint* [natural_height]")
(CFNC-3.0 "void gtk_cell_area_box_context_get_group_height GtkCellAreaBoxContext* box_context gint group_idx gint* [minimum_height] gint* [natural_height]")
(CFNC-3.0 "void gtk_cell_area_box_context_get_group_width_for_height GtkCellAreaBoxContext* box_context gint group_idx gint for_height gint* [minimum_width] gint* [natural_width]")
(CFNC-3.0 "GtkRequestedSize* gtk_cell_area_box_context_get_widths GtkCellAreaBoxContext* box_context gint* [n_widths]")
(CFNC-3.0 "GtkRequestedSize* gtk_cell_area_box_context_get_heights GtkCellAreaBoxContext* box_context gint* [n_heights]")
(CFNC-3.0 "GtkCellArea* gtk_cell_area_context_get_area GtkCellAreaContext* context")
(CFNC-3.0 "void gtk_cell_area_context_allocate GtkCellAreaContext* context gint width gint height")
(CFNC-3.0 "void gtk_cell_area_context_reset GtkCellAreaContext* context")
(CFNC-3.0 "void gtk_cell_area_context_get_preferred_width GtkCellAreaContext* context gint* [minimum_width] gint* [natural_width]")
(CFNC-3.0 "void gtk_cell_area_context_get_preferred_height GtkCellAreaContext* context gint* [minimum_height] gint* [natural_height]")
(CFNC-3.0 "void gtk_cell_area_context_get_preferred_height_for_width GtkCellAreaContext* context gint width gint* [minimum_height] gint* [natural_height]")
(CFNC-3.0 "void gtk_cell_area_context_get_preferred_width_for_height GtkCellAreaContext* context gint height gint* [minimum_width] gint* [natural_width]")
(CFNC-3.0 "void gtk_cell_area_context_get_allocation GtkCellAreaContext* context gint* [width] gint* [height]")
(CFNC-3.0 "void gtk_cell_area_context_push_preferred_width GtkCellAreaContext* context gint minimum_width gint natural_width")
(CFNC-3.0 "void gtk_cell_area_context_push_preferred_height GtkCellAreaContext* context gint minimum_height gint natural_height")
(CFNC-3.0 "GtkCellArea* gtk_cell_layout_get_area GtkCellLayout* cell_layout")
(CFNC-3.0 "void gtk_cell_renderer_get_aligned_area GtkCellRenderer* cell GtkWidget* widget GtkCellRendererState flags GdkRectangle* cell_area GdkRectangle* aligned_area" 'const)
(CFNC-3.0 "gboolean gtk_cell_renderer_is_activatable GtkCellRenderer* cell")
(CFNC-3.0 "GtkEntryCompletion* gtk_entry_completion_new_with_area GtkCellArea* area")
;;; 3.7.4 (CFNC-3.0 "const PangoFontDescription* gtk_style_context_get_font GtkStyleContext* context GtkStateFlags state")
(CFNC-3.0 "GtkTreeViewColumn* gtk_tree_view_column_new_with_area GtkCellArea* area")
