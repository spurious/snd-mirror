...
(CFNC-3.14 "GdkEvent* gtk_gesture_get_last_event GtkGesture* gesture GdkEventSequence* sequence")
...
(CCAST-3.14 "GTK_EVENT_CONTROLLER" "GttEventController*")
(CCHK-3.14 "GTK_IS_EVENT_CONTROLLER" "GttEventController*")
