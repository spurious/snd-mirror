...
(define* (CFNC-2134 data :optional spec)
  (let ((name (cadr-str data))
	(args (caddr-str data)))
    (if (assoc name names)
...
(define* (CFNC-2150 data :optional spec)
  (let ((name (cadr-str data))
	(args (caddr-str data)))
    (if (assoc name names)
...
(define* (CFNC-2172 data :optional spec)
  (let ((name (cadr-str data))
	(args (caddr-str data)))
    (if (assoc name names)
...
(define* (CFNC-2173 data :optional spec)
  (let ((name (cadr-str data))
	(args (caddr-str data)))
    (if (assoc name names)
...
(define* (CFNC-2177 data :optional spec)
  (let ((name (cadr-str data))
	(args (caddr-str data)))
    (if (assoc name names)
...
(define* (CINT-2134 name :optional type)
  (save-declared-type type)
  (if (assoc name names)
...
(define* (CINT-2150 name :optional type)
  (save-declared-type type)
  (if (assoc name names)
...
(define* (CINT-2172 name :optional type)
  (save-declared-type type)
  (if (assoc name names)
...
(define* (CINT-2173 name :optional type)
  (save-declared-type type)
  (if (assoc name names)
...
(define* (CINT-2177 name :optional type)
  (save-declared-type type)
  (if (assoc name names)
...
(if (not (null? types-2190)) (with-2190 hey (lambda () (for-each type-it (reverse types-2190)))))
...
(if (not (null? funcs-2190)) (with-2190 hey (lambda () (for-each handle-func (reverse funcs-2190)))))
...
(if (not (null? casts-2190)) (with-2190 hey (lambda () (for-each cast-it (reverse casts-2190)))))
...
(if (not (null? checks-2190)) (with-2190 hey (lambda () (for-each make-check (reverse checks-2190)))))
...
(hey "    }~%")
(hey "  return(XEN_WRAP_C_POINTER(pt));~%")
(hey "}~%")
(hey "~%")
...
(hey "  XEN_ASSERT_TYPE(XEN_WRAPPED_C_POINTER_P(arg1), arg1, XEN_ONLY_ARG, \"freeGdkPoints\", \"opaque GdkPoint array\");~%")
(hey "  pts = (void *)(XEN_UNWRAP_C_POINTER(arg1));~%") 
(hey "  free(pts);~%")
(hey "  return(XEN_FALSE);~%")
(hey "}~%")
(hey "~%")
...
(if (not (null? funcs-2190)) (with-2190 hey (lambda () (for-each argify-func (reverse funcs-2190)))))
...
(if (not (null? casts-2190)) (with-2190 hey (lambda () (for-each ruby-cast (reverse casts-2190)))))
...
(if (not (null? checks-2190)) (with-2190 hey (lambda () (for-each ruby-check (reverse checks-2190)))))
...
(if (not (null? funcs-2190)) (with-2190 hey (lambda () (for-each unargify-func (reverse funcs-2190)))))
...
(if (not (null? casts-2190)) (with-2190 hey (lambda () (for-each ruby-uncast (reverse casts-2190)))))
...
(if (not (null? checks-2190)) (with-2190 hey (lambda () (for-each ruby-uncheck (reverse checks-2190)))))
...
(if (not (null? funcs-2190)) (with-2190 hey (lambda () (for-each defun (reverse funcs-2190)))))
...
(if (not (null? casts-2190)) (with-2190 hey (lambda () (for-each cast-out (reverse casts-2190)))))
...
(if (not (null? checks-2190)) (with-2190 hey (lambda () (for-each check-out (reverse checks-2190)))))
