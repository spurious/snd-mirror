...
(hey " *~%")
(hey " * HISTORY:~%")
(hey " *     21-Jul:    gtk 2.7.3.~%")
(hey " *     9-Jul:     gtk 2.7.2.  Collapse 2.3.1 to 2.3.5 into 2.3.6, 2.5.1 to 2.5.5 into 2.5.6.~%")
(hey " *     5-Jul:     gtk 2.7.1.~%")
(hey " *     23-Jun:    gtk 2.7.0.~%")
...
(hey " *                gtk 2.5.6 and pango 1.7.0.~%")
(hey " *     3-Dec:     changed GPOINTER cast func to accept non-lists.~%")
(hey " *     15-Nov:    gtk 2.5.5.~%")
(hey " *     29-Oct:    gtk 2.5.4.~%")
(hey " *     27-Aug:    gtk 2.5.2. removed the PANGO_ENGINE and PANGO_BACKEND stuff.~%")
(hey " *     5-Aug:     gtk 2.5.1.~%")
(hey " *     21-Jul:    gtk 2.5.0.~%")
...
(hey " *     11-Mar:    gtk 2.3.6.~%")
(hey " *     4-Mar:     gtk 2.3.5.~%")
(hey " *     26-Feb:    gtk 3.2.4.~%")
(hey " *     12-Feb:    g_list_nth_data (Kjetil S. Matheussen).~%")
(hey " *     6-Feb:     gtk 2.3.2.~%")
(hey " *     --------~%")
(hey " *     16-Dec:    gtk 2.3.1.~%")
(hey " *     1-Dec:     gtk 2.3.~%")
