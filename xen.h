...
#define XEN_CONS(Arg1, Arg2)                       s7_cons(s7, s7_ungc(s7, Arg1), s7_ungc(s7, Arg2))
#define XEN_CONS_2(Arg1, Arg2, Arg3)               s7_cons(s7, s7_ungc(s7, Arg1), s7_ungc(s7, XEN_CONS(Arg2, Arg3)))
...
#define XEN_LIST_1(a)                              s7_ungc(s7, XEN_CONS(s7_ungc(s7, a), xen_nil))
#define XEN_LIST_2(a, b)                           s7_ungc(s7, XEN_CONS(s7_ungc(s7, a), XEN_LIST_1(b)))
#define XEN_LIST_3(a, b, c)                        s7_ungc(s7, XEN_CONS(s7_ungc(s7, a), XEN_LIST_2(b, c)))
#define XEN_LIST_4(a, b, c, d)                     s7_ungc(s7, XEN_CONS(s7_ungc(s7, a), XEN_LIST_3(b, c, d)))
#define XEN_LIST_5(a, b, c, d, e)                  s7_ungc(s7, XEN_CONS(s7_ungc(s7, a), XEN_LIST_4(b, c, d, e)))
#define XEN_LIST_6(a, b, c, d, e, f)               s7_ungc(s7, XEN_CONS(s7_ungc(s7, a), XEN_LIST_5(b, c, d, e, f)))
#define XEN_LIST_7(a, b, c, d, e, f, g)            s7_ungc(s7, XEN_CONS(s7_ungc(s7, a), XEN_LIST_6(b, c, d, e, f, g)))
#define XEN_LIST_8(a, b, c, d, e, f, g, h)         s7_ungc(s7, XEN_CONS(s7_ungc(s7, a), XEN_LIST_7(b, c, d, e, f, g, h)))
#define XEN_LIST_9(a, b, c, d, e, f, g, h, i)      s7_ungc(s7, XEN_CONS(s7_ungc(s7, a), XEN_LIST_8(b, c, d, e, f, g, h, i)))
