             ...
             (set! transient-dialog
                   (make-effect-dialog "transient-mangler ladspa plugin"
                                       ...
                                       (lambda (w c i)
                                         ...
                                         (|XtSetValues (car sliders) (list |XmNvalue (inexact->exact (* transient-attack-speed 100))))
                                         (set! transient-sustain-time 1)
                                         (|XtSetValues (cadr sliders) (list |XmNvalue (inexact->exact (* transient-sustain-time 100)))))))
             (set! sliders
