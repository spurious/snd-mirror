...
;; Last: Mon Dec 09 05:03:24 CET 2002
...
(defconst inf-snd-rcsid "$Id: inf-snd.el,v 1.3.2.1 2002/12/09 04:06:20 mike Exp $")
...
(defun inf-snd-set-keys (mode-name name)
  "Load the key bindings and menu entries for MODE-NAME.
Menu name is NAME. You can extend the key bindings and menu entries
here or via the hook  in .emacs file."
  ;; key bindings
  ...
  (define-key (current-local-map) [menu-bar mode-name]
    (cons name (make-sparse-keymap name)))
  (define-key (current-local-map) [menu-bar mode-name quit]
    '(menu-item "Quit Snd Session" inf-snd-quit))
  (define-key (current-local-map) [menu-bar mode-name kill]
    '(menu-item "Kill Snd Process only" inf-snd-kill))
  (define-key (current-local-map) [menu-bar mode-name break]
    '(menu-item "Send C-g to Snd Process" inf-snd-break))
  (define-key (current-local-map) [menu-bar mode-name sep-quit] '(menu-item "--"))
  (define-key (current-local-map) [menu-bar mode-name desc]
    '(menu-item "Describe Mode" describe-mode))
  (define-key (current-local-map) [menu-bar mode-name help]
    '(menu-item "Describe Snd Function ..." inf-snd-help))
  (define-key (current-local-map) [menu-bar mode-name sep-desc] '(menu-item "--"))
  (define-key (current-local-map) [menu-bar mode-name stop]
    '(menu-item "Stop Playing" inf-snd-stop))
  (define-key (current-local-map) [menu-bar mode-name play]
    '(menu-item "Start Playing" inf-snd-play))
  (define-key (current-local-map) [menu-bar mode-name sep-play] '(menu-item "--"))
  (define-key (current-local-map) [menu-bar mode-name load-r]
    '(menu-item "Load Ruby Script ..." inf-snd-load
		:visible inf-snd-ruby-flag))
  (define-key (current-local-map) [menu-bar mode-name load-g]
    '(menu-item "Load Guile Script ..." inf-snd-load
		:visible (not inf-snd-ruby-flag)))
  (define-key (current-local-map) [menu-bar mode-name file]
...
(defun snd-set-keys (mode-name name)
  "Load the key bindings and menu entries for MODE-NAME.
Menu name is NAME. You can extend the key bindings and menu entries
here or via the hook variables in .emacs file."
...
(unless inf-snd-keywords
  (setq inf-snd-keywords
	  ...
	  ("hankel-jn") ("hankel-transform") ("header-type")
	  ("help-dialog") ("help-hook") ("help-text-font")
	  ("hide-widget") ("highlight-color") ("html-dir")
	  ("in") ("initial-graph-hook") ("insert-region")
	  ("insert-sample") ("insert-samples") ("insert-samples-with-origin")
	  ("insert-selection") ("insert-silence") ("insert-sound")
	  ("just-sounds") ("just-sounds-hook") ("key")
	  ("key-binding") ("key-press-hook") ("keyboard-no-action")
	  ("ladspa-dir") ("left-sample") ("lisp-graph?")
	  ("lisp-graph") ("lisp-graph-hook") ("lisp-graph-style")
	  ("listener-color") ("listener-font") ("listener-prompt")
	  ("listener-selection") ("listener-text-color") ("load-font")
	  ("loop-samples") ("main-menu") ("main-widgets")
	  ("make-color") ("make-graph-data") ("make-mix-sample-reader")
	  ("make-player") ("make-region") ("make-region-sample-reader")
	  ("make-sample-reader") ("make-track-sample-reader") ("map-chan")
	  ("map-channel") ("mark-click-hook") ("mark-color")
	  ("mark-context") ("mark-drag-hook") ("mark-home")
	  ("mark-hook") ("mark-name") ("mark?")
	  ("mark-sample") ("mark-sync") ("mark-sync-max")
	  ("marks") ("max-regions") ("max-transform-peaks")
	  ("maxamp") ("memo-sound") ("menu-hook")
	  ("menu-sensitive") ("menu-widgets") ("min-dB")
	  ("minibuffer-history-length") ("mix") ("mix-amp")
	  ("mix-amp-changed-hook") ("mix-amp-env") ("mix-anchor")
	  ("mix-chans") ("mix-color") ("mix-file-dialog")
	  ("mix-frames") ("mix-home") ("mix-locked")
	  ("mix-name") ("mix?") ("mix-panel")
	  ("mix-position") ("mix-position-changed-hook") ("mix-region")
	  ("mix-sample-reader?") ("mix-selection") ("mix-sound")
	  ("mix-speed") ("mix-speed-changed-hook") ("mix-tag-height")
	  ("mix-tag-width") ("mix-tag-y") ("mix-track")
	  ("mix-vct") ("mix-waveform-height") ("mixes")
	  ("mouse-click-hook") ("mouse-drag-hook") ("mouse-enter-graph-hook")
	  ("mouse-enter-label-hook") ("mouse-enter-listener-hook") ("mouse-enter-text-hook")
	  ("mouse-leave-graph-hook") ("mouse-leave-label-hook") ("mouse-leave-listener-hook")
	  ("mouse-leave-text-hook") ("mouse-press-hook") ("mouse-release-hook")
	  ("multichannel-mix-hook") ("mus-error-hook") ("name-click-hook")
	  ("new-sound") ("new-widget-hook") ("next-mix-sample")
	  ("next-sample") ("next-track-sample") ("normalize-by-channel")
	  ("normalize-by-sound") ("normalize-globally") ("open-file-dialog")
	  ("open-hook") ("open-raw-sound") ("open-raw-sound-hook")
	  ("open-sound") ("open-sound-file") ("optimization")
	  ("optimization-hook") ("orientation-dialog") ("output-comment-hook")
	  ("output-name-hook") ("pad-channel") ("peak-env-info")
	  ("peaks") ("peaks-font") ("play")
	  ("play-and-wait") ("play-channel") ("play-hook")
	  ("play-mix") ("play-region") ("play-selection")
	  ("play-track") ("player-home") ("player?")
	  ("position->x") ("position->y") ("position-color")
	  ("preload-directory") ("preload-file") ("previous-files-select-hook")
	  ("previous-files-sort") ("previous-files-sort-procedure") ("previous-sample")
	  ("print-hook") ("print-length") ("progress-report")
	  ("prompt-in-minibuffer") ("property-changed-hook") ("protect-region")
	  ("ptree-channel") ("pushed-button-color") ("ramp-channel")
	  ("read-hook") ("read-only") ("read-peak-env-info-file")
	  ("read-sample") ("read-mix-sample") ("read-track-sample")
	  ("recolor-widget") ("recorder-autoload") ("recorder-buffer-size")
	  ("recorder-dialog") ("recorder-file") ("recorder-gain")
	  ("recorder-in-amp") ("recorder-in-format") ("recorder-in-device")
	  ("recorder-max-duration") ("recorder-out-amp") ("recorder-out-chans")
	  ("recorder-out-format") ("recorder-srate") ("recorder-trigger")
	  ("redo") ("region-chans") ("region-dialog")
	  ("region-frames") ("region-graph-style") ("region-maxamp")
	  ("region?") ("region-sample") ("region-samples")
	  ("region-samples->vct") ("region-srate") ("regions")
	  ("remove-from-menu") ("report-in-minibuffer") ("reset-controls")
	  ("reset-listener-cursor") ("restore-controls") ("restore-marks")
	  ("restore-region") ("reverb-control-decay") ("reverb-control-feedback")
	  ("reverb-control-length") ("reverb-control-lowpass") ("reverb-control?")
	  ("reverb-control-scale") ("reverse-channel") ("reverse-selection")
	  ("reverse-sound") ("revert-sound") ("right-sample")
	  ("run") ("sample") ("sample-reader-at-end?")
	  ("sample-reader-home") ("sample-reader-position") ("sample-reader?")
	  ("samples") ("samples->sound-data") ("samples->vct")
	  ("sash-color") ("save-controls") ("save-dir")
	  ("save-edit-history") ("save-envelopes") ("save-hook")
	  ("save-listener") ("save-macros") ("save-marks")
	  ("save-options") ("save-region") ("save-selection")
	  ("save-sound") ("save-sound-as") ("save-state")
	  ("save-state-file") ("save-state-hook") ("scale-by")
	  ("scale-channel") ("scale-selection-by") ("scale-selection-to")
	  ("scale-sound-by") ("scale-sound-to") ("scale-to")
	  ("scan-chan") ("scan-channel") ("script-arg")
	  ("script-args") ("search-procedure") ("select-all")
	  ("select-channel") ("select-channel-hook") ("select-mix")
	  ("select-mix-hook") ("select-sound") ("select-sound-hook")
	  ("selected-channel") ("selected-data-color") ("selected-graph-color")
	  ("selected-mix") ("selected-mix-color") ("selected-sound")
	  ("selection-chans") ("selection-color") ("selection-context")
	  ("selection-creates-region") ("selection-frames") ("selection-maxamp")
	  ("selection-member?") ("selection?") ("selection-position")
	  ("selection-srate") ("short-file-name") ("show-all-axes")
	  ("show-axes") ("show-backtrace") ("show-controls")
	  ("show-indices") ("show-listener") ("show-marks")
	  ("show-mix-waveforms") ("show-no-axes") ("show-selection-transform")
	  ("show-transform-peaks") ("show-widget") ("show-x-axis")
	  ("show-y-zero") ("sinc-width") ("smooth-channel")
	  ("smooth-selection") ("smooth-sound") ("snd-apropos")
	  ("snd-error") ("snd-error-hook") ("snd-gcs")
	  ("snd-help") ("snd-print") ("snd-spectrum")
	  ("snd-tempnam") ("snd-version") ("snd-warning")
	  ("snd-warning-hook") ("sound-files-in-directory") ("sound-loop-info")
	  ("sound?") ("sound-properties") ("sound-widgets")
	  ("soundfont-info") ("sounds") ("spectro-cutoff")
	  ("spectro-hop") ("spectro-start") ("spectro-x-angle")
	  ...
	  ("srate") ("src-channel") ("src-selection")
	  ("src-sound") ("start-hook") ("start-playing")
	  ("start-playing-hook") ("start-progress-report") ("stop-dac-hook")
	  ("stop-player") ("stop-playing") ("stop-playing-channel-hook")
	  ("stop-playing-hook") ("stop-playing-region-hook") ("stop-playing-selection-hook")
	  ("swap-channels") ("sync") ("syncd-marks")
	  ("temp-dir") ("text-focus-color") ("time-graph")
	  ("time-graph?") ("time-graph-style") ("time-graph-type")
	  ("tiny-font") ("track-sample-reader?") ("transform-dialog")
	  ("transform-graph") ("transform-graph?") ("transform-graph-style")
	  ("transform-graph-type") ("transform-hook") ("transform-normalization")
	  ("transform-sample") ("transform-samples") ("transform-samples-size")
	  ("transform-samples->vct") ("transform-size") ("transform-type")
	  ("trap-segfault") ("unbind-key") ("undo")
	  ("undo-hook") ("update-hook") ("update-lisp-graph")
	  ("update-sound") ("update-time-graph") ("update-transform-graph")
	  ("use-sinc-interp") ("vct-map") ("vct->channel")
	  ("vct->samples") ("vct->sound-file") ("verbose-cursor")
	  ("view-sound") ("vu-font") ("vu-font-size")
	  ("vu-size") ("walsh-transform") ("wavelet-transform")
	  ("wavelet-type") ("wavo-hop") ("wavo-trace")
	  ("widget-position") ("widget-size") ("widget-text")
	  ("window-height") ("window-width") ("window-x")
	  ("window-y") ("with-background-processes") ("with-gl")
	  ("with-mix-tags") ("with-relative-panes") ("write-peak-env-info-file")
	  ("x->position") ("x-axis-as-percentage") ("x-axis-in-beats")
	  ("x-axis-in-samples") ("x-axis-in-seconds") ("x-axis-style")
	  ("x-bounds") ("x-position-slider") ("x-zoom-slider")
	  ("y->position") ("y-bounds") ("y-position-slider")
	  ("y-zoom-slider") ("yes-or-no?") ("zero-pad")
	  ("zoom-color") ("zoom-focus-active") ("zoom-focus-left")
	  ("zoom-focus-middle") ("zoom-focus-right") ("zoom-focus-style"))))
