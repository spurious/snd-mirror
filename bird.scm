...
(define b-louisiana-waterthrush
  (let ((documentation "(louisiana-waterthrush beg) produces a louisiana waterthrush call at time 'beg'"))
	...
	(bird (+ beg .9) .2 3900 2000 .3 '(.00 1.00 .40 .00 .60 .10 1.00 .80 ) bird-tap)
...
(define b-robin
  (let ((documentation "(robin beg) produces a robin call at time 'beg'"))
    (lambda (beg)
      (set! beg (- beg .45))
      (bigbird (+ beg .45) .06 2000 800 .15 '(.00 .00 .12 .70 .30 .00 .70 1.00 1.00 .50 ) main-amp '(1 1 2 .1))
      (bigbird (+ beg .56) .10 2000 900 .15 '(.00 .10 .08 .70 .30 .00 .35 1.00 .40 .30 1.00 .30 ) main-amp '(1 1 2 .1))
      (bigbird (+ beg 1.04) .24 2000 2000 .25 '(.00 .00 .10 1.00 .20 .70 .35 .70 .65 .30 .70 .50 .80 .00 .90 .20 1.00 .0) main-amp '(1 1 2 .1))
      (bigbird (+ beg 1.63) .13 1900 1600 .20 '(.00 .20 .25 1.00 .60 .70 .90 .00 1.00 .10 ) main-amp '(1 1 2 .1))
      (bigbird (+ beg 1.80) .11 2200 1200 .25 '(.00 1.00 1.00 .0) main-amp '(1 1 2 .1))
      (bigbird (+ beg 2.31) .21 1950 2000 .15 '(.00 .50 .10 .00 .20 1.00 .30 .00 .40 1.00 .50 .00 .60 1.00 .70 .50 1.00 .20 ) main-amp '(1 1 2 .1)))))
...
(define b-eastern-phoebe
  (let ((documentation "(eastern-phoebe beg) produces an eastern-phoebe call at time 'beg'"))
	...
	(bird beg .225 3000 1300 .3 '(.00 .00 .30 .30 .35 .50 .55 .40 .70 .80 .75 .70 .80 1.00 .95 .90 1.00 .0) main-amp)
	(bird (+ beg .35) .12 3000 500 .1 '(.00 .00 .50 1.00 1.00 .0) phoebe-amp)
	(bird (+ beg .4) .10 3000 1500 .2 '(.00 .00 .10 .40 .80 1.00 1.00 .10 ) phoebe-amp)
	(bird (+ beg .55) .05 3000 1400 .2 '(.00 1.00 .50 .70 1.00 .0) phoebe-amp)))))
...
(define b-painted-bunting
  (let ((documentation "(painted-bunting beg) produces a painted bunting call at time 'beg'"))
	...
	(set! beg (- beg .05))
	(bird (+ beg .05) .10 3100 900 .05 b-one '(.00 .00 .90 1.00 1.00 .0))
	(bird (+ beg .21) .07 4100 700 .15 '(.00 1.00 1.00 .0) main-amp)
	(bird (+ beg .36) .12 3700 1000 .20 '(.00 .00 .50 1.00 1.00 .0) main-amp)
...
(define b-kentucky-warbler
  (let ((documentation "(kentucky-warbler beg) produces a kentucky warbler call at time 'beg'"))
	...
	(bigbird (+ beg .65) .03 4300 200 .15 '(.00 .00 1.00 1.0) main-amp '(1 1 2 .1))
...
(define b-black-throated-sparrow
  (let ((documentation "(black-throated-sparrow beg) produces a black throated sparrow call at time 'beg'"))
	...
	(bird (+ beg 1.52) .05 5600 400 .15 '(.00 .00 .50 1.00 1.00 .20) bird-amp)
