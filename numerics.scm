    ...
    (cond ((zero? m) 0)
	  ...
	  ((= n 257)
	   `(let* ((A1 (sqrt (- 514 (* 2 (sqrt 257)))))
		   ...
		   (A14 (sqrt (+ A8 (* 6 A1) (* -8 A9) (* 24 A10) (* -12 A11))))
		   (A15 (sqrt (+ A8 (* -6 A1) (* -12 A12) (* 24 A9) (* 8 A10))))
		   (A16 (sqrt (* 2 (+ (- 257 (* 9 (sqrt 257))) (* -3 A1) (* 6 A12) (* -12 A9) (* -4 A10)))))
		   (A17 (sqrt (* 2 (+ A7 (* -3 AA) (* -4 A12) (* 6 A9) (* 12 A11)))))
		   (A18 (sqrt (* 2 (+ A7 (* 3 AA) (* 12 A12) (* -6 A10) (* 4 A11)))))
		   (A19 (sqrt (* 2 (+ A7 (* 3 AA) (* -12 A12) (* 6 A10) (* -4 A11)))))
		   (A20 (sqrt (* 2 (+ A7 (* -3 AA) (* 4 A12) (* -6 A9) (* -12 A11)))))
		   (A22 (+ A4 (* 3 A1) (* -4 AA) (* -4 A12) (* 4 A9) (* -4 A10) (* 2 A11)))
		   (A23 (+ A5 (* -4 A1) (* -3 AA) (* -4 A12) (* 2 A9) (* 4 A10) (* 4 A11)))
		   (A24 (+ A5 (* 4 A1) (* 3 AA) (* 4 A12) (* 4 A9) (* -2 A10) (* 4 A11)))
		   (A26 (+ (* -4 A16) (* -4 A19) (* 4 A17) (* -6 A13)))
		   (A27 (+ (* 4 A16) (* 4 A19) (* -4 A17) (* 6 A13)))
		   (A28 (+ 257 (* 7 (sqrt 257)) (* 3 A1) (* -4 A9) (* 4 A10) (* 6 A11)))
		   (A29 (+ A24 (* 4 A15) (* -4 A20) (* -6 A18) (* -4 A13)))
		   (A30 (+ A28 (* -4 A18) (* -4 A17) (* -2 A13)))
		   (A31 (+ (* 8 (sqrt (+ A23 (* 4 A15) (* 4 A14) (* 4 A18) (* -6 A17)))) 
			   (* 4 (sqrt (+ A22 A26))) (* 8 (sqrt A29)) (* -8 (sqrt (+ A22 A27)))))
		   (A32 (sqrt (+ A22 A26)))
		   (A33 (sqrt (+ A22 A27))))
	      (* 1/16 (sqrt (* 1/2 (+ A4 (- A1) (* -2 A11) (* -2 A13) (* -4 A32)
				      (* -4 (sqrt (* 2 (+ A30 (- A31)))))
				      (* -8 (sqrt (+ A4 (- A1) (* -2 A11) (* 6 A13) (* -4 A32) (* -8 A33)
						     (* 4 (sqrt (* 2 (+ A30 A31))))
						     (* -8 (sqrt (* 2 (+ A28 (* 4 A18) (* 4 A17) (* 2 A13) (* -8 A32) (* -4 A33)
									 (* -8 (sqrt (+ A23 (* -4 A15) (* -4 A14) (* -4 A18) (* 6 A17))))
									 (* -8 (sqrt (+ A24 (* -4 A15) (* 4 A20) (* 6 A18) (* 4 A13)))))))))))))))))
