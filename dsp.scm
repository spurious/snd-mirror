...
(define (sin-m*pi/n m1 n1)
  ...
  ;;   if we can handle n -- currently it can be anything of the form 2^a 3^b [5 | 7 | 17 | 35]
  ...
  (let ((m (numerator (/ m1 n1)))
    ...
    (cond ((zero? m) 0)
	  ...
	  ((= n 7)
	   (cond ((or (= m 1)
		     (= m 6)) `(sqrt (+ 7/12 
					(* -1/2 (+ (expt (+ -7/3456 (sqrt -49/442368)) 1/3) (expt (- -7/3456 (sqrt -49/442368)) 1/3))) 
					(* 1/2 0+i (sqrt 3) (-  (expt (+ -7/3456 (sqrt -49/442368)) 1/3) (expt (- -7/3456 (sqrt -49/442368)) 1/3))))))
		 ((or (= m 2)
		      (= m 5)) `(sqrt (+ 7/12 
					 (* -1/2 (+ (expt (+ -7/3456 (sqrt -49/442368)) 1/3) (expt (- -7/3456 (sqrt -49/442368)) 1/3))) 
					 (* -1/2 0+i (sqrt 3) (- (expt (+ -7/3456 (sqrt -49/442368)) 1/3) (expt (- -7/3456 (sqrt -49/442368)) 1/3))))))
	  ...
	  ((= n 17)
	   (cond ((= m 1)                 ; there's a typo in this formula in Weisstein
		  `(* 1/8 (sqrt 2) 
		      (sqrt (- 17 
			       (sqrt 17)
			       (* (sqrt 2)
	  ...
	  ;; any fermat number should be do-able 2^2^n +1 = 5 17 257 65537 4294967297
	  (else #f))))
