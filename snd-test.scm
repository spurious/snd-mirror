...
(define (region2vct r c)
  (region-samples->vct 0 (region-length r) r c))
...
")))
	...
	(let* ((rid1 (make-region 2000 2020 ind 0))
	       (rid1-data (region2vct rid1 0)))
	  (scale-to .5)
	  (let ((nv (region2vct rid1 0)))
