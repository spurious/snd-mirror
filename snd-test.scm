...
(if (or full-test (= snd-test 4))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-aifc)) 
	      (snd-print (format #f ";save-as aifc -> ~A?" (mus-header-type-name (header-type ab)))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-raw)) 
	      (snd-print (format #f ";save-as raw -> ~A?" (mus-header-type-name (header-type ab)))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-nist)) 
	      (snd-print (format #f ";save-as nist -> ~A?" (mus-header-type-name (header-type ab)))))
	  ...
	  (if (not (= (data-format ab) mus-bint)) 
	      (snd-print (format #f ";save-as int -> ~A?" (mus-data-format-name (data-format ab)))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-riff)) 
	      (snd-print (format #f ";save-as riff -> ~A?" (mus-header-type-name (header-type ab)))))
	  ...
	  (if (not (= (data-format ab) mus-lfloat)) 
	      (snd-print (format #f ";save-as float -> ~A?" (mus-data-format-name (data-format ab)))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-aiff)) 
	      (snd-print (format #f ";save-as aiff -> ~A?" (mus-header-type-name (header-type ab)))))
	  ...
	  (if (not (= (data-format ab) mus-b24int))
	      (snd-print (format #f ";save-as 24-bit -> ~A?" (mus-data-format-name (data-format ab)))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-ircam)) 
	      (snd-print (format #f ";save-as ircam -> ~A?" (mus-header-type-name (header-type ab)))))
	  ...
	  (if (not (= (data-format ab) mus-mulaw))
	      (snd-print (format #f ";save-as mulaw -> ~A?" (mus-data-format-name (data-format ab)))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-next)) 
	      (snd-print (format #f ";save-as next -> ~A?" (mus-header-type-name (header-type ab)))))
	  ...
	  (if (not (= (data-format ab) mus-alaw)) 
	      (snd-print (format #f ";save-as alaw -> ~A?" (mus-data-format-name (data-format ab)))))
	...
	(let ((ab (open-sound "test.snd")))
	  ...
	  (if (not (= (data-format ab) mus-bshort)) 
	      (snd-print (format #f ";save-as short -> ~A?" (mus-data-format-name (data-format ab)))))
...
(if (or full-test (= snd-test 5))
	...
	(if (and psf (string? psf))
      ...
      (if (not (= (data-format index) 1)) (snd-print (format #f ";oboe: format ~A?" (data-format index))))
...
(if (or full-test (= snd-test 9))
	...
	(let ((mix-id (mix "oboe.snd" 100)))
	  ...
	  (if (not (= (data-format (list mix-id)) 1)) (snd-print (format #f ";mix oboe: format ~A?" (data-format (list mix-id)))))
