...
(if (or full-test (= snd-test 5) (and keep-going (<= snd-test 5)))
	...
	(let ((nmx (maxamp ind1 0)))
	  ...
	  (if (not (equal? (edit-fragment 1 ind1 0) (list "scale-by 2.0000" "lambda" 0 50828)))
	      (snd-display ";scale-sound-by: ~A?" (edit-fragment 1 ind1 0))))
	(scale-sound-to 0.5)
	(let ((nmx (maxamp ind1 0)))
	  (if (fneq nmx 0.5) (snd-display ";scale-sound-to 0.5: ~A?" nmx))
	  (if (not (equal? (edit-fragment 2 ind1 0) (list "scale-by 1.6978" "lambda" 0 50828)))
	...
	(let ((nmx (maxamp ind1 0)))
	  ...
	  (if (not (equal? (edit-fragment 3 ind1 0) (list "scale-sound-by 0.0000 0 1000" "lambda" 0 1000)))
	...
	(let ((oldv (samples->vct 12000 10 ind1 0)))
	  ...
	  (if (not (equal? (edit-fragment 1 ind1 0) (list "scale-sound-by 2.0000 12000 10" "lambda" 12000 10)))
	...
	(if (not (equal? (edit-fragment 3 ind2 1) (list "scale-sound-by 0.0000 0 1000" "lambda" 0 1000)))
	  ...
	  (let ((snd-return-key #xFF0D)
		...
		(let ((ls (left-sample))
		  ...
		  (let ((fr (frames)))
		    ...
		    (if (not (string=? (car (edit-fragment 4)) "scale-sound-by 0.0000 5001 1"))
