...
(if (or full-test (= snd-test 4))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-aifc)) 
	      (snd-print (format #f ";save-as aifc -> ~A?" (header-type ab))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-raw)) 
	      (snd-print (format #f ";save-as raw -> ~A?" (header-type ab))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-nist)) 
	      (snd-print (format #f ";save-as nist -> ~A?" (header-type ab))))
	  ...
	  (if (not (= (data-format ab) mus-bint)) 
	      (snd-print (format #f ";save-as int -> ~A?" (data-format ab))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-riff)) 
	      (snd-print (format #f ";save-as riff -> ~A?" (header-type ab))))
	  ...
	  (if (not (= (data-format ab) mus-lfloat)) 
	      (snd-print (format #f ";save-as float -> ~A?" (data-format ab))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-aiff)) 
	      (snd-print (format #f ";save-as aiff -> ~A?" (header-type ab))))
	  ...
	  (if (not (= (data-format ab) mus-b24int))
	      (snd-print (format #f ";save-as 24-bit -> ~A?" (data-format ab))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-ircam)) 
	      (snd-print (format #f ";save-as ircam -> ~A?" (header-type ab))))
	  ...
	  (if (not (= (data-format ab) mus-mulaw))
	      (snd-print (format #f ";save-as mulaw -> ~A?" (data-format ab))))
	...
	(let ((ab (open-sound "test.snd")))
	  (if (not (= (header-type ab) mus-next)) 
	      (snd-print (format #f ";save-as next -> ~A?" (header-type ab))))
	  ...
	  (if (not (= (data-format ab) mus-alaw)) 
	      (snd-print (format #f ";save-as alaw -> ~A?" (data-format ab))))
	...
	(let ((ab (open-sound "test.snd")))
	  ...
	  (if (not (= (data-format ab) mus-bshort)) 
	      (snd-print (format #f ";save-as short -> ~A?" (data-format ab))))
