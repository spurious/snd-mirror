    ...
    (begin
	  ...
	  (if (provided? 'snd-motif)
		...
		(let* ((ind (open-sound "pistol.snd"))
		  ...
		  (move-scroll (find-child sctrls "srate") 10)
		...
		(let ((statsd (|Widget (list-ref (dialog-widgets) 20))))
		  ...
		  (click-button (cadr (|XmMessageBoxGetChild statsd |XmDIALOG_OK_BUTTON)))
		  (click-button (cadr (|XmMessageBoxGetChild statsd |XmDIALOG_CANCEL_BUTTON)))
