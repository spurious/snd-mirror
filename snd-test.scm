...
(if (or full-test (= snd-test 4))
    (let ((chns (mus-sound-chans "oboe.snd"))
	  ...
	  (snd-print (format #f ";mus-sound-comment \"nasahal8.wav\") -> ~A?" com)))
	  ...
	  (snd-print (format #f ";mus-sound-comment \"8svx-8.snd\") -> ~A?" com)))
	  ...
	  (snd-print (format #f ";mus-sound-comment \"wood.maud\") -> ~A?" com)))
	  ...
	  (snd-print (format #f ";mus-sound-comment \"nasahal.pat\") -> ~A?" com)))
	  ...
	  (snd-print (format #f ";mus-sound-comment \"telephone.wav\") -> ~A?" com)))
...
(if (or full-test (= snd-test 6))
	...
	(let ((vn (make-vct 32))
	  ...
	  (let ((vnew (vct-subseq vn 3)))
	    (if (fneq (vct-ref vnew 0) 3.0) (snd-print (format #f ";vct-subseq[3:] ~A?" (vct-ref vnew 0))))
	    (if (not (= (vct-length vnew) 29)) (snd-print (format #f ";vct-subseq[3:] length: ~A?" (vct-length vnew)))))
	  (let ((vnew (vct-subseq vn 3 8)))
	    (if (fneq (vct-ref vnew 0) 3.0) (snd-print (format #f ";vct-subseq[3:8] ~A?" (vct-ref vnew 0))))
	    (if (not (= (vct-length vnew) 6)) (snd-print (format #f ";vct-subseq[3:8] length: ~A?" (vct-length vnew)))))
	  (vct-subseq vn 3 3 vs)
	  (if (or (fneq (vct-ref vs 0) 3.0)
		  (fneq (vct-ref vs 1) 0.0)
		  (fneq (vct-ref vs 2) 0.0))
	      (snd-print (format #f ";vct-subseq[3:3->vs] ~A?" vs)))
	  (vct-subseq vn 0 32 vs)
	  (if (not (= (vct-length vs) 3)) (snd-print (format #f ";vct-subseq[0:32->vs] length: ~A?" (vct-length vs))))
	  (vct-subseq vn 2 3 vss)
	  (if (fneq (vct-ref vss 0) 2.0) (snd-print (format #f ";vct-subseq[2:3->vss] ~A?" (vct-ref vss 0))))
	  (vct-set! vb 8 123.0)
	  (vct-subseq vn 1 8 vb)
	  (if (fneq (vct-ref vb 0) 1.0) (snd-print (format #f ";vct-subseq[1:8->vb] ~A?" (vct-ref vb 0))))
	  (if (fneq (vct-ref vb 8) 123.0) (snd-print (format #f ";vct-subseq[1:8->vb][8] ~A?" (vct-ref vb 8)))))
