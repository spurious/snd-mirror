...
(define (read-bytevector . args) (->bytevector (apply write-string args)))
    ...
    `(begin
	  ...
	  (lambda (field)
	    (if (pair? field)
		    ...
		    (values)
		    (if (null? (cddr field))
		        `(define ,(cadr field) (lambda (obj) (obj ',(car field))))
		        `(begin
			   (define ,(cadr field) (lambda (obj) (obj ',(car field))))
			   (define ,(caddr field) (lambda (obj val) (set! (obj ',(car field)) val))))))))
	  fields)
